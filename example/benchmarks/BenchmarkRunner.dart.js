...
$$._OptionsImpl = {"":"Object;_arguments",
 get$arguments: function() {
  if (this._arguments == null) {
    ...
    this._arguments = $.getInterceptor$JSArray(t1).getRange$2(t1, 0, $.getInterceptor$JSStringJSArray(t1).get$length(t1));
  }
  return this._arguments;
}
};

$$.DoubleLinkedQueueEntry = {"":"Object;_previous=,_liblib$_next=,_element>",
 ...
 append$1: function(e) {
  $.DoubleLinkedQueueEntry$(e)._link$2(this, this._liblib$_next);
},
 prepend$1: function(e) {
  $.DoubleLinkedQueueEntry$(e)._link$2(this._previous, this);
},
 remove$0: function() {
  var t1 = this._liblib$_next;
  this._previous.set$_liblib$_next(t1);
  t1 = this._previous;
  this._liblib$_next.set$_previous(t1);
...
$$._DoubleLinkedQueueEntrySentinel = {"":"DoubleLinkedQueueEntry;_previous,_liblib$_next,_element",
 remove$0: function() {
...
$$.DoubleLinkedQueue = {"":"Object;_sentinel",
 ...
 removeFirst$0: function() {
  return this._sentinel._liblib$_next.remove$0();
},
 ...
 forEach$1: function(f) {
  var entry, nextEntry;
  entry = this._sentinel._liblib$_next;
  for (; !(entry === this._sentinel); entry = nextEntry) {
    nextEntry = entry.get$_liblib$_next();
...
$$._DoubleLinkedQueueIterator = {"":"Object;_sentinel,_currentEntry",
 get$hasNext: function() {
  var t1, t2;
  t1 = this._currentEntry.get$_liblib$_next();
  t2 = this._sentinel;
 ...
 next$0: function() {
  if (this.get$hasNext() !== true)
    throw $.$$throw($.StateError$("No more elements"));
  this._currentEntry = this._currentEntry.get$_liblib$_next();
...
$$._StopwatchImpl = {"":"Object;_start,_stop",
 start$0: function() {
  ...
  if (this._start == null)
    ...
    t3 = this._stop;
    if (typeof t3 !== 'number')
      return this.start$0$bailout(2, t3, t1);
    t5 = this._start;
    if (typeof t5 !== 'number')
      return this.start$0$bailout(3, t3, t5, t1);
...
$$.BenchmarkRunner = {"":"Object;_solveLoops,_steps,_benchmarks,_resultsWriter",
 setupBenchmarks$1: function(filter) {
  ...
  if (filter == null || $.getInterceptor$JSStringJSArray(filter).get$isEmpty(filter) === true)
    $.CONSTANT0.map$1(benchmarks, this.get$_addBenchmark());
  else
    benchmarks.where$1(new $.BenchmarkRunner_setupBenchmarks_anon($.getInterceptor$JSString(filter).split$1(filter, ",").mappedBy$1(new $.BenchmarkRunner_setupBenchmarks_anon0()))).mappedBy$1(this.get$_addBenchmark());
},
 runBenchmarks$0: function() {
  var t1, t2, t3, t4;
  for (t1 = $.CONSTANT0.iterator$0(this._benchmarks), t2 = this._resultsWriter, t3 = $.getInterceptor$JSArray(t2); t1.get$hasNext() === true;) {
    t4 = t1.next$0();
    $.print("Running " + $.S(t4.get$name()));
    t3.clear$0(t2);
 ...
 get$_addBenchmark: function() {
  return new $.BoundClosure0(this, '_addBenchmark$1');
}
};

$$.Benchmark = {"":"Object;bodies>",
 resetWorld$0: function() {
  this.bodies = $.List_List(null);
 ...
 runBenchmark$1: function(resultsWriter) {
  ...
  for (t1 = this._steps, t1 = $.getInterceptor$JSArray(t1).iterator$0(t1), t2 = this.solveLoops, t3 = $.getInterceptor$JSArray(t2); t1.get$hasNext() === true;) {
    t4 = t1.next$0();
    if (typeof t4 !== 'number')
      return this.runBenchmark$1$bailout(1, resultsWriter, t1, t2, t4, t3);
    for (t5 = t3.iterator$0(t2); t5.get$hasNext() === true;) {
      t6 = t5.next$0();
      this.initialize$0();
 ...
 runBenchmark$1$bailout: function(state0, env0, env1, env2, env3, env4) {
  switch (state0) {
    case 1:
      t3 = env4;
      t4 = env3;
  ...
  switch (state0) {
    ...
    case 1:
      var t1, t2, t3, t4, resultsWriter, t5, t6, watch, i;
      L0:
        while (true)
          switch (state0) {
            case 0:
 ...
 get$checksum: function() {
  ...
  for (t1 = this.bodies, t1 = $.getInterceptor$JSArray(t1).iterator$0(t1); t1.get$hasNext() === true;) {
    t2 = t1.next$0();
...
$$.BallCageBench = {"":"Benchmark;bodies,world,solveLoops,_steps",
 ...
 initialize$0: function() {
  ...
  for (i = 0; i < 10; ++i) {
    ...
    t1 = this.bodies;
    $.getInterceptor$JSArray(t1).add$1(t1, circleBody);
  ...
  t1 = this.bodies;
  $.getInterceptor$JSArray(t1).add$1(t1, activeBody);
...
$$.BallDropBench = {"":"Benchmark;bodies,world,solveLoops,_steps",
 initialize$0: function() {
  ...
  t1 = this.bodies;
  $.getInterceptor$JSArray(t1).add$1(t1, ballBody);
},
 get$name: function() {
  return "Ball Drop";
}
...
$$.CircleStressBench = {"":"Benchmark;_joint,bodies,world,solveLoops,_steps",
 ...
 initialize$0: function() {
  var bd, ground, t1, shape, sd, b, fd, wallDef, rightWall, leftWall, cornerDef, myBod, topDef, topBody, body, i, cd, xPos, t2, yPos, bodyDef, groundBody, rjd, j, circ, bod, fd2, myBody;
  this.resetWorld$0();
  bd = $.BodyDef$();
  ground = this.world.createBody$1(bd);
  t1 = this.bodies;
  $.getInterceptor$JSArray(t1).add$1(t1, ground);
  shape = $.PolygonShape$();
  ...
  t1 = this.bodies;
  $.getInterceptor$JSArray(t1).add$1(t1, rightWall);
  rightWall.createFixtureFromShape$1(sd);
  wallDef.position = $.Vector$(-45, 25);
  leftWall = this.world.createBody$1(wallDef);
  t1 = this.bodies;
  $.getInterceptor$JSArray(t1).add$1(t1, leftWall);
  ...
  t1 = this.bodies;
  $.getInterceptor$JSArray(t1).add$1(t1, myBod);
  ...
  t1 = this.bodies;
  $.getInterceptor$JSArray(t1).add$1(t1, topBody);
  fd.shape = sd;
  fd.friction = 1;
  ...
  t1 = this.bodies;
  $.getInterceptor$JSArray(t1).add$1(t1, body);
  for (i = 0; i < 5; ++i) {
    fd = $.FixtureDef$();
    cd = $.CircleShape$();
    cd.radius = 1.2;
  ...
  for (j = 0; j < 8; ++j)
    for (yPos = 50 + j, i = 0; i < 20; ++i) {
      ...
      t1 = this.bodies;
      $.getInterceptor$JSArray(t1).add$1(t1, myBody);
...
$$.DominoPlatformBench = {"":"Benchmark;bodies,world,solveLoops,_steps",
 ...
 initialize$0: function() {
  var fd, sd, bd, body, t1, i, t2, t3, j, t4, myBody;
  this.resetWorld$0();
  fd = $.FixtureDef$();
  sd = $.PolygonShape$();
  sd.setAsBox$2(50, 10);
  ...
  for (i = 0; i < 4; ++i)
    for (t1 = i === 2, t2 = 7.3 + 5 * i, t3 = i === 3, j = 0; j < 25; ++j) {
      ...
      t4 = this.bodies;
      $.getInterceptor$JSArray(t4).add$1(t4, myBody);
    }
}
};
...
$$.ArgParser = {"":"Object;_options,_optionNames,_args,_current",
 ...
 _addOption$10$allowMultiple$isFlag$negatable: function(name$, abbr, help, allowed, allowedHelp, defaultsTo, callback, allowMultiple, isFlag, negatable) {
  ...
  if (!(abbr == null)) {
    if ($.gtB($.getInterceptor$JSStringJSArray(abbr).get$length(abbr), 1))
  ...
  $.indexSet(t1, name$, $._Option$(name$, abbr, help, allowed, allowedHelp, defaultsTo, callback, allowMultiple, isFlag, negatable));
 ...
 _findByAbbr$1: function(abbr) {
  var t1, t2;
  for (t1 = this._options.get$values(), t1 = $.getInterceptor$JSArray(t1).iterator$0(t1); t1.get$hasNext() === true;) {
    t2 = t1.next$0();
    if ($.eqB(t2.get$abbreviation(), abbr))
      return t2;
  }
  return;
}
...
$$.Collision = {"":"Object;_pool,cache,input,output,results1,results2,incidentEdge>,localTangent,localNormal>,planePoint,tangent,normal>,normal1,v11,v12,clipPoints1,clipPoints2",
 ...
 edgeSeparation$5: function(poly1, xf1, edge1, poly2, xf2) {
  var vertices1, normals1, count2, vertices2, R, v, t5, t6, t8, t10, t11, t13, normal1Worldy, normal1Worldx, R1, t15, normal1x, t18, normal1y, t1, t2, index, minDot, i, a, t3, dot, v3, t4, v1y, t17, t19, v1x, v4, t22, t24, t26, t28, v2y, t30, t32, t34, t36, t38;
  ...
  for (t1 = $.getInterceptor$JSStringJSArray(vertices2), t2 = vertices2.length, index = 0, minDot = 99999999999999, i = 0; i < count2; ++i) {
    if (i >= t2)
      throw $.ioore(i);
    a = vertices2[i];
    t3 = a.get$x();
    if (t3 !== (t3 | 0))
      return this.edgeSeparation$5$bailout(17, xf1, edge1, xf2, normal1Worldx, R1, vertices1, count2, vertices2, R, index, minDot, normal1x, i, t1, a, t3, normal1y, normal1Worldy);
    t3 *= normal1x;
    t5 = a.get$y();
    if (t5 !== (t5 | 0))
      return this.edgeSeparation$5$bailout(18, xf1, edge1, xf2, normal1Worldx, R1, vertices1, count2, vertices2, R, index, minDot, normal1x, i, t1, normal1Worldy, normal1y, t3, t5);
    dot = t3 + t5 * normal1y;
    if (dot < minDot) {
      minDot = dot;
      index = i;
  ...
  if (typeof t2 !== 'number')
    return this.edgeSeparation$5$bailout(19, xf1, v3, xf2, t2, normal1Worldx, R1, t1, vertices2, normal1Worldy, R, index);
  t4 = R.get$col1().get$y();
  if (typeof t4 !== 'number')
  ...
  t8 = R.get$col2().get$y();
  if (typeof t8 !== 'number')
    return this.edgeSeparation$5$bailout(22, xf1, xf2, normal1Worldx, R1, vertices2, R, index, v3, t1, t2, normal1Worldy, t8);
  t10 = v3.get$y();
  if (typeof t10 !== 'number')
    return this.edgeSeparation$5$bailout(23, xf1, xf2, normal1Worldx, R1, vertices2, R, index, v3, t1, t2, normal1Worldy, t8, t10);
  v1y = t2 + t8 * t10;
  t2 = xf1.get$position().get$x();
  if (typeof t2 !== 'number')
    return this.edgeSeparation$5$bailout(24, v1y, v3, xf2, t2, normal1Worldx, R1, t1, vertices2, normal1Worldy, R, index);
  ...
  if (typeof t17 !== 'number')
    return this.edgeSeparation$5$bailout(27, normal1Worldy, v1y, v3, xf2, normal1Worldx, R1, t1, t2, vertices2, t17, index);
  t19 = v3.get$y();
  if (typeof t19 !== 'number')
    return this.edgeSeparation$5$bailout(28, normal1Worldy, v1y, xf2, normal1Worldx, R1, t1, t2, vertices2, t17, index, t19);
  v1x = t2 + t17 * t19;
 ...
 edgeSeparation$5$bailout: function(state0, env0, env1, env2, env3, env4, env5, env6, env7, env8, env9, env10, env11, env12, env13, env14, env15, env16, env17) {
  ...
  switch (state0) {
    ...
    case 37:
      ...
      t37 = v4.get$y();
    case 38:
      var vertices1, xf2, poly2, edge1, xf1, poly1, normals1, count2, vertices2, R, v, t5, t7, t10, normal1Worldy, t13, t16, normal1Worldx, R1, t19, normal1x, t22, normal1y, t1, index, minDot, i, a, t2, t4, dot, v3, t6, t8, v1y, t15, t17, v1x, v4, t21, t23, t25, t27, v2y, t29, t31, t33, t35, t37;
      state0 = 0;
 ...
 findIncidentEdge$6: function(c, poly1, xf1, edge1, poly2, xf2) {
  var normals1, count2, vertices2, normals2, t3, t4, t5, i, index, minDot, t1, dot, i2, t2;
  poly1.get$vertexCount();
  normals1 = poly1.get$normals();
  count2 = poly2.get$vertexCount();
  if (typeof count2 !== 'number')
  ...
  for (i = 0, index = 0, minDot = 99999999999999; i < count2; ++i) {
 ...
 findIncidentEdge$6$bailout: function(state0, env0, env1, env2, env3, env4, env5, env6, env7) {
  ...
  switch (state0) {
    ...
    case 1:
      ...
      normals2 = poly2.get$normals();
    case 2:
      var normals1, count2, xf2, poly2, edge1, xf1, c, vertices2, normals2, t3, t4, t5, t1, i, index, minDot, t2, dot, i2;
      state0 = 0;
      t3 = xf1.get$rotation();
      t4 = $.getInterceptor$JSStringJSArray(normals1).operator$index$1(normals1, edge1);
      t5 = this.normal1;
      $.Matrix22_mulMatrixAndVectorToOut(t3, t4, t5);
      $.Matrix22_mulTransMatrixAndVectorToOut(xf2.get$rotation(), t5, t5);
      for (t1 = $.getInterceptor$JSStringJSArray(normals2), i = 0, index = 0, minDot = 99999999999999; $.ltB(i, count2); ++i) {
 ...
 collidePolygons$5: function(manifold, polyA, xfA, polyB, xfB) {
  ...
  if (typeof frontOffset !== 'number')
    return this.collidePolygons$5$bailout(2, manifold, t8, xf2, t3, frontOffset, totalRadius, t1, t2, t4, t5, t6, flip);
...
$$.Distance = {"":"Object;calls,iters,maxIters,simplex,saveA,saveB,closestPoint,searchDirection,temp,normal>",
 distance$3: function(output, cache, input) {
  var proxyA, proxyB, transformA, transformB, t1, vertices, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, iter, saveCount, i, t12, vertex, t13, duplicate, rA, rB;
  ...
  for (t3 = this.saveB, t4 = t3.length, t5 = this.saveA, t6 = t5.length, t7 = vertices.length, t8 = transformA.rotation, t9 = this.searchDirection, t10 = this.temp, t11 = transformB.rotation, iter = 0; iter < this.maxIters;) {
    ...
    $.Transform_mulToOut(transformA, $.getInterceptor$JSStringJSArray(t12).operator$index$1(t12, vertex.get$indexA()), vertex.get$wA());
    ...
    $.Transform_mulToOut(transformB, $.getInterceptor$JSStringJSArray(t13).operator$index$1(t13, vertex.get$indexB()), vertex.get$wB());
...
$$.DistanceProxy = {"":"Object;vertices>,count>,radius=",
 ...
 getSupport$1: function(direction) {
  ...
  t6 = direction.x;
  if (typeof t6 !== 'number')
    return this.getSupport$1$bailout(2, direction, t6, t4, t2, t1, t3);
  t4 *= t6;
  t3 = t3.get$y();
  if (typeof t3 !== 'number')
  ...
  t9 = direction.y;
  if (typeof t9 !== 'number')
    return this.getSupport$1$bailout(4, direction, t9, t2, t4, t3, t1);
  bestValue = t4 + t3 * t9;
  i = 1;
  bestIndex = 0;
  while (true) {
    t3 = this.count;
    if (typeof t3 !== 'number')
      return this.getSupport$1$bailout(5, direction, t3, i, bestIndex, t2, bestValue, t1);
    if (!(i < t3))
      break;
    if (i >= t2)
      throw $.ioore(i);
    ...
    t4 = t3.get$x();
    if (typeof t4 !== 'number')
      return this.getSupport$1$bailout(6, direction, t4, t3, i, bestIndex, t2, bestValue, t1);
    t4 *= t6;
    t3 = t3.get$y();
    if (typeof t3 !== 'number')
      return this.getSupport$1$bailout(8, direction, t4, t3, bestIndex, i, bestValue, t2, t1);
    value = t4 + t3 * t9;
    if (value > bestValue) {
      bestValue = value;
      bestIndex = i;
...
$$.Manifold = {"":"Object;points>,localNormal>,localPoint>,type=,pointCount=",
 setFrom$1: function(other) {
  ...
  while (true) {
    ...
    if (typeof t3 !== 'number')
      return this.setFrom$1$bailout1(1, other, t3, t2, i, t1);
    if (!(i < t3))
      break;
    if (i >= t2)
      throw $.ioore(i);
...
$$.Simplex = {"":"Object;v1,v2,v3,vertices>,count>,e13,e23,e12,case2,case22,case3,case33",
 readCache$5: function(cache, proxyA, transformA, proxyB, transformB) {
  var t1, t2, t3, t5, t6, i, v, t4, wALocal, wBLocal, metric1, metric2;
  this.count = cache.count;
  t1 = this.vertices;
  t2 = t1.length;
  t3 = cache.indexA;
  if (typeof t3 !== 'string' && (typeof t3 !== 'object' || t3 === null || t3.constructor !== Array && !t3.is$JavaScriptIndexingBehavior))
    return this.readCache$5$bailout(1, cache, proxyA, transformA, proxyB, transformB, t2, t3, t1);
  ...
  if (typeof t6 !== 'string' && (typeof t6 !== 'object' || t6 === null || t6.constructor !== Array && !t6.is$JavaScriptIndexingBehavior))
    return this.readCache$5$bailout(2, cache, proxyA, transformA, t6, transformB, t2, proxyB, t3, t1, t5);
  i = 0;
  for (; $.ltB(i, this.count); ++i) {
    ...
    wALocal = $.getInterceptor$JSStringJSArray(t4).operator$index$1(t4, v.get$indexA());
    t4 = proxyB.get$vertices();
    wBLocal = $.getInterceptor$JSStringJSArray(t4).operator$index$1(t4, v.get$indexB());
 ...
 readCache$5$bailout: function(state0, env0, env1, env2, env3, env4, env5, env6, env7, env8, env9) {
  switch (state0) {
    case 1:
      t1 = env7;
      t3 = env6;
  ...
  switch (state0) {
    ...
    case 1:
      ...
      t6 = cache.indexB;
    case 2:
      var t1, t2, t3, transformB, proxyB, transformA, proxyA, cache, t5, t6, t8, i, v, t4, wALocal, wBLocal, metric1, metric2;
      state0 = 0;
      ...
      for (; $.ltB(i, this.count); ++i) {
        if (i >= t2)
          throw $.ioore(i);
        v = t1[i];
        v.set$indexA(t5.operator$index$1(t3, i));
        v.set$indexB(t8.operator$index$1(t6, i));
        t4 = proxyA.get$vertices();
        wALocal = $.getInterceptor$JSStringJSArray(t4).operator$index$1(t4, v.get$indexA());
        t4 = proxyB.get$vertices();
        wBLocal = $.getInterceptor$JSStringJSArray(t4).operator$index$1(t4, v.get$indexB());
 ...
 writeCache$1: function(cache) {
  ...
  if (typeof t5 !== 'object' || t5 === null || (t5.constructor !== Array || !!t5.immutable$list) && !t5.is$JavaScriptIndexingBehavior)
    return this.writeCache$1$bailout(2, t1, t5, t4, t3);
  i = 0;
  for (; $.ltB(i, this.count); ++i) {
    if (i >= t4)
      throw $.ioore(i);
...
$$.TimeOfImpact = {"":"Object;cache,distanceInput,xfA,xfB,distanceOutput,fcn,indexes,sweepA>,sweepB>,pool",
 timeOfImpact$2: function(output, input) {
  ...
  for (t1 = this.fcn, t2 = this.indexes, t5 = t2.length, t6 = target + 0.00125, t7 = target - 0.00125, t8 = this.distanceOutput, t9 = this.xfA, t11 = this.xfB, t13 = this.pool, t14 = 0, iter = 0; true;) {
    ...
    t15 = t8.distance;
    if (typeof t15 !== 'number')
      return this.timeOfImpact$2$bailout(5, output, t11, t1, target, t2, t7, t13, proxyA, proxyB, t15, t3, t4, t6, t8, t10, t14, tMax, iter, t12, t5, t9);
    if (t15 <= 0) {
      output.set$state(2);
      output.set$t(0);
      break;
    ...
    for (t20 = tMax, pushBackIter = 0; done = false, true;) {
      ...
      if (typeof s2 !== 'number')
        return this.timeOfImpact$2$bailout(7, output, t20, pushBackIter, t11, s2, t13, proxyA, proxyB, t8, tMax, t1, target, t2, t7, t3, t4, t6, t10, t14, t12, iter, t5, t9);
      if (s2 > t6) {
        output.set$state(4);
        output.set$t(tMax);
        done = true;
      ...
      if (typeof s1 !== 'number')
        return this.timeOfImpact$2$bailout(8, output, t20, pushBackIter, t11, s2, t13, proxyA, proxyB, t8, tMax, t1, target, t2, s1, t7, t3, t4, t6, t10, t14, t12, iter, t5, t9);
      if (s1 < t7) {
        output.set$state(1);
        output.set$t(t14);
        done = true;
      ...
      for (a2 = t20, a1 = t14, rootIterCount = 0; true;) {
        ...
        if (typeof s !== 'number')
          return this.timeOfImpact$2$bailout(9, output, t20, pushBackIter, a2, t11, t9, t13, proxyA, s2, proxyB, t8, t5, tMax, t1, target, t2, t7, t, t3, t4, t6, s, t10, t14, t12, iter, s1, rootIterCount, a1);
        t15 = $.CONSTANT1.abs$0(s - target);
        if (typeof t15 !== 'number')
          return this.timeOfImpact$2$bailout(10, output, t20, pushBackIter, a2, t11, t9, t13, proxyA, s2, proxyB, t8, t5, tMax, t1, target, t2, t7, t, t3, t4, t6, s, t10, t14, t15, iter, t12, s1, rootIterCount, a1);
        if (t15 < 0.00125) {
          t20 = t;
          break;
        }
        ...
        if (a1 !== (a1 | 0))
          return this.timeOfImpact$2$bailout(11, output, t20, pushBackIter, t11, t9, s1, a1, a2, s2, t13, proxyA, proxyB, t8, tMax, t1, target, t2, t7, t3, t4, t6, t10, t14, t12, iter, rootIterCount, t5);
        ++rootIterCount;
        t16 = $.TimeOfImpact_toiRootIters;
        if (typeof t16 !== 'number')
          return this.timeOfImpact$2$bailout(12, output, t20, pushBackIter, t11, s1, a1, a2, s2, rootIterCount, t16, proxyA, t13, proxyB, t8, tMax, t1, target, t2, t7, t3, t4, t6, t10, t14, t12, iter, t5, t9);
        $.TimeOfImpact_toiRootIters = t16 + 1;
        if (rootIterCount === 50)
          break;
      }
      if (t20 !== (t20 | 0))
        return this.timeOfImpact$2$bailout(13, output, t11, pushBackIter, t13, proxyA, proxyB, t8, tMax, rootIterCount, t1, target, t2, t7, t20, t3, t4, t6, t10, t14, t12, iter, t5, t9);
    ...
    if (typeof t15 !== 'number')
      return this.timeOfImpact$2$bailout(14, output, t11, t14, t1, target, done, t7, t2, t13, iter, t15, proxyA, proxyB, t3, t4, t6, t8, t10, t12, tMax, t5, t9);
...
$$.SeparationFunction = {"":"Object;proxyA=,proxyB=,type=,localPoint>,axis,sweepA>,sweepB>,localPointA,localPointB,pointA,pointB,localPointA1,localPointA2,normal>,localPointB1,localPointB2,axisA,axisB,temp,xfa,xfb",
 initialize$6: function(cache, argProxyA, argSweepA, argProxyB, argSweepB, t1) {
  var count, t3, t4, t5, t2, t6, t7, t9, t10, t12, t13, t15, t8, t11, t14, t16, t17, t18, s;
  ...
  if (count === 1) {
    ...
    if (typeof t7 !== 'string' && (typeof t7 !== 'object' || t7 === null || t7.constructor !== Array && !t7.is$JavaScriptIndexingBehavior))
      return this.initialize$6$bailout(3, cache, t4, t5, t1, t7, t2, t6);
    if (0 >= t7.length)
      throw $.ioore(0);
    t7 = t7[0];
    if (t7 !== (t7 | 0))
    ...
    if (typeof t10 !== 'string' && (typeof t10 !== 'object' || t10 === null || t10.constructor !== Array && !t10.is$JavaScriptIndexingBehavior))
      return this.initialize$6$bailout(4, cache, t4, t5, t1, t10, t9);
    ...
    if (typeof t13 !== 'string' && (typeof t13 !== 'object' || t13 === null || t13.constructor !== Array && !t13.is$JavaScriptIndexingBehavior))
      return this.initialize$6$bailout(5, t4, t5, t1, t10, t12, t9, t13);
    if (0 >= t13.length)
      throw $.ioore(0);
    t13 = t13[0];
    if (t13 !== (t13 | 0))
    ...
    if (typeof t8 !== 'string' && (typeof t8 !== 'object' || t8 === null || t8.constructor !== Array && !t8.is$JavaScriptIndexingBehavior))
      return this.initialize$6$bailout(7, t4, t3, t5, t1, t7, t8);
    t10 = this.pointA;
    t11 = this.axis;
    t12 = this.temp;
    t13 = this.normal;
    t14 = this.localPoint;
    t15 = this.pointB;
    t16 = $.getInterceptor$JSStringJSArray(t8);
    if (t7) {
      this.type = 2;
      t2 = this.localPointB1;
      t6 = this.proxyB.get$vertices();
      if (typeof t6 !== 'string' && (typeof t6 !== 'object' || t6 === null || t6.constructor !== Array && !t6.is$JavaScriptIndexingBehavior))
        return this.initialize$6$bailout(8, t15, t3, t1, t10, t2, t8, t6, t12, t4, t5, t11, t13, t14);
      if (0 >= t8.length)
        throw $.ioore(0);
      t9 = t8[0];
      if (t9 !== (t9 | 0))
      ...
      if (typeof t18 !== 'string' && (typeof t18 !== 'object' || t18 === null || t18.constructor !== Array && !t18.is$JavaScriptIndexingBehavior))
        return this.initialize$6$bailout(9, t15, t3, t1, t10, t2, t8, t17, t12, t4, t16, t5, t11, t18, t13, t14);
      if (1 >= t8.length)
        throw $.ioore(1);
      t8 = t8[1];
      if (t8 !== (t8 | 0))
        throw $.iae(t8);
      if (t8 < 0 || t8 >= t18.length)
        throw $.ioore(t8);
      t17.setFrom$1(t18[t8]);
      t12.setFrom$1(t17).subLocal$1(t2);
      $.Vector_crossVectorAndNumToOut(t12, 1, t11);
      t11.normalize$0();
      $.Matrix22_mulMatrixAndVectorToOut(t5.rotation, t11, t13);
      t14.setFrom$1(t2);
      t14.addLocal$1(t17);
      t14.mulLocal$1(0.5);
      $.Transform_mulToOut(t5, t14, t15);
      ...
      if (typeof t5 !== 'string' && (typeof t5 !== 'object' || t5 === null || t5.constructor !== Array && !t5.is$JavaScriptIndexingBehavior))
        return this.initialize$6$bailout(10, t12, t15, t4, t14, t11, t3, t5, t10, t13, t1);
      if (0 >= t1.length)
        throw $.ioore(0);
      t1 = t1[0];
      if (t1 !== (t1 | 0))
      ...
      if (t1 < 0 || t1 >= t5.length)
        throw $.ioore(t1);
      t14.setFrom$1(t5[t1]);
      $.Transform_mulToOut(t4, t14, t10);
      t12.setFrom$1(t10);
      t12.subLocal$1(t15);
      t15 = t12.x;
      if (typeof t15 !== 'number')
        return this.initialize$6$bailout(11, t12, t13, t11, t15);
      t14 = t13.x;
      if (typeof t14 !== 'number')
        return this.initialize$6$bailout(12, t12, t13, t11, t15, t14);
      t14 = t15 * t14;
      t12 = t12.y;
      if (typeof t12 !== 'number')
        return this.initialize$6$bailout(13, t12, t13, t11, t14);
      t13 = t13.y;
      if (typeof t13 !== 'number')
        return this.initialize$6$bailout(14, t12, t13, t11, t14);
      s = t14 + t12 * t13;
      if (s < 0) {
        t11.negateLocal$0();
        s = -s;
      ...
      if (typeof t6 !== 'string' && (typeof t6 !== 'object' || t6 === null || t6.constructor !== Array && !t6.is$JavaScriptIndexingBehavior))
        return this.initialize$6$bailout(15, t15, t3, t1, t10, t8, t6, t12, t4, t5, t11, t2, t13, t14);
      if (0 >= t1.length)
        throw $.ioore(0);
      t9 = t1[0];
      if (t9 !== (t9 | 0))
      ...
      if (typeof t17 !== 'string' && (typeof t17 !== 'object' || t17 === null || t17.constructor !== Array && !t17.is$JavaScriptIndexingBehavior))
        return this.initialize$6$bailout(16, t15, t3, t1, t10, t8, t12, t4, t5, t11, t2, t17, t16, t13, t14);
      if (1 >= t1.length)
        throw $.ioore(1);
      t1 = t1[1];
      if (t1 !== (t1 | 0))
        throw $.iae(t1);
      if (t1 < 0 || t1 >= t17.length)
        throw $.ioore(t1);
      t16.setFrom$1(t17[t1]);
      t12.setFrom$1(t16);
      t12.subLocal$1(t2);
      $.Vector_crossVectorAndNumToOut(t12, 1, t11);
      t11.normalize$0();
      $.Matrix22_mulMatrixAndVectorToOut(t4.rotation, t11, t13);
      t14.setFrom$1(t2);
      t14.addLocal$1(t16);
      t14.mulLocal$1(0.5);
      $.Transform_mulToOut(t4, t14, t10);
      ...
      if (typeof t4 !== 'string' && (typeof t4 !== 'object' || t4 === null || t4.constructor !== Array && !t4.is$JavaScriptIndexingBehavior))
        return this.initialize$6$bailout(17, t12, t15, t5, t11, t10, t13, t8, t14, t4);
      if (0 >= t8.length)
        throw $.ioore(0);
      t8 = t8[0];
      if (t8 !== (t8 | 0))
      ...
      t10 = t12.x;
      if (typeof t10 !== 'number')
        return this.initialize$6$bailout(18, t12, t13, t10, t11);
      t14 = t13.x;
      if (typeof t14 !== 'number')
        return this.initialize$6$bailout(19, t12, t13, t10, t14, t11);
      t14 = t10 * t14;
      t12 = t12.y;
      if (typeof t12 !== 'number')
        return this.initialize$6$bailout(20, t13, t12, t11, t14);
      t13 = t13.y;
      if (typeof t13 !== 'number')
        return this.initialize$6$bailout(21, t12, t13, t14, t11);
      s = t14 + t12 * t13;
      if (s < 0) {
        t11.negateLocal$0();
        s = -s;
 ...
 initialize$6$bailout: function(state0, env0, env1, env2, env3, env4, env5, env6, env7, env8, env9, env10, env11, env12, env13, env14) {
  switch (state0) {
    case 1:
      count = env4;
      t1 = env3;
  ...
  switch (state0) {
    ...
    case 1:
      ...
      t3.getTransform$2(t5, t1);
    default:
      var count, t1, argSweepB, argSweepA, cache, t3, t4, t5, t2, t6, t7, t9, t10, t12, t13, t15, t11, t14, t16, t17, t18, s;
      if (state0 === 5 || state0 === 4 || state0 === 3 || state0 === 2 || state0 === 0 && $.eqB(count, 1))
        ...
        switch (state0) {
          ...
          case 6:
            state0 = 0;
            t3 = $.getInterceptor$JSStringJSArray(t1);
            t6 = $.eqB(t3.operator$index$1(t1, 0), t3.operator$index$1(t1, 1));
            t7 = cache.indexB;
          case 7:
            state0 = 0;
            t9 = this.pointA;
          ...
          default:
            if (state0 === 14 || state0 === 13 || state0 === 12 || state0 === 11 || state0 === 10 || state0 === 9 || state0 === 8 || state0 === 0 && t6)
              switch (state0) {
                ...
                case 8:
                  state0 = 0;
                  t15 = $.getInterceptor$JSStringJSArray(t6);
                  t16 = $.getInterceptor$JSStringJSArray(t7);
                  t2.setFrom$1(t15.operator$index$1(t6, t16.operator$index$1(t7, 0)));
                  t17 = this.localPointB2;
                  t18 = this.proxyB.get$vertices();
                case 9:
                  state0 = 0;
                  t17.setFrom$1($.getInterceptor$JSStringJSArray(t18).operator$index$1(t18, t16.operator$index$1(t7, 1)));
                  t11.setFrom$1(t17).subLocal$1(t2);
                ...
                case 10:
                  state0 = 0;
                  t13.setFrom$1($.getInterceptor$JSStringJSArray(t5).operator$index$1(t5, t3.operator$index$1(t1, 0)));
              ...
              switch (state0) {
                ...
                case 15:
                  state0 = 0;
                  t2.setFrom$1($.getInterceptor$JSStringJSArray(t6).operator$index$1(t6, t3.operator$index$1(t1, 0)));
                  t15 = this.localPointA2;
                  t16 = this.proxyA.get$vertices();
                case 16:
                  state0 = 0;
                  t15.setFrom$1($.getInterceptor$JSStringJSArray(t16).operator$index$1(t16, t3.operator$index$1(t1, 1)));
                  t11.setFrom$1(t15);
                  t11.subLocal$1(t2);
                  $.Vector_crossVectorAndNumToOut(t11, 1, t10);
                  t10.normalize$0();
                ...
                case 17:
                  state0 = 0;
                  t13.setFrom$1($.getInterceptor$JSStringJSArray(t4).operator$index$1(t4, $.getInterceptor$JSStringJSArray(t7).operator$index$1(t7, 0)));
                  $.Transform_mulToOut(t5, t13, t14);
                  t11.setFrom$1(t14);
                  t11.subLocal$1(t9);
                  t9 = t11.x;
 ...
 findMinSeparation$2: function(indexes, t) {
  ...
  switch (t1) {
    case 0:
      ...
      t8 = this.localPointA;
      t6 = this.proxyA.get$vertices();
      t8.setFrom$1($.getInterceptor$JSStringJSArray(t6).operator$index$1(t6, indexes[0]));
      t7 = this.localPointB;
      t1 = this.proxyB.get$vertices();
      t7.setFrom$1($.getInterceptor$JSStringJSArray(t1).operator$index$1(t1, indexes[1]));
      t9 = this.pointA;
      $.Transform_mulToOut(t2, t8, t9);
      t8 = this.pointB;
      $.Transform_mulToOut(t3, t7, t8);
      t9 = t8.subLocal$1(t9);
    ...
    case 1:
      ...
      t2.setFrom$1($.getInterceptor$JSStringJSArray(t5).operator$index$1(t5, indexes[1]));
      t7 = this.pointB;
      $.Transform_mulToOut(t3, t2, t7);
      t1 = t7.subLocal$1(t1);
    ...
    case 2:
      ...
      t3 = this.localPointA;
      t5 = this.proxyA.get$vertices();
      t3.setFrom$1($.getInterceptor$JSStringJSArray(t5).operator$index$1(t5, indexes[0]));
      t8 = this.pointA;
 ...
 rebalance$1: function(iterations) {
  ...
  for (i = 0; i < iterations; ++i) {
    ...
    while (true) {
      ...
      t2 = this._path;
      if (t2 !== (t2 | 0))
        return this.rebalance$1$bailout(2, iterations, i, bit, current, t2, t1);
      if (!t1)
        break;
...
$$.PolygonShape = {"":"Shape;centroid>,vertices>,normals>,vertexCount>,type,radius",
 getSupport$1: function(d) {
  ...
  t6 = t5.get$x();
  if (typeof t6 !== 'number')
    return this.getSupport$1$bailout0(2, d, t6, t1, t3, t5);
  t8 = d.x;
  if (typeof t8 !== 'number')
    return this.getSupport$1$bailout0(3, d, t3, t5, t6, t1, t8);
  t6 *= t8;
  t5 = t5.get$y();
  if (typeof t5 !== 'number')
    return this.getSupport$1$bailout0(4, d, t6, t5, t3, t1);
  t11 = d.y;
  if (typeof t11 !== 'number')
    return this.getSupport$1$bailout0(5, d, t3, t6, t5, t1, t11);
  bestValue = t6 + t5 * t11;
  bestIndex = 0;
  i = 1;
  while (true) {
    t2 = this.vertexCount;
    if (typeof t2 !== 'number')
      return this.getSupport$1$bailout0(6, d, t2, t3, bestIndex, bestValue, i, t1);
    if (!(i < t2))
      break;
    if (i >= t4)
      throw $.ioore(i);
    ...
    t5 = t2.get$x();
    if (typeof t5 !== 'number')
      return this.getSupport$1$bailout0(7, d, t2, t5, t3, bestIndex, bestValue, i, t1);
    t5 *= t8;
    t2 = t2.get$y();
    if (typeof t2 !== 'number')
      return this.getSupport$1$bailout0(9, d, t3, bestIndex, t5, bestValue, t2, i, t1);
    value = t5 + t2 * t11;
    if (value > bestValue) {
      bestValue = value;
      bestIndex = i;
 ...
 setAsBox$2: function(hx, hy) {
  ...
  t4 = this.normals;
  if (typeof t4 !== 'string' && (typeof t4 !== 'object' || t4 === null || t4.constructor !== Array && !t4.is$JavaScriptIndexingBehavior))
    return this.setAsBox$2$bailout(2, t4);
  if (0 >= t4.length)
    throw $.ioore(0);
 ...
 setAsBox$2$bailout: function(state0, env0, env1, env2) {
  switch (state0) {
    case 1:
      t1 = env2;
      hy = env1;
...
$$.Matrix22 = {"":"Object;col1>,col2>",
 ...
 addLocal$1: function(other) {
  ...
  t2 = t1.get$x();
  if (typeof t2 !== 'number')
    return this.addLocal$1$bailout0(1, other, t1, t2);
  t4 = other.get$col1().get$x();
  if (typeof t4 !== 'number')
    return this.addLocal$1$bailout0(2, other, t1, t2, t4);
  t1.set$x(t2 + t4);
  t1 = this.col1;
  t6 = t1.get$y();
  if (typeof t6 !== 'number')
    return this.addLocal$1$bailout0(3, other, t1, t6);
  t8 = other.get$col1().get$y();
  if (typeof t8 !== 'number')
    return this.addLocal$1$bailout0(4, other, t1, t6, t8);
  t1.set$y(t6 + t8);
  t1 = this.col2;
  t10 = t1.get$x();
  if (typeof t10 !== 'number')
    return this.addLocal$1$bailout0(5, other, t10, t1);
  t12 = other.get$col2().get$x();
  if (typeof t12 !== 'number')
    return this.addLocal$1$bailout0(6, other, t10, t1, t12);
  t1.set$x(t10 + t12);
  t1 = this.col2;
  t14 = t1.get$y();
  if (typeof t14 !== 'number')
    return this.addLocal$1$bailout0(7, other, t14, t1);
  t16 = other.get$col2().get$y();
  if (typeof t16 !== 'number')
    return this.addLocal$1$bailout0(8, t14, t16, t1);
  t1.set$y(t14 + t16);
  return this;
},
 addLocal$1$bailout0: function(state0, env0, env1, env2, env3) {
  switch (state0) {
    case 1:
      t2 = env2;
      t1 = env1;
  ...
  switch (state0) {
    ...
    case 7:
      ...
      t16 = other.get$col2().get$y();
    case 8:
      var t1, t2, other, t4, t6, t8, t10, t12, t14, t16;
      state0 = 0;
...
$$.Vector3 = {"":"Object;x=,y=,z>",
 ...
 addLocal$1: function(argVec) {
  ...
  t1 = this.x;
  if (typeof t1 !== 'number')
    return this.addLocal$1$bailout1(1, argVec, t1);
  t3 = argVec.get$x();
  if (typeof t3 !== 'number')
    return this.addLocal$1$bailout1(2, argVec, t1, t3);
  this.x = t1 + t3;
  t5 = this.y;
  if (typeof t5 !== 'number')
    return this.addLocal$1$bailout1(3, argVec, t5);
  t7 = argVec.get$y();
  if (typeof t7 !== 'number')
    return this.addLocal$1$bailout1(4, argVec, t7, t5);
  this.y = t5 + t7;
  t9 = this.z;
  if (typeof t9 !== 'number')
    return this.addLocal$1$bailout1(5, t9, argVec);
  t11 = argVec.get$z();
  if (typeof t11 !== 'number')
    return this.addLocal$1$bailout1(6, t9, t11);
  this.z = t9 + t11;
  return this;
},
 addLocal$1$bailout1: function(state0, env0, env1, env2) {
  switch (state0) {
    case 1:
      t1 = env1;
      argVec = env0;
 ...
 add$1: function(argVec) {
  ...
  t1 = this.x;
  if (typeof t1 !== 'number')
    return this.add$1$bailout0(1, argVec, t1);
  t3 = argVec.get$x();
  if (typeof t3 !== 'number')
    return this.add$1$bailout0(2, argVec, t1, t3);
  t3 = t1 + t3;
  t1 = this.y;
  if (typeof t1 !== 'number')
    return this.add$1$bailout0(3, argVec, t1, t3);
  t6 = argVec.get$y();
  if (typeof t6 !== 'number')
    return this.add$1$bailout0(4, argVec, t6, t1, t3);
  t6 = t1 + t6;
  t1 = this.z;
  if (typeof t1 !== 'number')
    return this.add$1$bailout0(5, argVec, t6, t1, t3);
  t9 = argVec.get$z();
  if (typeof t9 !== 'number')
    return this.add$1$bailout0(6, t6, t1, t9, t3);
  return $.Vector3$(t3, t6, t1 + t9);
},
 add$1$bailout0: function(state0, env0, env1, env2, env3) {
  switch (state0) {
    case 1:
      t1 = env1;
      argVec = env0;
...
$$.Body = {"":"Object;world,flags=,contactList=,sleepTime=,userData=,_linearVelocity,_angularVelocity,mass>,invMass>,next=,prev=,fixtureList,fixtureCount,jointList=,_force>,_torque=,_inertia,invInertia>,linearDamping>,angularDamping>,_type>,islandIndex<,originTransform>,sweep>,_fixDef,_pmd,_pxf,oldCenter,tempCenter",
 ...
 createFixture$1: function(def) {
  ...
  t2 = t1._flags;
  if (t2 !== (t2 | 0))
    return this.createFixture$1$bailout(3, fixture, t1, t2);
  t1._flags = (t2 | 1) >>> 0;
  return fixture;
},
 createFixture$1$bailout: function(state0, env0, env1, env2) {
  switch (state0) {
    case 1:
      fixture = env1;
      t1 = env0;
...
$$.Island = {"":"Object;listener,bodies>,contacts,joints>,positions,velocities,bodyCount>,jointCount,contactCount>,bodyCapacity,contactCapacity,jointCapacity,positionIterationCount,_contactSolver,_translation,impulse",
 ...
 solve$3: function(step, gravity, allowSleep) {
  ...
  while (true) {
    t4 = this.bodyCount;
    if (typeof t4 !== 'number')
      return this.solve$3$bailout(34, i, step, t3, t2, allowSleep, temp, t1, t4);
    if (!(i < t4))
      break;
    c$0: {
      t4 = this.bodies;
      if (typeof t4 !== 'string' && (typeof t4 !== 'object' || t4 === null || t4.constructor !== Array && !t4.is$JavaScriptIndexingBehavior))
        return this.solve$3$bailout(35, i, step, t3, t2, allowSleep, temp, t1, t4);
      if (i >= t4.length)
        throw $.ioore(i);
      b = t4[i];
      t4 = b.get$type();
      if (typeof t4 !== 'number')
        return this.solve$3$bailout(36, i, step, t3, t4, allowSleep, t2, temp, t1, b);
      if (t4 === 0)
        break c$0;
      ...
      t4 = t1.x;
      if (typeof t4 !== 'number')
        return this.solve$3$bailout(37, i, step, t3, t2, t4, allowSleep, temp, t1, b);
      t4 *= t4;
      t6 = t1.y;
      if (typeof t6 !== 'number')
        return this.solve$3$bailout(38, i, step, t3, t2, t4, allowSleep, t6, temp, t1, b);
      if (t4 + t6 * t6 > 4) {
        t4 = t3.get$length(t1);
        if (typeof t4 !== 'number')
          throw $.iae(t4);
      ...
      t4 = step.get$dt();
      if (typeof t4 !== 'number')
        return this.solve$3$bailout(39, i, step, t3, t2, allowSleep, t4, temp, t1, b);
      t6 = b.get$angularVelocity();
      if (typeof t6 !== 'number')
        return this.solve$3$bailout(40, i, step, t3, t2, allowSleep, t4, temp, t6, t1, b);
      rotation = t4 * t6;
      if (rotation * rotation > 2.4674011002723395) {
        t4 = $.CONSTANT1.abs$0(rotation);
        if (typeof t4 !== 'number')
          throw $.iae(t4);
        ratio = 1.5707963267948966 / t4;
        t4 = b.get$angularVelocity();
        if (typeof t4 !== 'number')
          return this.solve$3$bailout(41, i, step, t3, t2, allowSleep, ratio, temp, t4, t1, b);
      ...
      t6 = t5.get$angle();
      if (typeof t6 !== 'number')
        return this.solve$3$bailout(42, i, t5, t6, step, t3, allowSleep, t2, temp, t1, b);
      t8 = step.get$dt();
      if (typeof t8 !== 'number')
        return this.solve$3$bailout(43, i, t5, t6, t8, t3, allowSleep, step, t2, temp, t1, b);
      t10 = b.get$angularVelocity();
      if (typeof t10 !== 'number')
        return this.solve$3$bailout(44, i, t5, t6, t8, t10, allowSleep, step, t1, b, t2, t3, temp);
  ...
  while (true) {
    ...
    while (true) {
      ...
      t1 = this.joints;
      if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior))
        return this.solve$3$bailout(47, t1, step, allowSleep, jointsOkay, j, t2, i, contactsOkay);
      if (j >= t1.length)
        throw $.ioore(j);
  ...
  if (allowSleep === true) {
    ...
    while (true) {
      ...
      c$0: {
        ...
        t1 = b.get$flags();
        if (t1 !== (t1 | 0))
          return this.solve$3$bailout(51, step, minSleepTime, b, i, t1);
        if ((t1 & 4) === 0) {
          b.set$sleepTime(0);
          minSleepTime = 0;
        }
        ...
        if ((t1 & 4) !== 0) {
          ...
          if (!(t1 * t3 > 0.0012184696791468343)) {
            ...
            t2 = t2.get$y();
            if (typeof t2 !== 'number')
              return this.solve$3$bailout(58, step, b, t5, t1, i, minSleepTime, t2);
            t8 = t5 + t1 * t2 > 0.0001;
            t1 = t8;
          } else
            t1 = true;
        ...
        if (t1) {
          ...
          if (minSleepTime !== (minSleepTime | 0))
            return this.solve$3$bailout(61, i, minSleepTime, step);
        }
      }
      ++i;
    }
...
$$.World = {"":"Object;_flags,_contactManager,_bodyList,_jointList,_bodyCount,_jointCount,_gravity,_allowSleep,_debugDraw,_fixtureDestructionListener,_jointDestructionListener,_pool,_inverseTimestep,_warmStarting,_continuousPhysics,_contactStacks,center>,axis,timestep,cA,cB,wqwrapper,toiInput,toiOutput,backup,toiSolver,contacts,island,stack",
 ...
 step$3: function(dt, velocityIterations, positionIterations) {
  ...
  if (typeof t1 !== 'number')
    return this.step$3$bailout(4, dt, t3, t1);
  t3.dtRatio = t1 * dt;
  t3.warmStarting = this._warmStarting;
  this._contactManager.collide$0();
  t1 = t3.dt;
  if (typeof t1 !== 'number')
    return this.step$3$bailout(5, t3, t1);
  if (t1 > 0)
    this.solve$1(t3);
  if (this._continuousPhysics) {
    t1 = t3.dt;
    if (typeof t1 !== 'number')
      return this.step$3$bailout(6, t3, t1);
    t1 = t1 > 0;
  } else
    t1 = false;
  if (t1)
  ...
  t1 = t3.dt;
  if (typeof t1 !== 'number')
    return this.step$3$bailout(7, t3, t1);
  if (t1 > 0)
    this._inverseTimestep = t3.inv_dt;
  t1 = this._flags;
  if (t1 !== (t1 | 0))
    return this.step$3$bailout(8, t1);
  if ((t1 & 4) === 4)
    this.clearForces$0();
  t1 = this._flags;
  if (t1 !== (t1 | 0))
    return this.step$3$bailout(9, t1);
  this._flags = (t1 & 4294967293) >>> 0;
},
 step$3$bailout: function(state0, env0, env1, env2, env3) {
  switch (state0) {
    case 1:
      t1 = env3;
  ...
  switch (state0) {
    ...
    case 1:
      state0 = 0;
    case 2:
      if (state0 === 2 || state0 === 0 && $.eqB($.and(t1, 1), 1))
        switch (state0) {
          case 0:
            this._contactManager.findNewContacts$0();
            t1 = this._flags;
    ...
    case 5:
      ...
      if ($.gtB(t1, 0))
        this.solve$1(t3);
    case 6:
      if (state0 === 6 || state0 === 0 && this._continuousPhysics)
        switch (state0) {
          case 0:
            t1 = t3.dt;
          case 6:
    ...
    case 8:
      ...
      t1 = this._flags;
    case 9:
      var t1, positionIterations, velocityIterations, dt, t3;
      state0 = 0;
 ...
 solveTimeOfImpactGivenBody$1: function(body) {
  ...
  do {
    for (ce = body.get$contactList(), found = false, count = 0; !(ce == null); ce = ce.get$next()) {
      ...
      if (typeof type !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(2, t8, body, bullet, t2, other, type, iter, toi, toiOther, found, count, t4, t3, t5, ce, toiContact, t7, t6);
      if (bullet) {
        t1 = other.get$flags();
        if (t1 !== (t1 | 0))
          return this.solveTimeOfImpactGivenBody$1$bailout(3, t8, t6, body, bullet, t2, other, type, iter, t1, toi, toiOther, found, count, t3, t4, ce, t5, toiContact, t7);
        if ((t1 & 64) === 0)
          continue;
        if (!(type === 0)) {
          t1 = ce.get$contact().get$flags();
          if (t1 !== (t1 | 0))
            return this.solveTimeOfImpactGivenBody$1$bailout(4, t8, body, bullet, t1, t2, other, iter, toi, toiOther, found, count, t4, t3, t5, ce, toiContact, t7, t6);
          t10 = (t1 & 16) !== 0;
          t1 = t10;
        } else
          t1 = false;
      ...
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(5, t8, body, contact, t1, bullet, t2, other, iter, toi, toiOther, found, count, t4, t3, t5, ce, toiContact, t7, t6);
      if (!t1)
        continue;
      t1 = contact.get$toiCount();
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(6, t8, body, contact, bullet, t2, other, t1, iter, toi, toiOther, found, count, t4, t3, t5, ce, toiContact, t7, t6);
      if (t1 > 10)
        continue;
      ...
      t1 = t2.state;
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(7, t8, body, contact, t1, bullet, t2, other, iter, toi, toiOther, found, count, t4, t3, t5, ce, toiContact, t7, t6);
      if (t1 === 3) {
        t1 = t2.t;
        if (typeof t1 !== 'number')
          return this.solveTimeOfImpactGivenBody$1$bailout(8, t8, body, contact, bullet, t1, t2, other, iter, toi, toiOther, found, count, t4, t3, t5, ce, toiContact, t7, t6);
        t1 = t1 < toi;
      } else
        t1 = false;
      if (t1) {
        toi = t2.t;
        if (toi !== (toi | 0))
          return this.solveTimeOfImpactGivenBody$1$bailout(9, t8, body, contact, bullet, t2, toi, other, iter, t3, count, t4, t5, ce, t6, t7);
        toiContact = contact;
        toiOther = other;
        found = true;
      }
  ...
  while (true) {
    ...
    c$0: {
      ...
      if (typeof type !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(12, body, count, toiOther, ce, type, toiContact);
      if (type === 2)
        break c$0;
      contact = ce.get$contact();
      t1 = contact.get$enabled();
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(13, body, count, contact, t1, toiOther, ce, toiContact);
      if (!t1)
        break c$0;
      fixtureA = contact.get$fixtureA();
      fixtureB = contact.get$fixtureB();
      ...
      t1 = contact.get$enabled();
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(14, body, count, contact, toiOther, ce, t1, toiContact);
      if (!t1)
        break c$0;
      t1 = contact.get$touching();
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(15, body, count, contact, toiOther, t1, ce, toiContact);
      if (!t1)
        break c$0;
      t1 = this.contacts;
      if (count >= t1.length)
 ...
 update$1: function(listener) {
  ...
  if (sensor) {
    ...
    while (true) {
      ...
      t4 = t4.get$points();
      if (typeof t4 !== 'string' && (typeof t4 !== 'object' || t4 === null || t4.constructor !== Array && !t4.is$JavaScriptIndexingBehavior))
        return this.update$1$bailout(6, listener, bodyA, wasTouching, bodyB, sensor, t1, touching, t2, i, t3, t4);
      if (i >= t4.length)
        throw $.ioore(i);
      mp2 = t4[i];
      ...
      while (true) {
        t4 = t1.pointCount;
        if (typeof t4 !== 'number')
          return this.update$1$bailout(7, listener, bodyA, j, bodyB, t4, t2, mp2, wasTouching, id2, t1, touching, i, t3, sensor);
        if (!(j < t4))
          break;
        if (j >= t3)
          throw $.ioore(j);
...
$$.ContactSolver = {"":"Object;constraints>,constraintCount,worldManifold,tangent,temp1,temp2,P,dv,dv1,dv2,x>,d,P1,P2,psolver,rA>,rB>",
 init$3: function(contacts, contactCount, impulseRatio) {
  ...
  for (t1 = this.worldManifold, t2 = t1.points, t3 = t2.length, t4 = this.tangent, t5 = this.temp2, t6 = this.temp1, t7 = $.getInterceptor$JSStringJSArray(contacts), t8 = t1.normal, i = 0; $.ltB(i, this.constraintCount); ++i) {
    ...
    if (typeof restitution !== 'number')
      return this.init$3$bailout(2, restitution, t1, impulseRatio, i, t2, contacts, t7, t4, radiusA, radiusB, bodyA, bodyB, t3, manifold, t5, t8, friction, t6);
    vA = bodyA.get$linearVelocity();
    vB = bodyB.get$linearVelocity();
    wA = bodyA.get$angularVelocity();
    if (typeof wA !== 'number')
      return this.init$3$bailout(3, restitution, vA, vB, wA, i, impulseRatio, t1, t2, contacts, t7, t4, radiusA, radiusB, bodyA, bodyB, t3, manifold, t5, t8, friction, t6);
 ...
 solveVelocityConstraints$0: function() {
  ...
  while (true) {
    ...
    while (true) {
      ...
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(9, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t6, t2, t7, j, t8, wA, wB, t1, t11);
      if (!(j < t11))
        break;
      t11 = c.get$points();
      if (typeof t11 !== 'string' && (typeof t11 !== 'object' || t11 === null || t11.constructor !== Array && !t11.is$JavaScriptIndexingBehavior))
        return this.solveVelocityConstraints$0$bailout(10, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t6, t2, t7, j, t8, wA, wB, t1, t11);
      if (j >= t11.length)
        throw $.ioore(j);
      ccp = t11[j];
      a = ccp.get$rA();
      ...
      if (typeof t13 !== 'number')
        return this.solveVelocityConstraints$0$bailout(11, ccp, a, t9, t11, i, t13, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t6, t2, t7, j, t8, wA, wB, t1);
      t13 = t11 * t13;
      t11 = vB.get$x();
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(12, ccp, a, t9, i, t10, t13, t11, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t6, t2, t7, j, t8, wA, wB, t1);
      t11 = t13 + t11;
      t13 = vA.get$x();
      if (typeof t13 !== 'number')
        return this.solveVelocityConstraints$0$bailout(13, ccp, a, t9, i, t10, t11, t13, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t6, t2, t7, j, t8, wA, wB, t1);
      t13 = t11 - t13;
      t11 = a.get$y();
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(14, ccp, a, t9, i, t10, t13, t11, bodyB, bodyA, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t6, t2, t7, j, t8, wA, wB, t1);
      t1.x = t13 + wA * t11;
      t18 = ccp.get$rB().get$x();
      if (typeof t18 !== 'number')
        return this.solveVelocityConstraints$0$bailout(15, ccp, a, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t18, c, friction, t3, t4, t5, t6, t2, t7, t8, j, wA, wB, t1);
      t18 = wB * t18;
      t20 = vB.get$y();
      if (typeof t20 !== 'number')
        return this.solveVelocityConstraints$0$bailout(16, ccp, a, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t18, t20, c, friction, t3, t4, t5, t6, t2, t7, j, t8, wA, wB, t1);
      t20 = t18 + t20;
      t18 = vA.get$y();
      if (typeof t18 !== 'number')
        return this.solveVelocityConstraints$0$bailout(17, ccp, a, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t20, t18, c, friction, t3, t4, t5, t6, t2, t7, j, t8, wA, wB, t1);
      t18 = t20 - t18;
      t20 = a.get$x();
      if (typeof t20 !== 'number')
        return this.solveVelocityConstraints$0$bailout(18, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t18, t20, c, friction, t3, t4, t5, t6, t2, t7, j, t8, wA, wB, t1);
      t1.y = t18 - wA * t20;
      t24 = t1.x;
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(19, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t24, t2, t6, t7, j, t8, wA, wB, t1);
      t26 = t2.x;
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(20, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t24, t2, t26, t6, t7, j, t8, wA, wB, t1);
      t26 = t24 * t26;
      t24 = t1.y;
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(21, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t26, t6, t2, t7, t24, j, t8, wA, wB, t1);
      t29 = t2.y;
      if (typeof t29 !== 'number')
        return this.solveVelocityConstraints$0$bailout(22, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t26, t6, t2, t7, t24, t8, j, t29, wA, wB, t1);
      vt = t26 + t24 * t29;
      t26 = ccp.get$tangentMass();
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(23, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t6, t2, t7, j, t8, t26, vt, wA, wB, t1);
      lambda = t26 * -vt;
      t26 = ccp.get$normalImpulse();
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(24, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t6, t2, t7, j, t8, wA, wB, t26, lambda, t1);
      maxFriction = friction * t26;
      t26 = ccp.get$tangentImpulse();
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(25, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, t5, friction, t6, t2, t7, t8, j, wA, t1, wB, maxFriction, t26, lambda);
      t26 += lambda;
      ...
      t34 = t2.x;
      if (typeof t34 !== 'number')
        return this.solveVelocityConstraints$0$bailout(26, ccp, t9, newImpulse, t10, lambda, i, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, t5, friction, t6, t2, t7, j, t8, t34, wA, wB, t1);
      Px = t34 * lambda;
      t34 = t2.y;
      if (typeof t34 !== 'number')
        return this.solveVelocityConstraints$0$bailout(27, ccp, t9, newImpulse, t10, lambda, i, Px, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, t5, friction, t6, t2, t7, j, t8, t34, wA, wB, t1);
      Py = t34 * lambda;
      t34 = vA.get$x();
      if (typeof t34 !== 'number')
        return this.solveVelocityConstraints$0$bailout(28, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, Py, t34, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, t5, friction, t6, t2, t7, j, t8, wA, wB, t1);
      vA.set$x(t34 - Px * invMassA);
      t38 = vA.get$y();
      if (typeof t38 !== 'number')
        return this.solveVelocityConstraints$0$bailout(29, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, t38, c, t3, t4, t5, friction, t6, t2, t7, j, t8, wA, wB, t1);
      vA.set$y(t38 - Py * invMassA);
      t40 = ccp.get$rA();
      t41 = t40.get$x();
      if (typeof t41 !== 'number')
        return this.solveVelocityConstraints$0$bailout(30, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, t41, c, t3, t4, t5, friction, t6, t2, t7, j, t8, wA, wB, t1);
      t41 *= Py;
      t40 = t40.get$y();
      if (typeof t40 !== 'number')
        return this.solveVelocityConstraints$0$bailout(31, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, t41, t40, c, t3, t4, t5, friction, t6, t2, t7, j, t8, wA, wB, t1);
      wA -= invIA * (t41 - t40 * Px);
      t44 = vB.get$x();
      if (typeof t44 !== 'number')
        return this.solveVelocityConstraints$0$bailout(32, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, wA, t44, t5, t6, t2, t7, friction, j, t8, wB, t1);
      vB.set$x(t44 + Px * invMassB);
      t46 = vB.get$y();
      if (typeof t46 !== 'number')
        return this.solveVelocityConstraints$0$bailout(33, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, wA, t5, t6, t2, t7, t46, friction, j, t8, wB, t1);
      vB.set$y(t46 + Py * invMassB);
      t48 = ccp.get$rB();
      t49 = t48.get$x();
      if (typeof t49 !== 'number')
        return this.solveVelocityConstraints$0$bailout(34, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, wA, t5, t6, t2, t7, friction, j, t8, t49, wB, t1);
      t49 *= Py;
      t48 = t48.get$y();
      if (typeof t48 !== 'number')
        return this.solveVelocityConstraints$0$bailout(35, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, wA, t5, t6, t2, t7, friction, j, t8, wB, t49, t48, t1);
      wB += invIB * (t49 - t48 * Px);
    ...
    if (typeof t12 !== 'string' && (typeof t12 !== 'object' || t12 === null || t12.constructor !== Array && !t12.is$JavaScriptIndexingBehavior))
      return this.solveVelocityConstraints$0$bailout(37, t9, i, t10, t11, bodyA, bodyB, t12, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
    t14 = -wB;
    t15 = t12.length;
    if (t11) {
      if (0 >= t15)
      ...
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(38, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, t11, invIB, a1, invIA, t14, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t11 = t14 * t11;
      t14 = vB.get$x();
      if (typeof t14 !== 'number')
        return this.solveVelocityConstraints$0$bailout(39, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, t14, t11, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t14 = t11 + t14;
      t11 = vA.get$x();
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(40, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, t14, t11, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t11 = t14 - t11;
      t14 = a1.get$y();
      if (typeof t14 !== 'number')
        return this.solveVelocityConstraints$0$bailout(41, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, t11, t14, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t1.x = t11 + wA * t14;
      t18 = ccp.get$rB().get$x();
      if (typeof t18 !== 'number')
        return this.solveVelocityConstraints$0$bailout(42, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, c, t18, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t18 = wB * t18;
      t20 = vB.get$y();
      if (typeof t20 !== 'number')
        return this.solveVelocityConstraints$0$bailout(43, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, c, t3, t4, t18, t20, t5, t6, t2, t7, t8, wA, wB, t1);
      t20 = t18 + t20;
      t18 = vA.get$y();
      if (typeof t18 !== 'number')
        return this.solveVelocityConstraints$0$bailout(44, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, c, t3, t4, t5, t20, t18, t2, t6, t7, t8, wA, wB, t1);
      t18 = t20 - t18;
      t20 = a1.get$x();
      if (typeof t20 !== 'number')
        return this.solveVelocityConstraints$0$bailout(45, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, c, t3, t4, t5, t6, t2, t18, t20, t7, t8, wA, wB, t1);
      t1.y = t18 - wA * t20;
      b = c.get$normal();
      t24 = t1.x;
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(46, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1, b, t24);
      t26 = b.get$x();
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(47, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1, t26, b, t24);
      t24 *= t26;
      t28 = t1.y;
      if (typeof t28 !== 'number')
        return this.solveVelocityConstraints$0$bailout(48, t28, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1, b, t24);
      t30 = b.get$y();
      if (typeof t30 !== 'number')
        return this.solveVelocityConstraints$0$bailout(49, t28, t30, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1, t24);
      vn = t24 + t28 * t30;
      t24 = ccp.get$normalMass();
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(50, t9, vn, i, t24, t10, bodyA, bodyB, vA, ccp, invMassA, invIA, vB, invMassB, invIB, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t24 = -t24;
      t33 = ccp.get$velocityBias();
      if (typeof t33 !== 'number')
        return this.solveVelocityConstraints$0$bailout(51, t9, vn, i, t10, t24, t33, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      lambda = t24 * (vn - t33);
      t24 = ccp.get$normalImpulse();
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(52, t9, i, t10, lambda, t24, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      a = t24 + lambda;
      newImpulse = a > 0 ? a : 0;
      ...
      t11 = vA.get$x();
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(56, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, newImpulse, invIB, invIA, Px, Py, t11, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      vA.set$x(t11 - Px * invMassA);
      t13 = vA.get$y();
      if (typeof t13 !== 'number')
        return this.solveVelocityConstraints$0$bailout(57, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, newImpulse, invIB, invIA, Px, Py, t3, t13, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      vA.set$y(t13 - Py * invMassA);
      t15 = ccp.get$rA();
      t16 = t15.get$x();
      if (typeof t16 !== 'number')
        return this.solveVelocityConstraints$0$bailout(58, t9, i, t10, bodyA, bodyB, vA, vB, ccp, invMassB, newImpulse, invIB, invIA, Px, Py, t3, t4, t5, t6, t2, t16, t7, t8, wA, wB, t1);
      t16 *= Py;
      t15 = t15.get$y();
      if (typeof t15 !== 'number')
        return this.solveVelocityConstraints$0$bailout(59, t9, i, t10, bodyA, bodyB, vA, vB, ccp, invMassB, newImpulse, invIB, invIA, Px, Py, t3, t4, t5, t6, t2, t7, t16, t8, t15, wA, wB, t1);
      wA -= invIA * (t16 - t15 * Px);
      t19 = vB.get$x();
      if (typeof t19 !== 'number')
        return this.solveVelocityConstraints$0$bailout(60, t9, i, t10, bodyA, bodyB, vA, vB, ccp, invMassB, newImpulse, invIB, Px, Py, t3, t4, t5, t6, t2, t7, t8, wB, t1, wA, t19);
      vB.set$x(t19 + Px * invMassB);
      t21 = vB.get$y();
      if (typeof t21 !== 'number')
        return this.solveVelocityConstraints$0$bailout(61, t9, t21, i, t10, bodyA, bodyB, vA, vB, ccp, invMassB, newImpulse, invIB, Px, Py, t3, t4, t5, t6, t2, t7, t8, wB, t1, wA);
      vB.set$y(t21 + Py * invMassB);
      t23 = ccp.get$rB();
      t24 = t23.get$x();
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(62, Py, t9, i, t10, t3, t4, t24, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, ccp, newImpulse, invIB, wB, t1, wA, Px);
      t24 *= Py;
      t23 = t23.get$y();
      if (typeof t23 !== 'number')
        return this.solveVelocityConstraints$0$bailout(63, t9, i, t10, t3, t4, t5, t24, t6, t23, bodyB, t7, bodyA, vA, vB, t2, ccp, t8, newImpulse, invIB, wB, t1, wA, Px);
      wB += invIB * (t24 - t23 * Px);
      ...
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(65, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t14, t11, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t11 = t14 * t11;
      t13 = vB.get$x();
      if (typeof t13 !== 'number')
        return this.solveVelocityConstraints$0$bailout(66, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t11, t13, t6, t2, t7, t8, wA, wB, t1);
      t13 = t11 + t13;
      t11 = vA.get$x();
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(67, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t13, t11, t6, t2, t7, t8, wA, wB, t1);
      t11 = t13 - t11;
      t13 = cp1.get$rA().get$y();
      if (typeof t13 !== 'number')
        return this.solveVelocityConstraints$0$bailout(68, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t11, t2, t7, t13, t8, wA, wB, t1);
      t9.x = t11 + wA * t13;
      t19 = cp1.get$rB().get$x();
      if (typeof t19 !== 'number')
        return this.solveVelocityConstraints$0$bailout(69, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1, t19);
      t19 = wB * t19;
      t21 = vB.get$y();
      if (typeof t21 !== 'number')
        return this.solveVelocityConstraints$0$bailout(70, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t19, t21, t1);
      t21 = t19 + t21;
      t19 = vA.get$y();
      if (typeof t19 !== 'number')
        return this.solveVelocityConstraints$0$bailout(71, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1, t21, t19);
      t19 = t21 - t19;
      t21 = cp1.get$rA().get$x();
      if (typeof t21 !== 'number')
        return this.solveVelocityConstraints$0$bailout(72, t19, t9, t21, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t9.y = t19 - wA * t21;
      t25 = cp2.get$rB().get$y();
      if (typeof t25 !== 'number')
        return this.solveVelocityConstraints$0$bailout(73, t9, i, t10, t14, t25, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t25 = t14 * t25;
      t14 = vB.get$x();
      if (typeof t14 !== 'number')
        return this.solveVelocityConstraints$0$bailout(74, t9, i, t10, t25, t14, bodyB, bodyA, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t14 = t25 + t14;
      t25 = vA.get$x();
      if (typeof t25 !== 'number')
        return this.solveVelocityConstraints$0$bailout(75, t9, i, t10, bodyA, bodyB, t14, vA, vB, invMassA, invIA, invMassB, invIB, t25, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t25 = t14 - t25;
      t14 = cp2.get$rA().get$y();
      if (typeof t14 !== 'number')
        return this.solveVelocityConstraints$0$bailout(76, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t14, t25, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t10.x = t25 + wA * t14;
      t30 = cp2.get$rB().get$x();
      if (typeof t30 !== 'number')
        return this.solveVelocityConstraints$0$bailout(77, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, t30, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t30 = wB * t30;
      t32 = vB.get$y();
      if (typeof t32 !== 'number')
        return this.solveVelocityConstraints$0$bailout(78, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, t30, t32, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t32 = t30 + t32;
      t30 = vA.get$y();
      if (typeof t30 !== 'number')
        return this.solveVelocityConstraints$0$bailout(79, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, t32, t30, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t30 = t32 - t30;
      t32 = cp2.get$rA().get$x();
      if (typeof t32 !== 'number')
        return this.solveVelocityConstraints$0$bailout(80, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t30, t3, t4, t5, t32, t6, t2, t7, t8, wA, wB, t1);
      t10.y = t30 - wA * t32;
      t36 = t9.x;
      if (typeof t36 !== 'number')
        return this.solveVelocityConstraints$0$bailout(81, t9, i, t10, t36, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t38 = c.get$normal();
      t39 = t38.get$x();
      if (typeof t39 !== 'number')
        return this.solveVelocityConstraints$0$bailout(82, t9, i, t10, t36, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t39, t8, wA, wB, t1);
      t36 *= t39;
      t41 = t9.y;
      if (typeof t41 !== 'number')
        return this.solveVelocityConstraints$0$bailout(83, t9, i, t10, t41, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, t36, wA, wB, t1);
      t38 = t38.get$y();
      if (typeof t38 !== 'number')
        return this.solveVelocityConstraints$0$bailout(84, t9, i, t10, t41, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, t36, wA, wB, t1, t38);
      vn1 = t36 + t41 * t38;
      t36 = t10.x;
      if (typeof t36 !== 'number')
        return this.solveVelocityConstraints$0$bailout(85, t9, i, t10, bodyA, t36, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1, vn1);
      t39 = t36 * t39;
      t36 = t10.y;
      if (typeof t36 !== 'number')
        return this.solveVelocityConstraints$0$bailout(87, t39, t9, i, t10, bodyA, bodyB, t36, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1, vn1);
      vn2 = t39 + t36 * t38;
      t39 = cp1.get$velocityBias();
      if (typeof t39 !== 'number')
        return this.solveVelocityConstraints$0$bailout(89, t9, i, t10, vn2, t39, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1, vn1);
      t39 = vn1 - t39;
      t47 = cp2.get$velocityBias();
      if (typeof t47 !== 'number')
        return this.solveVelocityConstraints$0$bailout(90, t9, i, t10, vn2, t39, bodyB, t47, bodyA, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      b = $.Vector$(t39, vn2 - t47);
      t39 = c.get$K();
      t49 = t39.get$col1().get$x();
      if (typeof t49 !== 'number')
        return this.solveVelocityConstraints$0$bailout(91, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, t49, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t51 = a.x;
      if (typeof t51 !== 'number')
        return this.solveVelocityConstraints$0$bailout(92, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, t51, cp2, t49, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t51 = t49 * t51;
      t49 = t39.get$col2().get$x();
      if (typeof t49 !== 'number')
        return this.solveVelocityConstraints$0$bailout(93, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t51, cp1, b, t49, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t54 = a.y;
      if (typeof t54 !== 'number')
        return this.solveVelocityConstraints$0$bailout(94, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t51, t54, cp1, b, t49, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t8.x = t51 + t49 * t54;
      t56 = c.get$K();
      t57 = t56.get$col1().get$y();
      if (typeof t57 !== 'number')
        return this.solveVelocityConstraints$0$bailout(95, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, c, a, t57, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t59 = a.x;
      if (typeof t59 !== 'number')
        return this.solveVelocityConstraints$0$bailout(96, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, t59, cp1, cp2, c, a, t57, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t59 = t57 * t59;
      t57 = t56.get$col2().get$y();
      if (typeof t57 !== 'number')
        return this.solveVelocityConstraints$0$bailout(97, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, c, a, t3, t4, t5, t59, t57, t6, t2, t7, t8, wA, wB, t1);
      t62 = a.y;
      if (typeof t62 !== 'number')
        return this.solveVelocityConstraints$0$bailout(98, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t62, cp1, b, cp2, c, a, t3, t4, t5, t59, t57, t6, t2, t7, t8, wA, wB, t1);
      t8.y = t59 + t57 * t62;
      t64 = b.x;
      if (typeof t64 !== 'number')
        return this.solveVelocityConstraints$0$bailout(99, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, t64, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t66 = t8.x;
      if (typeof t66 !== 'number')
        return this.solveVelocityConstraints$0$bailout(100, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, t64, cp1, t66, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      b.x = t64 - t66;
      t68 = b.y;
      if (typeof t68 !== 'number')
        return this.solveVelocityConstraints$0$bailout(101, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, t68, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t70 = t8.y;
      if (typeof t70 !== 'number')
        return this.solveVelocityConstraints$0$bailout(102, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, t68, t70, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      b.y = t68 - t70;
      $loop$1: {
        ...
        t11 = t4.get$x();
        if (typeof t11 !== 'number')
          return this.solveVelocityConstraints$0$bailout(103, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, c, a, t11, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
        if (t11 >= 0) {
          t11 = t4.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(104, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, c, a, t3, t4, t5, t11, t6, t2, t7, t8, wA, wB, t1);
          t11 = t11 >= 0;
        } else
          t11 = false;
        if (t11) {
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(105, t9, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, invIA, t11, invIB, wA, wB, t12, cp1, t1, cp2);
          t14 = t5.y;
          if (typeof t14 !== 'number')
            return this.solveVelocityConstraints$0$bailout(106, t9, i, t10, bodyA, bodyB, vA, vB, invIA, t11, invIB, t12, cp1, cp2, t3, t4, t5, t6, t2, t7, t8, wA, wB, t14, t1);
          t12 *= t14;
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(107, t9, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, invIA, invIB, wA, wB, t12, cp1, t11, cp2, t1);
          t17 = t5.x;
          if (typeof t17 !== 'number')
            return this.solveVelocityConstraints$0$bailout(108, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, t12, cp1, t11, cp2, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1, t17);
          t12 -= t11 * t17;
          t19 = cp2.get$rA();
          t20 = t19.get$x();
          if (typeof t20 !== 'number')
            return this.solveVelocityConstraints$0$bailout(109, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t12, t19, t20, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
          t22 = t6.y;
          if (typeof t22 !== 'number')
            return this.solveVelocityConstraints$0$bailout(110, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t12, t19, t20, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1, t22);
          t20 *= t22;
          t19 = t19.get$y();
          if (typeof t19 !== 'number')
            return this.solveVelocityConstraints$0$bailout(111, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t12, t20, t19, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
          t25 = t6.x;
          if (typeof t25 !== 'number')
            return this.solveVelocityConstraints$0$bailout(112, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t12, t20, t19, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1, t25);
          wA -= invIA * (t12 + (t20 - t19 * t25));
          t27 = cp1.get$rB();
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(113, t9, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t27, t28, t8, invIB, wA, wB, t1, cp1, cp2);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
            return this.solveVelocityConstraints$0$bailout(115, t9, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, wA, invIB, t14, wB, t27, cp1, t1, cp2);
          t14 -= t27 * t17;
          t30 = cp2.get$rB();
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(117, t30, t31, t9, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, wA, invIB, wB, t1, cp1, t14, cp2);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(119, t9, t22, i, t30, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, wA, invIB, wB, t1, cp1, cp2, t14);
        ...
        if (typeof t11 !== 'number')
          return this.solveVelocityConstraints$0$bailout(121, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, t11, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
        t11 = -t11;
        t13 = b.x;
        if (typeof t13 !== 'number')
          return this.solveVelocityConstraints$0$bailout(122, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, t11, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, t13, wA, wB, t1);
        t4.set$x(t11 * t13);
        t4.set$y(0);
        t15 = c.get$K().get$col1().get$y();
        if (typeof t15 !== 'number')
          return this.solveVelocityConstraints$0$bailout(123, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, c, a, t15, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
        t17 = t4.get$x();
        if (typeof t17 !== 'number')
          return this.solveVelocityConstraints$0$bailout(124, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, c, a, t15, t17, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
        t15 *= t17;
        t19 = b.y;
        if (typeof t19 !== 'number')
          return this.solveVelocityConstraints$0$bailout(125, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, c, a, t3, t4, t5, t15, t6, t2, t7, t8, wA, wB, t1, t19);
        vn2 = t15 + t19;
        if (t17 >= 0 && vn2 >= 0) {
          t3.setFrom$1(t4).subLocal$1(a);
          t5.setFrom$1(c.get$normal()).mulLocal$1(t3.x);
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(127, t12, t9, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, invIA, invIB, wA, wB, t1, cp1, cp2, t11);
          t14 = t5.y;
          if (typeof t14 !== 'number')
            return this.solveVelocityConstraints$0$bailout(128, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t11, t14, t12, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
          t12 *= t14;
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(129, t9, t12, i, t11, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, invIA, invIB, wA, wB, t1, cp1, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
            return this.solveVelocityConstraints$0$bailout(130, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t17, t12, t11, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
          t12 -= t11 * t17;
          t19 = cp2.get$rA();
          t20 = t19.get$x();
          if (typeof t20 !== 'number')
            return this.solveVelocityConstraints$0$bailout(131, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t12, t19, t20, t6, t2, t7, t8, wA, wB, t1);
          t22 = t6.y;
          if (typeof t22 !== 'number')
            return this.solveVelocityConstraints$0$bailout(132, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t22, t3, t4, t12, t5, t19, t20, t6, t2, t7, t8, wA, wB, t1);
          t20 *= t22;
          t19 = t19.get$y();
          if (typeof t19 !== 'number')
            return this.solveVelocityConstraints$0$bailout(133, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t12, t6, t2, t20, t19, t7, t8, wA, wB, t1);
          t25 = t6.x;
          if (typeof t25 !== 'number')
            return this.solveVelocityConstraints$0$bailout(134, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t25, t3, t4, t12, t5, t6, t2, t20, t19, t7, t8, wA, wB, t1);
          wA -= invIA * (t12 + (t20 - t19 * t25));
          t27 = cp1.get$rB();
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(135, t9, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, invIB, wB, t1, cp1, wA, t27, cp2, t28);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
            return this.solveVelocityConstraints$0$bailout(137, t14, t27, i, t10, t9, t4, t5, t3, t6, bodyA, bodyB, t7, t2, vA, vB, t8, invIB, wB, t1, cp1, wA, cp2);
          t14 -= t27 * t17;
          t30 = cp2.get$rB();
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(139, t9, i, t10, t14, t4, t30, t31, t6, bodyA, bodyB, t5, t2, vA, vB, t8, t7, invIB, wB, t1, cp1, wA, t3, cp2);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(141, t9, i, t10, t14, t4, t5, t3, t6, t22, t30, bodyB, bodyA, vA, vB, t2, t7, invIB, wB, t1, cp1, wA, t8, cp2);
          wB += invIB * (t14 + (t22 - t30 * t25));
          cp1.set$normalImpulse(t4.get$x());
          cp2.set$normalImpulse(t4.get$y());
          break $loop$1;
        ...
        if (typeof t11 !== 'number')
          return this.solveVelocityConstraints$0$bailout(143, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, c, a, t11, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
        t11 = -t11;
        t13 = b.y;
        if (typeof t13 !== 'number')
          return this.solveVelocityConstraints$0$bailout(144, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, c, a, t11, t3, t4, t5, t6, t2, t7, t8, wA, wB, t13, t1);
        t4.set$y(t11 * t13);
        t15 = c.get$K().get$col2().get$x();
        if (typeof t15 !== 'number')
          return this.solveVelocityConstraints$0$bailout(145, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, c, a, t3, t4, t5, t6, t2, t15, t7, t8, wA, wB, t1);
        t17 = t4.get$y();
        if (typeof t17 !== 'number')
          return this.solveVelocityConstraints$0$bailout(146, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, c, a, t3, t4, t5, t6, t2, t15, t7, t17, t8, wA, wB, t1);
        t15 *= t17;
        t19 = b.x;
        if (typeof t19 !== 'number')
          return this.solveVelocityConstraints$0$bailout(147, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, t15, wA, wB, t19, t1);
        vn1 = t15 + t19;
        if (t17 >= 0 && vn1 >= 0) {
          t3.setFrom$1(t4).subLocal$1(a);
          t5.setFrom$1(c.get$normal()).mulLocal$1(t3.x);
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(149, t9, i, t10, t3, t4, t5, t12, t11, t6, bodyA, bodyB, t7, t2, vA, vB, t8, invIA, invIB, wA, wB, t1, cp1, cp2);
          t14 = t5.y;
          if (typeof t14 !== 'number')
            return this.solveVelocityConstraints$0$bailout(150, t9, t14, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t12, t11, t6, t2, t7, t8, wA, wB, t1);
          t12 *= t14;
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(151, t9, i, t10, t3, t4, t5, t6, t12, t11, bodyB, bodyA, vA, vB, t2, invIA, t7, invIB, wA, wB, t1, cp1, t8, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
            return this.solveVelocityConstraints$0$bailout(152, t9, i, t17, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, t12, t11, t7, t2, t8, wA, wB, t1);
          t12 -= t11 * t17;
          t19 = cp2.get$rA();
          t20 = t19.get$x();
          if (typeof t20 !== 'number')
            return this.solveVelocityConstraints$0$bailout(153, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, t2, t7, t8, t12, t19, t20, wA, wB, t1);
          t22 = t6.y;
          if (typeof t22 !== 'number')
            return this.solveVelocityConstraints$0$bailout(154, t9, i, t10, t22, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, t2, t7, t8, t12, t19, t20, wA, wB, t1);
          t20 *= t22;
          t19 = t19.get$y();
          if (typeof t19 !== 'number')
            return this.solveVelocityConstraints$0$bailout(155, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, t2, t7, t8, t12, wA, wB, t20, t19, t1);
          t25 = t6.x;
          if (typeof t25 !== 'number')
            return this.solveVelocityConstraints$0$bailout(156, t9, i, t10, t25, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, t2, t7, t8, t12, wA, wB, t20, t19, t1);
          wA -= invIA * (t12 + (t20 - t19 * t25));
          t27 = cp1.get$rB();
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(157, t9, i, wA, t27, t3, t4, t5, t28, t6, bodyA, bodyB, t10, t2, vA, vB, t8, t7, invIB, wB, t1, cp1, cp2);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
            return this.solveVelocityConstraints$0$bailout(159, t9, i, wA, t10, t3, t4, t5, t14, t27, t6, bodyA, bodyB, t2, vA, vB, t8, t7, invIB, wB, t1, cp1, cp2);
          t14 -= t27 * t17;
          t30 = cp2.get$rB();
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(161, t9, i, wA, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t30, t14, t31, invIB, wB, t1, cp1, t8, cp2);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(163, t9, i, wA, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, t14, invIB, t22, wB, t30, cp1, t1, cp2);
          wB += invIB * (t14 + (t22 - t30 * t25));
          cp1.set$normalImpulse(t4.get$x());
          cp2.set$normalImpulse(t4.get$y());
          break $loop$1;
        ...
        if (typeof vn1 !== 'number')
          return this.solveVelocityConstraints$0$bailout(165, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1, vn1);
        vn2 = b.y;
        if (typeof vn2 !== 'number')
          return this.solveVelocityConstraints$0$bailout(166, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1, vn1, vn2);
        if (vn1 >= 0 && vn2 >= 0) {
          t3.setFrom$1(t4).subLocal$1(a);
          t5.setFrom$1(c.get$normal()).mulLocal$1(t3.x);
          t6.setFrom$1(c.get$normal()).mulLocal$1(t3.y);
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(167, t9, t11, i, t12, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, invIA, invIB, wA, wB, t1, cp1, cp2);
          t14 = t5.y;
          if (typeof t14 !== 'number')
            return this.solveVelocityConstraints$0$bailout(168, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t11, t12, t14, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
          t12 *= t14;
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(169, t9, i, t10, t12, t4, t5, t3, t11, t6, bodyA, bodyB, t7, t2, vA, vB, t8, invIA, invIB, wA, wB, t1, cp1, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
            return this.solveVelocityConstraints$0$bailout(170, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t12, t4, t5, t17, t11, t6, t2, t7, t3, t8, wA, wB, t1);
          t12 -= t11 * t17;
          t19 = cp2.get$rA();
          t20 = t19.get$x();
          if (typeof t20 !== 'number')
            return this.solveVelocityConstraints$0$bailout(171, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, t12, t19, t7, t20, t8, t2, wA, wB, t1);
          t22 = t6.y;
          if (typeof t22 !== 'number')
            return this.solveVelocityConstraints$0$bailout(172, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t22, t6, t12, t19, t7, t20, t8, t2, wA, wB, t1);
          t20 *= t22;
          t19 = t19.get$y();
          if (typeof t19 !== 'number')
            return this.solveVelocityConstraints$0$bailout(173, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, t12, t2, t7, t8, t20, t19, wA, wB, t1);
          t25 = t6.x;
          if (typeof t25 !== 'number')
            return this.solveVelocityConstraints$0$bailout(174, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t25, t6, t12, t2, t7, t8, t20, t19, wA, wB, t1);
          wA -= invIA * (t12 + (t20 - t19 * t25));
          t27 = cp1.get$rB();
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(175, wA, t27, t9, t28, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, invIB, wB, t1, cp1, cp2);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
            return this.solveVelocityConstraints$0$bailout(177, wA, t9, i, t14, t27, t3, t4, t5, t10, t6, bodyA, bodyB, t7, t2, vA, vB, t8, invIB, wB, t1, cp1, cp2);
          t14 -= t27 * t17;
          t30 = cp2.get$rB();
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(179, wA, t9, i, t10, t3, t4, t5, t14, t30, t6, t31, bodyB, bodyA, vA, vB, t2, t7, invIB, wB, t1, cp1, t8, cp2);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(181, wA, t9, i, t10, t3, t4, t5, t14, t6, bodyA, bodyB, t7, t2, vA, vB, t30, t22, t8, invIB, wB, t1, cp1, cp2);
          wB += invIB * (t14 + (t22 - t30 * t25));
          cp1.set$normalImpulse(t4.get$x());
          cp2.set$normalImpulse(t4.get$y());
          break $loop$1;
 ...
 solvePositionConstraints$1: function(baumgarte) {
  ...
  while (true) {
    ...
    if (typeof t5 !== 'number')
      return this.solvePositionConstraints$1$bailout(1, baumgarte, t5, point, i, t4, minSeparation, t1, t2, psm, normal, t3);
    if (!(i < t5))
      break;
    t5 = this.constraints;
    if (i >= t5.length)
    ...
    t5 = bodyA.get$mass();
    if (typeof t5 !== 'number')
      return this.solvePositionConstraints$1$bailout(2, baumgarte, i, minSeparation, t1, t2, t3, bodyA, bodyB, t5, t4, c, psm, normal, point);
    t7 = bodyA.get$invMass();
    if (typeof t7 !== 'number')
      return this.solvePositionConstraints$1$bailout(3, baumgarte, i, minSeparation, t1, t2, t3, bodyA, bodyB, t5, t7, t4, c, psm, normal, point);
    invMassA = t5 * t7;
    t7 = bodyA.get$invInertia();
    if (typeof t7 !== 'number')
      return this.solvePositionConstraints$1$bailout(5, baumgarte, i, minSeparation, t1, t2, t3, bodyA, bodyB, t4, invMassA, psm, normal, t5, point, c, t7);
    invIA = t5 * t7;
    t7 = bodyB.get$mass();
    if (typeof t7 !== 'number')
      return this.solvePositionConstraints$1$bailout(6, baumgarte, i, minSeparation, t1, t2, t3, bodyA, bodyB, t4, invMassA, psm, normal, invIA, point, c, t7);
    t10 = bodyB.get$invMass();
    if (typeof t10 !== 'number')
      return this.solvePositionConstraints$1$bailout(7, baumgarte, i, minSeparation, t1, t2, t3, bodyA, bodyB, t4, invMassA, psm, normal, invIA, point, c, t10, t7);
    invMassB = t7 * t10;
    t10 = bodyB.get$invInertia();
    if (typeof t10 !== 'number')
      return this.solvePositionConstraints$1$bailout(9, baumgarte, t10, i, minSeparation, t1, t2, t3, bodyA, bodyB, t4, invMassA, psm, normal, invIA, point, c, invMassB, t7);
    invIB = t7 * t10;
    ...
    while (true) {
      t6 = c.get$pointCount();
      if (typeof t6 !== 'number')
        return this.solvePositionConstraints$1$bailout(10, baumgarte, invIB, j, i, minSeparation, t1, t2, t3, t6, bodyA, bodyB, t4, invMassA, psm, normal, invIA, point, c, invMassB);
      if (!(j < t6))
        break;
      psm.initialize$2(c, j);
      separation = psm.separation;
      if (typeof separation !== 'number')
        return this.solvePositionConstraints$1$bailout(11, baumgarte, invIB, j, i, minSeparation, t1, t2, t3, bodyA, bodyB, t4, invMassA, psm, normal, invIA, separation, c, point, invMassB);
      ...
      if (minSeparation !== (minSeparation | 0))
        return this.solvePositionConstraints$1$bailout(12, baumgarte, invIB, minSeparation, j, i, t1, t2, t3, bodyA, bodyB, t4, invMassA, psm, normal, invIA, separation, c, point, invMassB);
      C = $.max(-0.2, $.min(baumgarte * (separation + 0.005), 0));
      t8 = t3.x;
      if (typeof t8 !== 'number')
        return this.solvePositionConstraints$1$bailout(13, baumgarte, invIB, minSeparation, j, i, t1, t2, t3, bodyA, bodyB, C, t4, invMassA, psm, normal, invIA, point, c, invMassB, t8);
      t10 = normal.y;
      if (typeof t10 !== 'number')
        return this.solvePositionConstraints$1$bailout(14, t10, baumgarte, invIB, minSeparation, j, i, t1, t2, t3, bodyA, bodyB, C, t4, invMassA, psm, normal, invIA, point, c, invMassB, t8);
      t8 *= t10;
      t12 = t3.y;
      if (typeof t12 !== 'number')
        return this.solvePositionConstraints$1$bailout(15, baumgarte, t12, invIB, minSeparation, j, i, t1, t2, t3, bodyA, bodyB, C, t4, invMassA, t8, normal, invIA, psm, c, point, invMassB);
      t14 = normal.x;
      if (typeof t14 !== 'number')
        return this.solvePositionConstraints$1$bailout(16, baumgarte, t12, invIB, t14, minSeparation, j, i, t1, t2, t3, bodyA, bodyB, C, t4, invMassA, t8, normal, invIA, psm, c, point, invMassB);
      rnA = t8 - t12 * t14;
      t8 = t4.x;
      if (typeof t8 !== 'number')
        return this.solvePositionConstraints$1$bailout(17, baumgarte, invIB, t8, minSeparation, j, i, t1, t2, t3, bodyA, bodyB, C, t4, invMassA, psm, normal, invIA, point, c, invMassB, rnA);
      t10 = t8 * t10;
      t8 = t4.y;
      if (typeof t8 !== 'number')
        return this.solvePositionConstraints$1$bailout(19, baumgarte, invIB, t10, minSeparation, j, t8, t1, t2, i, t3, bodyA, bodyB, C, t4, invMassA, psm, normal, invIA, point, c, invMassB, rnA);
      rnB = t10 - t8 * t14;
      ...
      t7 = t6.get$angle();
      if (typeof t7 !== 'number')
        return this.solvePositionConstraints$1$bailout(21, baumgarte, invIB, minSeparation, j, i, t1, t2, t3, t6, t7, bodyA, bodyB, t4, invMassA, psm, normal, invIA, point, c, invMassB);
      t9 = t3.x;
      if (typeof t9 !== 'number')
        return this.solvePositionConstraints$1$bailout(22, baumgarte, invIB, minSeparation, j, i, t1, t2, t3, t9, t7, bodyA, bodyB, t6, t4, invMassA, psm, normal, invIA, point, c, invMassB);
      t11 = t1.y;
      if (typeof t11 !== 'number')
        return this.solvePositionConstraints$1$bailout(23, baumgarte, invIB, minSeparation, j, i, t1, t2, t3, t6, t7, bodyA, bodyB, t11, t9, t4, invMassA, psm, normal, invIA, point, c, invMassB);
      t11 = t9 * t11;
      t9 = t3.y;
      if (typeof t9 !== 'number')
        return this.solvePositionConstraints$1$bailout(24, baumgarte, invIB, minSeparation, j, i, t1, t2, c, t3, t6, t7, bodyA, bodyB, t9, t4, t11, psm, normal, invIA, point, invMassA, invMassB);
      t14 = t1.x;
      if (typeof t14 !== 'number')
        return this.solvePositionConstraints$1$bailout(25, baumgarte, minSeparation, i, t6, t7, bodyA, bodyB, c, t11, psm, normal, invIA, point, invMassA, invMassB, invIB, j, t1, t2, t3, t9, t14, t4);
      ...
      t16 = t6.get$angle();
      if (typeof t16 !== 'number')
        return this.solvePositionConstraints$1$bailout(26, baumgarte, invIB, minSeparation, j, i, t1, t2, t6, t16, t3, bodyA, bodyB, t4, invMassA, psm, normal, point, invIA, c, invMassB);
      t18 = t4.x;
      if (typeof t18 !== 'number')
        return this.solvePositionConstraints$1$bailout(27, baumgarte, invIB, minSeparation, j, i, t1, t2, t6, t16, t3, bodyA, bodyB, t4, invMassA, t18, psm, normal, point, c, invIA, invMassB);
      t20 = t1.y;
      if (typeof t20 !== 'number')
        return this.solvePositionConstraints$1$bailout(28, baumgarte, invIB, invIA, minSeparation, j, i, t1, t2, t6, t16, t3, bodyA, bodyB, t4, invMassA, t18, t20, normal, psm, c, point, invMassB);
      t20 = t18 * t20;
      t18 = t4.y;
      if (typeof t18 !== 'number')
        return this.solvePositionConstraints$1$bailout(29, baumgarte, invIB, minSeparation, j, i, t1, t2, t6, t16, t3, bodyA, t20, bodyB, t4, invMassA, psm, normal, t18, point, c, invIA, invMassB);
      t23 = t1.x;
      if (typeof t23 !== 'number')
        return this.solvePositionConstraints$1$bailout(30, baumgarte, invIB, invIA, minSeparation, j, i, t1, t2, t6, t16, t3, bodyA, t20, bodyB, t4, invMassA, psm, normal, t18, t23, c, point, invMassB);
...
$$.TimeOfImpactSolver = {"":"Object;constraints>,count>,toiBody,psm,rA>,rB>,P,temp",
 initialize$3: function(contacts, argCount, argToiBody) {
  ...
  if (t1 >= t3) {
    ...
    $.CONSTANT0.setRange$3(this.constraints, 0, t2.length, t2);
 ...
 initialize$3$bailout: function(state0, contacts, argCount, argToiBody) {
  ...
  for (t1 = $.getInterceptor$JSStringJSArray(contacts), i = 0; i < this.count; ++i) {
 ...
 solve$1: function(baumgarte) {
  ...
  for (t1 = this.P, t2 = this.temp, t3 = this.rA, t4 = this.rB, t5 = this.psm, normal = t5.normal, point = t5.point, minSeparation = 0, i = 0; i < this.count; ++i) {
    ...
    if (typeof massA !== 'number')
      return this.solve$1$bailout0(1, baumgarte, c, t5, t4, normal, minSeparation, point, i, bodyA, bodyB, massA, t1, t2, t3);
    massB = bodyB.get$mass();
    if (typeof massB !== 'number')
      return this.solve$1$bailout0(2, baumgarte, c, t5, t4, normal, minSeparation, point, i, bodyA, bodyB, massA, massB, t1, t2, t3);
    ...
    if (typeof t6 !== 'number')
      return this.solve$1$bailout0(3, baumgarte, t3, c, t5, t4, normal, minSeparation, point, i, bodyA, bodyB, t1, t2, massB, massA, t6);
    invMassA = massA * t6;
    t6 = bodyA.get$invInertia();
    if (typeof t6 !== 'number')
      return this.solve$1$bailout0(4, baumgarte, invMassA, t6, c, t5, t4, normal, minSeparation, point, i, bodyA, bodyB, t1, t2, massB, massA, t3);
    invIA = massA * t6;
    t6 = bodyB.get$invMass();
    if (typeof t6 !== 'number')
      return this.solve$1$bailout0(5, baumgarte, invMassA, c, invIA, t6, t5, t4, normal, minSeparation, point, i, bodyA, bodyB, t1, t2, massB, t3);
    invMassB = massB * t6;
    t6 = bodyB.get$invInertia();
    if (typeof t6 !== 'number')
      return this.solve$1$bailout0(6, baumgarte, invMassA, c, invIA, invMassB, t4, normal, t5, point, minSeparation, i, bodyA, bodyB, t6, t1, t2, massB, t3);
    invIB = massB * t6;
    ...
    while (true) {
      t7 = c.get$pointCount();
      if (typeof t7 !== 'number')
        return this.solve$1$bailout0(7, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, point, t5, minSeparation, bodyA, bodyB, i, j, t7, t1, t2, t3);
      if (!(j < t7))
        break;
      t5.initialize$2(c, j);
      separation = t5.separation;
      if (typeof separation !== 'number')
        return this.solve$1$bailout0(8, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, point, separation, minSeparation, bodyA, bodyB, t5, i, j, t1, t2, t3);
      t3.setFrom$1(point).subLocal$1(bodyA.get$sweep().get$center());
      t4.setFrom$1(point).subLocal$1(bodyB.get$sweep().get$center());
      minSeparation = $.min(minSeparation, separation);
      if (minSeparation !== (minSeparation | 0))
        return this.solve$1$bailout0(9, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, point, separation, i, bodyA, minSeparation, bodyB, t5, j, t1, t2, t3);
      C = $.max(-0.2, $.min(baumgarte * (separation + 0.005), 0));
      t9 = t3.x;
      if (typeof t9 !== 'number')
        return this.solve$1$bailout0(10, C, invMassA, baumgarte, invIA, c, invMassB, t4, normal, invIB, point, t5, i, bodyA, minSeparation, bodyB, t9, j, t1, t2, t3);
      t11 = normal.y;
      if (typeof t11 !== 'number')
        return this.solve$1$bailout0(11, C, invMassA, baumgarte, invIA, c, invMassB, t4, normal, invIB, point, t5, i, bodyA, minSeparation, bodyB, t9, t11, j, t1, t2, t3);
      t9 *= t11;
      t13 = t3.y;
      if (typeof t13 !== 'number')
        return this.solve$1$bailout0(12, C, invMassA, baumgarte, invIA, t9, c, invMassB, t4, normal, invIB, point, t5, i, bodyA, minSeparation, bodyB, t13, j, t1, t2, t3);
      t15 = normal.x;
      if (typeof t15 !== 'number')
        return this.solve$1$bailout0(13, C, invMassA, baumgarte, invIA, t9, c, invMassB, t4, normal, invIB, point, t5, i, bodyA, minSeparation, bodyB, t13, t15, j, t1, t2, t3);
      rnA = t9 - t13 * t15;
      t9 = t4.x;
      if (typeof t9 !== 'number')
        return this.solve$1$bailout0(14, C, invMassA, baumgarte, invIA, c, invMassB, t4, normal, invIB, rnA, point, t5, i, bodyA, minSeparation, bodyB, t9, j, t1, t2, t3);
      t11 = t9 * t11;
      t9 = t4.y;
      if (typeof t9 !== 'number')
        return this.solve$1$bailout0(16, C, invMassA, baumgarte, invIA, c, invMassB, t4, normal, invIB, rnA, point, t5, i, t11, bodyA, minSeparation, bodyB, t9, j, t1, t2, t3);
      rnB = t11 - t9 * t15;
      ...
      t8 = t7.get$angle();
      if (typeof t8 !== 'number')
        return this.solve$1$bailout0(18, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, point, t5, i, bodyA, minSeparation, bodyB, j, t1, t2, t7, t8, t3);
      t10 = t3.x;
      if (typeof t10 !== 'number')
        return this.solve$1$bailout0(19, baumgarte, t10, invMassA, c, invIA, invMassB, t4, normal, invIB, point, t5, i, bodyA, minSeparation, bodyB, j, t1, t2, t7, t8, t3);
      t12 = t1.y;
      if (typeof t12 !== 'number')
        return this.solve$1$bailout0(20, baumgarte, t10, t12, c, invIA, invMassB, t4, normal, invIB, invMassA, point, t5, i, bodyA, minSeparation, bodyB, j, t1, t2, t7, t8, t3);
      t12 = t10 * t12;
      t10 = t3.y;
      if (typeof t10 !== 'number')
        return this.solve$1$bailout0(21, baumgarte, invMassA, t12, invIA, t10, invMassB, t4, c, invIB, point, normal, t5, i, bodyA, minSeparation, bodyB, j, t1, t2, t7, t8, t3);
      t15 = t1.x;
      if (typeof t15 !== 'number')
        return this.solve$1$bailout0(22, baumgarte, t10, t15, t4, i, bodyA, minSeparation, bodyB, t7, t8, invMassA, t12, invIA, c, invMassB, t5, normal, invIB, point, j, t1, t2, t3);
      ...
      t17 = t7.get$angle();
      if (typeof t17 !== 'number')
        return this.solve$1$bailout0(23, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, point, t5, i, bodyA, minSeparation, bodyB, t7, j, t17, t1, t2, t3);
      t19 = t4.x;
      if (typeof t19 !== 'number')
        return this.solve$1$bailout0(24, baumgarte, invMassA, c, invIA, invMassB, t4, normal, t19, invIB, point, t5, i, bodyA, minSeparation, bodyB, t7, j, t17, t1, t2, t3);
      t21 = t1.y;
      if (typeof t21 !== 'number')
        return this.solve$1$bailout0(25, baumgarte, invMassA, c, invIA, invMassB, t4, normal, t19, invIB, t21, t5, point, bodyA, minSeparation, bodyB, i, t7, j, t17, t1, t2, t3);
      t21 = t19 * t21;
      t19 = t4.y;
      if (typeof t19 !== 'number')
        return this.solve$1$bailout0(26, baumgarte, invMassA, t3, c, invIA, invMassB, t4, normal, invIB, point, t19, t5, i, bodyA, minSeparation, bodyB, t7, j, t17, t1, t2, t21);
      t24 = t1.x;
      if (typeof t24 !== 'number')
        return this.solve$1$bailout0(27, baumgarte, t21, t4, i, t19, t24, bodyA, minSeparation, bodyB, invMassA, c, invIA, invMassB, t5, normal, invIB, point, t7, j, t17, t1, t2, t3);
 ...
 solve$1$bailout0: function(state0, env0, env1, env2, env3, env4, env5, env6, env7, env8, env9, env10, env11, env12, env13, env14, env15, env16, env17, env18, env19, env20, env21, env22) {
  ...
  switch (state0) {
    case 0:
      ...
      i = 0;
    default:
      var t1, t2, t3, t4, t5, normal, point, minSeparation, i, t6, c, bodyA, bodyB, massA, baumgarte, massB, invMassA, invIA, invMassB, invIB, j, separation, t8, C, t9, t11, t14, rnA, t17, t20, rnB, K, impulse, t7, t16, t18, t23;
      L0:
        while (true)
          switch (state0) {
            case 0:
...
$$.ConstantVolumeJoint = {"":"Joint;bodies>,targetLengths,targetVolume,normals>,step,_impulse,_world,distanceJoints,frequencyHz>,dampingRatio>,type,_prev,_next,edgeA,edgeB,bodyA,bodyB,islandFlag,collideConnected,userData,localCenterA,localCenterB,invMassA,invIA,invMassB,invIB",
 ...
 initVelocityConstraints$1: function(argStep) {
  var t1, d, i, prev, next, t2, t4, t3, t6, t8, t10, t12, t13, t16, t17, t19, t21, t23, t25, t26;
  this.step = argStep;
  t1 = this.bodies;
  ...
  while (true) {
    ...
    if (typeof t1 !== 'number')
      return this.initVelocityConstraints$1$bailout(1, d, t1, i);
    if (!(i < t1))
      break;
    t1 = $.Vector$(0, 0);
    if (i >= d.length)
  ...
  while (true) {
    ...
    t1 = $.getInterceptor$JSStringJSArray(t1).get$length(t1);
    if (typeof t1 !== 'number')
      return this.initVelocityConstraints$1$bailout(2, d, i, t1);
    if (!(i < t1))
      break;
    if (i === 0) {
      t1 = this.bodies;
      t1 = $.getInterceptor$JSStringJSArray(t1).get$length(t1);
      if (typeof t1 !== 'number')
        return this.initVelocityConstraints$1$bailout(3, d, t1, i);
      prev = t1 - 1;
    } else
      prev = i - 1;
    t1 = this.bodies;
    t1 = $.getInterceptor$JSStringJSArray(t1).get$length(t1);
    if (typeof t1 !== 'number')
      return this.initVelocityConstraints$1$bailout(4, d, prev, i, t1);
    next = i === t1 - 1 ? 0 : i + 1;
    if (i >= d.length)
      throw $.ioore(i);
    t1 = d[i];
    t2 = this.bodies;
    if (typeof t2 !== 'string' && (typeof t2 !== 'object' || t2 === null || t2.constructor !== Array && !t2.is$JavaScriptIndexingBehavior))
      return this.initVelocityConstraints$1$bailout(5, i, d, next, prev, t2, t1);
    if (next >= t2.length)
      throw $.ioore(next);
    ...
    t4 = this.bodies;
    if (typeof t4 !== 'string' && (typeof t4 !== 'object' || t4 === null || t4.constructor !== Array && !t4.is$JavaScriptIndexingBehavior))
      return this.initVelocityConstraints$1$bailout(6, t1, d, prev, i, t4);
    if (prev !== (prev | 0))
      throw $.iae(prev);
  ...
  if (t1.get$warmStarting() === true) {
    t2 = this._impulse;
    if (typeof t2 !== 'number')
      return this.initVelocityConstraints$1$bailout(7, d, t1, t2);
    t1 = t1.get$dtRatio();
    if (typeof t1 !== 'number')
      return this.initVelocityConstraints$1$bailout(8, d, t1, t2);
    this._impulse = t2 * t1;
    i = 0;
    while (true) {
      t1 = this.bodies;
      t1 = $.getInterceptor$JSStringJSArray(t1).get$length(t1);
      if (typeof t1 !== 'number')
        return this.initVelocityConstraints$1$bailout(9, d, t1, i);
      if (!(i < t1))
        break;
      t1 = this.bodies;
      if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior))
        return this.initVelocityConstraints$1$bailout(10, d, i, t1);
      if (i >= t1.length)
        throw $.ioore(i);
      t3 = t1[i].get$linearVelocity();
      t4 = t3.get$x();
      if (typeof t4 !== 'number')
        return this.initVelocityConstraints$1$bailout(11, d, t3, i, t4);
      t6 = this.bodies;
      if (typeof t6 !== 'string' && (typeof t6 !== 'object' || t6 === null || t6.constructor !== Array && !t6.is$JavaScriptIndexingBehavior))
        return this.initVelocityConstraints$1$bailout(12, t6, d, t3, i, t4);
      if (i >= t6.length)
        throw $.ioore(i);
      t8 = t6[i].get$invMass();
      if (typeof t8 !== 'number')
        return this.initVelocityConstraints$1$bailout(13, d, t3, i, t4, t8);
      if (i >= d.length)
        throw $.ioore(i);
      t10 = d[i].get$y();
      if (typeof t10 !== 'number')
        return this.initVelocityConstraints$1$bailout(14, t10, d, t3, i, t4, t8);
      t12 = t8 * t10 * 0.5;
      t13 = this._impulse;
      if (typeof t13 !== 'number')
        return this.initVelocityConstraints$1$bailout(15, t12, t13, d, t3, i, t4);
      t3.set$x(t4 + t12 * t13);
      t3 = this.bodies;
      if (typeof t3 !== 'string' && (typeof t3 !== 'object' || t3 === null || t3.constructor !== Array && !t3.is$JavaScriptIndexingBehavior))
        return this.initVelocityConstraints$1$bailout(16, d, i, t3);
      if (i >= t3.length)
        throw $.ioore(i);
      t16 = t3[i].get$linearVelocity();
      t17 = t16.get$y();
      if (typeof t17 !== 'number')
        return this.initVelocityConstraints$1$bailout(17, t17, d, i, t16);
      t19 = this.bodies;
      if (typeof t19 !== 'string' && (typeof t19 !== 'object' || t19 === null || t19.constructor !== Array && !t19.is$JavaScriptIndexingBehavior))
        return this.initVelocityConstraints$1$bailout(18, t17, t19, d, i, t16);
      if (i >= t19.length)
        throw $.ioore(i);
      t21 = t19[i].get$invMass();
      if (typeof t21 !== 'number')
        return this.initVelocityConstraints$1$bailout(19, t17, t21, d, i, t16);
      if (i >= d.length)
        throw $.ioore(i);
      t23 = d[i].get$x();
      if (typeof t23 !== 'number')
        return this.initVelocityConstraints$1$bailout(20, t17, t21, t23, d, i, t16);
      t25 = t21 * -t23 * 0.5;
      t26 = this._impulse;
      if (typeof t26 !== 'number')
        return this.initVelocityConstraints$1$bailout(21, t17, t26, d, i, t25, t16);
            ...
            L2:
              while (true)
                switch (state0) {
                  ...
                  case 16:
                    state0 = 0;
                    t16 = $.getInterceptor$JSStringJSArray(t3).operator$index$1(t3, i).get$linearVelocity();
                    t17 = t16.get$y();
                  case 17:
                    state0 = 0;
                    t19 = this.bodies;
                  case 18:
                    state0 = 0;
                    t21 = $.getInterceptor$JSStringJSArray(t19).operator$index$1(t19, i).get$invMass();
                  case 19:
                    state0 = 0;
                    if (i >= d.length)
                      throw $.ioore(i);
 ...
 solveVelocityConstraints$1: function(argStep) {
  var t1, d, i, crossMassSum, dotMassSum, prev, next, t2, t4, t7, t9, t11, t12, t14, lambda, t3, t6, t8, t10, t13, t16, t18, t20;
  t1 = this.bodies;
  d = $.List_List($.getInterceptor$JSStringJSArray(t1).get$length(t1));
  i = 0;
  while (true) {
    ...
    t1 = $.getInterceptor$JSStringJSArray(t1).get$length(t1);
    if (typeof t1 !== 'number')
      return this.solveVelocityConstraints$1$bailout(1, d, t1, i);
    if (!(i < t1))
      break;
    t1 = $.Vector$(0, 0);
    if (i >= d.length)
  ...
  while (true) {
    ...
    t1 = $.getInterceptor$JSStringJSArray(t1).get$length(t1);
    if (typeof t1 !== 'number')
      return this.solveVelocityConstraints$1$bailout(2, d, t1, crossMassSum, dotMassSum, i);
    if (!(i < t1))
      break;
    if (i === 0) {
      t1 = this.bodies;
      t1 = $.getInterceptor$JSStringJSArray(t1).get$length(t1);
      if (typeof t1 !== 'number')
        return this.solveVelocityConstraints$1$bailout(3, crossMassSum, dotMassSum, t1, i, d);
      prev = t1 - 1;
    } else
      prev = i - 1;
    t1 = this.bodies;
    t1 = $.getInterceptor$JSStringJSArray(t1).get$length(t1);
    if (typeof t1 !== 'number')
      return this.solveVelocityConstraints$1$bailout(4, t1, crossMassSum, dotMassSum, i, d, prev);
    next = i === t1 - 1 ? 0 : i + 1;
    if (i >= d.length)
      throw $.ioore(i);
    t1 = d[i];
    t2 = this.bodies;
    if (typeof t2 !== 'string' && (typeof t2 !== 'object' || t2 === null || t2.constructor !== Array && !t2.is$JavaScriptIndexingBehavior))
      return this.solveVelocityConstraints$1$bailout(5, crossMassSum, dotMassSum, t2, i, d, t1, next, prev);
    if (next >= t2.length)
      throw $.ioore(next);
    t1.setFrom$1(t2[next].get$worldCenter());
    if (i >= d.length)
    ...
    t4 = this.bodies;
    if (typeof t4 !== 'string' && (typeof t4 !== 'object' || t4 === null || t4.constructor !== Array && !t4.is$JavaScriptIndexingBehavior))
      return this.solveVelocityConstraints$1$bailout(6, crossMassSum, dotMassSum, i, d, t4, t1, prev);
    if (prev !== (prev | 0))
      throw $.iae(prev);
    if (prev < 0 || prev >= t4.length)
      throw $.ioore(prev);
    ...
    if (typeof t1 !== 'number')
      return this.solveVelocityConstraints$1$bailout(7, crossMassSum, dotMassSum, i, d, t1);
    t7 = this.bodies;
    if (typeof t7 !== 'string' && (typeof t7 !== 'object' || t7 === null || t7.constructor !== Array && !t7.is$JavaScriptIndexingBehavior))
      return this.solveVelocityConstraints$1$bailout(8, crossMassSum, dotMassSum, i, d, t7, t1);
    if (i >= t7.length)
      throw $.ioore(i);
    t9 = t7[i].get$mass();
    if (typeof t9 !== 'number')
      return this.solveVelocityConstraints$1$bailout(9, t9, crossMassSum, dotMassSum, i, d, t1);
    t9 = t1 / t9;
    if (t9 !== (t9 | 0))
      return this.solveVelocityConstraints$1$bailout(10, crossMassSum, dotMassSum, t9, i, d);
    dotMassSum += t9;
    if (i >= t7.length)
      throw $.ioore(i);
    t9 = t7[i].get$linearVelocity();
    if (i >= d.length)
      throw $.ioore(i);
    t11 = d[i];
    t12 = t9.get$x();
    if (typeof t12 !== 'number')
      return this.solveVelocityConstraints$1$bailout(12, crossMassSum, dotMassSum, i, d, t9, t11, t12);
    t14 = t11.get$y();
    if (typeof t14 !== 'number')
      return this.solveVelocityConstraints$1$bailout(13, crossMassSum, dotMassSum, i, d, t9, t11, t12, t14);
    t14 = t12 * t14;
    t9 = t9.get$y();
    if (typeof t9 !== 'number')
      return this.solveVelocityConstraints$1$bailout(14, t14, t9, crossMassSum, dotMassSum, i, d, t11);
    t11 = t11.get$x();
    if (typeof t11 !== 'number')
      return this.solveVelocityConstraints$1$bailout(15, t14, t9, t11, crossMassSum, dotMassSum, i, d);
    t14 -= t9 * t11;
    if (t14 !== (t14 | 0))
      return this.solveVelocityConstraints$1$bailout(16, d, crossMassSum, dotMassSum, t14, i);
    crossMassSum += t14;
    ++i;
  }
  ...
  t1 = this._impulse;
  if (typeof t1 !== 'number')
    return this.solveVelocityConstraints$1$bailout(17, d, t1, lambda);
  ...
  while (true) {
    ...
    t1 = $.getInterceptor$JSStringJSArray(t1).get$length(t1);
    if (typeof t1 !== 'number')
      return this.solveVelocityConstraints$1$bailout(18, i, d, lambda, t1);
    if (!(i < t1))
      break;
    t1 = this.bodies;
    if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior))
      return this.solveVelocityConstraints$1$bailout(19, i, d, lambda, t1);
    if (i >= t1.length)
      throw $.ioore(i);
    t3 = t1[i].get$linearVelocity();
    t4 = t3.get$x();
    if (typeof t4 !== 'number')
      return this.solveVelocityConstraints$1$bailout(20, i, lambda, d, t3, t4);
    t6 = this.bodies;
    if (typeof t6 !== 'string' && (typeof t6 !== 'object' || t6 === null || t6.constructor !== Array && !t6.is$JavaScriptIndexingBehavior))
      return this.solveVelocityConstraints$1$bailout(21, i, lambda, d, t3, t4, t6);
    if (i >= t6.length)
      throw $.ioore(i);
    t8 = t6[i].get$invMass();
    if (typeof t8 !== 'number')
      return this.solveVelocityConstraints$1$bailout(22, i, t8, lambda, d, t3, t4);
    if (i >= d.length)
      throw $.ioore(i);
    t10 = d[i].get$y();
    if (typeof t10 !== 'number')
      return this.solveVelocityConstraints$1$bailout(23, i, t8, lambda, t10, d, t3, t4);
    t3.set$x(t4 + t8 * t10 * 0.5 * lambda);
    t3 = this.bodies;
    if (typeof t3 !== 'string' && (typeof t3 !== 'object' || t3 === null || t3.constructor !== Array && !t3.is$JavaScriptIndexingBehavior))
      return this.solveVelocityConstraints$1$bailout(24, i, t3, d, lambda);
    if (i >= t3.length)
      throw $.ioore(i);
    t13 = t3[i].get$linearVelocity();
    t14 = t13.get$y();
    if (typeof t14 !== 'number')
      return this.solveVelocityConstraints$1$bailout(25, i, t13, t14, lambda, d);
    t16 = this.bodies;
    if (typeof t16 !== 'string' && (typeof t16 !== 'object' || t16 === null || t16.constructor !== Array && !t16.is$JavaScriptIndexingBehavior))
      return this.solveVelocityConstraints$1$bailout(26, i, t16, t13, t14, lambda, d);
    if (i >= t16.length)
      throw $.ioore(i);
    t18 = t16[i].get$invMass();
    if (typeof t18 !== 'number')
      return this.solveVelocityConstraints$1$bailout(27, i, t13, t14, lambda, t18, d);
    if (i >= d.length)
      throw $.ioore(i);
    t20 = d[i].get$x();
    if (typeof t20 !== 'number')
      return this.solveVelocityConstraints$1$bailout(28, i, t13, t14, lambda, t18, d, t20);
 ...
 solveVelocityConstraints$1$bailout: function(state0, env0, env1, env2, env3, env4, env5, env6, env7) {
  ...
  switch (state0) {
      ...
      L1:
        while (true)
          switch (state0) {
            ...
            case 8:
              state0 = 0;
              t9 = $.getInterceptor$JSStringJSArray(t7).operator$index$1(t7, i).get$mass();
            case 9:
              state0 = 0;
              t9 = $.div(t1, t9);
              if (typeof t9 !== 'number')
            ...
            case 11:
              state0 = 0;
              t12 = $.getInterceptor$JSStringJSArray(t9).operator$index$1(t9, i).get$linearVelocity();
              if (i >= d.length)
                throw $.ioore(i);
              t13 = d[i];
              t14 = t12.get$x();
    ...
    case 27:
    case 28:
      var t1, d, i, crossMassSum, dotMassSum, prev, next, t2, t4, t7, t9, t12, t13, t14, t16, lambda, t3, t6, t8, t10, t18, t20;
      L2:
        while (true)
          switch (state0) {
            case 0:
...
$$.DistanceJoint = {"":"Joint;localAnchor1,localAnchor2,u,impulse,mass>,length=,frequencyHz>,dampingRatio>,gamma,bias,type,_prev,_next,edgeA,edgeB,bodyA,bodyB,islandFlag,collideConnected,userData,localCenterA,localCenterB,invMassA,invIA,invMassB,invIB",
 initVelocityConstraints$1: function(step) {
  ...
  if (typeof t1 !== 'number')
    return this.initVelocityConstraints$1$bailout2(1, step, r1, r2, t1, b1, b2);
  t3 = r2.x;
  if (typeof t3 !== 'number')
    return this.initVelocityConstraints$1$bailout2(2, step, t3, r1, r2, t1, b1, b2);
  t3 = t1 + t3;
  t1 = b1.get$sweep().get$center().get$x();
  if (typeof t1 !== 'number')
    return this.initVelocityConstraints$1$bailout2(3, step, t1, b2, r1, r2, b1, t3);
  t1 = t3 - t1;
  t3 = r1.x;
  if (typeof t3 !== 'number')
    return this.initVelocityConstraints$1$bailout2(4, step, t3, t1, r1, r2, b1, b2);
  t3 = t1 - t3;
  t1 = this.u;
  t1.x = t3;
  t3 = b2.get$sweep().get$center().get$y();
  if (typeof t3 !== 'number')
    return this.initVelocityConstraints$1$bailout2(5, step, t1, r1, r2, t3, b1, b2);
  t8 = r2.y;
  if (typeof t8 !== 'number')
    return this.initVelocityConstraints$1$bailout2(6, step, t1, t8, r1, r2, t3, b1, b2);
  t8 = t3 + t8;
  t3 = b1.get$sweep().get$center().get$y();
  if (typeof t3 !== 'number')
    return this.initVelocityConstraints$1$bailout2(7, step, t3, t1, b2, r1, r2, b1, t8);
  t3 = t8 - t3;
  t8 = r1.y;
  if (typeof t8 !== 'number')
    return this.initVelocityConstraints$1$bailout2(8, step, t1, t3, t8, r1, r2, b1, b2);
  t1.y = t3 - t8;
  len = $.getInterceptor$JSStringJSArray(t1).get$length(t1);
  if (typeof len !== 'number')
    return this.initVelocityConstraints$1$bailout2(9, step, t1, r1, r2, len, b1, b2);
  if (len > 0.005) {
    t2 = t1.x;
    if (typeof t2 !== 'number')
      return this.initVelocityConstraints$1$bailout2(10, step, t1, r1, r2, len, t2, b1, b2);
    t4 = 1 / len;
    t1.x = t2 * t4;
    t5 = t1.y;
    if (typeof t5 !== 'number')
      return this.initVelocityConstraints$1$bailout2(11, step, t5, t1, t4, r1, r2, len, b1, b2);
    t1.y = t5 * t4;
  } else
    t1.setCoords$2(0, 0);
  t2 = r1.x;
  if (typeof t2 !== 'number')
    return this.initVelocityConstraints$1$bailout2(12, step, t2, t1, r1, r2, len, b1, b2);
  t4 = t1.y;
  if (typeof t4 !== 'number')
    return this.initVelocityConstraints$1$bailout2(13, step, t2, t4, r1, r2, t1, len, b1, b2);
  t2 *= t4;
  t6 = r1.y;
  if (typeof t6 !== 'number')
    return this.initVelocityConstraints$1$bailout2(14, step, t1, t6, r1, r2, t2, len, b1, b2);
  t8 = t1.x;
  if (typeof t8 !== 'number')
    return this.initVelocityConstraints$1$bailout2(15, step, t1, t6, t8, r1, r2, t2, len, b1, b2);
  cr1u = t2 - t6 * t8;
  t2 = r2.x;
  if (typeof t2 !== 'number')
    return this.initVelocityConstraints$1$bailout2(16, step, cr1u, t1, r1, r2, t2, len, b1, b2);
  t4 = t2 * t4;
  t2 = r2.y;
  if (typeof t2 !== 'number')
    return this.initVelocityConstraints$1$bailout2(18, step, cr1u, t1, t4, r1, r2, t2, len, b1, b2);
  cr2u = t4 - t2 * t8;
  t4 = b1.get$invMass();
  if (typeof t4 !== 'number')
    return this.initVelocityConstraints$1$bailout2(20, step, cr1u, len, t1, r1, r2, cr2u, t4, b1, b2);
  t13 = b1.get$invInertia();
  if (typeof t13 !== 'number')
    return this.initVelocityConstraints$1$bailout2(21, step, cr1u, len, b1, t1, r1, r2, cr2u, t4, t13, b2);
  t4 += t13 * cr1u * cr1u;
  t15 = b2.get$invMass();
  if (typeof t15 !== 'number')
    return this.initVelocityConstraints$1$bailout2(22, step, t1, t4, t15, r1, r2, len, cr2u, b1, b2);
  t15 = t4 + t15;
  t4 = b2.get$invInertia();
  if (typeof t4 !== 'number')
    return this.initVelocityConstraints$1$bailout2(23, step, t1, t15, r1, r2, t4, len, cr2u, b1, b2);
  invMass = t15 + t4 * cr2u * cr2u;
  this.mass = 1 / invMass;
  t2 = this.frequencyHz;
  if (typeof t2 !== 'number')
    return this.initVelocityConstraints$1$bailout2(24, step, b1, b2, t1, r1, r2, len, t2, invMass);
  if (t2 > 0) {
    t3 = this.length;
    if (typeof t3 !== 'number')
      return this.initVelocityConstraints$1$bailout2(25, step, t3, t1, r1, invMass, r2, len, b1, b2);
    C = len - t3;
    ...
    t6 = step.get$dt();
    if (typeof t6 !== 'number')
      return this.initVelocityConstraints$1$bailout2(26, step, invMass, t1, r1, d, r2, C, k, t6, b1, b2);
    this.gamma = t6 * (d + t6 * k);
    t2 = this.gamma;
    if (typeof t2 !== 'number')
      return this.initVelocityConstraints$1$bailout2(27, step, invMass, t1, t2, r1, r2, C, k, b1, b2);
    this.gamma = !(t2 === 0) ? 1 / t2 : 0;
    t2 = step.get$dt();
    if (typeof t2 !== 'number')
      return this.initVelocityConstraints$1$bailout2(28, step, b1, t1, t2, r1, r2, C, k, invMass, b2);
    t4 = C * t2 * k;
    t5 = this.gamma;
    if (typeof t5 !== 'number')
      return this.initVelocityConstraints$1$bailout2(29, step, b2, t1, r1, r2, t4, t5, invMass, b1);
    this.bias = t4 * t5;
    t7 = this.gamma;
    if (typeof t7 !== 'number')
      throw $.iae(t7);
  ...
  if (step.get$warmStarting() === true) {
    ...
    t5 = t4.get$x();
    if (typeof t5 !== 'number')
      return this.initVelocityConstraints$1$bailout2(30, t4, t5, r1, r2, P, b1, b2);
    t7 = b1.get$invMass();
    if (typeof t7 !== 'number')
      return this.initVelocityConstraints$1$bailout2(31, t4, t5, t7, r1, r2, P, b1, b2);
    t9 = P.x;
    if (typeof t9 !== 'number')
      return this.initVelocityConstraints$1$bailout2(32, t4, t5, t7, t9, r1, r2, P, b1, b2);
    t4.set$x(t5 - t7 * t9);
    t4 = b1.get$linearVelocity();
    t11 = t4.get$y();
    if (typeof t11 !== 'number')
      return this.initVelocityConstraints$1$bailout2(33, r1, r2, t4, t11, P, b1, b2);
    t13 = b1.get$invMass();
    if (typeof t13 !== 'number')
      return this.initVelocityConstraints$1$bailout2(34, b1, r1, r2, t4, t11, t13, P, b2);
    t15 = P.y;
    if (typeof t15 !== 'number')
      return this.initVelocityConstraints$1$bailout2(35, b1, r1, t15, r2, t4, t11, t13, P, b2);
    t4.set$y(t11 - t13 * t15);
    t4 = b1.get$angularVelocity();
    if (typeof t4 !== 'number')
      return this.initVelocityConstraints$1$bailout2(36, t4, r1, r2, P, b1, b2);
    t18 = b1.get$invInertia();
    if (typeof t18 !== 'number')
      return this.initVelocityConstraints$1$bailout2(37, t4, t18, r1, r2, P, b1, b2);
    t20 = r1.x;
    if (typeof t20 !== 'number')
      return this.initVelocityConstraints$1$bailout2(38, t4, t18, r1, r2, t20, P, b1, b2);
    t22 = P.y;
    if (typeof t22 !== 'number')
      return this.initVelocityConstraints$1$bailout2(39, t4, t18, r1, r2, t20, t22, P, b1, b2);
    t22 = t20 * t22;
    t20 = r1.y;
    if (typeof t20 !== 'number')
      return this.initVelocityConstraints$1$bailout2(40, t4, t18, r2, t22, t20, P, b1, b2);
    t25 = P.x;
    if (typeof t25 !== 'number')
      return this.initVelocityConstraints$1$bailout2(41, t4, t18, r2, t22, t20, t25, P, b1, b2);
    b1.set$angularVelocity(t4 - t18 * (t22 - t20 * t25));
    t27 = b2.get$linearVelocity();
    t28 = t27.get$x();
    if (typeof t28 !== 'number')
      return this.initVelocityConstraints$1$bailout2(42, P, r2, t27, t28, b2);
    t30 = b2.get$invMass();
    if (typeof t30 !== 'number')
      return this.initVelocityConstraints$1$bailout2(43, t27, t28, t30, r2, P, b2);
    t32 = P.x;
    if (typeof t32 !== 'number')
      return this.initVelocityConstraints$1$bailout2(44, t27, t28, t30, r2, P, t32, b2);
    t27.set$x(t28 + t30 * t32);
    t27 = b2.get$linearVelocity();
    t34 = t27.get$y();
    if (typeof t34 !== 'number')
      return this.initVelocityConstraints$1$bailout2(45, t34, r2, P, t27, b2);
    t36 = b2.get$invMass();
    if (typeof t36 !== 'number')
      return this.initVelocityConstraints$1$bailout2(46, t36, t34, r2, P, t27, b2);
    t38 = P.y;
    if (typeof t38 !== 'number')
      return this.initVelocityConstraints$1$bailout2(47, t36, t27, b2, r2, P, t38, t34);
    t27.set$y(t34 + t36 * t38);
    t27 = b2.get$angularVelocity();
    if (typeof t27 !== 'number')
      return this.initVelocityConstraints$1$bailout2(48, b2, r2, P, t27);
    t41 = b2.get$invInertia();
    if (typeof t41 !== 'number')
      return this.initVelocityConstraints$1$bailout2(49, t27, t41, r2, P, b2);
    t43 = r2.x;
    if (typeof t43 !== 'number')
      return this.initVelocityConstraints$1$bailout2(50, t43, t27, t41, r2, P, b2);
    t45 = P.y;
    if (typeof t45 !== 'number')
      return this.initVelocityConstraints$1$bailout2(51, t45, t43, t27, t41, r2, P, b2);
    t45 = t43 * t45;
    t43 = r2.y;
    if (typeof t43 !== 'number')
      return this.initVelocityConstraints$1$bailout2(52, t43, t27, t41, t45, P, b2);
    t48 = P.x;
    if (typeof t48 !== 'number')
      return this.initVelocityConstraints$1$bailout2(53, t43, t48, t27, t41, t45, b2);
    b2.set$angularVelocity(t27 + t41 * (t45 - t43 * t48));
  } else
    this.impulse = 0;
},
 initVelocityConstraints$1$bailout2: function(state0, env0, env1, env2, env3, env4, env5, env6, env7, env8, env9, env10) {
  switch (state0) {
    case 1:
      b2 = env5;
      b1 = env4;
 ...
 solveVelocityConstraints$1: function(step) {
  var b1, b2, r1, r2, v1, v2, t1, t2, t3, t5, Cdot, t10, t12, t14, imp, Px, Py, t16, t18, t20, t23, t25, t27, t29, t30, t32, t34, t36, t39, t41, t43;
  b1 = this.bodyA;
  b2 = this.bodyB;
  r1 = $.Vector$(0, 0);
  r2 = $.Vector$(0, 0);
  ...
  t3 = t1.x;
  if (typeof t3 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(1, b2, t1, t3, r1, r2, t2, b1);
  t5 = t2.get$x();
  if (typeof t5 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(2, b2, t1, t3, r1, r2, t2, t5, b1);
  t5 = t3 * t5;
  t3 = t1.y;
  if (typeof t3 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(3, b2, t1, t3, r1, r2, t2, t5, b1);
  t2 = t2.get$y();
  if (typeof t2 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(4, b2, t2, t1, t3, r1, r2, t5, b1);
  Cdot = t5 + t3 * t2;
  t5 = this.mass;
  if (typeof t5 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(5, b2, t1, Cdot, t5, r1, r2, b1);
  t5 = -t5;
  t10 = this.bias;
  if (typeof t10 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(6, b2, t1, Cdot, t5, r1, r2, t10, b1);
  t10 = Cdot + t10;
  t12 = this.gamma;
  if (typeof t12 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(7, b2, t1, t5, r1, r2, t10, t12, b1);
  t14 = this.impulse;
  imp = t5 * (t10 + t12 * t14);
  this.impulse = t14 + imp;
  t5 = t1.x;
  if (typeof t5 !== 'number')
    throw $.iae(t5);
  Px = imp * t5;
  ...
  t5 = t1.get$x();
  if (typeof t5 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(8, b2, t5, t1, r1, r2, Px, Py, b1);
  t16 = b1.get$invMass();
  if (typeof t16 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(9, b2, t5, t16, t1, r1, r2, Px, Py, b1);
  t1.set$x(t5 - t16 * Px);
  t1 = b1.get$linearVelocity();
  t18 = t1.get$y();
  if (typeof t18 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(10, b2, t1, r1, r2, Px, t18, Py, b1);
  t20 = b1.get$invMass();
  if (typeof t20 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(11, b2, t1, r1, r2, Px, t18, t20, Py, b1);
  t1.set$y(t18 - t20 * Py);
  t1 = b1.get$angularVelocity();
  if (typeof t1 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(12, b2, b1, r1, r2, Px, Py, t1);
  t23 = b1.get$invInertia();
  if (typeof t23 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(13, b2, t23, b1, r1, r2, Px, Py, t1);
  t25 = r1.x;
  if (typeof t25 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(14, b2, t23, b1, t25, r1, r2, Px, Py, t1);
  t25 *= Py;
  t27 = r1.y;
  if (typeof t27 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(15, b2, t23, t27, t25, t1, r2, Px, Py, b1);
  b1.set$angularVelocity(t1 - t23 * (t25 - t27 * Px));
  t29 = b2.get$linearVelocity();
  t30 = t29.get$x();
  if (typeof t30 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(16, b2, t29, r2, Px, Py, t30);
  t32 = b2.get$invMass();
  if (typeof t32 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(17, b2, t32, t29, r2, Px, Py, t30);
  t29.set$x(t30 + t32 * Px);
  t29 = b2.get$linearVelocity();
  t34 = t29.get$y();
  if (typeof t34 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(18, b2, t29, t34, r2, Px, Py);
  t36 = b2.get$invMass();
  if (typeof t36 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(19, b2, t29, t34, t36, r2, Px, Py);
  t29.set$y(t34 + t36 * Py);
  t29 = b2.get$angularVelocity();
  if (typeof t29 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(20, b2, r2, Px, Py, t29);
  t39 = b2.get$invInertia();
  if (typeof t39 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(21, b2, t29, r2, Px, Py, t39);
  t41 = r2.x;
  if (typeof t41 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(22, b2, t41, t39, r2, Px, Py, t29);
  t41 *= Py;
  t43 = r2.y;
  if (typeof t43 !== 'number')
    return this.solveVelocityConstraints$1$bailout2(23, b2, t41, t43, Px, t29, t39);
  b2.set$angularVelocity(t29 + t39 * (t41 - t43 * Px));
},
 solveVelocityConstraints$1$bailout2: function(state0, env0, env1, env2, env3, env4, env5, env6, env7, env8) {
  switch (state0) {
    case 1:
      b1 = env6;
      t2 = env5;
  ...
  switch (state0) {
    ...
    case 7:
      state0 = 0;
      imp = $.mul(t5, $.add(t10, $.mul(t12, this.impulse)));
      t5 = this.impulse;
    ...
    case 15:
      state0 = 0;
      b1.set$angularVelocity($.sub(t1, $.mul(t23, $.sub(t25, $.mul(t27, Px)))));
      t29 = b2.get$linearVelocity();
      t30 = t29.get$x();
    case 16:
      state0 = 0;
    ...
    case 22:
      ...
      t43 = r2.y;
    case 23:
      var b1, b2, r1, r2, v1, v2, t1, t2, t3, t5, Cdot, t10, t12, imp, t14, Px, Py, t16, t18, t20, t23, t25, t27, t29, t30, t32, t34, t36, t39, t41, t43;
      state0 = 0;
      b2.set$angularVelocity($.add(t29, $.mul(t39, $.sub(t41, $.mul(t43, Px)))));
  }
},
 solvePositionConstraints$1: function(baumgarte) {
  ...
  t1 = b2.get$sweep().get$center().get$x();
  if (typeof t1 !== 'number')
    return this.solvePositionConstraints$1$bailout1(2, r1, r2, d, t1, b1, b2);
  t3 = r2.x;
  if (typeof t3 !== 'number')
    return this.solvePositionConstraints$1$bailout1(3, r1, r2, t3, d, t1, b1, b2);
  t3 = t1 + t3;
  t1 = b1.get$sweep().get$center().get$x();
  if (typeof t1 !== 'number')
    return this.solvePositionConstraints$1$bailout1(4, r1, r2, d, t3, t1, b1, b2);
  t1 = t3 - t1;
  t3 = r1.x;
  if (typeof t3 !== 'number')
    return this.solvePositionConstraints$1$bailout1(5, r1, r2, t3, d, t1, b1, b2);
  d.x = t1 - t3;
  t7 = b2.get$sweep().get$center().get$y();
  if (typeof t7 !== 'number')
    return this.solvePositionConstraints$1$bailout1(6, r1, r2, d, t7, b1, b2);
  t9 = r2.y;
  if (typeof t9 !== 'number')
    return this.solvePositionConstraints$1$bailout1(7, r1, r2, d, t9, t7, b1, b2);
  t9 = t7 + t9;
  t7 = b1.get$sweep().get$center().get$y();
  if (typeof t7 !== 'number')
    return this.solvePositionConstraints$1$bailout1(8, r1, r2, d, t9, t7, b1, b2);
  t7 = t9 - t7;
  t9 = r1.y;
  if (typeof t9 !== 'number')
    return this.solvePositionConstraints$1$bailout1(9, r1, t7, r2, d, t9, b1, b2);
  d.y = t7 - t9;
  len = d.normalize$0();
  if (typeof len !== 'number')
    return this.solvePositionConstraints$1$bailout1(10, r1, r2, len, d, b1, b2);
  t14 = this.length;
  if (typeof t14 !== 'number')
    return this.solvePositionConstraints$1$bailout1(11, r1, r2, len, d, t14, b1, b2);
  C = $.max(-0.2, $.min(len - t14, 0.2));
  t16 = this.mass;
  if (typeof t16 !== 'number')
    return this.solvePositionConstraints$1$bailout1(12, r1, r2, d, C, t16, b1, b2);
  imp = -t16 * C;
  t18 = this.u;
  t18.setFrom$1(d);
  t19 = t18.x;
  if (typeof t19 !== 'number')
    return this.solvePositionConstraints$1$bailout1(13, r1, r2, imp, C, t18, t19, b1, b2);
  Px = imp * t19;
  t18 = t18.y;
  if (typeof t18 !== 'number')
    return this.solvePositionConstraints$1$bailout1(14, r1, t18, r2, imp, C, Px, b1, b2);
  Py = imp * t18;
  t18 = b1.get$sweep().get$center();
  t21 = t18.get$x();
  if (typeof t21 !== 'number')
    return this.solvePositionConstraints$1$bailout1(15, t18, t21, C, r1, Py, r2, Px, b1, b2);
  t23 = b1.get$invMass();
  if (typeof t23 !== 'number')
    return this.solvePositionConstraints$1$bailout1(16, t18, t21, t23, r1, Py, b2, r2, Px, b1, C);
  t18.set$x(t21 - t23 * Px);
  t18 = b1.get$sweep().get$center();
  t25 = t18.get$y();
  if (typeof t25 !== 'number')
    return this.solvePositionConstraints$1$bailout1(17, C, r1, r2, Py, t18, t25, Px, b1, b2);
  t27 = b1.get$invMass();
  if (typeof t27 !== 'number')
    return this.solvePositionConstraints$1$bailout1(18, b2, r1, r2, Py, t18, t25, t27, Px, b1, C);
  t18.set$y(t25 - t27 * Py);
  t18 = b1.get$sweep();
  t29 = t18.get$angle();
  if (typeof t29 !== 'number')
    return this.solvePositionConstraints$1$bailout1(19, C, t18, r2, t29, Py, r1, Px, b1, b2);
  t31 = b1.get$invInertia();
  if (typeof t31 !== 'number')
    return this.solvePositionConstraints$1$bailout1(20, C, t18, r2, t29, t31, r1, Py, Px, b1, b2);
  t33 = r1.x;
  if (typeof t33 !== 'number')
    return this.solvePositionConstraints$1$bailout1(21, b2, t18, t33, r2, t31, t29, r1, Py, Px, b1, C);
  t33 *= Py;
  t35 = r1.y;
  if (typeof t35 !== 'number')
    return this.solvePositionConstraints$1$bailout1(22, t35, t18, C, r2, t31, t29, t33, Py, Px, b1, b2);
  t18.set$angle(t29 - t31 * (t33 - t35 * Px));
  t18 = b2.get$sweep().get$center();
  t37 = t18.get$x();
  if (typeof t37 !== 'number')
    return this.solvePositionConstraints$1$bailout1(23, b2, b1, r2, t18, t37, Px, Py, C);
  t39 = b2.get$invMass();
  if (typeof t39 !== 'number')
    return this.solvePositionConstraints$1$bailout1(24, b2, b1, r2, t18, t37, t39, Px, Py, C);
  t18.set$x(t37 + t39 * Px);
  t18 = b2.get$sweep().get$center();
  t41 = t18.get$y();
  if (typeof t41 !== 'number')
    return this.solvePositionConstraints$1$bailout1(25, b2, b1, r2, Px, t18, t41, Py, C);
  t43 = b2.get$invMass();
  if (typeof t43 !== 'number')
    return this.solvePositionConstraints$1$bailout1(26, b2, b1, r2, Px, t18, t41, t43, Py, C);
  t18.set$y(t41 + t43 * Py);
  t18 = b2.get$sweep();
  t45 = t18.get$angle();
  if (typeof t45 !== 'number')
    return this.solvePositionConstraints$1$bailout1(27, C, Py, r2, t18, t45, Px, b1, b2);
  t47 = b2.get$invInertia();
  if (typeof t47 !== 'number')
    return this.solvePositionConstraints$1$bailout1(28, b2, b1, r2, t18, t45, t47, Px, Py, C);
  t49 = r2.x;
  if (typeof t49 !== 'number')
    return this.solvePositionConstraints$1$bailout1(29, b2, t49, r2, t18, t45, t47, b1, Px, Py, C);
  t49 *= Py;
  t51 = r2.y;
  if (typeof t51 !== 'number')
    return this.solvePositionConstraints$1$bailout1(30, C, t51, t18, t45, t47, t49, Px, b1, b2);
  t18.set$angle(t45 + t47 * (t49 - t51 * Px));
  b1.synchronizeTransform$0();
  b2.synchronizeTransform$0();
  t18 = $.CONSTANT1.abs$0(C);
  if (typeof t18 !== 'number')
    return this.solvePositionConstraints$1$bailout1(31, t18);
  return t18 < 0.005;
},
 solvePositionConstraints$1$bailout1: function(state0, env0, env1, env2, env3, env4, env5, env6, env7, env8, env9, env10) {
  switch (state0) {
    case 1:
      t1 = env0;
      break;
...
$$.FrictionJoint = {"":"Joint;_localAnchorA,_localAnchorB,_linearImpulse,_angularImpulse,_maxForce,_maxTorque,type,_prev,_next,edgeA,edgeB,bodyA,bodyB,islandFlag,collideConnected,userData,localCenterA,localCenterB,invMassA,invIA,invMassB,invIB",
 ...
 initVelocityConstraints$1: function(step) {
  ...
  t2 = t1.get$invMass();
  if (typeof t2 !== 'number')
    return this.initVelocityConstraints$1$bailout0(1, step, t2, r1, K, r2);
  t4 = this.bodyB;
  t5 = t4.get$invMass();
  if (typeof t5 !== 'number')
    return this.initVelocityConstraints$1$bailout0(2, step, t2, t5, r1, r2, K);
  t5 = t2 + t5;
  t1 = t1.get$invInertia();
  if (typeof t1 !== 'number')
    return this.initVelocityConstraints$1$bailout0(3, step, t5, r1, t1, r2, K);
  t7 = r1.y;
  if (typeof t7 !== 'number')
    return this.initVelocityConstraints$1$bailout0(4, step, t5, r1, t1, r2, K, t7);
  t1 *= t7;
  t5 += t1 * t7;
  t4 = t4.get$invInertia();
  if (typeof t4 !== 'number')
    return this.initVelocityConstraints$1$bailout0(6, step, t4, r1, r2, K, t5);
  t10 = r2.y;
  if (typeof t10 !== 'number')
    return this.initVelocityConstraints$1$bailout0(7, step, t4, t10, r1, r2, K, t5);
  t4 *= t10;
  t5 += t4 * t10;
  K.col1.set$x(t5);
  t5 = this.bodyA.get$invInertia();
  if (typeof t5 !== 'number')
    return this.initVelocityConstraints$1$bailout0(9, step, t5, r1, K, r2);
  t5 = -t5;
  t13 = r1.x;
  if (typeof t13 !== 'number')
    return this.initVelocityConstraints$1$bailout0(10, step, r1, t13, r2, K, t5);
  t13 = t5 * t13;
  t5 = r1.y;
  if (typeof t5 !== 'number')
    return this.initVelocityConstraints$1$bailout0(11, step, t13, r1, t5, r2, K);
  t5 = t13 * t5;
  t13 = this.bodyB.get$invInertia();
  if (typeof t13 !== 'number')
    return this.initVelocityConstraints$1$bailout0(12, step, t5, r1, t13, r2, K);
  t17 = r2.x;
  if (typeof t17 !== 'number')
    return this.initVelocityConstraints$1$bailout0(13, step, t5, r1, t13, r2, t17, K);
  t17 = t13 * t17;
  t13 = r2.y;
  if (typeof t13 !== 'number')
    return this.initVelocityConstraints$1$bailout0(14, step, t5, r1, r2, t17, t13, K);
  t5 -= t17 * t13;
  K.col1.set$y(t5);
  t5 = K.col1.get$y();
  K.col2.set$x(t5);
  ...
  t20 = t5.get$invMass();
  if (typeof t20 !== 'number')
    return this.initVelocityConstraints$1$bailout0(15, step, K, r1, t20, r2);
  t22 = this.bodyB;
  t23 = t22.get$invMass();
  if (typeof t23 !== 'number')
    return this.initVelocityConstraints$1$bailout0(16, step, r1, t20, r2, t23, K);
  t23 = t20 + t23;
  t5 = t5.get$invInertia();
  if (typeof t5 !== 'number')
    return this.initVelocityConstraints$1$bailout0(17, step, r1, r2, t23, t5, K);
  t25 = r1.x;
  if (typeof t25 !== 'number')
    return this.initVelocityConstraints$1$bailout0(18, step, t25, r1, r2, t23, t5, K);
  t5 *= t25;
  t23 += t5 * t25;
  t22 = t22.get$invInertia();
  if (typeof t22 !== 'number')
    return this.initVelocityConstraints$1$bailout0(20, step, t23, r1, t22, r2, K);
  t28 = r2.x;
  if (typeof t28 !== 'number')
    return this.initVelocityConstraints$1$bailout0(21, step, t28, t23, r1, t22, r2, K);
  t22 *= t28;
  t23 += t22 * t28;
  K.col2.set$y(t23);
  ...
  if (typeof t23 !== 'number')
    return this.initVelocityConstraints$1$bailout0(23, step, r1, t23, r2);
  t31 = this.bodyB.get$invInertia();
  if (typeof t31 !== 'number')
    return this.initVelocityConstraints$1$bailout0(24, step, t31, r1, t23, r2);
  if (t23 + t31 > 0)
    ;
  ...
  if (t1) {
    ...
    t4 = t2.get$x();
    if (typeof t4 !== 'number')
      return this.initVelocityConstraints$1$bailout0(25, t2, t4, P, r1, r2);
    t6 = this.bodyA.get$invMass();
    if (typeof t6 !== 'number')
      return this.initVelocityConstraints$1$bailout0(26, P, r1, t2, t4, r2, t6);
    t8 = P.x;
    if (typeof t8 !== 'number')
      return this.initVelocityConstraints$1$bailout0(27, P, r1, t2, t4, r2, t6, t8);
    t2.set$x(t4 - t6 * t8);
    t2 = this.bodyA.get$linearVelocity();
    t10 = t2.get$y();
    if (typeof t10 !== 'number')
      return this.initVelocityConstraints$1$bailout0(28, t2, P, t10, r1, r2);
    t12 = this.bodyA.get$invMass();
    if (typeof t12 !== 'number')
      return this.initVelocityConstraints$1$bailout0(29, t2, P, t10, r1, t12, r2);
    t14 = P.y;
    if (typeof t14 !== 'number')
      return this.initVelocityConstraints$1$bailout0(30, t2, P, t10, r1, t12, r2, t14);
    t2.set$y(t10 - t12 * t14);
    t2 = this.bodyA;
    t16 = t2.get$angularVelocity();
    if (typeof t16 !== 'number')
      return this.initVelocityConstraints$1$bailout0(31, P, t2, r1, t16, r2);
    t18 = this.bodyA.get$invInertia();
    if (typeof t18 !== 'number')
      return this.initVelocityConstraints$1$bailout0(32, P, t2, r1, r2, t16, t18);
    t20 = r1.x;
    if (typeof t20 !== 'number')
      return this.initVelocityConstraints$1$bailout0(33, P, t2, r1, t20, r2, t16, t18);
    t22 = P.y;
    if (typeof t22 !== 'number')
      return this.initVelocityConstraints$1$bailout0(34, P, t2, r1, t20, r2, t22, t16, t18);
    t22 = t20 * t22;
    t20 = r1.y;
    if (typeof t20 !== 'number')
      return this.initVelocityConstraints$1$bailout0(35, P, t2, t22, t20, r2, t16, t18);
    t25 = P.x;
    if (typeof t25 !== 'number')
      return this.initVelocityConstraints$1$bailout0(36, P, t2, t22, t20, r2, t25, t16, t18);
    t2.set$angularVelocity(t16 - t18 * (t22 - t20 * t25 + this._angularImpulse));
    t2 = this.bodyB.get$linearVelocity();
    t27 = t2.get$x();
    if (typeof t27 !== 'number')
      return this.initVelocityConstraints$1$bailout0(37, P, t2, t27, r2);
    t29 = this.bodyB.get$invMass();
    if (typeof t29 !== 'number')
      return this.initVelocityConstraints$1$bailout0(38, P, t2, t27, t29, r2);
    t31 = P.x;
    if (typeof t31 !== 'number')
      return this.initVelocityConstraints$1$bailout0(39, P, t2, t27, t29, r2, t31);
    t2.set$x(t27 + t29 * t31);
    t2 = this.bodyB.get$linearVelocity();
    t33 = t2.get$y();
    if (typeof t33 !== 'number')
      return this.initVelocityConstraints$1$bailout0(40, t33, P, t2, r2);
    t35 = this.bodyB.get$invMass();
    if (typeof t35 !== 'number')
      return this.initVelocityConstraints$1$bailout0(41, t33, t35, P, t2, r2);
    t37 = P.y;
    if (typeof t37 !== 'number')
      return this.initVelocityConstraints$1$bailout0(42, t33, t35, P, r2, t2, t37);
    t2.set$y(t33 + t35 * t37);
    t2 = this.bodyB;
    t39 = t2.get$angularVelocity();
    if (typeof t39 !== 'number')
      return this.initVelocityConstraints$1$bailout0(43, t2, t39, P, r2);
    t41 = this.bodyB.get$invInertia();
    if (typeof t41 !== 'number')
      return this.initVelocityConstraints$1$bailout0(44, t2, t39, P, t41, r2);
    t43 = r2.x;
    if (typeof t43 !== 'number')
      return this.initVelocityConstraints$1$bailout0(45, t2, t43, P, r2, t39, t41);
    t45 = P.y;
    if (typeof t45 !== 'number')
      return this.initVelocityConstraints$1$bailout0(46, t2, t43, P, t45, r2, t39, t41);
    t45 = t43 * t45;
    t43 = r2.y;
    if (typeof t43 !== 'number')
      return this.initVelocityConstraints$1$bailout0(47, t2, P, t43, t39, t41, t45);
    t48 = P.x;
    if (typeof t48 !== 'number')
      return this.initVelocityConstraints$1$bailout0(48, t2, t43, t48, t39, t41, t45);
 ...
 initVelocityConstraints$1$bailout0: function(state0, env0, env1, env2, env3, env4, env5, env6, env7) {
  switch (state0) {
    case 1:
      r2 = env4;
      K = env3;
 ...
 solveVelocityConstraints$1: function(step) {
  var t1, t3, Cdot, t5, angularMass, impulse, oldImpulse, maxImpulse, t7, t9, t11, r1, r2, temp, K, t13, t15, t16, t18, t21, t24, t28, t31, t33, t34, t36, t39, linearMass, impulse0, t41, t43, maxImpulse0, t2, t4, t6, t8, t10, t12, t14, t20, t23, t25, t27, t29, t38, t40, t42, t44, t47;
  t1 = this.bodyB.get$angularVelocity();
  if (typeof t1 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(1, step, t1);
  t3 = this.bodyA.get$angularVelocity();
  if (typeof t3 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(2, step, t1, t3);
  Cdot = t1 - t3;
  t3 = this.bodyA.get$invInertia();
  if (typeof t3 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(3, step, Cdot, t3);
  t5 = this.bodyB.get$invInertia();
  if (typeof t5 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(4, step, Cdot, t3, t5);
  angularMass = t3 + t5;
  if (angularMass > 0)
  ...
  t1 = step.get$dt();
  if (typeof t1 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(5, step, oldImpulse, t1, impulse);
  t3 = this._maxTorque;
  if (typeof t3 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(6, step, oldImpulse, t3, t1, impulse);
  maxImpulse = t1 * t3;
  t3 = oldImpulse + impulse;
  this._angularImpulse = $.max(-maxImpulse, $.min(t3, maxImpulse));
  impulse = this._angularImpulse - oldImpulse;
  t1 = this.bodyA;
  t5 = t1.get$angularVelocity();
  if (typeof t5 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(7, step, impulse, t5, t1);
  t7 = this.bodyA.get$invInertia();
  if (typeof t7 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(8, step, impulse, t5, t7, t1);
  t1.set$angularVelocity(t5 - t7 * impulse);
  t1 = this.bodyB;
  t9 = t1.get$angularVelocity();
  if (typeof t9 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(9, step, impulse, t1, t9);
  t11 = this.bodyB.get$invInertia();
  if (typeof t11 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(10, step, impulse, t1, t9, t11);
  t1.set$angularVelocity(t9 + t11 * impulse);
  r1 = $.Vector$(0, 0);
  r2 = $.Vector$(0, 0);
  r1.setFrom$1(this._localAnchorA).subLocal$1(this.bodyA.get$localCenter());
  r2.setFrom$1(this._localAnchorB).subLocal$1(this.bodyB.get$localCenter());
  ...
  t13 = t1.get$invMass();
  if (typeof t13 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(11, step, K, t13, r1, r2, Cdot);
  t15 = this.bodyB;
  t16 = t15.get$invMass();
  if (typeof t16 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(12, step, K, t13, t16, r1, r2, Cdot);
  t16 = t13 + t16;
  t1 = t1.get$invInertia();
  if (typeof t1 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(13, step, K, r1, t16, r2, t1, Cdot);
  t18 = r1.y;
  if (typeof t18 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(14, step, K, r1, t16, r2, t1, t18, Cdot);
  t1 *= t18;
  t16 += t1 * t18;
  t15 = t15.get$invInertia();
  if (typeof t15 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(16, step, K, t15, t16, r1, r2, Cdot);
  t21 = r2.y;
  if (typeof t21 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(17, step, K, t15, t16, r1, r2, t21, Cdot);
  t15 *= t21;
  t16 += t15 * t21;
  K.col1.set$x(t16);
  t16 = this.bodyA.get$invInertia();
  if (typeof t16 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(19, step, K, r1, r2, t16, Cdot);
  t16 = -t16;
  t24 = r1.x;
  if (typeof t24 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(20, step, K, t16, r1, r2, t24, Cdot);
  t24 = t16 * t24;
  t16 = r1.y;
  if (typeof t16 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(21, step, K, Cdot, t24, r1, r2, t16);
  t16 = t24 * t16;
  t24 = this.bodyB.get$invInertia();
  if (typeof t24 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(22, step, K, r1, t16, r2, t24, Cdot);
  t28 = r2.x;
  if (typeof t28 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(23, step, K, t28, r1, t16, r2, t24, Cdot);
  t28 = t24 * t28;
  t24 = r2.y;
  if (typeof t24 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(24, step, K, t24, r1, t16, r2, t28, Cdot);
  t16 -= t28 * t24;
  K.col1.set$y(t16);
  t16 = K.col1.get$y();
  K.col2.set$x(t16);
  ...
  t31 = t16.get$invMass();
  if (typeof t31 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(25, step, K, r1, r2, t31, Cdot);
  t33 = this.bodyB;
  t34 = t33.get$invMass();
  if (typeof t34 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(26, step, K, r1, r2, t31, t34, Cdot);
  t34 = t31 + t34;
  t16 = t16.get$invInertia();
  if (typeof t16 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(27, step, K, r1, r2, t34, t16, Cdot);
  t36 = r1.x;
  if (typeof t36 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(28, step, K, r1, r2, t36, t34, t16, Cdot);
  t16 *= t36;
  t34 += t16 * t36;
  t33 = t33.get$invInertia();
  if (typeof t33 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(30, step, K, r1, t34, r2, t33, Cdot);
  t39 = r2.x;
  if (typeof t39 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(31, step, K, r1, t34, r2, t33, t39, Cdot);
  t33 *= t39;
  t34 += t33 * t39;
  K.col2.set$y(t34);
  linearMass = $.Matrix22$(null, null);
  ...
  t34.addLocal$1(impulse0);
  t41 = step.get$dt();
  if (typeof t41 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(33, t41, r1, r2, impulse0, oldImpulse, t34);
  t43 = this._maxForce;
  if (typeof t43 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(34, t43, t41, r1, r2, impulse0, oldImpulse, t34);
  maxImpulse0 = t41 * t43;
  t1 = t34.get$lengthSquared();
  if (typeof t1 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(35, r1, maxImpulse0, r2, impulse0, t1, oldImpulse, t34);
  if (t1 > maxImpulse0 * maxImpulse0) {
    t34.normalize$0();
    t34.mulLocal$1(maxImpulse0);
  }
  impulse0.setFrom$1(t34).subLocal$1(oldImpulse);
  t1 = this.bodyA.get$linearVelocity();
  t2 = t1.get$x();
  if (typeof t2 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(36, impulse0, t1, t2, r1, r2);
  t4 = impulse0.x;
  if (typeof t4 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(37, r1, r2, impulse0, t1, t2, t4);
  t6 = this.bodyA.get$invMass();
  if (typeof t6 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(38, r1, r2, impulse0, t1, t2, t4, t6);
  t1.set$x(t2 - t4 * t6);
  t1 = this.bodyA.get$linearVelocity();
  t8 = t1.get$y();
  if (typeof t8 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(39, impulse0, t1, r1, t8, r2);
  t10 = impulse0.y;
  if (typeof t10 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(40, t1, r1, t8, r2, impulse0, t10);
  t12 = this.bodyA.get$invMass();
  if (typeof t12 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(41, t1, r1, t8, r2, impulse0, t12, t10);
  t1.set$y(t8 - t10 * t12);
  t1 = this.bodyA;
  t14 = t1.get$angularVelocity();
  if (typeof t14 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(42, impulse0, t14, r1, t1, r2);
  t16 = this.bodyA.get$invInertia();
  if (typeof t16 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(43, t16, r1, r2, impulse0, t1, t14);
  t18 = r1.x;
  if (typeof t18 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(44, t14, t16, r1, r2, impulse0, t1, t18);
  t20 = impulse0.y;
  if (typeof t20 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(45, t20, t16, t14, r1, r2, impulse0, t1, t18);
  t20 = t18 * t20;
  t18 = r1.y;
  if (typeof t18 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(46, t16, t18, t20, r2, impulse0, t1, t14);
  t23 = impulse0.x;
  if (typeof t23 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(47, t16, t18, t23, t20, r2, impulse0, t1, t14);
  t1.set$angularVelocity(t14 - t16 * (t20 - t18 * t23));
  t1 = this.bodyB.get$linearVelocity();
  t25 = t1.get$x();
  if (typeof t25 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(48, impulse0, t1, t25, r2);
  t27 = impulse0.x;
  if (typeof t27 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(49, impulse0, t1, t25, t27, r2);
  t29 = this.bodyB.get$invMass();
  if (typeof t29 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(50, t1, t25, t27, t29, r2, impulse0);
  t1.set$x(t25 + t27 * t29);
  t1 = this.bodyB.get$linearVelocity();
  t31 = t1.get$y();
  if (typeof t31 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(51, impulse0, t1, t31, r2);
  t33 = impulse0.y;
  if (typeof t33 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(52, impulse0, t33, t1, t31, r2);
  t36 = this.bodyB.get$invMass();
  if (typeof t36 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(53, t36, t33, impulse0, r2, t1, t31);
  t1.set$y(t31 + t33 * t36);
  t1 = this.bodyB;
  t38 = t1.get$angularVelocity();
  if (typeof t38 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(54, t38, t1, impulse0, r2);
  t40 = this.bodyB.get$invInertia();
  if (typeof t40 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(55, t38, t1, t40, impulse0, r2);
  t42 = r2.x;
  if (typeof t42 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(56, r2, t38, t1, t40, impulse0, t42);
  t44 = impulse0.y;
  if (typeof t44 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(57, r2, t38, t1, t40, impulse0, t42, t44);
  t44 = t42 * t44;
  t42 = r2.y;
  if (typeof t42 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(58, t38, t1, t40, impulse0, t42, t44);
  t47 = impulse0.x;
  if (typeof t47 !== 'number')
    return this.solveVelocityConstraints$1$bailout0(59, t38, t1, t40, t42, t44, t47);
  t1.set$angularVelocity(t38 + t40 * (t44 - t42 * t47));
},
 solveVelocityConstraints$1$bailout0: function(state0, env0, env1, env2, env3, env4, env5, env6, env7) {
  switch (state0) {
    case 1:
      t1 = env1;
      step = env0;
  ...
  switch (state0) {
    ...
    case 6:
      ...
      if (typeof impulse !== 'number')
        throw $.iae(impulse);
      t3 += impulse;
      this._angularImpulse = $.max($.neg(maxImpulse), $.min(t3, maxImpulse));
      impulse = this._angularImpulse - oldImpulse;
      t1 = this.bodyA;
      t5 = t1.get$angularVelocity();
    case 7:
    ...
    case 8:
      state0 = 0;
      t1.set$angularVelocity($.sub(t5, $.mul(t7, impulse)));
      t1 = this.bodyB;
      t9 = t1.get$angularVelocity();
    case 9:
      state0 = 0;
    ...
    case 10:
      state0 = 0;
      t1.set$angularVelocity($.add(t9, $.mul(t11, impulse)));
      r1 = $.Vector$(0, 0);
      r2 = $.Vector$(0, 0);
      r1.setFrom$1(this._localAnchorA).subLocal$1(this.bodyA.get$localCenter());
      r2.setFrom$1(this._localAnchorB).subLocal$1(this.bodyB.get$localCenter());
    ...
    case 35:
      state0 = 0;
      if ($.gtB(t1, $.mul(maxImpulse0, maxImpulse0))) {
        t34.normalize$0();
        t34.mulLocal$1(maxImpulse0);
      }
      impulse0.setFrom$1(t34).subLocal$1(oldImpulse);
    ...
    case 58:
      ...
      t47 = impulse0.x;
    case 59:
      var t1, step, t3, Cdot, t5, angularMass, impulse, oldImpulse, maxImpulse, t7, t9, t11, r1, r2, temp, K, t14, t17, t20, t22, t26, t30, t34, t37, t40, t42, linearMass, impulse0, t45, t47, maxImpulse0, t2, t4, t6, t8, t10, t12, t16, t18, t23, t25, t27, t29, t31, t33, t36, t38, t44;
      state0 = 0;
...
$$.RevoluteJoint = {"":"Joint;localAnchor1,localAnchor2,impulse,_motorImpulse,mass>,motorMass,_enableMotor,_maxMotorTorque,_motorSpeed,_enableLimit,referenceAngle>,lowerAngle>,upperAngle>,limitState,type,_prev,_next,edgeA,edgeB,bodyA,bodyB,islandFlag,collideConnected,userData,localCenterA,localCenterB,invMassA,invIA,invMassB,invIB",
 initVelocityConstraints$1: function(step) {
  ...
  t6 = r1.y;
  if (typeof t6 !== 'number')
    return this.initVelocityConstraints$1$bailout1(5, step, t5, t6, b1, r1, b2, r2, m1, m2, i1, i2);
  t8 = t5 + t6 * t6 * i1;
  t9 = r2.y;
  if (typeof t9 !== 'number')
    return this.initVelocityConstraints$1$bailout1(6, step, t9, t8, b1, r1, b2, r2, m1, m2, i1, i2);
  t8 += t9 * t9 * i2;
  t11 = this.mass;
  t12 = t11.col1;
  t12.x = t8;
  t8 = r1.y;
  if (typeof t8 !== 'number')
    return this.initVelocityConstraints$1$bailout1(7, step, t11, t12, t8, m1, m2, i1, i2, b1, r1, b2, r2);
  t8 = -t8;
  t14 = r1.x;
  if (typeof t14 !== 'number')
    return this.initVelocityConstraints$1$bailout1(8, step, t11, t12, t14, t8, m1, m2, i1, i2, b1, r1, b2, r2);
  t16 = t8 * t14 * i1;
  t17 = r2.y;
  if (typeof t17 !== 'number')
    return this.initVelocityConstraints$1$bailout1(9, step, t11, t12, t17, t16, m1, m2, i1, i2, b1, r1, b2, r2);
  t19 = r2.x;
  if (typeof t19 !== 'number')
    return this.initVelocityConstraints$1$bailout1(10, step, t11, t12, t17, t19, t16, m1, m2, i1, i2, b1, r1, b2, r2);
  t16 -= t17 * t19 * i2;
  t21 = t11.col2;
  t21.x = t16;
  t16 = r1.y;
  if (typeof t16 !== 'number')
    return this.initVelocityConstraints$1$bailout1(11, step, t11, t12, t21, m1, m2, i1, i2, t16, b1, r1, b2, r2);
  t23 = -t16 * i1;
  t24 = r2.y;
  if (typeof t24 !== 'number')
    return this.initVelocityConstraints$1$bailout1(12, step, t11, t12, t21, m1, t24, m2, i1, i2, b1, r1, b2, r2, t23);
  t23 -= t24 * i2;
  t11 = t11.col3;
  t11.x = t23;
  t12.y = t21.x;
  t23 = r1.x;
  if (typeof t23 !== 'number')
    return this.initVelocityConstraints$1$bailout1(13, step, t12, t21, t5, m1, m2, i2, t11, i1, t23, b1, r1, b2, r2);
  t5 += t23 * t23 * i1;
  t27 = r2.x;
  if (typeof t27 !== 'number')
    return this.initVelocityConstraints$1$bailout1(14, step, t12, t21, m1, m2, i1, i2, t11, t5, b1, r1, b2, r2, t27);
  t21.y = t5 + t27 * t27 * i2;
  t29 = r1.x;
  if (typeof t29 !== 'number')
    return this.initVelocityConstraints$1$bailout1(15, step, t12, t21, m1, m2, i1, i2, t11, b1, b2, r1, r2, t29);
  t29 *= i1;
  t31 = r2.x;
  if (typeof t31 !== 'number')
    return this.initVelocityConstraints$1$bailout1(16, step, t29, t12, t21, m1, m2, i1, i2, t11, b1, r1, b2, r2, t31);
  t11.y = t29 + t31 * i2;
  t12.z = t11.x;
  t21.z = t11.y;
  t21 = i1 + i2;
  ...
  t1 = this.motorMass;
  if (typeof t1 !== 'number')
    return this.initVelocityConstraints$1$bailout1(17, step, t1, b1, r1, b2, r2, m1, m2, i1, i2);
  if (t1 > 0)
    this.motorMass = 1 / t1;
  t1 = this._enableMotor;
  if (typeof t1 !== 'boolean')
    return this.initVelocityConstraints$1$bailout1(18, step, t1, b1, r1, b2, r2, m1, m2, i1, i2);
  if (!t1)
    this._motorImpulse = 0;
  if (this._enableLimit === true) {
    t1 = b2.get$sweep().get$angle();
    if (typeof t1 !== 'number')
      return this.initVelocityConstraints$1$bailout1(19, step, r2, b1, r1, b2, t1, m1, m2, i1, i2);
    t3 = b1.get$sweep().get$angle();
    if (typeof t3 !== 'number')
      return this.initVelocityConstraints$1$bailout1(20, step, r2, t3, b1, r1, b2, t1, m1, m2, i1, i2);
    t3 = t1 - t3;
    t1 = this.referenceAngle;
    if (typeof t1 !== 'number')
      return this.initVelocityConstraints$1$bailout1(21, step, r2, t3, b1, r1, b2, t1, m1, m2, i1, i2);
    jointAngle = t3 - t1;
    t1 = this.upperAngle;
    if (typeof t1 !== 'number')
      return this.initVelocityConstraints$1$bailout1(22, step, jointAngle, t1, b1, r1, b2, r2, m1, m2, i1, i2);
    t3 = this.lowerAngle;
    if (typeof t3 !== 'number')
      return this.initVelocityConstraints$1$bailout1(23, step, jointAngle, m1, m2, i1, i2, b1, r1, b2, r2, t1, t3);
    t5 = $.CONSTANT1.abs$0(t1 - t3);
    if (typeof t5 !== 'number')
      return this.initVelocityConstraints$1$bailout1(24, step, jointAngle, b2, b1, t5, r1, r2, m1, m2, i1, i2);
    if (t5 < 0.06981317007977318)
      this.limitState = 3;
    else {
      t1 = this.lowerAngle;
      if (typeof t1 !== 'number')
        return this.initVelocityConstraints$1$bailout1(25, step, t1, jointAngle, b1, r1, b2, r2, m1, m2, i1, i2);
      if (jointAngle <= t1) {
        ...
        t1 = this.upperAngle;
        if (typeof t1 !== 'number')
          return this.initVelocityConstraints$1$bailout1(26, step, jointAngle, b2, b1, t1, r1, r2, m1, m2, i1, i2);
        if (jointAngle >= t1) {
  ...
  if (t1) {
    ...
    t4 = b1.get$angularVelocity();
    if (typeof t4 !== 'number')
      return this.initVelocityConstraints$1$bailout1(27, t4, temp, P, b1, b2, t2, r2, r1, m2, i1, i2);
    t6 = r1.x;
    if (typeof t6 !== 'number')
      return this.initVelocityConstraints$1$bailout1(28, t2, m2, i1, i2, temp, P, b1, b2, r1, r2, t6, t4);
    t8 = P.y;
    if (typeof t8 !== 'number')
      return this.initVelocityConstraints$1$bailout1(29, t2, m2, i1, i2, temp, P, b1, b2, r1, r2, t6, t8, t4);
    t8 = t6 * t8;
    t6 = r1.y;
    if (typeof t6 !== 'number')
      return this.initVelocityConstraints$1$bailout1(30, t8, t2, m2, i1, i2, temp, P, b1, b2, r2, t6, t4);
    t11 = P.x;
    if (typeof t11 !== 'number')
      return this.initVelocityConstraints$1$bailout1(31, t4, t8, t2, m2, i1, i2, temp, P, b1, b2, r2, t6, t11);
    t13 = t8 - t6 * t11 + this._motorImpulse;
    t14 = t2.z;
    if (typeof t14 !== 'number')
      return this.initVelocityConstraints$1$bailout1(32, t14, t2, t13, m2, i1, i2, temp, P, b1, b2, r2, t4);
    ...
    if (typeof t16 !== 'number')
      return this.initVelocityConstraints$1$bailout1(33, P, b2, t16, t2, r2, i2);
    t18 = r2.x;
    if (typeof t18 !== 'number')
      return this.initVelocityConstraints$1$bailout1(34, t18, P, b2, t2, t16, r2, i2);
    t20 = P.y;
    if (typeof t20 !== 'number')
      return this.initVelocityConstraints$1$bailout1(35, t18, t20, P, b2, t16, t2, r2, i2);
    t20 = t18 * t20;
    t18 = r2.y;
    if (typeof t18 !== 'number')
      return this.initVelocityConstraints$1$bailout1(36, t18, P, b2, t16, t2, t20, i2);
    t23 = P.x;
    if (typeof t23 !== 'number')
      return this.initVelocityConstraints$1$bailout1(37, t18, t23, b2, t16, t2, t20, i2);
    t25 = t20 - t18 * t23 + this._motorImpulse;
    t2 = t2.z;
    if (typeof t2 !== 'number')
      return this.initVelocityConstraints$1$bailout1(38, i2, b2, t16, t2, t25);
 ...
 initVelocityConstraints$1$bailout1: function(state0, env0, env1, env2, env3, env4, env5, env6, env7, env8, env9, env10, env11, env12, env13) {
  switch (state0) {
    case 1:
      m1 = env5;
      r2 = env4;
 ...
 solveVelocityConstraints$1: function(step) {
  var b1, b2, v1, w1, v2, w2, m1, m2, i1, i2, t1, t2, Cdot, imp, oldImpulse, t5, maxImpulse, temp, r1, r2, t3, t4, Cdot1, Cdot2, t6, t8, t10, P, t12, t15, t17, t13, t16, t18, t20, t23;
  b1 = this.bodyA;
  b2 = this.bodyB;
  ...
  if (this._enableMotor === true && !(this.limitState === 3)) {
    ...
    t2 = this._motorSpeed;
    if (typeof t2 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(5, step, t1, v1, w1, v2, w2, m1, m2, i1, i2, b1, b2, t2);
    Cdot = t1 - t2;
    t2 = this.motorMass;
    if (typeof t2 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(6, step, Cdot, v1, w1, v2, w2, m1, m2, i1, i2, b1, b2, t2);
    imp = t2 * -Cdot;
    oldImpulse = this._motorImpulse;
    t2 = step.get$dt();
    if (typeof t2 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(7, v1, w1, v2, w2, m1, m2, i1, i2, t2, imp, b1, b2, oldImpulse);
    t5 = this._maxMotorTorque;
    if (typeof t5 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(8, v1, w1, v2, w2, m1, m2, i1, i2, t2, imp, b1, b2, oldImpulse, t5);
    maxImpulse = t2 * t5;
    t5 = oldImpulse + imp;
    this._motorImpulse = $.max(-maxImpulse, $.min(t5, maxImpulse));
  ...
  if (t1) {
    ...
    if (t1 === 3)
      ...
      t2 = t1.z;
      if (typeof t2 !== 'number')
        return this.solveVelocityConstraints$1$bailout1(9, imp, v1, t4, v2, w2, m1, w1, temp, i2, m2, i1, r2, b1, b2, Cdot1, r1, t2, t1);
      t5 = imp.z;
      if (typeof t5 !== 'number')
        return this.solveVelocityConstraints$1$bailout1(10, imp, v1, t4, v2, w2, m1, w1, temp, i2, m2, i1, r2, b1, b2, Cdot1, r1, t2, t5, t1);
      if (t2 + t5 < 0) {
        ...
        t2 = t1.z;
        if (typeof t2 !== 'number')
          return this.solveVelocityConstraints$1$bailout1(11, imp, v1, v2, w2, m1, w1, temp, i2, m2, i1, r2, b1, b2, r1, t1, t2);
        imp.z = -t2;
        t4 = t1.x;
        if (typeof t4 !== 'number')
          return this.solveVelocityConstraints$1$bailout1(12, imp, v1, v2, w2, m1, w1, temp, i2, m2, i1, r2, b1, b2, r1, t1, t4);
        t6 = temp.x;
        if (typeof t6 !== 'number')
          return this.solveVelocityConstraints$1$bailout1(13, imp, v1, v2, w2, m1, w1, temp, i2, m2, i1, r2, b1, b2, r1, t1, t4, t6);
        t1.x = t4 + t6;
        t8 = t1.y;
        if (typeof t8 !== 'number')
          return this.solveVelocityConstraints$1$bailout1(14, imp, v1, v2, w2, m1, w1, temp, i2, m2, i1, r2, b1, b2, r1, t1, t8);
        t10 = temp.y;
        if (typeof t10 !== 'number')
          return this.solveVelocityConstraints$1$bailout1(15, imp, v1, v2, w2, m1, w1, temp, i2, m2, i1, r2, b1, b2, r1, t1, t8, t10);
        t1.y = t8 + t10;
        t1.z = 0;
      }
    } else if (t1 === 2) {
      ...
      t2 = t1.z;
      if (typeof t2 !== 'number')
        return this.solveVelocityConstraints$1$bailout1(16, imp, v1, t1, v2, w2, m1, w1, temp, i2, m2, i1, r2, b1, b2, Cdot1, r1, t4, t2);
      t5 = imp.z;
      if (typeof t5 !== 'number')
        return this.solveVelocityConstraints$1$bailout1(17, imp, v1, t1, v2, w2, m1, w1, temp, i2, m2, i1, r2, b1, b2, Cdot1, r1, t4, t2, t5);
      if (t2 + t5 > 0) {
        t4.solve22ToOut$2(Cdot1.negateLocal$0(), temp);
        imp.x = temp.x;
        imp.y = temp.y;
        t2 = t1.z;
        if (typeof t2 !== 'number')
          return this.solveVelocityConstraints$1$bailout1(18, imp, v1, t1, v2, w2, m1, w1, temp, i2, m2, i1, r2, b1, b2, r1, t2);
        imp.z = -t2;
        t4 = t1.x;
        if (typeof t4 !== 'number')
          return this.solveVelocityConstraints$1$bailout1(19, imp, v1, t1, v2, w2, m1, w1, temp, i2, m2, i1, r2, b1, b2, r1, t4);
        t6 = temp.x;
        if (typeof t6 !== 'number')
          return this.solveVelocityConstraints$1$bailout1(20, imp, v1, t1, v2, w2, m1, w1, temp, i2, m2, i1, r2, b1, b2, r1, t4, t6);
        t1.x = t4 + t6;
        t8 = t1.y;
        if (typeof t8 !== 'number')
          return this.solveVelocityConstraints$1$bailout1(21, imp, v1, t1, v2, w2, m1, w1, temp, i2, m2, i1, r2, b1, b2, r1, t8);
        t10 = temp.y;
        if (typeof t10 !== 'number')
          return this.solveVelocityConstraints$1$bailout1(22, imp, v1, t1, v2, w2, m1, w1, temp, i2, m2, i1, r2, b1, b2, r1, t8, t10);
        t1.y = t8 + t10;
        t1.z = 0;
      }
    }
    ...
    t1 = r1.x;
    if (typeof t1 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(23, imp, w1, w2, v2, temp, i2, m2, i1, P, b1, b2, r2, r1, t1);
    t3 = P.y;
    if (typeof t3 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(24, imp, w1, w2, v2, temp, i2, m2, i1, P, b1, b2, r2, r1, t1, t3);
    t3 = t1 * t3;
    t1 = r1.y;
    if (typeof t1 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(25, t1, imp, w1, w2, v2, temp, i2, m2, i1, P, b1, b2, r2, t3);
    t6 = P.x;
    if (typeof t6 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(26, t1, t6, imp, v2, w2, w1, temp, i2, m2, i1, P, b1, b2, r2, t3);
    t3 -= t1 * t6;
    t8 = imp.z;
    if (typeof t8 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(27, imp, t8, w1, w2, v2, temp, i2, m2, i1, P, b1, b2, r2, t3);
    w1 -= i1 * (t3 + t8);
    temp.setFrom$1(P).mulLocal$1(m2);
    v2.addLocal$1(temp);
    t10 = r2.x;
    if (typeof t10 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(28, b1, b2, imp, t10, P, w1, w2, i2, r2);
    t12 = P.y;
    if (typeof t12 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(29, b1, b2, imp, t10, t12, P, w1, w2, i2, r2);
    t12 = t10 * t12;
    t10 = r2.y;
    if (typeof t10 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(30, b1, b2, imp, t10, w1, w2, i2, t12, P);
    t15 = P.x;
    if (typeof t15 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(31, b1, b2, imp, t10, w1, t15, w2, i2, t12);
    t12 -= t10 * t15;
    t17 = imp.z;
    if (typeof t17 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(32, b1, b2, t12, w1, t17, w2, i2);
    w2 += i2 * (t12 + t17);
  } else {
    r1.setFrom$1(t2).subLocal$1(b1.get$localCenter());
    r2.setFrom$1(t3).subLocal$1(b2.get$localCenter());
    ...
    t4 = t1.x;
    if (typeof t4 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(33, v1, v2, w2, m1, m2, temp, i2, w1, i1, r2, b1, b2, imp, r1, t1, t4);
    t6 = imp.x;
    if (typeof t6 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(34, v1, v2, w2, m1, m2, temp, i2, w1, i1, r2, b1, b2, imp, r1, t1, t4, t6);
    t1.x = t4 + t6;
    t8 = t1.y;
    if (typeof t8 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(35, v1, v2, w2, m1, m2, temp, i2, w1, i1, r2, b1, b2, imp, r1, t1, t8);
    t10 = imp.y;
    if (typeof t10 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(36, v1, v2, w2, m1, m2, temp, i2, w1, i1, r2, b1, b2, imp, r1, t10, t1, t8);
    t1.y = t8 + t10;
    temp.setFrom$1(imp).mulLocal$1(m1);
    v1.subLocal$1(temp);
    t1 = r1.x;
    if (typeof t1 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(37, v2, w2, m2, temp, i2, w1, i1, imp, b1, b2, r2, r1, t1);
    t13 = imp.y;
    if (typeof t13 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(38, v2, w2, m2, temp, i2, w1, i1, imp, b1, b2, r2, r1, t1, t13);
    t13 = t1 * t13;
    t1 = r1.y;
    if (typeof t1 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(39, v2, w2, m2, temp, i2, w1, i1, imp, b1, b2, r2, t1, t13);
    t16 = imp.x;
    if (typeof t16 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(40, v2, w2, m2, temp, i2, w1, i1, imp, b1, b2, r2, t1, t13, t16);
    w1 -= i1 * (t13 - t1 * t16);
    temp.setFrom$1(imp).mulLocal$1(m2);
    v2.addLocal$1(temp);
    t18 = r2.x;
    if (typeof t18 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(41, b1, b2, r2, w1, t18, w2, i2, imp);
    t20 = imp.y;
    if (typeof t20 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(42, b1, b2, imp, w1, t18, w2, t20, i2, r2);
    t20 = t18 * t20;
    t18 = r2.y;
    if (typeof t18 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(43, b1, b2, w1, w2, t18, i2, t20, imp);
    t23 = imp.x;
    if (typeof t23 !== 'number')
      return this.solveVelocityConstraints$1$bailout1(44, b1, b2, w1, w2, t18, t23, i2, t20);
    w2 += i2 * (t20 - t18 * t23);
  }
  b1.set$angularVelocity(w1);
  b2.set$angularVelocity(w2);
},
 solveVelocityConstraints$1$bailout1: function(state0, env0, env1, env2, env3, env4, env5, env6, env7, env8, env9, env10, env11, env12, env13, env14, env15, env16, env17, env18) {
  switch (state0) {
    case 1:
      w1 = env4;
      v1 = env3;
  ...
  switch (state0) {
    ...
    default:
      if (state0 === 8 || state0 === 7 || state0 === 6 || state0 === 5 || state0 === 0 && this._enableMotor === true && !(this.limitState === 3))
        switch (state0) {
          ...
          case 8:
            state0 = 0;
            maxImpulse = $.mul(t2, t5);
            t5 = this._motorImpulse;
            if (typeof imp !== 'number')
              throw $.iae(imp);
            t5 += imp;
            this._motorImpulse = $.max($.neg(maxImpulse), $.min(t5, maxImpulse));
            imp = this._motorImpulse - oldImpulse;
    ...
    case 43:
    case 44:
      var b1, b2, v1, w1, step, v2, w2, m1, m2, i1, i2, t1, t2, Cdot, imp, oldImpulse, t5, maxImpulse, temp, r1, r2, t3, t4, Cdot1, Cdot2, t6, t8, t10, P, t12, t15, t17, t13, t16, t18, t20, t23;
                  ...
                  if (state0 === 15 || state0 === 14 || state0 === 13 || state0 === 12 || state0 === 11 || state0 === 10 || state0 === 9 || state0 === 0 && t1 === 1)
                    switch (state0) {
                      ...
                      case 10:
                        state0 = 0;
                      default:
                        if (state0 === 15 || state0 === 14 || state0 === 13 || state0 === 12 || state0 === 11 || state0 === 0 && $.ltB($.add(t2, t5), 0))
                          switch (state0) {
                            case 0:
                              t4.solve22ToOut$2(Cdot1.negateLocal$0(), temp);
                              imp.x = temp.x;
                        ...
                        if (state0 === 22 || state0 === 21 || state0 === 20 || state0 === 19 || state0 === 18 || state0 === 17 || state0 === 16 || state0 === 0 && t1 === 2)
                          switch (state0) {
                            ...
                            case 17:
                              state0 = 0;
                            default:
                              if (state0 === 22 || state0 === 21 || state0 === 20 || state0 === 19 || state0 === 18 || state0 === 0 && $.gtB($.add(t2, t5), 0))
                                switch (state0) {
                                  case 0:
                                    t4.solve22ToOut$2(Cdot1.negateLocal$0(), temp);
                                    imp.x = temp.x;
 ...
 solvePositionConstraints$1: function(baumgarte) {
  ...
  if (this._enableLimit === true && !(this.limitState === 0)) {
    ...
    if (t1 === 3) {
      ...
      limitImpulse = -t3 * C;
      angularError = $.CONSTANT1.abs$0(C);
...
$$.BenchmarkRunner_setupBenchmarks_anon0 = {"":"Closure;",
 call$1: function(e) {
  return $.getInterceptor$JSString(e).trim$0(e);
}
};

$$.BenchmarkRunner_setupBenchmarks_anon = {"":"Closure;filterList_0",
 call$1: function(e) {
  var t1 = this.filterList_0;
  return !$.eqB($.getInterceptor$JSStringJSArray(t1).indexOf$1(t1, e.get$name()), -1);
}
};
...
$.BenchmarkRunner$ = function() {
  ...
  return new $.BenchmarkRunner($.CONSTANT6, $.CONSTANT7, $.List_List(null), t1);
};
...
$.main = function() {
  ...
  results = parser.Parse$1($.Options_Options().get$arguments());
  runner.setupBenchmarks$1($.getInterceptor$JSStringJSArray(results).operator$index$1(results, "filter"));
...
$.Arrays_copy$bailout = function(state0, src, srcStart, dst, dstStart, count) {
  ...
  if (srcStart < dstStart)
    ...
    for (t1 = $.getInterceptor$JSStringJSArray(src), i = srcStart, j = dstStart; i < srcStart + count; ++i, ++j)
      $.indexSet(dst, j, t1.operator$index$1(src, i));
};
...
$._OptionsImpl__nativeArguments = Isolate.$isolateProperties.CONSTANT8;
