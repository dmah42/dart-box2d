...
$$.Collision = {"": "Object;_pool,cache,input,output,results1,results2,incidentEdge<,localTangent,localNormal<,planePoint,tangent,normal<,normal1,v11,v12,clipPoints1,clipPoints2",
  ...
  findMaxSeparation$5: function(results, poly1, xf1, poly2, xf2) {
    var count1, normals1, v, t3, t4, t5, predy, predx, v1, t6, t7, t8, tempy, dx, dy, t9, t10, dLocal1x, dLocal1y, edge, maxDot, i, norm, t1, dot_, s, prevEdge, sPrev, nextEdge, sNext, bestSeparation, bestEdge, increment, edge0;
    ...
    t4 = xf2.rotation;
    t5 = $.getInterceptor$x(v);
    predy = $.$add$ns($.$add$ns(t3.y, $.$mul$n($.get$y$x(t4.col0), t5.get$x(v))), $.$mul$n($.get$y$x(t4.col1), t5.get$y(v)));
    predx = $.$add$ns($.$add$ns(t3.x, $.$mul$n($.get$x$x(t4.col0), t5.get$x(v))), $.$mul$n($.get$x$x(t4.col1), t5.get$y(v)));
    v1 = poly1.get$centroid();
    t6 = xf1.position;
    t7 = xf1.rotation;
    t8 = $.getInterceptor$x(v1);
    tempy = $.$add$ns($.$add$ns(t6.y, $.$mul$n($.get$y$x(t7.col0), t8.get$x(v1))), $.$mul$n($.get$y$x(t7.col1), t8.get$y(v1)));
    dx = $.$sub$n(predx, $.$add$ns($.$add$ns(t6.x, $.$mul$n($.get$x$x(t7.col0), t8.get$x(v1))), $.$mul$n($.get$x$x(t7.col1), t8.get$y(v1))));
    dy = $.$sub$n(predy, tempy);
    t9 = $.getInterceptor$n(dx);
    t10 = $.getInterceptor$n(dy);
    dLocal1x = $.$add$ns(t9.$mul(dx, $.get$x$x(t7.col0)), t10.$mul(dy, $.get$y$x(t7.col0)));
    if (typeof dLocal1x !== "number")
      return this.findMaxSeparation$5$bailout(3, results, poly1, xf1, poly2, xf2, count1, normals1, dx, dy, dLocal1x, t9, t10, t7);
    dLocal1y = $.$add$ns(t9.$mul(dx, $.get$x$x(t7.col1)), t10.$mul(dy, $.get$y$x(t7.col1)));
  ...
  findMaxSeparation$5$bailout: function(state0, results, poly1, xf1, poly2, xf2, count1, normals1, dx, dy, dLocal1x, t9, t10, t7, dLocal1y, bestEdge, bestSeparation, increment) {
    switch (state0) {
      case 0:
        count1 = poly1.get$vertexCount();
      case 1:
      ...
      case 5:
        var v, t3, t4, t5, predy, predx, v1, t6, t8, tempy, t1, edge, maxDot, i, norm, t2, dot_, s, prevEdge, sPrev, nextEdge, sNext;
        state0 = 0;
  ...
  initialize$6: function(_, cache, argProxyA, argSweepA, argProxyB, argSweepB, t1) {
    ...
    if (count === 1) {
      ...
      if ($.$eq(t5, t1[1]) === true) {
        ...
        if (t9 !== (t9 | 0))
          throw $.iae(t9);
        if (t9 < 0 || t9 >= t16.length)
          throw $.ioore(t9);
        t15.copyFrom$1(t16[t9]);
        t11.copyFrom$1(t15).sub$1(t2);
        $.cross(t11, 1, t12);
        t12.normalize$0();
        t4.rotation.transformed$2(t12, t7);
        t2 = t10.copyFrom$1(t2);
        t15 = t2.add$1(t2, t15);
        t15.scale$1(t15, 0.5);
        $.Transform_mulToOut(t4, t10, t8);
        ...
        $.cross(t11, 1, t12);
        t12.normalize$0();
        t3.rotation.transformed$2(t12, t7);
        t2 = t10.copyFrom$1(t2);
        t15 = t2.add$1(t2, t15);
        t15.scale$1(t15, 0.5);
        $.Transform_mulToOut(t3, t10, t6);
        ...
        if (t9 < 0 || t9 >= t3.length)
          throw $.ioore(t9);
        t10.copyFrom$1(t3[t9]);
        $.Transform_mulToOut(t4, t10, t8);
        t11.copyFrom$1(t8).sub$1(t6);
        s = t11.dot$1(t7);
        if (s < 0) {
          t12.negate$0();
          s = -s;
...
$$.mat2 = {"": "Object;col0<,col1<",
  ...
  add$1: function(_, o) {
    var t1 = $.$add$ns($.get$x$x(this.col0), $.get$x$x(o.get$col0()));
    $.set$x$x(this.col0, t1);
    t1 = $.$add$ns($.get$y$x(this.col0), $.get$y$x(o.get$col0()));
    $.set$y$x(this.col0, t1);
    t1 = $.$add$ns($.get$x$x(this.col1), $.get$x$x(o.get$col1()));
    $.set$x$x(this.col1, t1);
    t1 = $.$add$ns($.get$y$x(this.col1), $.get$y$x(o.get$col1()));
    $.set$y$x(this.col1, t1);
    return this;
  },
  sub$1: function(o) {
