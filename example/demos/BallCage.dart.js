...
$$.BallCage = {"": "Demo;bodies,canvas,ctx,viewport,debugDraw,world,frameCount,fpsCounter,elapsedUs,worldStepTime,viewportScale,_stopwatch",
  initialize$0: function() {
    ...
    for (i = 0; i < 10; ++i) {
      t1 = $.$$mul$n($.$$mul$n(circleShape.radius, 2), i);
      if (typeof t1 !== "number")
        throw $.iae(t1);
      shiftX = -20 + t1;
      t1 = $.$$mul$n($.$$mul$n(circleShape.radius, 2), i);
...
$$.Collision = {"": "Object;_pool,cache,input,output,results1,results2,incidentEdge>,localTangent,localNormal>,planePoint,tangent,normal>,normal1,v11,v12,clipPoints1,clipPoints2",
  ...
  collidePolygonAndCircle$5$bailout: function(state0, manifold, polygon, circle, v1x, cLocaly, b, v1y, t5, t6, cLocalx, radius, vertexCount, normals, vertices) {
    switch (state0) {
      ...
      case 5:
        ...
        state0 = 0;
        for (t1 = $.getInterceptor$n(cLocalx), t2 = $.getInterceptor$n(cLocaly), t3 = $.getInterceptor$as(normals), normalIndex = 0, separation = 1e-12, i = 0; $.CONSTANT1.$lt(i, vertexCount); ++i) {
          if (i >= vertices.length)
            throw $.ioore(i);
          vertex = vertices[i];
  ...
  edgeSeparation$5: function(poly1, xf1, edge1, poly2, xf2) {
    ...
    t6 = t6.get$y();
    if (t6 !== (t6 | 0))
      return this.edgeSeparation$5$bailout(20, 0, xf1, edge1, 0, xf2, vertices1, 0, count2, R, 0, vertices2, 0, 0, 0, 0, normal1Worldy, t17, 0, 0, normal1Worldx, R1, $.CONSTANT0, t6);
    normal1x = t17 + normal1Worldy * t6;
    t17 = R1.col1;
    t19 = t17.get$x();
    if (t19 !== (t19 | 0))
      return this.edgeSeparation$5$bailout(23, 0, xf1, edge1, 0, xf2, vertices1, 0, count2, R, 0, vertices2, 0, 0, 0, 0, normal1Worldy, t19, 0, 0, normal1Worldx, R1, $.CONSTANT0, 0, $.CONSTANT0, normal1x);
    t21 = normal1Worldx * t19;
    t17 = t17.get$y();
    if (t17 !== (t17 | 0))
      return this.edgeSeparation$5$bailout(25, 0, xf1, edge1, 0, xf2, vertices1, 0, count2, R, 0, vertices2, 0, 0, 0, 0, normal1Worldy, t21, 0, 0, normal1Worldx, R1, 0, 0, $.CONSTANT0, normal1x, t17);
  ...
  findMaxSeparation$5: function(results, poly1, xf1, poly2, xf2) {
    ...
    t4 = t3.y;
    t5 = xf2.rotation;
    predy = $.$$add$n($.$$add$n(t4, $.$$mul$n(t5.col0.get$y(), v.get$x())), $.$$mul$n(t5.col1.get$y(), v.get$y()));
    predx = $.$$add$n($.$$add$n(t3.x, $.$$mul$n(t5.col0.get$x(), v.get$x())), $.$$mul$n(t5.col1.get$x(), v.get$y()));
    v1 = poly1.get$centroid();
    t6 = xf1.position;
    t7 = t6.y;
    t8 = xf1.rotation;
    tempy = $.$$add$n($.$$add$n(t7, $.$$mul$n(t8.col0.get$y(), v1.get$x())), $.$$mul$n(t8.col1.get$y(), v1.get$y()));
    dx = $.$$sub$n(predx, $.$$add$n($.$$add$n(t6.x, $.$$mul$n(t8.col0.get$x(), v1.get$x())), $.$$mul$n(t8.col1.get$x(), v1.get$y())));
  ...
  findMaxSeparation$5$bailout: function(state0, results, poly1, xf1, poly2, xf2, count1, normals1, dx, dy, dLocal1x, t9, t8, t10, dLocal1y, bestEdge, bestSeparation, increment) {
    switch (state0) {
      ...
      case 4:
        state0 = 0;
        for (t1 = $.getInterceptor$as(normals1), edge = 0, maxDot = 1e-12, i = 0; $.CONSTANT1.$lt(i, count1); ++i) {
  ...
  findIncidentEdge$6$bailout: function(state0, c, xf1, edge1, poly2, xf2, normals1, count2, vertices2, normals2) {
    switch (state0) {
      ...
      case 2:
        ...
        t3.transformed$2(t4, t5);
        xf2.rotation.transposed$0().transform$1(t5);
        for (t1 = $.getInterceptor$as(normals2), index = 0, minDot = 99999999999999, i = 0; $.CONSTANT1.$lt(i, count2); ++i) {
...
$.BallCage$ = function() {
  ...
  $.setRuntimeTypeInfo(t1, [$.Body]);
  t1 = new $.BallCage(t1, null, null, null, null, null, null, null, null, null, 10, null);
