...
$$.Collision = {"":"Object;_pool,cache,input,output,results1,results2,incidentEdge>,localTangent,localNormal>,planePoint,tangent,normal>,normal1,v11,v12,clipPoints1,clipPoints2",
 ...
 edgeSeparation$5: function(poly1, xf1, edge1, poly2, xf2) {
  ...
  if (typeof t2 !== 'number')
    return this.edgeSeparation$5$bailout(19, index, xf1, v3, xf2, t2, normal1Worldx, R1, t1, vertices2, normal1Worldy, R);
  t4 = R.get$col1().get$y();
  if (typeof t4 !== 'number')
  ...
  if (typeof t2 !== 'number')
    return this.edgeSeparation$5$bailout(24, index, v1y, v3, xf2, t2, normal1Worldx, R1, t1, vertices2, normal1Worldy, R);
  ...
  if (typeof t17 !== 'number')
    return this.edgeSeparation$5$bailout(27, index, v1y, v3, xf2, normal1Worldx, R1, t1, vertices2, t2, t17, normal1Worldy);
  t19 = v3.get$y();
  if (typeof t19 !== 'number')
    return this.edgeSeparation$5$bailout(28, index, normal1Worldy, v1y, xf2, normal1Worldx, R1, t1, vertices2, t2, t17, t19);
  v1x = t2 + t17 * t19;
 ...
 collidePolygons$5: function(manifold, polyA, xfA, polyB, xfB) {
  var totalRadius, t2, t1, t3, t4, edge1, poly1, xf2, xf1, poly2, flip, count1, vertices1, t5, t6, t7, t8, frontOffset, sideOffset1, sideOffset2, t9, np, i, pointCount, cp;
  manifold.set$pointCount(0);
  ...
  if (typeof frontOffset !== 'number')
    return this.collidePolygons$5$bailout(2, manifold, flip, t8, t3, frontOffset, totalRadius, t1, t2, t4, t5, t6, xf2);
 ...
 collidePolygons$5$bailout: function(state0, env0, env1, env2, env3, env4, env5, env6, env7, env8, env9, env10, env11) {
  ...
  switch (state0) {
    ...
    case 1:
      ...
      frontOffset = $.add($.mul(t3.x, t2.x), $.mul(t3.y, t2.y));
    case 2:
      var totalRadius, xfB, polyB, xfA, polyA, manifold, t2, t1, t3, t4, edge1, poly1, xf2, xf1, poly2, flip, count1, vertices1, t5, t6, t7, t8, frontOffset, sideOffset1, sideOffset2, t9, np, i, pointCount, cp;
      state0 = 0;
      sideOffset1 = $.add($.neg($.add($.mul(t8.x, t2.x), $.mul(t8.y, t2.y))), totalRadius);
      sideOffset2 = $.add($.add($.mul(t8.x, t4.x), $.mul(t8.y, t4.y)), totalRadius);
      t8.negateLocal$0();
...
$$.DistanceProxy = {"":"Object;vertices>,count=,radius=",
 ...
 getSupport$1: function(direction) {
  ...
  while (true) {
    t3 = this.count;
    if (typeof t3 !== 'number')
      return this.getSupport$1$bailout(5, direction, t3, bestIndex, t2, i, bestValue, t1);
    if (!(i < t3))
      break;
    if (i >= t2)
      throw $.ioore(i);
    ...
    t4 = t3.get$x();
    if (typeof t4 !== 'number')
      return this.getSupport$1$bailout(6, direction, t3, t4, bestIndex, t2, i, bestValue, t1);
    t4 *= t6;
    t3 = t3.get$y();
    if (typeof t3 !== 'number')
      return this.getSupport$1$bailout(8, direction, bestIndex, t2, t4, t3, i, bestValue, t1);
    value = t4 + t3 * t9;
    if (value > bestValue) {
      bestValue = value;
      bestIndex = i;
 ...
 rebalance$1: function(iterations) {
  ...
  for (i = 0; i < iterations; ++i) {
    ...
    while (true) {
      ...
      t2 = this._path;
      if (t2 !== (t2 | 0))
        return this.rebalance$1$bailout(2, i, iterations, bit, current, t2, t1);
      if (!t1)
        break;
 ...
 solve$3: function(step, gravity, allowSleep) {
  ...
  while (true) {
    ...
    if (nonStatic) {
      ...
      t1[i1] = t5;
      if (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array || !!t1.immutable$list) && !t1.is$JavaScriptIndexingBehavior())
        return this.solve$3$bailout(28, step, allowSleep, i1, temp, i2, t1);
      if (i2 >= t1.length)
        throw $.ioore(i2);
      t1[i2] = temp;
    }
  ...
  while (true) {
    ...
    while (true) {
      t1 = this.jointCount;
      if (typeof t1 !== 'number')
        return this.solve$3$bailout(32, step, t2, j, allowSleep, t1, i);
      if (!(j < t1))
        break;
      t1 = this.joints;
      if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))
  ...
  while (true) {
    t4 = this.bodyCount;
    if (typeof t4 !== 'number')
      return this.solve$3$bailout(34, step, t3, allowSleep, i, t2, temp, t1, t4);
    if (!(i < t4))
      break;
    c$0: {
      t4 = this.bodies;
      if (typeof t4 !== 'string' && (typeof t4 !== 'object' || t4 === null || t4.constructor !== Array && !t4.is$JavaScriptIndexingBehavior()))
        return this.solve$3$bailout(35, step, t3, allowSleep, i, t2, temp, t1, t4);
      if (i >= t4.length)
        throw $.ioore(i);
      b = t4[i];
      t4 = b.get$type();
      if (typeof t4 !== 'number')
        return this.solve$3$bailout(36, step, t3, allowSleep, i, t4, temp, t1, b, t2);
      if (t4 === 0)
        break c$0;
      ...
      t4 = t1.x;
      if (typeof t4 !== 'number')
        return this.solve$3$bailout(37, step, t3, allowSleep, i, t4, t2, temp, t1, b);
      t4 *= t4;
      t6 = t1.y;
      if (typeof t6 !== 'number')
        return this.solve$3$bailout(38, step, t3, allowSleep, i, t4, t2, t6, temp, t1, b);
      if (t4 + t6 * t6 > 4) {
        t4 = t3.get$length(t1);
        if (typeof t4 !== 'number')
          throw $.iae(t4);
      ...
      t4 = step.get$dt();
      if (typeof t4 !== 'number')
        return this.solve$3$bailout(39, step, t3, allowSleep, i, t2, t4, temp, t1, b);
      t6 = b.get$angularVelocity();
      if (typeof t6 !== 'number')
        return this.solve$3$bailout(40, step, t3, allowSleep, i, t2, t4, temp, t6, t1, b);
      rotation = t4 * t6;
      if (rotation * rotation > 2.4674011002723395) {
        ...
        if (typeof t4 !== 'number')
          return this.solve$3$bailout(41, step, t3, allowSleep, i, t2, ratio, temp, t4, t1, b);
      ...
      t6 = t5.get$angle();
      if (typeof t6 !== 'number')
        return this.solve$3$bailout(42, t5, t6, t3, i, allowSleep, step, t2, temp, t1, b);
      t8 = step.get$dt();
      if (typeof t8 !== 'number')
        return this.solve$3$bailout(43, t5, t6, t8, i, t3, allowSleep, step, t2, temp, t1, b);
      t10 = b.get$angularVelocity();
      if (typeof t10 !== 'number')
        return this.solve$3$bailout(44, t5, t6, t8, i, t10, allowSleep, step, t1, b, t2, t3, temp);
  ...
  do {
    for (ce = body.get$contactList(), found = false, count = 0; !(ce == null); ce = ce.get$next()) {
      ...
      if (typeof type !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(2, t8, body, bullet, t2, other, type, iter, toiContact, toi, t3, toiOther, found, count, ce, t6, t5, t4, t7);
      if (bullet) {
        t1 = other.get$flags();
        if (t1 !== (t1 | 0))
          return this.solveTimeOfImpactGivenBody$1$bailout(3, t8, body, bullet, t2, other, type, iter, t1, toiContact, toi, t3, toiOther, found, count, ce, t6, t4, t7, t5);
        if ((t1 & 64) === 0)
          continue;
        if (!(type === 0)) {
          t1 = ce.get$contact().get$flags();
          if (t1 !== (t1 | 0))
            return this.solveTimeOfImpactGivenBody$1$bailout(4, t8, body, bullet, t1, t2, other, iter, toiContact, toi, t3, toiOther, found, count, ce, t6, t5, t4, t7);
          t10 = (t1 & 16) !== 0;
          t1 = t10;
        } else
          t1 = false;
      ...
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(5, t8, body, contact, t1, bullet, t2, other, iter, toiContact, toi, t3, toiOther, found, count, ce, t6, t5, t4, t7);
      if (!t1)
        continue;
      t1 = contact.get$toiCount();
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(6, t8, body, contact, bullet, t2, other, t1, iter, toiContact, toi, t3, toiOther, found, count, ce, t6, t5, t4, t7);
      if (t1 > 10)
        continue;
      ...
      t1 = t2.state;
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(7, t8, body, contact, t1, bullet, t2, other, iter, toiContact, toi, t3, toiOther, found, count, ce, t6, t5, t4, t7);
      if (t1 === 3) {
        t1 = t2.t;
        if (typeof t1 !== 'number')
          return this.solveTimeOfImpactGivenBody$1$bailout(8, t8, body, contact, bullet, t1, t2, other, iter, toiContact, toi, t3, toiOther, found, count, ce, t6, t5, t4, t7);
        t1 = t1 < toi;
      } else
        t1 = false;
      if (t1) {
...
$$.Contact = {"":"Object;flags=,prev=,next=,edge1>,edge2>,fixtureA>,fixtureB>,manifold=,toiCount=",
 ...
 update$1: function(listener) {
  ...
  if (sensor) {
    ...
    while (true) {
      ...
      while (true) {
        t4 = t1.pointCount;
        if (typeof t4 !== 'number')
          return this.update$1$bailout(7, listener, bodyA, sensor, bodyB, t4, t2, mp2, wasTouching, id2, t1, touching, t3, j, i);
        if (!(j < t4))
          break;
        if (j >= t3)
          throw $.ioore(j);
  ...
  t2 = this.flags;
  if (t2 !== (t2 | 0))
    return this.update$1$bailout(8, listener, wasTouching, touching, t2, t1, touching, sensor);
  if (touching)
    this.flags = (t2 | 2) >>> 0;
  else
...
$$.ContactSolver = {"":"Object;constraints>,constraintCount,worldManifold,tangent,temp1,temp2,P,dv,dv1,dv2,x>,d,P1,P2,psolver,rA>,rB>",
 ...
 solveVelocityConstraints$0: function() {
  ...
  while (true) {
    ...
    while (true) {
      ...
      if (typeof t18 !== 'number')
        return this.solveVelocityConstraints$0$bailout(15, ccp, a, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t18, c, friction, t3, t4, t5, t6, t2, t7, j, t8, wA, wB, t1);
      t18 = wB * t18;
      t20 = vB.get$y();
      if (typeof t20 !== 'number')
      ...
      t24 = t1.x;
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(19, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t24, t2, t6, j, t8, wA, wB, t1, t7);
      t26 = t2.x;
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(20, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t24, t2, t26, t6, j, t8, wA, wB, t1, t7);
      t26 = t24 * t26;
      t24 = t1.y;
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(21, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t26, t6, t2, t7, j, t24, t8, wA, wB, t1);
      t29 = t2.y;
      if (typeof t29 !== 'number')
        return this.solveVelocityConstraints$0$bailout(22, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t26, t6, t2, t7, j, t24, t8, t29, wA, wB, t1);
      vt = t26 + t24 * t29;
      t26 = ccp.get$tangentMass();
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(23, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t6, t2, t7, j, t8, vt, t26, wA, wB, t1);
      lambda = t26 * -vt;
      t26 = ccp.get$normalImpulse();
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(24, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t6, t2, t7, j, t8, wA, wB, lambda, t26, t1);
      maxFriction = friction * t26;
      t26 = ccp.get$tangentImpulse();
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(25, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, t5, friction, t6, t2, t7, j, t8, wA, wB, lambda, t1, maxFriction, t26);
      t26 += lambda;
      ...
      t34 = t2.y;
      if (typeof t34 !== 'number')
        return this.solveVelocityConstraints$0$bailout(27, ccp, t9, newImpulse, t10, lambda, i, Px, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, t5, friction, t6, t2, t7, j, t8, wA, wB, t34, t1);
      Py = t34 * lambda;
      t34 = vA.get$x();
      if (typeof t34 !== 'number')
      ...
      if (typeof t44 !== 'number')
        return this.solveVelocityConstraints$0$bailout(32, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, wA, t44, t5, t6, t2, t7, j, friction, t8, wB, t1);
      vB.set$x(t44 + Px * invMassB);
      t46 = vB.get$y();
      if (typeof t46 !== 'number')
        return this.solveVelocityConstraints$0$bailout(33, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, wA, t5, t6, t2, t7, j, t46, t8, wB, t1, friction);
      vB.set$y(t46 + Py * invMassB);
      t48 = ccp.get$rB();
      t49 = t48.get$x();
      if (typeof t49 !== 'number')
        return this.solveVelocityConstraints$0$bailout(34, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, wA, t5, t6, t2, t7, j, friction, t8, wB, t49, t1);
      t49 *= Py;
      t48 = t48.get$y();
      if (typeof t48 !== 'number')
        return this.solveVelocityConstraints$0$bailout(35, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, wA, t5, t6, t2, t7, j, friction, t8, wB, t1, t49, t48);
      wB += invIB * (t49 - t48 * Px);
    ...
    if (t11) {
      ...
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(38, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, t11, t15, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t11 = t15 * t11;
      t15 = vB.get$x();
      if (typeof t15 !== 'number')
        return this.solveVelocityConstraints$0$bailout(39, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, t15, t11, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t15 = t11 + t15;
      t11 = vA.get$x();
      if (typeof t11 !== 'number')
      ...
      t15 = a1.get$y();
      if (typeof t15 !== 'number')
        return this.solveVelocityConstraints$0$bailout(41, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, t11, t15, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t1.x = t11 + wA * t15;
      t18 = ccp.get$rB().get$x();
      if (typeof t18 !== 'number')
      ...
      t24 = t23.get$x();
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(62, Py, t9, i, t10, t3, t4, t24, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, ccp, invIB, newImpulse, t1, wB, wA, Px);
      t24 *= Py;
      t23 = t23.get$y();
      if (typeof t23 !== 'number')
        return this.solveVelocityConstraints$0$bailout(63, t9, i, t10, t3, t4, t5, t24, t6, t23, bodyB, t7, bodyA, vA, vB, t2, ccp, t8, newImpulse, wB, t1, invIB, wA, Px);
      wB += invIB * (t24 - t23 * Px);
      ...
      $loop$1: {
        ...
        if (t11) {
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(105, t9, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, invIA, wA, wB, invIB, t1, t12, cp1, cp2, t11);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(107, t9, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, invIA, wA, wB, invIB, t1, t12, cp1, t11, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
          ...
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(113, t9, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t27, t28, t8, wB, wA, t1, invIB, cp1, cp2);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
            return this.solveVelocityConstraints$0$bailout(115, t9, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, wA, invIB, wB, t14, t27, cp1, t1, cp2);
          t14 -= t27 * t17;
          t30 = cp2.get$rB();
          t31 = t30.get$x();
        ...
        if (t17 >= 0 && vn2 >= 0) {
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(127, t12, t9, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, invIA, wA, wB, invIB, t1, cp1, cp2, t11);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(129, t9, t12, i, t11, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, invIA, wA, wB, invIB, t1, cp1, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
          ...
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(139, t9, i, t10, t14, t4, t30, t31, t6, bodyA, bodyB, t5, t2, vA, vB, t8, t7, wB, invIB, t1, cp1, wA, t3, cp2);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(141, t9, i, t10, t14, t4, t5, t3, t6, t22, t30, bodyB, bodyA, vA, vB, t2, t7, wB, invIB, t8, t1, cp1, wA, cp2);
          wB += invIB * (t14 + (t22 - t30 * t25));
          cp1.set$normalImpulse(t4.get$x());
          cp2.set$normalImpulse(t4.get$y());
          break $loop$1;
        ...
        t19 = b.x;
        if (typeof t19 !== 'number')
          return this.solveVelocityConstraints$0$bailout(147, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, t15, wA, wB, t1, t19);
        vn1 = t15 + t19;
        if (t17 >= 0 && vn1 >= 0) {
          t3.setFrom$1(t4).subLocal$1(a);
          t5.setFrom$1(c.get$normal()).mulLocal$1(t3.x);
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(149, t9, i, t10, t3, t4, t5, t12, t11, t6, bodyA, bodyB, t7, t2, vA, vB, t8, invIA, wA, wB, invIB, t1, cp1, cp2);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(151, t9, i, t10, t3, t4, t5, t6, t12, t11, bodyB, bodyA, vA, vB, t2, invIA, wA, wB, invIB, t8, t7, cp1, t1, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
          ...
          t20 = t19.get$x();
          if (typeof t20 !== 'number')
            return this.solveVelocityConstraints$0$bailout(153, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, t2, t7, t8, t12, t19, wA, wB, t20, t1);
          t22 = t6.y;
          if (typeof t22 !== 'number')
            return this.solveVelocityConstraints$0$bailout(154, t9, i, t10, t22, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, t2, t7, t8, t12, t19, wA, wB, t20, t1);
          t20 *= t22;
          t19 = t19.get$y();
          if (typeof t19 !== 'number')
          ...
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(157, t9, i, wA, t27, t3, t4, t5, t28, t6, bodyA, bodyB, t10, t2, vA, vB, t8, t7, wB, invIB, t1, cp1, cp2);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
            return this.solveVelocityConstraints$0$bailout(159, t9, i, wA, t10, t3, t4, t5, t14, t27, t6, bodyA, bodyB, t2, vA, vB, t8, t7, wB, invIB, t1, cp1, cp2);
          t14 -= t27 * t17;
          t30 = cp2.get$rB();
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(161, t9, i, wA, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t30, t14, t31, wB, invIB, t8, t1, cp1, cp2);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(163, t9, i, wA, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, t14, wB, invIB, t22, t30, cp1, t1, cp2);
          wB += invIB * (t14 + (t22 - t30 * t25));
          cp1.set$normalImpulse(t4.get$x());
          cp2.set$normalImpulse(t4.get$y());
          break $loop$1;
        ...
        if (vn1 >= 0 && vn2 >= 0) {
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(167, t9, t11, i, t12, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, invIA, wA, wB, invIB, t1, cp1, cp2);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(169, t9, i, t10, t12, t4, t5, t3, t11, t6, bodyA, bodyB, t7, t2, vA, vB, t8, invIA, wA, wB, invIB, t1, cp1, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
          ...
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(179, wA, t9, i, t10, t3, t4, t5, t14, t30, t6, t31, bodyB, bodyA, vA, vB, t2, t7, wB, invIB, t8, t1, cp1, cp2);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(181, wA, t9, i, t10, t3, t4, t5, t14, t6, bodyA, bodyB, t7, t2, vA, vB, t30, t22, t8, wB, invIB, t1, cp1, cp2);
          wB += invIB * (t14 + (t22 - t30 * t25));
          cp1.set$normalImpulse(t4.get$x());
          cp2.set$normalImpulse(t4.get$y());
          break $loop$1;
 ...
 solvePositionConstraints$1: function(baumgarte) {
  ...
  while (true) {
    ...
    if (typeof t5 !== 'number')
      return this.solvePositionConstraints$1$bailout(1, baumgarte, t5, point, t4, minSeparation, i, t1, t2, psm, normal, t3);
    if (!(i < t5))
      break;
    t5 = this.constraints;
    if (i >= t5.length)
    ...
    t5 = bodyA.get$mass();
    if (typeof t5 !== 'number')
      return this.solvePositionConstraints$1$bailout(2, baumgarte, minSeparation, i, t1, t2, t3, bodyA, bodyB, t5, t4, c, psm, normal, point);
    ...
    while (true) {
      t6 = c.get$pointCount();
      if (typeof t6 !== 'number')
        return this.solvePositionConstraints$1$bailout(10, baumgarte, invIB, j, t1, t2, minSeparation, t3, i, t6, bodyA, bodyB, t4, invMassA, psm, normal, invIA, point, c, invMassB);
      if (!(j < t6))
        break;
      psm.initialize$2(c, j);
      separation = psm.separation;
      if (typeof separation !== 'number')
        return this.solvePositionConstraints$1$bailout(11, baumgarte, invIB, j, t1, t2, minSeparation, t3, i, bodyA, bodyB, t4, invMassA, psm, normal, invIA, separation, c, point, invMassB);
      ...
      if (minSeparation !== (minSeparation | 0))
        return this.solvePositionConstraints$1$bailout(12, baumgarte, invIB, minSeparation, j, t1, t2, i, t3, bodyA, bodyB, t4, invMassA, psm, normal, invIA, separation, c, point, invMassB);
      C = $.max(-0.2, $.min(baumgarte * (separation + 0.005), 0));
      t8 = t3.x;
      if (typeof t8 !== 'number')
        return this.solvePositionConstraints$1$bailout(13, baumgarte, invIB, minSeparation, j, t1, t2, i, t3, bodyA, bodyB, C, t4, invMassA, psm, normal, invIA, point, c, invMassB, t8);
      t10 = normal.y;
      if (typeof t10 !== 'number')
        return this.solvePositionConstraints$1$bailout(14, t10, baumgarte, invIB, minSeparation, j, t1, t2, i, t3, bodyA, bodyB, C, t4, invMassA, psm, normal, invIA, point, c, invMassB, t8);
      t8 *= t10;
      t12 = t3.y;
      if (typeof t12 !== 'number')
        return this.solvePositionConstraints$1$bailout(15, baumgarte, t12, invIB, minSeparation, j, t1, t2, i, t3, bodyA, bodyB, C, t4, invMassA, t8, normal, invIA, psm, c, point, invMassB);
      t14 = normal.x;
      if (typeof t14 !== 'number')
        return this.solvePositionConstraints$1$bailout(16, baumgarte, t12, invIB, t14, minSeparation, j, t1, t2, i, t3, bodyA, bodyB, C, t4, invMassA, t8, normal, invIA, psm, c, point, invMassB);
      rnA = t8 - t12 * t14;
      t8 = t4.x;
      if (typeof t8 !== 'number')
        return this.solvePositionConstraints$1$bailout(17, baumgarte, invIB, t8, minSeparation, j, t1, t2, i, t3, bodyA, bodyB, C, t4, invMassA, psm, normal, invIA, point, c, invMassB, rnA);
      t10 = t8 * t10;
      t8 = t4.y;
      if (typeof t8 !== 'number')
        return this.solvePositionConstraints$1$bailout(19, baumgarte, invIB, t10, minSeparation, t8, j, t1, t2, i, t3, bodyA, bodyB, C, t4, invMassA, psm, normal, invIA, point, c, invMassB, rnA);
      rnB = t10 - t8 * t14;
      ...
      t7 = t6.get$angle();
      if (typeof t7 !== 'number')
        return this.solvePositionConstraints$1$bailout(21, baumgarte, invIB, minSeparation, j, t1, t2, i, t3, t6, t7, bodyA, bodyB, t4, invMassA, psm, normal, invIA, point, c, invMassB);
      t9 = t3.x;
      if (typeof t9 !== 'number')
        return this.solvePositionConstraints$1$bailout(22, baumgarte, invIB, minSeparation, j, t1, t2, i, t3, t9, t7, bodyA, bodyB, t6, t4, invMassA, psm, normal, invIA, point, c, invMassB);
      t11 = t1.y;
      if (typeof t11 !== 'number')
        return this.solvePositionConstraints$1$bailout(23, baumgarte, invIB, minSeparation, j, t1, t2, i, t3, t6, t7, bodyA, bodyB, t11, t9, t4, invMassA, psm, normal, invIA, point, c, invMassB);
      t11 = t9 * t11;
      t9 = t3.y;
      if (typeof t9 !== 'number')
        return this.solvePositionConstraints$1$bailout(24, baumgarte, invIB, c, minSeparation, j, t1, t2, i, t3, t6, t7, bodyA, bodyB, t9, t4, t11, psm, normal, invIA, point, invMassA, invMassB);
      t14 = t1.x;
      if (typeof t14 !== 'number')
      ...
      t16 = t6.get$angle();
      if (typeof t16 !== 'number')
        return this.solvePositionConstraints$1$bailout(26, baumgarte, invIB, minSeparation, j, t1, t2, t6, t16, t3, i, bodyA, bodyB, t4, invMassA, psm, normal, point, invIA, c, invMassB);
      t18 = t4.x;
      if (typeof t18 !== 'number')
        return this.solvePositionConstraints$1$bailout(27, baumgarte, invIB, minSeparation, j, t1, t2, t6, t16, t3, i, bodyA, bodyB, t4, invMassA, t18, psm, normal, point, c, invIA, invMassB);
      t20 = t1.y;
      if (typeof t20 !== 'number')
        return this.solvePositionConstraints$1$bailout(28, baumgarte, invIB, invIA, minSeparation, j, t1, t2, t6, t16, t3, i, bodyA, bodyB, t4, invMassA, t18, t20, normal, psm, c, point, invMassB);
      t20 = t18 * t20;
      t18 = t4.y;
      if (typeof t18 !== 'number')
        return this.solvePositionConstraints$1$bailout(29, baumgarte, invIB, minSeparation, j, t1, t2, t6, t16, t3, i, bodyA, t20, bodyB, t4, invMassA, psm, normal, t18, point, c, invIA, invMassB);
      t23 = t1.x;
      if (typeof t23 !== 'number')
        return this.solvePositionConstraints$1$bailout(30, baumgarte, invIB, invIA, minSeparation, j, t1, t2, t6, t16, t3, i, bodyA, t20, bodyB, t4, invMassA, psm, normal, t18, t23, c, point, invMassB);
 ...
 solve$1: function(baumgarte) {
  ...
  while (true) {
    ...
    while (true) {
      t7 = c.get$pointCount();
      if (typeof t7 !== 'number')
        return this.solve$1$bailout0(8, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, point, t5, bodyA, bodyB, i, j, minSeparation, t7, t1, t2, t3);
      if (!(j < t7))
        break;
      t5.initialize$2(c, j);
      separation = t5.separation;
      if (typeof separation !== 'number')
        return this.solve$1$bailout0(9, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, point, separation, bodyA, bodyB, i, t5, j, minSeparation, t1, t2, t3);
      t3.setFrom$1(point).subLocal$1(bodyA.get$sweep().get$center());
      t4.setFrom$1(point).subLocal$1(bodyB.get$sweep().get$center());
      minSeparation = $.min(minSeparation, separation);
      if (minSeparation !== (minSeparation | 0))
      ...
      t9 = t4.y;
      if (typeof t9 !== 'number')
        return this.solve$1$bailout0(17, C, invMassA, baumgarte, invIA, c, invMassB, t4, normal, invIB, rnA, point, t5, t11, bodyA, minSeparation, bodyB, i, j, t9, t1, t2, t3);
      rnB = t11 - t9 * t15;
      ...
      t8 = t7.get$angle();
      if (typeof t8 !== 'number')
        return this.solve$1$bailout0(19, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, point, t5, bodyA, minSeparation, bodyB, i, j, t1, t7, t2, t8, t3);
      t10 = t3.x;
      if (typeof t10 !== 'number')
        return this.solve$1$bailout0(20, baumgarte, t10, invMassA, c, invIA, invMassB, t4, normal, invIB, point, t5, bodyA, minSeparation, bodyB, i, j, t1, t7, t2, t8, t3);
      t12 = t1.y;
      if (typeof t12 !== 'number')
        return this.solve$1$bailout0(21, baumgarte, t10, t12, c, invIA, t7, invMassB, t4, normal, invIB, invMassA, point, t5, bodyA, minSeparation, bodyB, i, j, t1, t2, t8, t3);
      t12 = t10 * t12;
      t10 = t3.y;
      if (typeof t10 !== 'number')
        return this.solve$1$bailout0(22, baumgarte, invMassA, t3, t12, invIA, t10, invMassB, t4, c, invIB, point, normal, t5, bodyA, minSeparation, bodyB, i, j, t1, t2, t8, t7);
      t15 = t1.x;
      if (typeof t15 !== 'number')
      ...
      t17 = t7.get$angle();
      if (typeof t17 !== 'number')
        return this.solve$1$bailout0(24, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, point, t5, bodyA, minSeparation, bodyB, i, j, t7, t17, t1, t2, t3);
      t19 = t4.x;
      if (typeof t19 !== 'number')
        return this.solve$1$bailout0(25, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, t19, point, t5, bodyA, minSeparation, bodyB, i, j, t7, t17, t1, t2, t3);
      t21 = t1.y;
      if (typeof t21 !== 'number')
        return this.solve$1$bailout0(26, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, t21, point, t19, t5, minSeparation, bodyB, bodyA, i, j, t7, t17, t1, t2, t3);
      t21 = t19 * t21;
      t19 = t4.y;
      if (typeof t19 !== 'number')
        return this.solve$1$bailout0(27, baumgarte, invMassA, t3, c, invIA, invMassB, t4, normal, invIB, point, t19, t5, bodyA, minSeparation, bodyB, i, j, t7, t17, t1, t2, t21);
      t24 = t1.x;
      if (typeof t24 !== 'number')
...
$.BallCage$ = function() {
  var t1 = new $.BallCage($.List_List(null), null, null, null, null, null, null, null, null, null, 10, null);
