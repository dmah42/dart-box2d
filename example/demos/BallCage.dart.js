...
$$.BallCage = {"": ["bodies", "canvas", "ctx", "viewport", "debugDraw", "world", "frameCount", "fpsCounter", "elapsedUs", "worldStepTime", "viewportScale", "_stopwatch"],
 ...
 initialize$0: function() {
  ...
  for (i = 0; i < 10; ++i) {
    ...
    t1 = this.bodies;
    $.getInterceptor(t1).add$1(t1, circleBody);
...
$$.TimeOfImpact = {"": ["cache", "distanceInput", "xfA", "xfB", "distanceOutput", "fcn", "indexes", "sweepA>", "sweepB>", "pool"],
 ...
 timeOfImpact$2: function(output, input) {
  ...
  for (t1 = this.fcn, t2 = this.indexes, t5 = t2.length, t6 = target + 0.00125, t7 = target - 0.00125, t8 = this.distanceOutput, t9 = this.xfA, t11 = this.xfB, t13 = this.pool, t14 = 0, iter = 0; true;) {
    ...
    t15 = t8.distance;
    if (typeof t15 !== 'number')
      return this.timeOfImpact$2$bailout(5, output, t1, t2, t11, target, t7, t13, proxyA, proxyB, t15, t3, t5, t6, t8, t4, t10, t14, tMax, iter, t12, t9);
    if (t15 <= 0) {
      output.set$state(2);
      output.set$t(0);
      break;
    ...
    for (t20 = tMax, pushBackIter = 0; done = false, true;) {
      ...
      if (typeof s2 !== 'number')
        return this.timeOfImpact$2$bailout(7, output, t11, s2, t13, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t3, t5, t6, t4, t10, t14, t12, iter, t20, pushBackIter, t9);
      if (s2 > t6) {
        output.set$state(4);
        output.set$t(tMax);
        done = true;
      ...
      if (typeof s1 !== 'number')
        return this.timeOfImpact$2$bailout(8, output, t11, s2, t13, proxyA, proxyB, t8, tMax, t1, t2, s1, target, t7, t3, t5, t6, t4, t10, t14, t12, iter, t20, pushBackIter, t9);
      if (s1 < t7) {
        output.set$state(1);
        output.set$t(t14);
        done = true;
      ...
      for (a2 = t20, a1 = t14, rootIterCount = 0; true;) {
        ...
        if (typeof s !== 'number')
          return this.timeOfImpact$2$bailout(9, output, t11, s2, s1, rootIterCount, a1, a2, t13, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t, t3, t5, t6, s, t4, t10, t14, t12, iter, t20, pushBackIter, t9);
        t15 = s - target;
        t15 = $.getInterceptor(t15).abs$0(t15);
        if (typeof t15 !== 'number')
          return this.timeOfImpact$2$bailout(10, output, t11, s2, s1, rootIterCount, a1, a2, t13, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t, t3, t5, t6, s, t4, t10, t15, t14, iter, t12, t20, pushBackIter, t9);
        if (t15 < 0.00125) {
          t20 = t;
          break;
        }
        ...
        if (a1 !== (a1 | 0))
          return this.timeOfImpact$2$bailout(11, output, t11, s2, s1, a1, a2, rootIterCount, t13, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t3, t5, t6, t4, t10, t14, t12, iter, t20, pushBackIter, t9);
        ++rootIterCount;
        t16 = $.TimeOfImpact_toiRootIters;
        if (typeof t16 !== 'number')
          return this.timeOfImpact$2$bailout(12, output, t11, s2, s1, a1, a2, rootIterCount, t16, proxyA, t13, proxyB, t8, tMax, t1, t2, target, t7, t3, t5, t6, t4, t10, t14, t12, iter, t20, pushBackIter, t9);
        $.TimeOfImpact_toiRootIters = t16 + 1;
        if (rootIterCount === 50)
          break;
      }
      if (t20 !== (t20 | 0))
        return this.timeOfImpact$2$bailout(13, output, t11, t13, proxyA, proxyB, t8, tMax, t20, t1, t2, rootIterCount, target, t7, t3, t5, t6, t4, t10, t14, t12, iter, pushBackIter, t9);
    ...
    if (typeof t15 !== 'number')
      return this.timeOfImpact$2$bailout(14, output, done, t1, t2, t11, target, t7, t13, iter, t15, proxyA, proxyB, t3, t5, t6, t8, t4, t10, t12, tMax, t14, t9);
 ...
 solve$3: function(step, gravity, allowSleep) {
  ...
  while (true) {
    ...
    c$0: {
      t3 = this.bodies;
      if (typeof t3 !== 'string' && (typeof t3 !== 'object' || t3 === null || t3.constructor !== Array && !t3.is$JavaScriptIndexingBehavior()))
        return this.solve$3$bailout(35, step, t2, allowSleep, temp, t1, i, t3);
      if (i >= t3.length)
        throw $.ioore(i);
      b = t3[i];
      t3 = b.get$type();
      if (typeof t3 !== 'number')
        return this.solve$3$bailout(36, step, t3, allowSleep, t2, temp, t1, i, b);
      if (t3 === 0)
        break c$0;
      ...
      t3 = t1.x;
      if (typeof t3 !== 'number')
        return this.solve$3$bailout(37, step, t2, allowSleep, t3, temp, t1, i, b);
      t3 *= t3;
      t5 = t1.y;
      if (typeof t5 !== 'number')
        return this.solve$3$bailout(38, step, t2, allowSleep, t3, t5, temp, t1, i, b);
      if (t3 + t5 * t5 > 4) {
      ...
      t3 = step.get$dt();
      if (typeof t3 !== 'number')
        return this.solve$3$bailout(39, step, t2, allowSleep, t3, temp, t1, i, b);
      t5 = b.get$angularVelocity();
      if (typeof t5 !== 'number')
        return this.solve$3$bailout(40, step, t2, allowSleep, t3, temp, t5, t1, i, b);
      rotation = t3 * t5;
      if (rotation * rotation > 2.4674011002723395) {
        ...
        if (typeof t3 !== 'number')
          return this.solve$3$bailout(41, step, t2, allowSleep, ratio, temp, t3, t1, i, b);
      ...
      t5 = t4.get$angle();
      if (typeof t5 !== 'number')
        return this.solve$3$bailout(42, t4, t5, allowSleep, step, t2, temp, t1, i, b);
      t7 = step.get$dt();
      if (typeof t7 !== 'number')
        return this.solve$3$bailout(43, t4, t5, t7, step, allowSleep, t2, temp, t1, i, b);
      t9 = b.get$angularVelocity();
      if (typeof t9 !== 'number')
        return this.solve$3$bailout(44, t4, t5, t7, t9, allowSleep, step, t2, temp, t1, i, b);
  ...
  do {
    for (ce = body.get$contactList(), count = 0, found = false; !(ce == null); ce = ce.get$next()) {
      ...
      if (typeof type !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(2, t8, body, bullet, iter, t2, other, type, count, ce, t4, toiContact, toi, toiOther, found, t3, t7, t6, t5);
      if (bullet) {
        t1 = other.get$flags();
        if (t1 !== (t1 | 0))
          return this.solveTimeOfImpactGivenBody$1$bailout(3, t8, body, bullet, iter, t2, other, type, count, t1, ce, t4, toiContact, toi, toiOther, found, t3, t7, t6, t5);
        if ((t1 & 64) === 0)
          continue;
        if (!(type === 0)) {
          t1 = ce.get$contact().get$flags();
          if (t1 !== (t1 | 0))
            return this.solveTimeOfImpactGivenBody$1$bailout(4, t8, body, bullet, t1, iter, t2, other, count, ce, t4, toiContact, t3, toiOther, found, toi, t7, t6, t5);
          t10 = (t1 & 16) !== 0;
          t1 = t10;
        } else
          t1 = false;
      ...
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(5, t8, body, contact, t1, bullet, iter, t2, other, count, ce, t4, toiContact, toi, toiOther, found, t3, t7, t6, t5);
      if (!t1)
        continue;
      t1 = contact.get$toiCount();
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(6, t8, t4, contact, body, bullet, iter, t2, other, t1, count, ce, t3, toiContact, toi, toiOther, found, t5, t7, t6);
      if (t1 > 10)
        continue;
      ...
      t1 = t2.state;
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(7, t8, body, contact, t7, t1, bullet, iter, t2, other, count, ce, t3, toiContact, toi, toiOther, found, t5, t4, t6);
      if (t1 === 3) {
        t1 = t2.t;
        if (typeof t1 !== 'number')
          return this.solveTimeOfImpactGivenBody$1$bailout(8, t8, body, contact, t7, bullet, t1, iter, t2, other, count, ce, t3, toiContact, toi, toiOther, found, t5, t4, t6);
        t1 = t1 < toi;
      } else
        t1 = false;
      if (t1) {
        toi = t2.t;
        if (toi !== (toi | 0))
          return this.solveTimeOfImpactGivenBody$1$bailout(9, t8, body, contact, bullet, iter, t2, toi, other, count, ce, t4, t3, t5, t6, t7);
        toiOther = other;
        toiContact = contact;
        found = true;
      }
...
$$.ContactSolver = {"": ["constraints>", "constraintCount", "worldManifold", "tangent", "temp1", "temp2", "P", "dv", "dv1", "dv2", "x>", "d", "P1", "P2", "psolver", "rA>", "rB>"],
 ...
 init$3: function(contacts, contactCount, impulseRatio) {
  ...
  for (t1 = this.worldManifold, t2 = t1.points, t3 = t2.length, t4 = this.tangent, t5 = this.temp2, t6 = this.temp1, t7 = t1.normal, i = 0; $.ltB(i, this.constraintCount); ++i) {
    ...
    if (typeof wA !== 'number')
      return this.init$3$bailout(3, restitution, vA, vB, wA, impulseRatio, t4, i, contacts, t3, radiusA, t5, bodyA, bodyB, manifold, t6, t7, radiusB, friction, t1, t2);
 ...
 solveVelocityConstraints$0: function() {
  ...
  while (true) {
    ...
    while (true) {
      ...
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(9, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, wA, wB, t7, t2, t8, j, t1, t11);
      if (!(j < t11))
        break;
      t11 = c.get$points();
      if (typeof t11 !== 'string' && (typeof t11 !== 'object' || t11 === null || t11.constructor !== Array && !t11.is$JavaScriptIndexingBehavior()))
        return this.solveVelocityConstraints$0$bailout(10, t11, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, wA, wB, t7, t2, t8, j, t1);
      if (j >= t11.length)
        throw $.ioore(j);
      ccp = t11[j];
      a = ccp.get$rA();
      ...
      if (typeof t13 !== 'number')
        return this.solveVelocityConstraints$0$bailout(11, t9, ccp, a, t11, t10, t13, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, wA, wB, t7, t2, t8, j, t1);
      t13 = t11 * t13;
      t11 = vB.get$x();
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(12, t9, ccp, a, t10, i, t13, t11, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, wA, wB, t7, t2, t8, j, t1);
      t11 = t13 + t11;
      t13 = vA.get$x();
      if (typeof t13 !== 'number')
        return this.solveVelocityConstraints$0$bailout(13, t9, ccp, a, t10, i, t11, t13, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, wA, wB, t7, t2, t8, j, t1);
      t13 = t11 - t13;
      t11 = a.get$y();
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(14, t9, ccp, a, t10, i, c, t13, t11, bodyB, bodyA, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, wA, wB, t7, t2, t8, j, t1);
      t1.x = t13 + wA * t11;
      t18 = ccp.get$rB().get$x();
      if (typeof t18 !== 'number')
        return this.solveVelocityConstraints$0$bailout(15, t9, ccp, a, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t18, t3, t4, friction, t5, t6, wA, wB, t7, t2, t8, j, t1);
      t18 = wB * t18;
      t20 = vB.get$y();
      if (typeof t20 !== 'number')
        return this.solveVelocityConstraints$0$bailout(16, t9, ccp, a, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t18, t20, t3, t4, friction, t5, t6, wA, wB, t7, t2, t8, j, t1);
      t20 = t18 + t20;
      t18 = vA.get$y();
      if (typeof t18 !== 'number')
        return this.solveVelocityConstraints$0$bailout(17, t9, ccp, a, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t20, t18, t3, t4, friction, t5, t6, wA, wB, t7, t2, t8, j, t1);
      t18 = t20 - t18;
      t20 = a.get$x();
      if (typeof t20 !== 'number')
        return this.solveVelocityConstraints$0$bailout(18, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t18, t20, t3, t4, friction, t5, t6, wA, wB, t7, t2, t8, j, t1);
      t1.y = t18 - wA * t20;
      t24 = t1.x;
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(19, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t24, wA, wB, t6, t2, t7, t8, j, t1);
      t26 = t2.x;
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(20, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t24, wA, wB, t26, t2, t6, t8, t7, j, t1);
      t26 = t24 * t26;
      t24 = t1.y;
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(21, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, wA, wB, t7, t24, t8, t26, j, t2, t1);
      t29 = t2.y;
      if (typeof t29 !== 'number')
        return this.solveVelocityConstraints$0$bailout(22, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, wA, wB, t7, t24, t29, t26, t8, j, t2, t1);
      vt = t26 + t24 * t29;
      t26 = ccp.get$tangentMass();
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(23, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, wA, wB, t7, t2, t8, vt, j, t26, t1);
      lambda = t26 * -vt;
      t26 = ccp.get$normalImpulse();
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(24, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, wA, wB, t7, t2, t8, j, t1, lambda, t26);
      maxFriction = friction * t26;
      t26 = ccp.get$tangentImpulse();
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(25, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, t5, friction, t6, wA, wB, t7, t2, t8, j, t1, lambda, maxFriction, t26);
      t26 += lambda;
      ...
      t34 = t2.x;
      if (typeof t34 !== 'number')
        return this.solveVelocityConstraints$0$bailout(26, t9, ccp, t10, newImpulse, i, lambda, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, t5, friction, t6, wA, wB, t7, t2, t8, t34, j, t1);
      Px = t34 * lambda;
      t34 = t2.y;
      if (typeof t34 !== 'number')
        return this.solveVelocityConstraints$0$bailout(27, t9, ccp, t10, newImpulse, i, lambda, Px, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, t5, friction, t6, wA, wB, t7, t2, t8, j, t34, t1);
      Py = t34 * lambda;
      t34 = vA.get$x();
      if (typeof t34 !== 'number')
        return this.solveVelocityConstraints$0$bailout(28, t9, ccp, t10, newImpulse, i, Px, c, bodyA, bodyB, Py, t34, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, t5, friction, t6, wA, wB, t7, t2, t8, j, t1);
      vA.set$x(t34 - Px * invMassA);
      t38 = vA.get$y();
      if (typeof t38 !== 'number')
        return this.solveVelocityConstraints$0$bailout(29, t9, ccp, t10, newImpulse, i, Px, c, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, t38, t3, t4, t5, friction, t6, wA, wB, t7, t2, t8, j, t1);
      vA.set$y(t38 - Py * invMassA);
      t40 = ccp.get$rA();
      t41 = t40.get$x();
      if (typeof t41 !== 'number')
        return this.solveVelocityConstraints$0$bailout(30, t9, ccp, t10, newImpulse, i, Px, c, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, t41, t3, t4, t5, friction, t6, wA, wB, t7, t2, t8, j, t1);
      t41 *= Py;
      t40 = t40.get$y();
      if (typeof t40 !== 'number')
        return this.solveVelocityConstraints$0$bailout(31, t9, ccp, t10, newImpulse, i, Px, c, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, t41, t40, t3, t4, t5, friction, t6, wA, wB, t7, t2, t8, j, t1);
      wA -= invIA * (t41 - t40 * Px);
      t44 = vB.get$x();
      if (typeof t44 !== 'number')
        return this.solveVelocityConstraints$0$bailout(32, t9, ccp, t10, newImpulse, i, Px, c, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, t5, friction, wA, t44, t6, wB, t7, t2, t8, j, t1);
    ...
    if (typeof t12 !== 'string' && (typeof t12 !== 'object' || t12 === null || t12.constructor !== Array && !t12.is$JavaScriptIndexingBehavior()))
      return this.solveVelocityConstraints$0$bailout(37, t9, t10, i, t11, c, bodyA, bodyB, t12, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
    t14 = t12.length;
    t15 = -wB;
    if (t11) {
      if (0 >= t14)
      ...
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(38, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, t11, t15, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t11 = t15 * t11;
      t15 = vB.get$x();
      if (typeof t15 !== 'number')
        return this.solveVelocityConstraints$0$bailout(39, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, t15, t11, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t15 = t11 + t15;
      t11 = vA.get$x();
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(40, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, t15, t11, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t11 = t15 - t11;
      t15 = a1.get$y();
      if (typeof t15 !== 'number')
        return this.solveVelocityConstraints$0$bailout(41, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, t11, t15, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t1.x = t11 + wA * t15;
      t18 = ccp.get$rB().get$x();
      if (typeof t18 !== 'number')
        return this.solveVelocityConstraints$0$bailout(42, t9, t10, i, c, bodyA, bodyB, ccp, vA, vB, invMassA, invMassB, invIB, invIA, a1, t3, t4, t18, t5, t6, wA, wB, t7, t2, t8, t1);
      t18 = wB * t18;
      t20 = vB.get$y();
      if (typeof t20 !== 'number')
        return this.solveVelocityConstraints$0$bailout(43, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, t3, t4, t5, t18, t20, wA, wB, t6, t2, t7, t8, t1);
      t20 = t18 + t20;
      t18 = vA.get$y();
      if (typeof t18 !== 'number')
        return this.solveVelocityConstraints$0$bailout(44, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, t3, t4, t5, t6, wA, wB, t18, t2, t20, t7, t8, t1);
      t18 = t20 - t18;
      t20 = a1.get$x();
      if (typeof t20 !== 'number')
        return this.solveVelocityConstraints$0$bailout(45, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, t3, t4, t5, t6, wA, wB, t7, t2, t18, t20, t8, t1);
      t1.y = t18 - wA * t20;
      b = c.get$normal();
      t24 = t1.x;
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(46, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1, b, t24);
      t26 = b.get$x();
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(47, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1, b, t26, t24);
      t24 *= t26;
      t28 = t1.y;
      if (typeof t28 !== 'number')
        return this.solveVelocityConstraints$0$bailout(48, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1, b, t24, t28);
      t30 = b.get$y();
      if (typeof t30 !== 'number')
        return this.solveVelocityConstraints$0$bailout(49, t30, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1, t24, t28);
      vn = t24 + t28 * t30;
      t24 = ccp.get$normalMass();
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(50, t9, vn, i, t24, t10, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t24 = -t24;
      t33 = ccp.get$velocityBias();
      if (typeof t33 !== 'number')
        return this.solveVelocityConstraints$0$bailout(51, t9, vn, i, t24, t33, t10, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      lambda = t24 * (vn - t33);
      t24 = ccp.get$normalImpulse();
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(52, t9, t10, i, lambda, c, bodyA, bodyB, t24, vA, vB, invMassA, ccp, invMassB, invIB, invIA, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      a = t24 + lambda;
      newImpulse = a > 0 ? a : 0;
      ...
      t11 = vA.get$x();
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(56, t9, t10, i, bodyA, bodyB, ccp, vB, invMassA, vA, invMassB, newImpulse, invIB, invIA, Px, Py, t11, t3, t4, t5, t6, t2, wA, wB, t7, t8, t1);
      ...
      t24 = t23.get$x();
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(62, t9, Py, t10, i, t3, t4, t5, t24, t6, t2, wB, bodyA, bodyB, t7, vA, vB, t8, ccp, invIB, newImpulse, t1, wA, Px);
      t24 *= Py;
      t23 = t23.get$y();
      if (typeof t23 !== 'number')
      ...
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(65, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t15, t3, t4, t5, t11, t6, wA, wB, t7, t2, t8, t1);
      t11 = t15 * t11;
      t13 = vB.get$x();
      if (typeof t13 !== 'number')
        return this.solveVelocityConstraints$0$bailout(66, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t11, t13, t6, wA, wB, t7, t2, t8, t1);
      t13 = t11 + t13;
      t11 = vA.get$x();
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(67, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, t11, wA, wB, t7, t8, t2, t13, t1);
      t11 = t13 - t11;
      t13 = cp1.get$rA().get$y();
      if (typeof t13 !== 'number')
        return this.solveVelocityConstraints$0$bailout(68, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t11, t13, t8, t2, t1);
      t9.x = t11 + wA * t13;
      t19 = cp1.get$rB().get$x();
      if (typeof t19 !== 'number')
        return this.solveVelocityConstraints$0$bailout(69, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1, t19);
      t19 = wB * t19;
      t21 = vB.get$y();
      if (typeof t21 !== 'number')
        return this.solveVelocityConstraints$0$bailout(70, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1, t19, t21);
      t21 = t19 + t21;
      t19 = vA.get$y();
      if (typeof t19 !== 'number')
        return this.solveVelocityConstraints$0$bailout(71, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1, t21, t19);
      t19 = t21 - t19;
      t21 = cp1.get$rA().get$x();
      if (typeof t21 !== 'number')
        return this.solveVelocityConstraints$0$bailout(72, t9, t19, t21, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t9.y = t19 - wA * t21;
      t25 = cp2.get$rB().get$y();
      if (typeof t25 !== 'number')
        return this.solveVelocityConstraints$0$bailout(73, t9, t10, i, t15, t25, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t25 = t15 * t25;
      t15 = vB.get$x();
      if (typeof t15 !== 'number')
        return this.solveVelocityConstraints$0$bailout(74, t9, t10, i, c, t25, t15, bodyB, bodyA, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t15 = t25 + t15;
      t25 = vA.get$x();
      if (typeof t25 !== 'number')
        return this.solveVelocityConstraints$0$bailout(75, t9, t10, i, c, bodyA, bodyB, t15, vA, vB, invMassA, invIA, invMassB, invIB, t25, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t25 = t15 - t25;
      t15 = cp2.get$rA().get$y();
      if (typeof t15 !== 'number')
        return this.solveVelocityConstraints$0$bailout(76, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t15, t25, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t10.x = t25 + wA * t15;
      t30 = cp2.get$rB().get$x();
      if (typeof t30 !== 'number')
        return this.solveVelocityConstraints$0$bailout(77, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, t30, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t30 = wB * t30;
      t32 = vB.get$y();
      if (typeof t32 !== 'number')
        return this.solveVelocityConstraints$0$bailout(78, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, t30, t32, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t32 = t30 + t32;
      t30 = vA.get$y();
      if (typeof t30 !== 'number')
        return this.solveVelocityConstraints$0$bailout(79, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t32, t30, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t30 = t32 - t30;
      t32 = cp2.get$rA().get$x();
      if (typeof t32 !== 'number')
        return this.solveVelocityConstraints$0$bailout(80, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t30, t6, wA, wB, t7, t2, t8, t32, t1);
      t10.y = t30 - wA * t32;
      t36 = t9.x;
      if (typeof t36 !== 'number')
        return this.solveVelocityConstraints$0$bailout(81, t9, t10, i, t36, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t38 = c.get$normal();
      t39 = t38.get$x();
      if (typeof t39 !== 'number')
        return this.solveVelocityConstraints$0$bailout(82, t9, t10, i, t36, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t39, t1);
      t36 *= t39;
      t41 = t9.y;
      if (typeof t41 !== 'number')
        return this.solveVelocityConstraints$0$bailout(83, t9, t10, i, t41, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t36, t1);
      t38 = t38.get$y();
      if (typeof t38 !== 'number')
        return this.solveVelocityConstraints$0$bailout(84, t9, t10, i, t41, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t36, t1, t38);
      vn1 = t36 + t41 * t38;
      t36 = t10.x;
      if (typeof t36 !== 'number')
        return this.solveVelocityConstraints$0$bailout(85, t9, t10, i, t36, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1, vn1);
      t39 = t36 * t39;
      t36 = t10.y;
      if (typeof t36 !== 'number')
        return this.solveVelocityConstraints$0$bailout(87, t9, t39, t10, i, c, bodyA, t36, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1, vn1);
      vn2 = t39 + t36 * t38;
      t39 = cp1.get$velocityBias();
      if (typeof t39 !== 'number')
        return this.solveVelocityConstraints$0$bailout(89, t9, t10, i, vn2, t39, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1, vn1);
      t39 = vn1 - t39;
      t47 = cp2.get$velocityBias();
      if (typeof t47 !== 'number')
        return this.solveVelocityConstraints$0$bailout(90, t9, t10, i, vn2, c, t39, t47, bodyB, bodyA, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      b = $.Vector$(t39, vn2 - t47);
      t39 = c.get$K();
      t49 = t39.get$col1().get$x();
      if (typeof t49 !== 'number')
        return this.solveVelocityConstraints$0$bailout(91, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, t49, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t51 = a.x;
      if (typeof t51 !== 'number')
        return this.solveVelocityConstraints$0$bailout(92, t9, t10, i, c, bodyA, bodyB, t51, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, t49, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t51 = t49 * t51;
      t49 = t39.get$col2().get$x();
      if (typeof t49 !== 'number')
        return this.solveVelocityConstraints$0$bailout(93, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, t51, cp1, t49, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t54 = a.y;
      if (typeof t54 !== 'number')
        return this.solveVelocityConstraints$0$bailout(94, t9, t10, i, c, bodyA, bodyB, t54, vA, vB, invMassA, invIA, invMassB, invIB, b, t51, cp1, t49, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t8.x = t51 + t49 * t54;
      t56 = c.get$K();
      t57 = t56.get$col1().get$y();
      if (typeof t57 !== 'number')
        return this.solveVelocityConstraints$0$bailout(95, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, a, t57, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t59 = a.x;
      if (typeof t59 !== 'number')
        return this.solveVelocityConstraints$0$bailout(96, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, t59, cp1, cp2, a, t57, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t59 = t57 * t59;
      t57 = t56.get$col2().get$y();
      if (typeof t57 !== 'number')
        return this.solveVelocityConstraints$0$bailout(97, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, a, t3, t4, t5, t59, t6, wA, wB, t7, t2, t8, t57, t1);
      t62 = a.y;
      if (typeof t62 !== 'number')
        return this.solveVelocityConstraints$0$bailout(98, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, t62, a, t3, t4, t5, t59, t6, wA, wB, t7, t2, t8, t57, t1);
      t8.y = t59 + t57 * t62;
      t64 = b.x;
      if (typeof t64 !== 'number')
        return this.solveVelocityConstraints$0$bailout(99, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, t64, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t66 = t8.x;
      if (typeof t66 !== 'number')
        return this.solveVelocityConstraints$0$bailout(100, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, t64, t66, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      b.x = t64 - t66;
      t68 = b.y;
      if (typeof t68 !== 'number')
        return this.solveVelocityConstraints$0$bailout(101, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, t68, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      t70 = t8.y;
      if (typeof t70 !== 'number')
        return this.solveVelocityConstraints$0$bailout(102, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, t68, cp2, t70, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
      b.y = t68 - t70;
      $loop$1: {
        ...
        t11 = t4.get$x();
        if (typeof t11 !== 'number')
          return this.solveVelocityConstraints$0$bailout(103, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, a, t11, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
        if (t11 >= 0) {
          t11 = t4.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(104, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, a, t3, t4, t5, t11, t6, wA, wB, t7, t2, t8, t1);
          t11 = t11 >= 0;
        } else
          t11 = false;
        if (t11) {
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(105, t9, t2, t10, i, t3, t4, t5, t6, wA, wB, bodyA, bodyB, t7, vA, vB, t8, invIA, t11, invIB, t12, t1, cp1, cp2);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(107, t9, t10, i, t3, t4, t5, t6, wA, wB, bodyA, bodyB, t7, vA, vB, t8, invIA, t2, invIB, t1, t12, cp1, t11, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
            return this.solveVelocityConstraints$0$bailout(108, t9, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, t12, cp1, t11, cp2, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1, t17);
          t12 -= t11 * t17;
          t19 = cp2.get$rA();
          t20 = t19.get$x();
          if (typeof t20 !== 'number')
            return this.solveVelocityConstraints$0$bailout(109, t9, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t12, t19, t20, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
          t22 = t6.y;
          if (typeof t22 !== 'number')
            return this.solveVelocityConstraints$0$bailout(110, t9, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t12, t19, t20, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1, t22);
          t20 *= t22;
          t19 = t19.get$y();
          if (typeof t19 !== 'number')
            return this.solveVelocityConstraints$0$bailout(111, t9, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t12, t20, t4, t5, t3, t19, t6, wA, wB, t7, t2, t8, t1);
          t25 = t6.x;
          if (typeof t25 !== 'number')
            return this.solveVelocityConstraints$0$bailout(112, t9, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t12, t20, t4, t5, t3, t19, t6, wA, wB, t7, t2, t8, t1, t25);
          wA -= invIA * (t12 + (t20 - t19 * t25));
          t27 = cp1.get$rB();
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(113, t9, t10, i, t3, t4, t5, t6, t2, wB, bodyA, bodyB, t7, vA, vB, t27, wA, t28, invIB, t1, cp1, cp2, t8);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
          ...
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(117, t30, t31, t9, t10, i, t3, t4, t5, t6, t2, wB, bodyA, bodyB, t7, vA, vB, t8, wA, invIB, t1, cp1, t14, cp2);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
        ...
        if (typeof t11 !== 'number')
          return this.solveVelocityConstraints$0$bailout(121, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, t11, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
        t11 = -t11;
        t13 = b.x;
        if (typeof t13 !== 'number')
          return this.solveVelocityConstraints$0$bailout(122, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, t11, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t13, t1);
        t4.set$x(t11 * t13);
        t4.set$y(0);
        t15 = c.get$K().get$col1().get$y();
        if (typeof t15 !== 'number')
          return this.solveVelocityConstraints$0$bailout(123, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, a, t15, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
        t17 = t4.get$x();
        if (typeof t17 !== 'number')
          return this.solveVelocityConstraints$0$bailout(124, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, a, t15, t3, t4, t5, t17, t6, wA, wB, t7, t2, t8, t1);
        t15 *= t17;
        t19 = b.y;
        if (typeof t19 !== 'number')
          return this.solveVelocityConstraints$0$bailout(125, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, a, t3, t4, t5, t15, t6, wA, wB, t7, t2, t8, t1, t19);
        vn2 = t15 + t19;
        if (t17 >= 0 && vn2 >= 0) {
          t3.setFrom$1(t4).subLocal$1(a);
          t5.setFrom$1(c.get$normal()).mulLocal$1(t3.x);
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(127, t9, t12, t10, i, t3, t4, t5, t6, wA, wB, bodyA, bodyB, t7, vA, vB, t8, invIA, t2, invIB, t1, cp1, cp2, t11);
          t14 = t5.y;
          if (typeof t14 !== 'number')
            return this.solveVelocityConstraints$0$bailout(128, t9, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, t14, cp2, t11, t12, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
          t12 *= t14;
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(129, t9, t12, i, t11, t4, t5, t3, t10, t6, wA, wB, bodyA, bodyB, t7, vA, vB, t8, invIA, t2, invIB, t1, cp1, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
            return this.solveVelocityConstraints$0$bailout(130, t9, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t17, t12, t11, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
          t12 -= t11 * t17;
          t19 = cp2.get$rA();
          t20 = t19.get$x();
          if (typeof t20 !== 'number')
            return this.solveVelocityConstraints$0$bailout(131, t9, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t12, t19, t6, t20, wB, wA, t7, t2, t8, t1);
          t22 = t6.y;
          if (typeof t22 !== 'number')
            return this.solveVelocityConstraints$0$bailout(132, t9, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t22, t3, t4, t5, t12, t6, wA, t20, wB, t7, t19, t2, t8, t1);
          t20 *= t22;
          t19 = t19.get$y();
          if (typeof t19 !== 'number')
            return this.solveVelocityConstraints$0$bailout(133, t9, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t12, t6, wA, wB, t7, t2, t20, t19, t8, t1);
          t25 = t6.x;
          if (typeof t25 !== 'number')
            return this.solveVelocityConstraints$0$bailout(134, t9, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t25, t3, t4, t5, t12, t6, wA, wB, t7, t2, t20, t19, t8, t1);
          wA -= invIA * (t12 + (t20 - t19 * t25));
          t27 = cp1.get$rB();
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
          ...
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(139, t9, t10, i, t3, t4, t14, t30, t6, t31, wB, bodyA, bodyB, t7, vA, vB, t8, t2, invIB, t1, cp1, wA, t5, cp2);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(141, t9, t10, i, t3, t4, t14, t5, t6, t2, wB, t22, t30, bodyB, bodyA, vA, vB, t7, t8, invIB, t1, cp1, wA, cp2);
          wB += invIB * (t14 + (t22 - t30 * t25));
          cp1.set$normalImpulse(t4.get$x());
          cp2.set$normalImpulse(t4.get$y());
          break $loop$1;
        ...
        if (typeof t11 !== 'number')
          return this.solveVelocityConstraints$0$bailout(143, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, a, t11, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1);
        t11 = -t11;
        t13 = b.y;
        if (typeof t13 !== 'number')
          return this.solveVelocityConstraints$0$bailout(144, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, a, t3, t4, t5, t11, t6, wA, wB, t7, t2, t8, t1, t13);
        t4.set$y(t11 * t13);
        t15 = c.get$K().get$col2().get$x();
        if (typeof t15 !== 'number')
          return this.solveVelocityConstraints$0$bailout(145, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t15, t8, t2, t1);
        t17 = t4.get$y();
        if (typeof t17 !== 'number')
          return this.solveVelocityConstraints$0$bailout(146, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t15, t8, t17, t2, t1);
        t15 *= t17;
        t19 = b.x;
        if (typeof t19 !== 'number')
          return this.solveVelocityConstraints$0$bailout(147, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t15, t1, t19);
        vn1 = t15 + t19;
        if (t17 >= 0 && vn1 >= 0) {
          t3.setFrom$1(t4).subLocal$1(a);
          t5.setFrom$1(c.get$normal()).mulLocal$1(t3.x);
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(149, t9, t10, i, t3, t4, t5, t11, t12, t6, wA, wB, bodyA, bodyB, t7, vA, vB, t8, invIA, t2, invIB, t1, cp1, cp2);
          t14 = t5.y;
          if (typeof t14 !== 'number')
            return this.solveVelocityConstraints$0$bailout(150, t9, t14, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t11, t12, t6, wA, wB, t7, t8, t2, t1);
          t12 *= t14;
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(151, t9, t10, i, t3, t4, t5, t6, wA, wB, t12, t11, bodyB, bodyA, vA, vB, t7, invIA, t2, invIB, t1, cp1, cp2, t8);
          t17 = t5.x;
          if (typeof t17 !== 'number')
            return this.solveVelocityConstraints$0$bailout(152, t9, t17, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, wA, wB, t12, t11, t7, t2, t8, t1);
          t12 -= t11 * t17;
          t19 = cp2.get$rA();
          t20 = t19.get$x();
          if (typeof t20 !== 'number')
          ...
          t19 = t19.get$y();
          if (typeof t19 !== 'number')
            return this.solveVelocityConstraints$0$bailout(155, t9, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, wA, wB, t7, t2, t8, t12, t1, t20, t19);
          t25 = t6.x;
          if (typeof t25 !== 'number')
            return this.solveVelocityConstraints$0$bailout(156, t9, t10, i, t25, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, wA, wB, t7, t2, t8, t12, t1, t20, t19);
          wA -= invIA * (t12 + (t20 - t19 * t25));
          t27 = cp1.get$rB();
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(157, t9, t10, i, wA, t4, t5, t28, t27, t6, t3, wB, bodyA, bodyB, t7, vA, vB, t8, t2, invIB, t1, cp1, cp2);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
          ...
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(161, t9, t10, i, wA, t4, t5, t3, t6, t2, wB, bodyA, bodyB, t7, vA, vB, t30, t14, t31, invIB, t1, cp1, cp2, t8);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
        ...
        if (typeof vn1 !== 'number')
          return this.solveVelocityConstraints$0$bailout(165, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1, vn1);
        vn2 = b.y;
        if (typeof vn2 !== 'number')
          return this.solveVelocityConstraints$0$bailout(166, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, wA, wB, t7, t2, t8, t1, vn1, vn2);
        if (vn1 >= 0 && vn2 >= 0) {
          t3.setFrom$1(t4).subLocal$1(a);
          t5.setFrom$1(c.get$normal()).mulLocal$1(t3.x);
          t6.setFrom$1(c.get$normal()).mulLocal$1(t3.y);
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(167, t9, t11, t10, i, t12, t4, t5, t3, t6, wA, wB, bodyA, bodyB, t7, vA, vB, t8, invIA, t2, invIB, t1, cp1, cp2);
          t14 = t5.y;
          if (typeof t14 !== 'number')
            return this.solveVelocityConstraints$0$bailout(168, t9, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t11, t12, t3, t4, t5, t6, wA, wB, t7, t14, t8, t2, t1);
          t12 *= t14;
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(169, t9, t10, i, t3, t4, t5, t12, t11, t6, wA, wB, bodyA, bodyB, t7, vA, vB, t8, invIA, t2, invIB, t1, cp1, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
            return this.solveVelocityConstraints$0$bailout(170, t9, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t17, t4, t5, t12, t11, t6, wA, wB, t7, t2, t3, t8, t1);
          t12 -= t11 * t17;
          t19 = cp2.get$rA();
          t20 = t19.get$x();
          if (typeof t20 !== 'number')
            return this.solveVelocityConstraints$0$bailout(171, t9, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, wA, wB, t12, t19, t20, t2, t7, t8, t1);
          t22 = t6.y;
          if (typeof t22 !== 'number')
            return this.solveVelocityConstraints$0$bailout(172, t9, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t22, t6, wA, wB, t12, t19, t20, t2, t7, t8, t1);
          t20 *= t22;
          t19 = t19.get$y();
          if (typeof t19 !== 'number')
          ...
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
            return this.solveVelocityConstraints$0$bailout(177, wA, t9, t10, i, t14, t27, t4, t5, t6, t3, wB, bodyA, bodyB, t7, vA, vB, t8, t2, invIB, t1, cp1, cp2);
          t14 -= t27 * t17;
          t30 = cp2.get$rB();
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(179, wA, t9, t10, i, t3, t4, t5, t6, t14, t30, wB, bodyA, bodyB, t7, vA, vB, t8, t31, t2, invIB, t1, cp1, cp2);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(181, wA, t9, t10, i, t3, t4, t5, t6, t14, wB, bodyA, bodyB, t7, vA, vB, t30, t22, t2, invIB, t1, cp1, cp2, t8);
          wB += invIB * (t14 + (t22 - t30 * t25));
          cp1.set$normalImpulse(t4.get$x());
          cp2.set$normalImpulse(t4.get$y());
          break $loop$1;
 ...
 solvePositionConstraints$1: function(baumgarte) {
  ...
  while (true) {
    ...
    if (typeof t5 !== 'number')
      return this.solvePositionConstraints$1$bailout(1, baumgarte, t5, t4, psm, t1, t2, i, minSeparation, t3, normal, point);
    if (!(i < t5))
      break;
    t5 = this.constraints;
    if (i >= t5.length)
    ...
    while (true) {
      ...
      t9 = t3.x;
      if (typeof t9 !== 'number')
        return this.solvePositionConstraints$1$bailout(22, baumgarte, invIB, minSeparation, t1, t2, i, t3, j, t9, t6, t7, bodyA, bodyB, c, t4, psm, normal, point, invMassA, invIA, invMassB);
      t11 = t1.y;
      if (typeof t11 !== 'number')
        return this.solvePositionConstraints$1$bailout(23, baumgarte, invIB, minSeparation, t1, t2, i, t3, j, t9, t11, t6, t7, bodyA, bodyB, c, t4, psm, normal, point, invMassA, invIA, invMassB);
      t11 = t9 * t11;
      t9 = t3.y;
      if (typeof t9 !== 'number')
      ...
      t16 = t6.get$angle();
      if (typeof t16 !== 'number')
        return this.solvePositionConstraints$1$bailout(26, baumgarte, invIB, minSeparation, t1, t2, i, t6, j, t16, t3, c, bodyA, bodyB, t4, psm, normal, point, invMassA, invIA, invMassB);
      t18 = t4.x;
      if (typeof t18 !== 'number')
        return this.solvePositionConstraints$1$bailout(27, baumgarte, invIB, minSeparation, t1, t2, i, t6, j, t16, t3, c, bodyA, bodyB, t4, t18, psm, normal, point, invIA, invMassA, invMassB);
      t20 = t1.y;
      if (typeof t20 !== 'number')
        return this.solvePositionConstraints$1$bailout(28, baumgarte, invIB, minSeparation, t1, t2, i, t6, j, t16, t3, c, bodyA, bodyB, t4, t18, t20, normal, psm, invIA, point, invMassA, invMassB);
      t20 = t18 * t20;
      t18 = t4.y;
      if (typeof t18 !== 'number')
        return this.solvePositionConstraints$1$bailout(29, baumgarte, invIB, minSeparation, t1, t2, i, t6, j, t16, t3, c, bodyA, t20, bodyB, t4, psm, normal, t18, point, invIA, invMassA, invMassB);
      t23 = t1.x;
      if (typeof t23 !== 'number')
        return this.solvePositionConstraints$1$bailout(30, baumgarte, invIB, minSeparation, t1, t2, i, t6, j, t16, t3, c, bodyA, t20, bodyB, t4, psm, normal, t18, t23, invIA, point, invMassA, invMassB);
...
$$.TimeOfImpactSolver = {"": ["constraints>", "count=", "toiBody", "psm", "rA>", "rB>", "P", "temp"],
 ...
 solve$1: function(baumgarte) {
  ...
  while (true) {
    t6 = this.count;
    if (typeof t6 !== 'number')
      return this.solve$1$bailout0(1, baumgarte, t5, t4, normal, minSeparation, point, t1, t2, i, t3, t6);
    if (!(i < t6))
      break;
    t6 = this.constraints;
    if (i >= t6.length)
    ...
    while (true) {
      ...
      if (typeof separation !== 'number')
        return this.solve$1$bailout0(9, baumgarte, invMassA, invIA, t5, t4, normal, invMassB, point, invIB, separation, i, minSeparation, c, bodyA, bodyB, j, t2, t1, t3);
      t3.setFrom$1(point).subLocal$1(bodyA.get$sweep().get$center());
      t4.setFrom$1(point).subLocal$1(bodyB.get$sweep().get$center());
      minSeparation = $.min(minSeparation, separation);
      if (minSeparation !== (minSeparation | 0))
      ...
      t10 = t3.y;
      if (typeof t10 !== 'number')
        return this.solve$1$bailout0(22, baumgarte, t10, invMassA, t12, invIA, t5, t4, invMassB, normal, point, invIB, i, c, bodyA, minSeparation, bodyB, t3, j, t2, t1, t7, t8);
      t15 = t1.x;
      if (typeof t15 !== 'number')
      ...
      t21 = t1.y;
      if (typeof t21 !== 'number')
        return this.solve$1$bailout0(26, baumgarte, invMassA, invIA, t5, t4, normal, t19, t21, invIB, point, invMassB, i, c, minSeparation, bodyB, bodyA, t7, j, t17, t2, t1, t3);
      t21 = t19 * t21;
      t19 = t4.y;
      if (typeof t19 !== 'number')
