...
$$.Collision = {"":"Object;_pool,cache,input,output,results1,results2,incidentEdge>,localTangent,localNormal>,planePoint,tangent,normal>,normal1,v11,v12,clipPoints1,clipPoints2",
 ...
 collidePolygons$5: function(manifold, polyA, xfA, polyB, xfB) {
  ...
  if (typeof frontOffset !== 'number')
    return this.collidePolygons$5$bailout(2, manifold, xf2, t8, t4, frontOffset, totalRadius, t1, t2, t3, t5, t6, flip);
...
$$.DistanceProxy = {"":"Object;vertices>,count=,radius=",
 ...
 getSupport$1: function(direction) {
  ...
  while (true) {
    ...
    t3 = t3.get$y();
    if (typeof t3 !== 'number')
      return this.getSupport$1$bailout(8, direction, t2, bestIndex, t4, bestValue, t3, i, t1);
    value = t4 + t3 * t9;
    if (value > bestValue) {
      bestValue = value;
      bestIndex = i;
 ...
 solve$3: function(step, gravity, allowSleep) {
  ...
  while (true) {
    ...
    while (true) {
      t1 = this.jointCount;
      if (typeof t1 !== 'number')
        return this.solve$3$bailout(32, step, t2, allowSleep, j, i, t1);
      if (!(j < t1))
        break;
      t1 = this.joints;
      if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))
  ...
  while (true) {
    ...
    c$0: {
      t4 = this.bodies;
      if (typeof t4 !== 'string' && (typeof t4 !== 'object' || t4 === null || t4.constructor !== Array && !t4.is$JavaScriptIndexingBehavior()))
        return this.solve$3$bailout(35, step, t3, i, allowSleep, t2, temp, t1, t4);
      if (i >= t4.length)
        throw $.ioore(i);
      b = t4[i];
      t4 = b.get$type();
      if (typeof t4 !== 'number')
        return this.solve$3$bailout(36, step, t3, allowSleep, t4, t2, temp, t1, b, i);
      if (t4 === 0)
        break c$0;
      ...
      t4 = t1.x;
      if (typeof t4 !== 'number')
        return this.solve$3$bailout(37, step, t3, allowSleep, t2, t4, temp, t1, b, i);
      t4 *= t4;
      t6 = t1.y;
      if (typeof t6 !== 'number')
        return this.solve$3$bailout(38, step, t3, allowSleep, t2, t4, t6, temp, t1, b, i);
      if (t4 + t6 * t6 > 4) {
        t4 = t3.get$length(t1);
        if (typeof t4 !== 'number')
          throw $.iae(t4);
      ...
      t4 = step.get$dt();
      if (typeof t4 !== 'number')
        return this.solve$3$bailout(39, step, t3, allowSleep, t2, t4, temp, t1, b, i);
      t6 = b.get$angularVelocity();
      if (typeof t6 !== 'number')
        return this.solve$3$bailout(40, step, t3, allowSleep, t2, t4, temp, t6, t1, b, i);
      rotation = t4 * t6;
      if (rotation * rotation > 2.4674011002723395) {
        ...
        if (typeof t4 !== 'number')
          return this.solve$3$bailout(41, step, t3, allowSleep, t2, ratio, temp, t4, t1, b, i);
      ...
      t6 = t5.get$angle();
      if (typeof t6 !== 'number')
        return this.solve$3$bailout(42, t5, t6, t3, step, allowSleep, t2, temp, t1, b, i);
      t8 = step.get$dt();
      if (typeof t8 !== 'number')
        return this.solve$3$bailout(43, t5, t6, t8, step, t3, allowSleep, t2, temp, t1, b, i);
  ...
  while (true) {
    ...
    while (true) {
      t1 = this.jointCount;
      if (typeof t1 !== 'number')
        return this.solve$3$bailout(46, step, t2, jointsOkay, j, allowSleep, i, contactsOkay, t1);
      if (!(j < t1))
        break;
      t1 = this.joints;
      if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))
        return this.solve$3$bailout(47, t1, step, jointsOkay, j, allowSleep, t2, i, contactsOkay);
      if (j >= t1.length)
        throw $.ioore(j);
  ...
  if (allowSleep === true) {
    ...
    while (true) {
      ...
      c$0: {
        ...
        t1 = b.get$type();
        if (typeof t1 !== 'number')
          return this.solve$3$bailout(50, step, minSleepTime, i, b, t1);
        if (t1 === 0)
          break c$0;
        t1 = b.get$flags();
        if (t1 !== (t1 | 0))
        ...
        if ((t1 & 4) !== 0) {
          ...
          if (typeof t3 !== 'number')
            return this.solve$3$bailout(54, step, i, b, t3, t1, minSleepTime);
          if (!(t1 * t3 > 0.0012184696791468343)) {
            ...
            t5 = t2.get$x();
            if (typeof t5 !== 'number')
              return this.solve$3$bailout(56, step, t2, t3, t1, t5, i, b, minSleepTime);
            t5 = t3 * t5;
            t1 = t1.get$y();
            if (typeof t1 !== 'number')
              return this.solve$3$bailout(57, step, t2, t5, i, t1, b, minSleepTime);
            t2 = t2.get$y();
            if (typeof t2 !== 'number')
 ...
 solveTimeOfImpactGivenBody$1: function(body) {
  ...
  do {
    for (ce = body.get$contactList(), found = false, count = 0; !(ce == null); ce = ce.get$next()) {
      ...
      if (typeof type !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(2, t8, body, bullet, t2, other, type, iter, toiOther, found, count, ce, t4, t3, toiContact, toi, t5, t7, t6);
      if (bullet) {
        t1 = other.get$flags();
        if (t1 !== (t1 | 0))
          return this.solveTimeOfImpactGivenBody$1$bailout(3, t8, body, bullet, t2, other, type, iter, t1, toiOther, found, count, ce, t3, t4, toiContact, toi, t7, t6, t5);
        if ((t1 & 64) === 0)
          continue;
        if (!(type === 0)) {
          t1 = ce.get$contact().get$flags();
          if (t1 !== (t1 | 0))
            return this.solveTimeOfImpactGivenBody$1$bailout(4, t8, body, bullet, t1, t2, other, iter, toiOther, found, count, ce, t4, t3, toiContact, toi, t5, t7, t6);
          t10 = (t1 & 16) !== 0;
          t1 = t10;
        } else
          t1 = false;
      ...
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(5, t8, body, contact, t1, bullet, t2, other, iter, toiOther, found, count, ce, t4, t3, toiContact, toi, t5, t7, t6);
      if (!t1)
        continue;
      t1 = contact.get$toiCount();
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(6, t8, body, contact, bullet, t2, other, t1, iter, toiOther, found, count, ce, t4, t3, toiContact, toi, t5, t7, t6);
      if (t1 > 10)
        continue;
      ...
      t1 = t2.state;
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(7, t8, body, contact, t1, bullet, t2, other, iter, toiOther, found, count, ce, t4, t3, toiContact, toi, t5, t7, t6);
      if (t1 === 3) {
        t1 = t2.t;
        if (typeof t1 !== 'number')
          return this.solveTimeOfImpactGivenBody$1$bailout(8, t8, body, contact, bullet, t1, t2, other, iter, toiOther, found, count, ce, t4, t3, toiContact, toi, t5, t7, t6);
        t1 = t1 < toi;
      } else
        t1 = false;
      if (t1) {
        toi = t2.t;
        if (toi !== (toi | 0))
          return this.solveTimeOfImpactGivenBody$1$bailout(9, t8, body, contact, bullet, t2, other, toi, iter, t3, count, ce, t5, t4, t6, t7);
        toiContact = contact;
        toiOther = other;
        found = true;
      }
  ...
  while (true) {
    ...
    c$0: {
      ...
      t1 = contact.get$enabled();
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(13, body, ce, count, contact, t1, toiOther, toiContact);
      if (!t1)
        break c$0;
      fixtureA = contact.get$fixtureA();
      fixtureB = contact.get$fixtureB();
      ...
      t1 = contact.get$enabled();
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(14, body, ce, count, contact, toiOther, toiContact, t1);
      if (!t1)
        break c$0;
      t1 = contact.get$touching();
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(15, body, ce, count, contact, toiOther, t1, toiContact);
      if (!t1)
        break c$0;
      t1 = this.contacts;
      if (count >= t1.length)
 ...
 init$3: function(contacts, contactCount, impulseRatio) {
  ...
  for (t1 = this.worldManifold, t2 = t1.points, t3 = t2.length, t4 = this.tangent, t5 = this.temp2, t6 = this.temp1, t7 = t1.normal, i = 0; $.ltB(i, this.constraintCount); ++i) {
    ...
    if (typeof restitution !== 'number')
      return this.init$3$bailout(2, restitution, t2, impulseRatio, i, contacts, t4, t3, radiusA, radiusB, t5, bodyB, manifold, bodyA, t6, t7, friction, t1);
 ...
 solveVelocityConstraints$0: function() {
  ...
  while (true) {
    ...
    while (true) {
      ...
      if (typeof t18 !== 'number')
        return this.solveVelocityConstraints$0$bailout(15, t9, ccp, a, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t18, t3, t4, friction, t5, t6, t2, j, t7, t8, wA, wB, t1);
      t18 = wB * t18;
      t20 = vB.get$y();
      if (typeof t20 !== 'number')
      ...
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(19, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t24, t2, j, t7, t6, t8, wA, wB, t1);
      t26 = t2.x;
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(20, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t24, t2, t26, j, t7, t6, t8, wA, wB, t1);
      t26 = t24 * t26;
      t24 = t1.y;
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(21, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, t2, t26, j, t24, t7, t8, wA, wB, t1);
      t29 = t2.y;
      if (typeof t29 !== 'number')
        return this.solveVelocityConstraints$0$bailout(22, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, t2, t26, j, t24, t29, t8, wA, wB, t1, t7);
      vt = t26 + t24 * t29;
      t26 = ccp.get$tangentMass();
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(23, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, t2, j, t7, t8, wA, wB, t26, t1, vt);
      lambda = t26 * -vt;
      ...
      if (typeof t44 !== 'number')
        return this.solveVelocityConstraints$0$bailout(32, t9, ccp, t10, newImpulse, i, Px, c, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, t5, friction, wA, t44, t2, j, t7, t6, t8, wB, t1);
    ...
    if (t11) {
      ...
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(38, t9, t10, i, c, bodyA, bodyB, vA, vB, a1, ccp, invMassB, t11, invIB, invMassA, invIA, t15, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t11 = t15 * t11;
      t15 = vB.get$x();
      if (typeof t15 !== 'number')
        return this.solveVelocityConstraints$0$bailout(39, t9, t10, i, c, bodyA, bodyB, vA, vB, a1, ccp, invMassB, invIB, invIA, t11, t15, invMassA, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t15 = t11 + t15;
      t11 = vA.get$x();
      if (typeof t11 !== 'number')
      ...
      t15 = a1.get$y();
      if (typeof t15 !== 'number')
        return this.solveVelocityConstraints$0$bailout(41, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, t11, t15, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t1.x = t11 + wA * t15;
      t18 = ccp.get$rB().get$x();
      if (typeof t18 !== 'number')
      ...
      t18 = vA.get$y();
      if (typeof t18 !== 'number')
        return this.solveVelocityConstraints$0$bailout(44, t9, t10, i, c, bodyA, bodyB, vA, a1, vB, ccp, invMassB, invIB, invIA, invMassA, t3, t4, t5, t6, t2, t20, t18, t7, t8, wA, wB, t1);
      t18 = t20 - t18;
      t20 = a1.get$x();
      if (typeof t20 !== 'number')
      ...
      t15 = t15.get$y();
      if (typeof t15 !== 'number')
        return this.solveVelocityConstraints$0$bailout(59, t9, t10, i, bodyA, bodyB, vA, vB, ccp, invMassB, newImpulse, invIB, invIA, Px, Py, t3, t4, t5, t6, t2, t7, t8, t16, wA, wB, t15, t1);
      wA -= invIA * (t16 - t15 * Px);
      t19 = vB.get$x();
      if (typeof t19 !== 'number')
      ...
      t24 = t23.get$x();
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(62, t9, Py, t10, i, t3, t4, t5, t24, t6, t2, bodyA, bodyB, t7, vA, vB, wB, ccp, invIB, newImpulse, t1, t8, wA, Px);
      t24 *= Py;
      t23 = t23.get$y();
      if (typeof t23 !== 'number')
      ...
      $loop$1: {
        ...
        if (t11) {
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(105, t9, t10, i, t3, t4, t5, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, invIA, wA, invIB, t11, t12, cp1, t1, cp2);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(107, t9, t10, i, t3, t4, t5, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, invIA, wA, invIB, t1, t12, cp1, t11, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
        ...
        if (t17 >= 0 && vn2 >= 0) {
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(127, t9, t12, t10, i, t3, t4, t5, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, invIA, wA, invIB, t1, cp1, cp2, t11);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(129, t9, t12, i, t11, t4, t5, t3, t10, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, invIA, wA, invIB, t1, cp1, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
        ...
        if (typeof t11 !== 'number')
          return this.solveVelocityConstraints$0$bailout(143, t9, t10, i, c, bodyA, bodyB, b, vA, vB, invIA, invMassB, invIB, invMassA, cp1, cp2, a, t11, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
        t11 = -t11;
        t13 = b.y;
        if (typeof t13 !== 'number')
          return this.solveVelocityConstraints$0$bailout(144, t9, t10, i, c, bodyA, bodyB, b, vA, vB, invIA, invMassB, invIB, invMassA, cp1, cp2, a, t3, t4, t5, t11, t6, t2, t7, t8, wA, wB, t13, t1);
        t4.set$y(t11 * t13);
        t15 = c.get$K().get$col2().get$x();
        if (typeof t15 !== 'number')
          return this.solveVelocityConstraints$0$bailout(145, t9, t10, i, c, bodyA, bodyB, b, vA, vB, invIA, invMassB, invIB, invMassA, cp1, cp2, a, t3, t4, t5, t6, t2, t7, t15, t8, wA, wB, t1);
        t17 = t4.get$y();
        if (typeof t17 !== 'number')
          return this.solveVelocityConstraints$0$bailout(146, t9, t10, i, c, bodyA, bodyB, b, vA, vB, invIA, invMassB, invIB, invMassA, cp1, cp2, a, t3, t4, t5, t6, t2, t7, t15, t8, t17, wA, wB, t1);
        t15 *= t17;
        t19 = b.x;
        if (typeof t19 !== 'number')
          return this.solveVelocityConstraints$0$bailout(147, t9, t10, i, c, bodyA, bodyB, b, vA, vB, invIA, invMassB, invIB, invMassA, cp1, cp2, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t15, t1, t19);
        vn1 = t15 + t19;
        if (t17 >= 0 && vn1 >= 0) {
          t3.setFrom$1(t4).subLocal$1(a);
          t5.setFrom$1(c.get$normal()).mulLocal$1(t3.x);
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(149, t9, t10, i, t3, t4, t5, t11, t6, t12, t2, bodyA, bodyB, t7, vA, vB, wB, invIA, wA, invIB, t1, cp1, cp2, t8);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(151, t9, t10, i, t3, t4, t5, t6, t2, t8, t12, t11, bodyB, bodyA, vA, vB, wB, invIA, wA, invIB, t7, t1, cp1, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
        ...
        if (vn1 >= 0 && vn2 >= 0) {
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(167, t9, t11, t10, i, t12, t4, t5, t3, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, invIA, wA, invIB, t1, cp1, cp2);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(169, t9, t10, i, t3, t4, t5, t12, t11, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, invIA, wA, invIB, t1, cp1, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
 ...
 solvePositionConstraints$1: function(baumgarte) {
  ...
  while (true) {
    ...
    while (true) {
      t6 = c.get$pointCount();
      if (typeof t6 !== 'number')
        return this.solvePositionConstraints$1$bailout(10, baumgarte, invIB, j, t1, t2, i, minSeparation, t3, c, bodyA, bodyB, t6, t4, invMassA, normal, point, psm, invIA, invMassB);
      if (!(j < t6))
        break;
      psm.initialize$2(c, j);
      separation = psm.separation;
      if (typeof separation !== 'number')
        return this.solvePositionConstraints$1$bailout(11, baumgarte, invIB, j, t1, t2, i, minSeparation, t3, c, bodyA, bodyB, t4, invMassA, normal, point, separation, invIA, psm, invMassB);
