...
$$.DominoTest = {"": ["bodies", "canvas", "ctx", "viewport", "debugDraw", "world", "frameCount", "fpsCounter", "elapsedUs", "worldStepTime", "viewportScale", "_stopwatch"],
 "super": "Demo",
...
$$.Collision = {"": ["_pool", "cache", "input", "output", "results1", "results2", "incidentEdge?", "localTangent", "localNormal?", "planePoint", "tangent", "normal?", "normal1", "v11", "v12", "clipPoints1", "clipPoints2"],
 ...
 edgeSeparation$5: function(poly1, xf1, edge1, poly2, xf2) {
  ...
  for (t1 = vertices2.length, index = 0, minDot = 99999999999999, i = 0; i < count2; ++i) {
    ...
    t2 = a.get$x();
    if (t2 !== (t2 | 0))
      return this.edgeSeparation$5$bailout(17, xf1, edge1, xf2, normal1Worldx, index, minDot, i, vertices2, R, R1, count2, normal1x, vertices1, a, t2, normal1y, normal1Worldy);
    t2 *= normal1x;
    t4 = a.get$y();
    if (t4 !== (t4 | 0))
      return this.edgeSeparation$5$bailout(18, xf1, edge1, xf2, normal1Worldx, index, minDot, i, vertices2, R, R1, count2, normal1x, vertices1, normal1Worldy, normal1y, t2, t4);
    dot = t2 + t4 * normal1y;
    if (dot < minDot) {
      minDot = dot;
      index = i;
...
$$.DistanceProxy = {"": ["vertices?", "count=", "radius="],
  ...
  if (t1 === 0) {
    ...
    if (t1 === 1) {
      ...
      while (true) {
        t3 = this.count;
        if (typeof t3 !== 'number')
          return this.setFromShape$1$bailout(3, i, t3, shape, t1, t2);
        if (!(i < t3))
          break;
        if (i >= t2)
          throw $.ioore(i);
 ...
 getSupport$1: function(direction) {
  ...
  while (true) {
    t3 = this.count;
    if (typeof t3 !== 'number')
      return this.getSupport$1$bailout(5, direction, t2, bestValue, i, bestIndex, t1, t3);
    if (!(i < t3))
      break;
    if (i >= t2)
      throw $.ioore(i);
    ...
    t3 = t3.get$y();
    if (typeof t3 !== 'number')
      return this.getSupport$1$bailout(8, direction, t2, bestValue, i, t4, t3, bestIndex, t1);
    value = t4 + t3 * t9;
    if (value > bestValue) {
      bestValue = value;
      bestIndex = i;
...
$$.TimeOfImpact = {"": ["cache", "distanceInput", "xfA", "xfB", "distanceOutput", "fcn", "indexes", "sweepA?", "sweepB?", "pool"],
 ...
 timeOfImpact$2: function(output, input) {
  ...
  for (t1 = this.fcn, t2 = this.indexes, t5 = t2.length, t6 = target + 0.00125, t7 = target - 0.00125, t8 = this.distanceOutput, t9 = this.xfA, t11 = this.xfB, t13 = this.pool, t14 = 0, iter = 0; true;) {
    ...
    t15 = t8.distance;
    if (typeof t15 !== 'number')
      return this.timeOfImpact$2$bailout(5, output, t1, t2, t11, target, t7, t13, t9, proxyA, proxyB, t15, t3, t4, t6, t8, t5, t10, t12, tMax, t14, iter);
    if (t15 <= 0) {
      output.set$state(2);
      output.set$t(0);
      break;
    ...
    for (t20 = tMax, pushBackIter = 0; done = false, true;) {
      ...
      if (typeof s2 !== 'number')
        return this.timeOfImpact$2$bailout(7, output, t11, iter, s2, t13, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t3, t4, t6, t5, t10, t20, pushBackIter, t12, t14, t9);
      if (s2 > t6) {
        output.set$state(4);
        output.set$t(tMax);
        done = true;
      ...
      if (typeof s1 !== 'number')
        return this.timeOfImpact$2$bailout(8, output, t11, t9, s2, t13, proxyA, proxyB, t8, tMax, t1, t2, s1, target, t7, t3, t4, t6, t5, t10, t20, pushBackIter, t12, t14, iter);
      if (s1 < t7) {
        output.set$state(1);
        output.set$t(t14);
        done = true;
      ...
      for (a2 = t20, a1 = t14, rootIterCount = 0; true;) {
        ...
        if (typeof s !== 'number')
          return this.timeOfImpact$2$bailout(9, output, s2, rootIterCount, a1, a2, t9, s1, t13, t11, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t, t3, t4, t6, s, t5, t10, t20, pushBackIter, t12, t14, iter);
        t15 = $.abs(s - target);
        if (typeof t15 !== 'number')
          return this.timeOfImpact$2$bailout(10, output, s2, rootIterCount, a1, a2, t9, s1, t13, t11, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t, t3, t4, t6, s, t5, t10, t20, pushBackIter, t15, t12, t14, iter);
        if (t15 < 0.00125) {
          t20 = t;
          break;
        }
        ...
        if (a1 !== (a1 | 0))
          return this.timeOfImpact$2$bailout(11, output, t11, rootIterCount, t9, s2, s1, a1, a2, t13, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t3, t4, t6, t5, t10, t20, pushBackIter, t12, t14, iter);
        ++rootIterCount;
        t16 = $.TimeOfImpact_toiRootIters;
        if (typeof t16 !== 'number')
          return this.timeOfImpact$2$bailout(12, output, t11, t9, s2, s1, a1, a2, rootIterCount, t16, proxyA, t13, proxyB, t8, tMax, t1, t2, target, t7, t3, t4, t6, t5, t10, t20, pushBackIter, t12, t14, iter);
        $.TimeOfImpact_toiRootIters = t16 + 1;
        if (rootIterCount === 50)
          break;
      }
      if (t20 !== (t20 | 0))
        return this.timeOfImpact$2$bailout(13, output, t11, iter, t13, proxyA, proxyB, t8, tMax, t20, rootIterCount, t1, t2, target, t7, t3, t4, t6, t5, t10, pushBackIter, t12, t14, t9);
    ...
    if (typeof t15 !== 'number')
      return this.timeOfImpact$2$bailout(14, output, t1, t2, t11, t14, target, t7, t13, iter, t15, proxyA, proxyB, t3, t4, t6, t8, t5, t10, t12, tMax, done, t9);
...
$$.PolygonShape = {"": ["centroid?", "vertices?", "normals?", "vertexCount?", "type", "radius"],
 ...
 getSupport$1: function(d) {
  ...
  while (true) {
    t2 = this.vertexCount;
    if (typeof t2 !== 'number')
      return this.getSupport$1$bailout(6, d, bestIndex, i, bestValue, t1, t2);
    if (!(i < t2))
      break;
    if (i >= t3)
      throw $.ioore(i);
    ...
    t4 = t2.get$x();
    if (typeof t4 !== 'number')
      return this.getSupport$1$bailout(7, d, t2, t4, bestIndex, i, bestValue, t1);
    t4 *= t7;
    t2 = t2.get$y();
    if (typeof t2 !== 'number')
      return this.getSupport$1$bailout(9, d, bestIndex, t4, t2, i, bestValue, t1);
    value = t4 + t2 * t10;
    if (value > bestValue) {
      bestValue = value;
      bestIndex = i;
...
$$.Island = {"": ["listener", "bodies?", "contacts", "joints", "positions", "velocities", "bodyCount?", "jointCount", "contactCount?", "bodyCapacity", "contactCapacity", "jointCapacity", "positionIterationCount", "_contactSolver", "_translation", "impulse"],
 ...
 solve$3: function(step, gravity, allowSleep) {
  ...
  while (true) {
    ...
    t1 = this.joints;
    if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))
      return this.solve$3$bailout(30, step, t2, i, allowSleep, t1);
    if (i >= t1.length)
      throw $.ioore(i);
  ...
  while (true) {
    ...
    c$0: {
      ...
      t3 = t1.x;
      if (typeof t3 !== 'number')
        return this.solve$3$bailout(37, step, t2, allowSleep, i, t3, temp, t1, b);
      t3 *= t3;
      t5 = t1.y;
      if (typeof t5 !== 'number')
      ...
      t7 = step.get$dt();
      if (typeof t7 !== 'number')
        return this.solve$3$bailout(43, t4, t5, t7, step, i, t2, allowSleep, temp, t1, b);
      t9 = b.get$angularVelocity();
      if (typeof t9 !== 'number')
        return this.solve$3$bailout(44, t4, t5, t7, t9, i, step, allowSleep, t2, temp, t1, b);
  ...
  if (allowSleep === true) {
    ...
    if (minSleepTime >= 0.5) {
      ...
      while (true) {
        t1 = this.bodyCount;
        if (typeof t1 !== 'number')
          return this.solve$3$bailout(61, t1, i);
        if (!(i < t1))
          break;
        t1 = this.bodies;
        if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))
 ...
 solveTimeOfImpactGivenBody$1: function(body) {
  ...
  while (true) {
    for (ce = body.get$contactList(), found = false, count = 0; !(ce == null); ce = ce.get$next()) {
      ...
      if (typeof type !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(2, body, bullet, t2, other, type, iter, toiContact, t3, t4, toi, toiOther, count, ce, found, t7, t6, t5, t8);
      if (bullet) {
        t1 = other.get$flags();
        if (t1 !== (t1 | 0))
          return this.solveTimeOfImpactGivenBody$1$bailout(3, t6, body, bullet, t2, other, type, iter, t1, toiContact, toi, t4, t3, count, toiOther, found, t7, ce, t5, t8);
        if ((t1 & 64) === 0)
          continue;
        if (!(type === 0)) {
          t1 = ce.get$contact().get$flags();
          if (t1 !== (t1 | 0))
            return this.solveTimeOfImpactGivenBody$1$bailout(4, body, bullet, t1, t2, other, iter, toiContact, t3, t4, toi, toiOther, count, ce, found, t7, t6, t5, t8);
          t10 = (t1 & 16) !== 0;
          t1 = t10;
        } else
          t1 = false;
      ...
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(5, body, contact, t1, bullet, t2, other, iter, toiContact, t3, t4, toiOther, found, count, ce, t6, toi, t7, t5, t8);
      if (!t1)
        continue;
      t1 = contact.get$toiCount();
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(6, body, contact, bullet, t2, other, t1, iter, toiContact, t3, t4, toi, toiOther, count, ce, found, t7, t6, t5, t8);
      if (t1 > 10)
        continue;
      ...
      t1 = t2.state;
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(7, body, contact, t1, bullet, t2, other, iter, toiContact, t3, toi, toiOther, found, count, ce, t6, t4, t7, t5, t8);
      if (t1 === 3) {
        t1 = t2.t;
        if (typeof t1 !== 'number')
          return this.solveTimeOfImpactGivenBody$1$bailout(8, body, contact, bullet, t1, t2, other, iter, toiContact, t3, toi, toiOther, found, count, ce, t6, t4, t7, t5, t8);
        t1 = t1 < toi;
      } else
        t1 = false;
      if (t1) {
        toi = t2.t;
        if (toi !== (toi | 0))
          return this.solveTimeOfImpactGivenBody$1$bailout(9, body, contact, bullet, t2, toi, other, iter, t3, t4, t5, count, ce, t6, t7, t8);
        toiOther = other;
        toiContact = contact;
        found = true;
      }
  ...
  while (true) {
    ...
    c$0: {
      ...
      t1 = contact.get$enabled();
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(13, body, contact, ce, toiContact, count, t1, toiOther);
      if (!t1)
        break c$0;
      fixtureA = contact.get$fixtureA();
      fixtureB = contact.get$fixtureB();
      ...
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(15, body, t1, contact, ce, count, toiContact, toiOther);
      if (!t1)
        break c$0;
      t1 = this.contacts;
      if (count >= t1.length)
 ...
 init$3: function(contacts, contactCount, impulseRatio) {
  ...
  for (t1 = this.worldManifold, t2 = t1.points, t3 = t2.length, t4 = this.tangent, t5 = this.temp2, t6 = this.temp1, t7 = t1.normal, i = 0; $.ltB(i, this.constraintCount); ++i) {
    ...
    if (typeof restitution !== 'number')
      return this.init$3$bailout(2, restitution, t4, impulseRatio, i, contacts, t3, t5, radiusA, radiusB, t6, bodyB, manifold, bodyA, t7, t2, friction, t1);
    vA = bodyA.get$linearVelocity();
    vB = bodyB.get$linearVelocity();
    wA = bodyA.get$angularVelocity();
    if (typeof wA !== 'number')
      return this.init$3$bailout(3, restitution, vA, vB, wA, t4, impulseRatio, contacts, i, t3, t5, radiusA, radiusB, t6, bodyB, manifold, bodyA, t7, t2, friction, t1);
    wB = bodyB.get$angularVelocity();
    if (typeof wB !== 'number')
      return this.init$3$bailout(4, restitution, vA, vB, wA, wB, impulseRatio, contacts, t4, i, t3, t5, radiusA, radiusB, t6, bodyB, manifold, bodyA, t7, t2, friction, t1);
  ...
  while (true) {
    ...
    while (true) {
      ...
      if (typeof t46 !== 'number')
        return this.solveVelocityConstraints$0$bailout(33, ccp, newImpulse, i, Px, c, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, t5, t6, t2, t7, friction, wA, t8, t1, t46, j, wB, t9, t10);
    ...
    if (t11) {
      ...
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(38, i, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, t11, t14, t3, t4, t5, t6, t2, t7, t8, t1, wA, wB, t9, t10);
      t11 = t14 * t11;
      t14 = vB.get$x();
      if (typeof t14 !== 'number')
        return this.solveVelocityConstraints$0$bailout(39, i, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, t11, t14, t3, t4, t5, t6, t2, t7, t8, t1, wA, wB, t9, t10);
      t14 = t11 + t14;
      t11 = vA.get$x();
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(40, i, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, t14, t11, t3, t4, t5, t6, t2, t7, t8, t1, wA, wB, t9, t10);
      t11 = t14 - t11;
      t14 = a1.get$y();
      if (typeof t14 !== 'number')
        return this.solveVelocityConstraints$0$bailout(41, i, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, t11, t14, t4, t5, t6, t2, t7, t3, t8, t1, wA, wB, t9, t10);
      t1.x = t11 + wA * t14;
      t18 = ccp.get$rB().get$x();
      if (typeof t18 !== 'number')
      ...
      if (typeof t28 !== 'number')
        return this.solveVelocityConstraints$0$bailout(48, i, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, t3, t4, t5, t6, t2, t7, t8, t1, t28, wA, wB, t9, b, t24, t10);
      t30 = b.get$y();
      if (typeof t30 !== 'number')
        return this.solveVelocityConstraints$0$bailout(49, t30, i, c, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, t3, t4, t5, t6, t2, t7, t8, t1, t28, wA, wB, t9, t24, t10);
      vn = t24 + t28 * t30;
      ...
      t24 = t23.get$x();
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(62, t4, t5, Py, t6, i, t2, t7, t24, t8, bodyA, bodyB, t1, vA, vB, ccp, newImpulse, wB, t9, invIB, wA, t10, Px, t3);
      t24 *= Py;
      t23 = t23.get$y();
      if (typeof t23 !== 'number')
      ...
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(65, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, t3, t4, t5, a, t6, t14, t11, t7, t2, t8, t1, wA, wB, t9, t10);
      t11 = t14 * t11;
      t13 = vB.get$x();
      if (typeof t13 !== 'number')
      ...
      if (typeof t19 !== 'number')
        return this.solveVelocityConstraints$0$bailout(69, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, t3, t4, t5, a, t6, t2, t7, t8, t1, wA, wB, t9, t19, t10);
      t19 = wB * t19;
      t21 = vB.get$y();
      if (typeof t21 !== 'number')
      ...
      if (typeof t25 !== 'number')
        return this.solveVelocityConstraints$0$bailout(73, i, t14, t25, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, t3, t4, t5, a, t6, t2, t7, t8, t1, wA, wB, t9, t10);
      t25 = t14 * t25;
      t14 = vB.get$x();
      if (typeof t14 !== 'number')
        return this.solveVelocityConstraints$0$bailout(74, i, c, t25, t14, bodyB, bodyA, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, t3, t4, t5, a, t6, t2, t7, t8, t1, wA, wB, t9, t10);
      t14 = t25 + t14;
      t25 = vA.get$x();
      if (typeof t25 !== 'number')
        return this.solveVelocityConstraints$0$bailout(75, i, c, bodyA, bodyB, t14, vA, vB, invMassA, invIA, invMassB, invIB, t25, cp1, cp2, t3, t4, t5, a, t6, t2, t7, t8, t1, wA, wB, t9, t10);
      t25 = t14 - t25;
      t14 = cp2.get$rA().get$y();
      if (typeof t14 !== 'number')
        return this.solveVelocityConstraints$0$bailout(76, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t14, t25, cp1, cp2, t3, t4, t5, a, t6, t2, t7, t8, t1, wA, wB, t9, t10);
      t10.x = t25 + wA * t14;
      ...
      while (true) {
        ...
        if (t11) {
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(105, t4, t5, t10, t6, i, t2, t7, t8, bodyA, bodyB, t1, vA, vB, invIA, t11, invIB, wB, t9, wA, cp1, t12, cp2, t3);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(107, t4, t5, t10, t6, i, t2, t7, t8, bodyA, bodyB, t1, vA, vB, invIA, invIB, wB, t9, wA, cp1, t11, t12, cp2, t3);
          t17 = t5.x;
          if (typeof t17 !== 'number')
          ...
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(113, t4, t5, t6, i, t2, t7, t8, bodyA, bodyB, t1, vA, vB, t27, wA, t28, invIB, wB, t9, cp1, t10, cp2, t3);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
            return this.solveVelocityConstraints$0$bailout(115, t4, t5, t6, i, t2, t7, t8, bodyA, bodyB, t1, vA, vB, wA, invIB, wB, t14, t27, cp1, t9, t10, cp2, t3);
          t14 -= t27 * t17;
          t30 = cp2.get$rB();
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(117, t4, t31, t30, t6, i, t2, t5, t7, t3, t8, bodyA, bodyB, t1, vA, vB, wA, invIB, wB, t9, cp1, t10, t14, cp2);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(119, t4, t5, t3, t22, i, t30, t6, t2, t7, t8, bodyA, bodyB, t1, vA, vB, wA, invIB, wB, t9, cp1, t10, cp2, t14);
        ...
        if (t17 >= 0 && vn2 >= 0) {
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(127, t4, t5, t12, t6, i, t2, t7, t3, t8, bodyA, bodyB, t1, vA, vB, invIA, invIB, wB, t9, wA, cp1, t10, cp2, t11);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(129, t4, t5, t6, i, t11, t12, t2, t7, t8, bodyA, bodyB, t1, vA, vB, invIA, invIB, wB, t9, wA, cp1, t10, cp2, t3);
          t17 = t5.x;
          if (typeof t17 !== 'number')
          ...
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(135, t4, t5, t3, t10, t6, i, t2, t7, t8, bodyA, bodyB, t1, vA, vB, invIB, wB, t9, cp1, wA, t27, cp2, t28);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
            return this.solveVelocityConstraints$0$bailout(137, t4, t5, t14, t27, t6, i, t2, t7, t8, bodyA, bodyB, t1, vA, vB, invIB, wB, t9, cp1, wA, t10, cp2, t3);
          t14 -= t27 * t17;
          t30 = cp2.get$rB();
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(139, t4, t5, t6, i, t2, t7, t14, t30, t8, t31, bodyA, bodyB, t1, vA, vB, invIB, wB, t9, cp1, wA, t10, cp2, t3);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(141, t4, t5, t6, i, t2, t7, t14, t8, t22, t30, bodyB, bodyA, vA, vB, t1, invIB, wB, t9, cp1, wA, t10, cp2, t3);
          wB += invIB * (t14 + (t22 - t30 * t25));
          cp1.set$normalImpulse(t4.get$x());
          cp2.set$normalImpulse(t4.get$y());
          break;
        ...
        if (t17 >= 0 && vn1 >= 0) {
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(149, t4, t5, t6, i, t2, t7, t11, t8, t12, bodyA, bodyB, t1, vA, vB, invIA, invIB, wB, t9, wA, cp1, t10, cp2, t3);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(151, t4, t5, t6, i, t2, t7, t8, t12, t11, bodyB, bodyA, vA, vB, invIA, t1, invIB, wB, t9, wA, cp1, t10, cp2, t3);
          t17 = t5.x;
          if (typeof t17 !== 'number')
          ...
          t20 = t19.get$x();
          if (typeof t20 !== 'number')
            return this.solveVelocityConstraints$0$bailout(153, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, t2, t7, t8, t1, t12, t19, wA, wB, t9, t20, t10);
          t22 = t6.y;
          if (typeof t22 !== 'number')
            return this.solveVelocityConstraints$0$bailout(154, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, t2, t7, t8, t1, t12, t19, wA, wB, t9, t20, t10, t22);
          t20 *= t22;
          t19 = t19.get$y();
          if (typeof t19 !== 'number')
          ...
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(157, t4, t5, t6, i, wA, t27, t2, t28, t7, t8, bodyA, bodyB, t1, vA, vB, invIB, wB, t9, cp1, t10, cp2, t3);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
            return this.solveVelocityConstraints$0$bailout(159, t4, t5, t6, i, wA, t7, t2, t8, t14, t27, bodyA, bodyB, t1, vA, vB, invIB, wB, t9, cp1, t10, cp2, t3);
          t14 -= t27 * t17;
          t30 = cp2.get$rB();
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(161, t4, t5, t6, i, wA, t7, t2, t8, bodyA, bodyB, t1, vA, vB, t30, t14, t31, invIB, wB, t9, cp1, t10, cp2, t3);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(163, t4, t5, t6, i, wA, t7, t2, t8, bodyA, bodyB, t1, vA, vB, t14, invIB, wB, t22, t30, cp1, t9, t10, cp2, t3);
          wB += invIB * (t14 + (t22 - t30 * t25));
          cp1.set$normalImpulse(t4.get$x());
          cp2.set$normalImpulse(t4.get$y());
          break;
        ...
        if (typeof vn2 !== 'number')
          return this.solveVelocityConstraints$0$bailout(166, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, t3, t4, t5, a, t6, t2, t7, t8, t1, vn1, vn2, wA, wB, t9, t10);
        if (vn1 >= 0 && vn2 >= 0) {
          t3.setFrom$1(t4).subLocal$1(a);
          t5.setFrom$1(c.get$normal()).mulLocal$1(t3.x);
          t6.setFrom$1(c.get$normal()).mulLocal$1(t3.y);
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(167, t4, t5, t11, t6, i, t12, t7, t2, t8, bodyA, bodyB, t1, vA, vB, invIA, invIB, wB, t9, wA, cp1, t10, cp2, t3);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(169, t4, t5, t6, i, t2, t7, t12, t11, t8, bodyA, bodyB, t1, vA, vB, invIA, invIB, wB, t9, wA, cp1, t10, cp2, t3);
          t17 = t5.x;
          if (typeof t17 !== 'number')
          ...
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(175, wA, t4, t5, t28, t6, i, t2, t27, t7, t8, bodyA, bodyB, t1, vA, vB, invIB, wB, t9, cp1, t10, cp2, t3);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
            return this.solveVelocityConstraints$0$bailout(177, wA, t4, t5, t6, i, t14, t27, t2, t7, t8, bodyA, bodyB, t1, vA, vB, invIB, wB, t9, cp1, t10, cp2, t3);
          t14 -= t27 * t17;
          t30 = cp2.get$rB();
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(179, wA, t4, t5, t6, i, t2, t7, t8, t14, t30, bodyA, t31, bodyB, t1, vA, vB, invIB, wB, t9, cp1, t10, cp2, t3);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(181, wA, t4, t5, t6, i, t2, t7, t8, t14, bodyA, bodyB, t1, vA, vB, t30, t22, invIB, wB, t9, cp1, t10, cp2, t3);
          wB += invIB * (t14 + (t22 - t30 * t25));
          cp1.set$normalImpulse(t4.get$x());
          cp2.set$normalImpulse(t4.get$y());
          break;
 ...
 solvePositionConstraints$1: function(baumgarte) {
  ...
  while (true) {
    ...
    while (true) {
      ...
      t9 = t3.x;
      if (typeof t9 !== 'number')
        return this.solvePositionConstraints$1$bailout(21, baumgarte, invIB, minSeparation, t1, t2, j, t3, t9, i, t6, t7, bodyA, bodyB, c, t4, invMassA, normal, point, psm, invIA, invMassB);
      t11 = t1.y;
      if (typeof t11 !== 'number')
        return this.solvePositionConstraints$1$bailout(22, baumgarte, invIB, minSeparation, t1, t2, j, t3, t9, t11, t6, t7, bodyA, bodyB, c, t4, invMassA, i, normal, point, invIA, psm, invMassB);
      t11 = t9 * t11;
      t9 = t3.y;
      if (typeof t9 !== 'number')
      ...
      t16 = t6.get$angle();
      if (typeof t16 !== 'number')
        return this.solvePositionConstraints$1$bailout(25, baumgarte, invIB, minSeparation, t1, t2, j, t6, t16, t3, c, bodyA, bodyB, t4, invMassA, i, normal, point, invIA, psm, invMassB);
      t18 = t4.x;
      if (typeof t18 !== 'number')
        return this.solvePositionConstraints$1$bailout(26, baumgarte, invIB, minSeparation, t1, t2, j, t6, t16, t3, c, bodyA, bodyB, t4, t18, i, normal, invMassA, invIA, point, psm, invMassB);
      t20 = t1.y;
      if (typeof t20 !== 'number')
        return this.solvePositionConstraints$1$bailout(27, baumgarte, invIB, minSeparation, t1, t2, j, t6, t16, t3, c, bodyA, bodyB, t4, t18, t20, normal, invMassA, invIA, point, psm, i, invMassB);
      t20 = t18 * t20;
      t18 = t4.y;
      if (typeof t18 !== 'number')
        return this.solvePositionConstraints$1$bailout(28, baumgarte, invIB, minSeparation, t1, t2, j, t6, t16, t3, c, bodyA, t20, bodyB, t4, invMassA, i, t18, point, normal, invIA, psm, invMassB);
      t23 = t1.x;
      if (typeof t23 !== 'number')
        return this.solvePositionConstraints$1$bailout(29, baumgarte, invIB, minSeparation, t1, t2, j, t6, t16, t3, c, bodyA, t20, bodyB, t4, invMassA, i, t18, t23, normal, point, psm, invIA, invMassB);
...
$.DominoTest$ = function() {
  var t1 = new $.DominoTest($._ListImpl_List(null), null, null, null, null, null, null, null, null, null, 10, null);
