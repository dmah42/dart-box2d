...
$$.PolygonShape = {"":
 ...
 setAsBox$2: function(hx, hy) {
  ...
  t4 = this.normals;
  if (typeof t4 !== 'string' && (typeof t4 !== 'object' || t4 === null || t4.constructor !== Array && !t4.is$JavaScriptIndexingBehavior()))
    return this.setAsBox$2$bailout(2, t4, 0, 0);
  if (0 >= t4.length)
    throw $.ioore(0);
...
$$.Body = {"":
 ...
 createFixture$1: function(def) {
  ...
  var t2 = t1._flags;
  if (t2 !== (t2 | 0))
    return this.createFixture$1$bailout(2, fixture, t1, t2);
  t1._flags = (t2 | 1) >>> 0;
  return fixture;
},
...
$.DominoTest$ = function() {
  var t1 = new $.DominoTest($.ListImplementation_List(null), null, null, null, null, null, null, null, null, null, 10, null);
