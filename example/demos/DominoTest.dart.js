  ...
  initialize$0: function(_) {
    ...
    for (i = 0; i < 4; ++i)
      for (t1 = i === 2, t2 = 7.3 + 5 * i, t3 = i === 3, j = 0; j < 25; ++j) {
        fd.friction = 0.5;
        bd.position = new $.Vector(-14.75 + j * 1.2291666666666667, t2);
        if (t1 && j === 0) {
          bd.angle = -0.1;
          t4 = bd.position;
          t4.x = $.$add$ns(t4.x, 0.1);
        } else if (t3 && j === 24) {
          bd.angle = 0.1;
          t4 = bd.position;
          t4.x = $.$sub$n(t4.x, 0.1);
...
main: function() {
  var domino = new $.DominoTest($.List_List($), null, null, null, null, null, null, null, null, null, 10, null);
  domino.Demo$3("Domino test", null, 10);
  domino.initialize$0(domino);
