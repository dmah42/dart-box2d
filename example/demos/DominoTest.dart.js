...
$$.DistanceProxy = {"": ["vertices>", "count=", "radius="],
 ...
 getSupport$1: function(direction) {
  ...
  while (true) {
    ...
    t3 = t3.get$y();
    if (typeof t3 !== 'number')
      return this.getSupport$1$bailout(8, direction, t2, t4, bestIndex, bestValue, i, t3, t1);
    value = t4 + t3 * t9;
    if (value > bestValue) {
      bestValue = value;
      bestIndex = i;
...
$$.Simplex = {"": ["v1", "v2", "v3", "vertices>", "count=", "e13", "e23", "e12", "case2", "case22", "case3", "case33"],
 ...
 readCache$5: function(cache, proxyA, transformA, proxyB, transformB) {
  ...
  if (typeof t3 !== 'string' && (typeof t3 !== 'object' || t3 === null || t3.constructor !== Array && !t3.is$JavaScriptIndexingBehavior()))
    return this.readCache$5$bailout(1, cache, proxyA, transformA, t3, transformB, proxyB, t1, t2);
  t5 = cache.indexB;
  if (typeof t5 !== 'string' && (typeof t5 !== 'object' || t5 === null || t5.constructor !== Array && !t5.is$JavaScriptIndexingBehavior()))
    return this.readCache$5$bailout(2, cache, proxyA, transformA, t3, transformB, proxyB, t1, t5, t2);
  i = 0;
 ...
 readCache$5$bailout: function(state0, env0, env1, env2, env3, env4, env5, env6, env7, env8) {
  ...
  switch (state0) {
    ...
    case 1:
      ...
      t5 = cache.indexB;
    case 2:
      var t1, t2, t3, proxyB, transformB, transformA, proxyA, cache, t5, i, v, wALocal, wBLocal, metric1, metric2;
      state0 = 0;
      i = 0;
      for (; $.ltB(i, this.count); ++i) {
        if (i >= t2)
...
$$.TimeOfImpact = {"": ["cache", "distanceInput", "xfA", "xfB", "distanceOutput", "fcn", "indexes", "sweepA>", "sweepB>", "pool"],
 ...
 timeOfImpact$2: function(output, input) {
  ...
  for (t1 = this.fcn, t2 = this.indexes, t5 = t2.length, t6 = target + 0.00125, t7 = target - 0.00125, t8 = this.distanceOutput, t9 = this.xfA, t11 = this.xfB, t13 = this.pool, t14 = 0, iter = 0; true;) {
    ...
    t15 = t8.distance;
    if (typeof t15 !== 'number')
      return this.timeOfImpact$2$bailout(5, output, t1, t2, t11, target, t7, t13, proxyA, proxyB, t15, t3, t5, t6, t8, t4, t10, t12, t14, tMax, iter, t9);
    if (t15 <= 0) {
      output.set$state(2);
      output.set$t(0);
      break;
    ...
    for (t20 = tMax, pushBackIter = 0; done = false, true;) {
      ...
      if (typeof s2 !== 'number')
        return this.timeOfImpact$2$bailout(7, output, t11, s2, t13, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t3, t5, t6, t4, t10, t12, t14, iter, t20, pushBackIter, t9);
      if (s2 > t6) {
        output.set$state(4);
        output.set$t(tMax);
        done = true;
      ...
      if (typeof s1 !== 'number')
        return this.timeOfImpact$2$bailout(8, output, t11, s2, t13, proxyA, proxyB, t8, tMax, t1, t2, s1, target, t7, t3, t5, t6, t4, t10, t12, t14, iter, t20, pushBackIter, t9);
      if (s1 < t7) {
        output.set$state(1);
        output.set$t(t14);
        done = true;
      ...
      for (a2 = t20, a1 = t14, rootIterCount = 0; true;) {
        ...
        if (typeof s !== 'number')
          return this.timeOfImpact$2$bailout(9, output, t11, s2, s1, rootIterCount, a1, a2, t13, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t, t3, t5, t6, s, t4, t10, t12, t14, iter, t20, pushBackIter, t9);
        t15 = s - target;
        t15 = $.getInterceptor(t15).abs$0(t15);
        if (typeof t15 !== 'number')
          return this.timeOfImpact$2$bailout(10, output, t11, t12, s2, s1, rootIterCount, a1, a2, t13, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t, t3, t5, t6, s, t4, t10, t15, t14, iter, t20, pushBackIter, t9);
        if (t15 < 0.00125) {
          t20 = t;
          break;
        }
        ...
        if (a1 !== (a1 | 0))
          return this.timeOfImpact$2$bailout(11, output, t11, s2, s1, a1, a2, rootIterCount, proxyA, t13, proxyB, t8, tMax, t1, t2, target, t7, t3, t5, t6, t4, t10, t12, t14, iter, t20, pushBackIter, t9);
        ++rootIterCount;
        t16 = $.TimeOfImpact_toiRootIters;
        if (typeof t16 !== 'number')
          return this.timeOfImpact$2$bailout(12, output, t11, s2, s1, a1, a2, rootIterCount, t16, proxyA, t13, proxyB, t8, tMax, t1, t2, target, t7, t3, t5, t6, t4, t10, t12, t14, iter, t20, pushBackIter, t9);
        $.TimeOfImpact_toiRootIters = t16 + 1;
        if (rootIterCount === 50)
          break;
      }
      if (t20 !== (t20 | 0))
        return this.timeOfImpact$2$bailout(13, output, t11, t13, proxyA, proxyB, t8, tMax, t20, t1, t2, rootIterCount, target, t7, t3, t5, t6, t4, t10, t12, t14, iter, pushBackIter, t9);
    ...
    if (typeof t15 !== 'number')
      return this.timeOfImpact$2$bailout(14, output, t1, done, t2, t11, target, t7, t13, iter, t15, proxyA, proxyB, t3, t5, t6, t8, t4, t10, t12, tMax, t14, t9);
    ...
    while (true) {
      ...
      c$0: {
        ...
        if (t1) {
          ...
          t3 = step.get$dt();
          if (typeof t3 !== 'number')
            return this.solve$3$bailout(60, i, step, b, minSleepTime, t1, t3);
  ...
  do {
    for (ce = body.get$contactList(), found = false, count = 0; !(ce == null); ce = ce.get$next()) {
      ...
      if (typeof type !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(2, t8, body, bullet, t2, other, type, iter, toiContact, toi, toiOther, found, count, ce, t5, t6, t3, t4, t7);
      if (bullet) {
        t1 = other.get$flags();
        if (t1 !== (t1 | 0))
          return this.solveTimeOfImpactGivenBody$1$bailout(3, t8, body, t3, bullet, t2, other, type, iter, t1, toiContact, toi, toiOther, found, count, ce, t6, t5, t4, t7);
        if ((t1 & 64) === 0)
          continue;
        if (!(type === 0)) {
          t1 = ce.get$contact().get$flags();
          if (t1 !== (t1 | 0))
            return this.solveTimeOfImpactGivenBody$1$bailout(4, t8, body, bullet, t1, t2, other, iter, toiContact, toi, toiOther, found, count, ce, t5, t6, t3, t4, t7);
          t10 = (t1 & 16) !== 0;
          t1 = t10;
        } else
          t1 = false;
      ...
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(5, t8, body, contact, t1, bullet, t2, other, iter, toiContact, toi, toiOther, found, count, ce, t5, t6, t3, t4, t7);
      if (!t1)
        continue;
      t1 = contact.get$toiCount();
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(6, t8, body, contact, bullet, t2, other, t1, iter, toiContact, toi, toiOther, found, count, ce, t5, t6, t3, t4, t7);
      if (t1 > 10)
        continue;
      ...
      t1 = t2.state;
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(7, t8, body, contact, t1, bullet, t2, other, iter, toiContact, toi, toiOther, found, count, ce, t4, t6, t3, t7, t5);
      if (t1 === 3) {
        t1 = t2.t;
        if (typeof t1 !== 'number')
          return this.solveTimeOfImpactGivenBody$1$bailout(8, t8, body, contact, bullet, t1, t2, other, iter, toiContact, toi, toiOther, found, count, ce, t4, t6, t3, t7, t5);
        t1 = t1 < toi;
      } else
        t1 = false;
      if (t1) {
  ...
  while (true) {
    ...
    if (t11) {
      ...
      $loop$1: {
        ...
        t19 = b.y;
        if (typeof t19 !== 'number')
          return this.solveVelocityConstraints$0$bailout(125, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, a, t3, t4, t5, t15, t6, t2, wA, wB, t7, t8, t1, t19);
        vn2 = t15 + t19;
        if (t17 >= 0 && vn2 >= 0) {
          t3.setFrom$1(t4).subLocal$1(a);
          t5.setFrom$1(c.get$normal()).mulLocal$1(t3.x);
        ...
        t13 = b.y;
        if (typeof t13 !== 'number')
          return this.solveVelocityConstraints$0$bailout(144, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, a, t3, t4, t5, t11, t6, t2, wA, wB, t7, t8, t1, t13);
        t4.set$y(t11 * t13);
        ...
        if (typeof vn1 !== 'number')
          return this.solveVelocityConstraints$0$bailout(165, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, a, t3, t4, t5, t6, t2, wA, t7, wB, t8, t1, vn1);
        vn2 = b.y;
        if (typeof vn2 !== 'number')
          return this.solveVelocityConstraints$0$bailout(166, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, t2, wA, t7, wB, t8, t1, vn1, vn2);
        if (vn1 >= 0 && vn2 >= 0) {
          t3.setFrom$1(t4).subLocal$1(a);
          t5.setFrom$1(c.get$normal()).mulLocal$1(t3.x);
          t6.setFrom$1(c.get$normal()).mulLocal$1(t3.y);
 ...
 solvePositionConstraints$1: function(baumgarte) {
  ...
  while (true) {
    ...
    while (true) {
      t6 = c.get$pointCount();
      if (typeof t6 !== 'number')
        return this.solvePositionConstraints$1$bailout(10, baumgarte, invIB, i, t1, t2, t3, j, minSeparation, c, bodyA, bodyB, t6, t4, invMassA, normal, point, psm, invIA, invMassB);
      if (!(j < t6))
        break;
      psm.initialize$2(c, j);
      separation = psm.separation;
      if (typeof separation !== 'number')
        return this.solvePositionConstraints$1$bailout(11, baumgarte, invIB, i, t1, t2, t3, j, minSeparation, c, bodyA, bodyB, t4, invMassA, normal, point, separation, invIA, psm, invMassB);
      ...
      if (minSeparation !== (minSeparation | 0))
        return this.solvePositionConstraints$1$bailout(12, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, c, bodyA, bodyB, t4, invMassA, normal, point, separation, invIA, psm, invMassB);
      C = $.max(-0.2, $.min(baumgarte * (separation + 0.005), 0));
      t8 = t3.x;
      if (typeof t8 !== 'number')
        return this.solvePositionConstraints$1$bailout(13, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, c, bodyA, bodyB, C, t4, invMassA, normal, point, psm, invIA, t8, invMassB);
      t10 = normal.y;
      if (typeof t10 !== 'number')
        return this.solvePositionConstraints$1$bailout(14, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, c, bodyA, bodyB, C, t4, invMassA, normal, point, psm, invIA, t8, invMassB, t10);
      t8 *= t10;
      t12 = t3.y;
      if (typeof t12 !== 'number')
        return this.solvePositionConstraints$1$bailout(15, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, c, bodyA, bodyB, C, t4, invMassA, normal, t8, psm, invIA, point, invMassB, t12);
      t14 = normal.x;
      if (typeof t14 !== 'number')
        return this.solvePositionConstraints$1$bailout(16, t14, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, c, bodyA, bodyB, C, t4, invMassA, normal, t8, psm, invIA, point, invMassB, t12);
      rnA = t8 - t12 * t14;
      t8 = t4.x;
      if (typeof t8 !== 'number')
        return this.solvePositionConstraints$1$bailout(17, baumgarte, invIB, t8, minSeparation, i, t1, t2, t3, j, c, bodyA, bodyB, C, t4, invMassA, normal, point, psm, invIA, invMassB, rnA);
      t10 = t8 * t10;
      t8 = t4.y;
      if (typeof t8 !== 'number')
        return this.solvePositionConstraints$1$bailout(19, baumgarte, invIB, t10, t8, minSeparation, i, t1, t2, t3, j, c, bodyA, bodyB, C, t4, invMassA, normal, point, psm, invIA, invMassB, rnA);
      rnB = t10 - t8 * t14;
      ...
      t7 = t6.get$angle();
      if (typeof t7 !== 'number')
        return this.solvePositionConstraints$1$bailout(21, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, t6, t7, bodyA, bodyB, c, t4, psm, normal, point, invMassA, invIA, invMassB);
      t9 = t3.x;
      if (typeof t9 !== 'number')
        return this.solvePositionConstraints$1$bailout(22, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, t9, t6, t7, bodyA, bodyB, c, t4, psm, normal, point, invMassA, invIA, invMassB);
      t11 = t1.y;
      if (typeof t11 !== 'number')
        return this.solvePositionConstraints$1$bailout(23, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, t9, t6, t7, bodyA, bodyB, c, t4, psm, normal, t11, point, invIA, invMassA, invMassB);
      t11 = t9 * t11;
      t9 = t3.y;
      if (typeof t9 !== 'number')
        return this.solvePositionConstraints$1$bailout(24, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, t9, t7, bodyA, bodyB, c, t4, t6, t11, psm, normal, point, invIA, invMassA, invMassB);
      t14 = t1.x;
      if (typeof t14 !== 'number')
      ...
      t16 = t6.get$angle();
      if (typeof t16 !== 'number')
        return this.solvePositionConstraints$1$bailout(26, baumgarte, invIB, minSeparation, i, t1, t2, t6, t16, j, t3, c, bodyA, bodyB, t4, psm, normal, point, invMassA, invIA, invMassB);
      t18 = t4.x;
      if (typeof t18 !== 'number')
        return this.solvePositionConstraints$1$bailout(27, baumgarte, invIB, minSeparation, i, t1, t2, t6, t16, j, t3, c, bodyA, bodyB, t4, t18, psm, normal, point, invIA, invMassA, invMassB);
      t20 = t1.y;
      if (typeof t20 !== 'number')
        return this.solvePositionConstraints$1$bailout(28, baumgarte, invIB, minSeparation, i, t1, t2, t6, t16, j, t3, c, bodyA, bodyB, t4, t18, t20, normal, psm, invIA, point, invMassA, invMassB);
      t20 = t18 * t20;
      t18 = t4.y;
      if (typeof t18 !== 'number')
        return this.solvePositionConstraints$1$bailout(29, baumgarte, invIB, minSeparation, i, t1, t2, t6, t16, j, t3, c, bodyA, t20, bodyB, t4, psm, normal, t18, point, invIA, invMassA, invMassB);
      t23 = t1.x;
      if (typeof t23 !== 'number')
        return this.solvePositionConstraints$1$bailout(30, baumgarte, invIB, minSeparation, i, t1, t2, t6, t16, j, t3, c, bodyA, t20, bodyB, t4, psm, normal, t18, t23, invIA, point, invMassA, invMassB);
 ...
 solve$1: function(baumgarte) {
  ...
  while (true) {
    ...
    while (true) {
      t7 = c.get$pointCount();
      if (typeof t7 !== 'number')
        return this.solve$1$bailout0(8, baumgarte, invMassA, invIA, t5, t4, normal, invMassB, point, invIB, j, minSeparation, c, bodyA, bodyB, i, t1, t2, t7, t3);
      if (!(j < t7))
        break;
      t5.initialize$2(c, j);
      ...
      t9 = t3.x;
      if (typeof t9 !== 'number')
        return this.solve$1$bailout0(11, C, invMassA, baumgarte, invIA, t5, t4, normal, invMassB, point, invIB, j, t9, c, bodyA, minSeparation, bodyB, i, t1, t2, t3);
      t11 = normal.y;
      if (typeof t11 !== 'number')
        return this.solve$1$bailout0(12, C, invMassA, baumgarte, invIA, t5, t4, normal, invMassB, point, invIB, j, t9, t11, bodyA, minSeparation, bodyB, c, t1, t2, i, t3);
      t9 *= t11;
      t13 = t3.y;
      if (typeof t13 !== 'number')
      ...
      t9 = t4.y;
      if (typeof t9 !== 'number')
        return this.solve$1$bailout0(17, C, invMassA, baumgarte, invIA, t5, t4, normal, invMassB, point, invIB, rnA, j, t11, bodyA, minSeparation, bodyB, t9, t1, t2, i, t3, c);
      rnB = t11 - t9 * t15;
      ...
      t8 = t7.get$angle();
      if (typeof t8 !== 'number')
        return this.solve$1$bailout0(19, baumgarte, invMassA, invIA, t5, t4, invMassB, normal, point, invIB, j, c, bodyA, minSeparation, bodyB, i, t1, t2, t7, t8, t3);
      t10 = t3.x;
      if (typeof t10 !== 'number')
        return this.solve$1$bailout0(20, baumgarte, invMassA, invIA, t5, t4, invMassB, normal, point, invIB, j, c, bodyA, minSeparation, bodyB, i, t1, t2, t7, t8, t3, t10);
      t12 = t1.y;
      if (typeof t12 !== 'number')
        return this.solve$1$bailout0(21, t12, baumgarte, invMassA, invIA, t5, t4, invMassB, normal, point, invIB, j, c, bodyA, minSeparation, bodyB, i, t1, t2, t7, t8, t3, t10);
      t12 = t10 * t12;
      t10 = t3.y;
      if (typeof t10 !== 'number')
        return this.solve$1$bailout0(22, baumgarte, t10, invMassA, t12, invIA, t5, t4, invMassB, normal, point, invIB, j, c, bodyA, minSeparation, bodyB, i, t1, t2, t7, t8, t3);
      t15 = t1.x;
      if (typeof t15 !== 'number')
      ...
      t17 = t7.get$angle();
      if (typeof t17 !== 'number')
        return this.solve$1$bailout0(24, baumgarte, invMassA, invIA, t5, t4, normal, invMassB, point, invIB, j, c, bodyA, minSeparation, bodyB, i, t7, t17, t1, t2, t3);
      t19 = t4.x;
      if (typeof t19 !== 'number')
        return this.solve$1$bailout0(25, baumgarte, invMassA, invIA, t5, t4, normal, t19, point, invIB, j, c, invMassB, minSeparation, bodyB, bodyA, i, t7, t17, t1, t2, t3);
      t21 = t1.y;
      if (typeof t21 !== 'number')
        return this.solve$1$bailout0(26, baumgarte, invMassA, invIA, t5, t4, normal, t19, t21, invIB, point, j, c, invMassB, minSeparation, bodyB, bodyA, i, t7, t17, t1, t2, t3);
      t21 = t19 * t21;
      t19 = t4.y;
      if (typeof t19 !== 'number')
