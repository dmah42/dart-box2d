...
$$.Collision = {"":"Object;_pool,cache,input,output,results1,results2,incidentEdge>,localTangent,localNormal>,planePoint,tangent,normal>,normal1,v11,v12,clipPoints1,clipPoints2",
 ...
 edgeSeparation$5: function(poly1, xf1, edge1, poly2, xf2) {
  ...
  for (t1 = $.getInterceptor$JSStringJSArray(vertices2), t2 = vertices2.length, i = 0, index = 0, minDot = 99999999999999; i < count2; ++i) {
    ...
    t3 = a.get$x();
    if (t3 !== (t3 | 0))
      return this.edgeSeparation$5$bailout(17, i, edge1, xf1, xf2, normal1Worldx, R1, vertices1, count2, vertices2, R, normal1x, index, minDot, t1, a, t3, normal1y, normal1Worldy);
    t3 *= normal1x;
    t5 = a.get$y();
    if (t5 !== (t5 | 0))
      return this.edgeSeparation$5$bailout(18, i, edge1, xf2, xf1, normal1Worldx, R1, count2, vertices1, vertices2, R, normal1x, index, minDot, t1, normal1Worldy, normal1y, t3, t5);
    dot = t3 + t5 * normal1y;
    if (dot < minDot) {
      minDot = dot;
      index = i;
  ...
  t4 = R.get$col1().get$y();
  if (typeof t4 !== 'number')
    return this.edgeSeparation$5$bailout(20, xf1, xf2, normal1Worldx, R1, vertices2, R, v3, index, t2, t4, t1, normal1Worldy);
  t6 = v3.get$x();
  if (typeof t6 !== 'number')
    return this.edgeSeparation$5$bailout(21, xf1, xf2, normal1Worldx, R1, vertices2, R, v3, index, t2, t4, t6, t1, normal1Worldy);
  t2 += t4 * t6;
  t8 = R.get$col2().get$y();
  if (typeof t8 !== 'number')
    return this.edgeSeparation$5$bailout(22, xf1, xf2, normal1Worldx, R1, vertices2, R, v3, index, t1, normal1Worldy, t2, t8);
  t10 = v3.get$y();
  if (typeof t10 !== 'number')
    return this.edgeSeparation$5$bailout(23, xf1, xf2, normal1Worldx, R1, vertices2, R, v3, index, t1, normal1Worldy, t2, t8, t10);
  v1y = t2 + t8 * t10;
  t2 = xf1.get$position().get$x();
  if (typeof t2 !== 'number')
    return this.edgeSeparation$5$bailout(24, v1y, v3, xf2, t2, index, normal1Worldx, R1, t1, vertices2, normal1Worldy, R);
  t13 = R.get$col1().get$x();
  if (typeof t13 !== 'number')
    return this.edgeSeparation$5$bailout(25, v1y, xf2, t2, t13, normal1Worldx, R1, vertices2, R, v3, index, t1, normal1Worldy);
  t15 = v3.get$x();
  if (typeof t15 !== 'number')
    return this.edgeSeparation$5$bailout(26, v1y, xf2, t2, t13, normal1Worldx, R1, t15, vertices2, R, v3, index, t1, normal1Worldy);
  t2 += t13 * t15;
  t17 = R.get$col2().get$x();
  if (typeof t17 !== 'number')
    return this.edgeSeparation$5$bailout(27, v1y, v3, xf2, index, normal1Worldx, R1, t1, vertices2, t2, t17, normal1Worldy);
  t19 = v3.get$y();
...
$$.Distance = {"":"Object;calls,iters,maxIters,simplex,saveA,saveB,closestPoint,searchDirection,temp,normal>",
 ...
 get$distance: function() {
  return new $.BoundClosure2(this, 'distance$3');
}
};
...
$$.DistanceProxy = {"":"Object;vertices>,count=,radius=",
 ...
 getSupport$1: function(direction) {
  ...
  t6 = direction.get$x();
  if (typeof t6 !== 'number')
    return this.getSupport$1$bailout(2, direction, t2, t4, t6, t1, t3);
  t4 *= t6;
  t3 = t3.get$y();
  if (typeof t3 !== 'number')
  ...
  while (true) {
    ...
    t3 = t3.get$y();
    if (typeof t3 !== 'number')
      return this.getSupport$1$bailout(8, direction, t2, bestIndex, bestValue, i, t3, t4, t1);
    value = t4 + t3 * t9;
    if (value > bestValue) {
      bestValue = value;
      bestIndex = i;
...
$$.TimeOfImpact = {"":"Object;cache,distanceInput,xfA,xfB,distanceOutput,fcn,indexes,sweepA>,sweepB>,pool",
 timeOfImpact$2: function(output, input) {
  ...
  for (t1 = this.fcn, t2 = this.indexes, t5 = t2.length, t6 = target + 0.00125, t7 = target - 0.00125, t8 = this.distanceOutput, t9 = this.xfA, t11 = this.xfB, t13 = this.pool, t14 = 0, iter = 0; true;) {
    ...
    t15 = t8.distance;
    if (typeof t15 !== 'number')
      return this.timeOfImpact$2$bailout(5, output, t11, t1, target, t2, t7, t13, proxyA, proxyB, t15, t3, t4, t6, t8, t10, t14, t12, iter, tMax, t5, t9);
    if (t15 <= 0) {
      output.set$state(2);
      output.set$t(0);
      break;
    ...
    for (t20 = tMax, pushBackIter = 0; done = false, true;) {
      ...
      if (typeof s1 !== 'number')
        return this.timeOfImpact$2$bailout(8, output, t20, pushBackIter, t11, s2, t13, proxyA, proxyB, t8, tMax, t1, target, t2, t7, s1, t3, t4, t6, t10, t14, t12, iter, t5, t9);
      if (s1 < t7) {
        output.set$state(1);
        output.set$t(t14);
        done = true;
      ...
      for (a2 = t20, a1 = t14, rootIterCount = 0; true;) {
        ...
        if (typeof s !== 'number')
          return this.timeOfImpact$2$bailout(9, output, t20, pushBackIter, t11, t9, t13, s2, s1, proxyB, proxyA, t8, t5, tMax, t1, target, t2, t7, t, t3, t4, t6, s, t10, t14, t12, iter, rootIterCount, a1, a2);
        t15 = $.CONSTANT0.abs$0(s - target);
        if (typeof t15 !== 'number')
          return this.timeOfImpact$2$bailout(10, output, t20, pushBackIter, t11, t9, t13, s2, s1, proxyB, proxyA, t8, t5, tMax, t1, target, t2, t7, t, t3, t4, t6, s, t10, t14, t15, iter, t12, rootIterCount, a1, a2);
        if (t15 < 0.00125) {
          t20 = t;
          break;
        }
        ...
        if (a1 !== (a1 | 0))
          return this.timeOfImpact$2$bailout(11, output, t20, pushBackIter, t11, a1, a2, s2, s1, t13, proxyA, proxyB, t8, tMax, t1, target, t2, t7, t3, t4, t6, t10, t14, t12, iter, rootIterCount, t5, t9);
        ++rootIterCount;
        t16 = $.TimeOfImpact_toiRootIters;
        if (typeof t16 !== 'number')
          return this.timeOfImpact$2$bailout(12, output, t20, pushBackIter, t11, a1, a2, s2, s1, rootIterCount, t16, proxyA, t13, proxyB, t8, tMax, t1, target, t2, t7, t3, t4, t6, t10, t14, t12, iter, t5, t9);
 ...
 get$timeOfImpact: function() {
  return new $.BoundClosure3(this, 'timeOfImpact$2');
},
...
$$.PolygonShape = {"":"Shape;centroid>,vertices>,normals>,vertexCount>,type,radius",
 getSupport$1: function(d) {
  ...
  t8 = d.get$x();
  if (typeof t8 !== 'number')
    return this.getSupport$1$bailout0(3, d, t3, t5, t6, t8, t1);
  t6 *= t8;
  t5 = t5.get$y();
  if (typeof t5 !== 'number')
  ...
  while (true) {
    t2 = this.vertexCount;
    if (typeof t2 !== 'number')
      return this.getSupport$1$bailout0(6, d, t3, bestIndex, bestValue, i, t1, t2);
    if (!(i < t2))
      break;
    if (i >= t4)
      throw $.ioore(i);
    ...
    t2 = t2.get$y();
    if (typeof t2 !== 'number')
      return this.getSupport$1$bailout0(9, d, t3, t5, t2, bestValue, bestIndex, i, t1);
    value = t5 + t2 * t11;
    if (value > bestValue) {
      bestValue = value;
      bestIndex = i;
...
$$.Island = {"":"Object;listener,bodies>,contacts,joints,positions,velocities,bodyCount>,jointCount,contactCount>,bodyCapacity,contactCapacity,jointCapacity,positionIterationCount,_contactSolver,_translation,impulse",
 ...
 solve$3: function(step, gravity, allowSleep) {
  ...
  while (true) {
    t1 = this.contactCount;
    if (typeof t1 !== 'number')
      return this.solve$3$bailout(21, i2, step, allowSleep, t1, i1);
    t3 = i2 < t1;
    t4 = this.contacts;
    if (typeof t4 !== 'string' && (typeof t4 !== 'object' || t4 === null || t4.constructor !== Array && !t4.is$JavaScriptIndexingBehavior))
      return this.solve$3$bailout(22, i2, step, allowSleep, t3, t4, i1);
    if (!t3)
      break;
    if (i2 >= t4.length)
      throw $.ioore(i2);
    ...
    t1 = bodyA.get$type();
    if (typeof t1 !== 'number')
      return this.solve$3$bailout(24, i2, bodyB, allowSleep, t1, step, i1);
    if (!(t1 === 0)) {
      t1 = bodyB.get$type();
      if (typeof t1 !== 'number')
        return this.solve$3$bailout(25, i2, step, allowSleep, t1, i1);
      nonStatic = !(t1 === 0);
    } else
      nonStatic = false;
    if (nonStatic) {
      ...
      t1 = this.contacts;
      if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior))
        return this.solve$3$bailout(26, i2, i1, allowSleep, step, t1);
      if (i1 >= t1.length)
        throw $.ioore(i1);
      temp = t1[i1];
      if (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array || !!t1.immutable$list) && !t1.is$JavaScriptIndexingBehavior)
        return this.solve$3$bailout(27, i2, step, allowSleep, i1, temp, t1);
      t4 = t1.length;
      if (i2 >= t4)
        throw $.ioore(i2);
      t5 = t1[i2];
      ...
      t1[i1] = t5;
      if (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array || !!t1.immutable$list) && !t1.is$JavaScriptIndexingBehavior)
        return this.solve$3$bailout(28, i2, step, allowSleep, i1, temp, t1);
      if (i2 >= t1.length)
        throw $.ioore(i2);
      t1[i2] = temp;
    }
  ...
  while (true) {
    ...
    while (true) {
      t1 = this.jointCount;
      if (typeof t1 !== 'number')
        return this.solve$3$bailout(32, step, j, i, t2, allowSleep, t1);
      if (!(j < t1))
        break;
      t1 = this.joints;
      if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior))
  ...
  while (true) {
    ...
    c$0: {
      ...
      t4 = b.get$type();
      if (typeof t4 !== 'number')
        return this.solve$3$bailout(36, step, t3, allowSleep, t4, i, temp, t1, b, t2);
      if (t4 === 0)
        break c$0;
      ...
      t4 = t1.x;
      if (typeof t4 !== 'number')
        return this.solve$3$bailout(37, step, t3, allowSleep, t2, t4, i, temp, t1, b);
      t4 *= t4;
      t6 = t1.y;
      if (typeof t6 !== 'number')
        return this.solve$3$bailout(38, step, t3, allowSleep, t2, t4, i, t6, temp, t1, b);
      if (t4 + t6 * t6 > 4) {
        t4 = t3.get$length(t1);
        if (typeof t4 !== 'number')
          throw $.iae(t4);
      ...
      t6 = t5.get$angle();
      if (typeof t6 !== 'number')
        return this.solve$3$bailout(42, t5, t6, t3, step, allowSleep, i, t2, temp, t1, b);
      t8 = step.get$dt();
      if (typeof t8 !== 'number')
        return this.solve$3$bailout(43, t5, t6, t8, step, t3, allowSleep, i, t2, temp, t1, b);
      t10 = b.get$angularVelocity();
      if (typeof t10 !== 'number')
        return this.solve$3$bailout(44, t5, t6, t8, t10, allowSleep, i, step, t1, b, t2, t3, temp);
  ...
  while (true) {
    ...
    while (true) {
      t1 = this.jointCount;
      if (typeof t1 !== 'number')
        return this.solve$3$bailout(46, step, t2, allowSleep, i, j, contactsOkay, jointsOkay, t1);
      if (!(j < t1))
        break;
      t1 = this.joints;
      if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior))
        return this.solve$3$bailout(47, t1, step, allowSleep, t2, i, j, contactsOkay, jointsOkay);
      if (j >= t1.length)
        throw $.ioore(j);
    ...
    while (true) {
      ...
      c$0: {
        ...
        if ((t1 & 4) !== 0) {
          t1 = b.get$angularVelocity();
          if (typeof t1 !== 'number')
            return this.solve$3$bailout(53, step, b, i, t1, minSleepTime);
          t3 = b.get$angularVelocity();
          if (typeof t3 !== 'number')
            return this.solve$3$bailout(54, step, b, i, t3, t1, minSleepTime);
          if (!(t1 * t3 > 0.0012184696791468343)) {
            ...
            t1 = t1.get$y();
            if (typeof t1 !== 'number')
              return this.solve$3$bailout(57, step, t2, t5, b, i, minSleepTime, t1);
            t2 = t2.get$y();
            if (typeof t2 !== 'number')
              return this.solve$3$bailout(58, step, t5, b, t2, i, minSleepTime, t1);
            t8 = t5 + t1 * t2 > 0.0001;
            t1 = t8;
          } else
            t1 = true;
 ...
 report$1: function(constraints) {
  var t1, t2, t3, t4, t5, i, t6, c, cc, j, t7, t8;
  ...
  for (t1 = this.impulse, t2 = t1.normalImpulses, t3 = t2.length, t4 = t1.tangentImpulses, t5 = t4.length, i = 0; $.ltB(i, this.contactCount); ++i) {
    t6 = this.contacts;
    c = $.getInterceptor$JSStringJSArray(t6).operator$index$1(t6, i);
    if (i >= constraints.length)
      throw $.ioore(i);
    cc = constraints[i];
    for (j = 0; $.ltB(j, cc.get$pointCount()); ++j) {
      t6 = cc.get$points();
      t7 = $.getInterceptor$JSStringJSArray(t6).operator$index$1(t6, j).get$normalImpulse();
      if (j >= t3)
        throw $.ioore(j);
      t2[j] = t7;
      t7 = cc.get$points();
      t8 = $.getInterceptor$JSStringJSArray(t7).operator$index$1(t7, j).get$tangentImpulse();
      if (j >= t5)
        throw $.ioore(j);
      t4[j] = t8;
    }
 ...
 report$1$bailout: function(state0, constraints) {
  var t1, t2, t3, t4, t5, t6, i, t7, c, cc, j, t8, t9;
  if (this.listener == null)
    return;
  for (t1 = this.impulse, t2 = t1.normalImpulses, t3 = t2.length, t4 = t1.tangentImpulses, t5 = t4.length, t6 = $.getInterceptor$JSStringJSArray(constraints), i = 0; $.ltB(i, this.contactCount); ++i) {
    t7 = this.contacts;
    c = $.getInterceptor$JSStringJSArray(t7).operator$index$1(t7, i);
    cc = t6.operator$index$1(constraints, i);
    for (j = 0; $.ltB(j, cc.get$pointCount()); ++j) {
      t7 = cc.get$points();
      t8 = $.getInterceptor$JSStringJSArray(t7).operator$index$1(t7, j).get$normalImpulse();
      if (j >= t3)
        throw $.ioore(j);
      t2[j] = t8;
      t8 = cc.get$points();
      t9 = $.getInterceptor$JSStringJSArray(t8).operator$index$1(t8, j).get$tangentImpulse();
      if (j >= t5)
        throw $.ioore(j);
      t4[j] = t9;
    }
...
$$.World = {"":"Object;_flags,_contactManager,_bodyList,_jointList,_bodyCount,_jointCount,_gravity,_allowSleep,_debugDraw,_fixtureDestructionListener,_jointDestructionListener,_pool,_inverseTimestep,_warmStarting,_continuousPhysics,_contactStacks,center>,axis,timestep,cA,cB,wqwrapper,toiInput,toiOutput,backup,toiSolver,contacts,island,stack",
 ...
 solveTimeOfImpactGivenBody$1: function(body) {
  var bullet, t2, t3, t4, t5, t6, t7, t8, toiOther, iter, toiContact, toi, ce, found, count, other, type, t1, t10, contact, fixtureA, fixtureB, bodyA, bodyB, i;
  ...
  do {
    for (ce = body.get$contactList(), found = false, count = 0; !(ce == null); ce = ce.get$next()) {
      ...
      if (typeof type !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(2, t8, body, bullet, t2, other, type, iter, toiOther, t3, count, t4, found, ce, toiContact, toi, t7, t6, t5);
      if (bullet) {
        t1 = other.get$flags();
        if (t1 !== (t1 | 0))
          return this.solveTimeOfImpactGivenBody$1$bailout(3, t8, body, bullet, t2, other, type, iter, toiOther, t1, t3, found, count, ce, t4, toiContact, toi, t7, t6, t5);
        if ((t1 & 64) === 0)
          continue;
        if (!(type === 0)) {
          t1 = ce.get$contact().get$flags();
          if (t1 !== (t1 | 0))
            return this.solveTimeOfImpactGivenBody$1$bailout(4, t8, body, bullet, t1, t2, other, iter, toiOther, t3, t4, count, found, ce, toiContact, toi, t7, t6, t5);
          t10 = (t1 & 16) !== 0;
          t1 = t10;
        } else
          t1 = false;
      ...
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(5, t8, body, contact, t1, bullet, t2, other, iter, toiOther, t3, found, count, ce, t4, toiContact, toi, t7, t6, t5);
      if (!t1)
        continue;
      t1 = contact.get$toiCount();
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(6, t8, body, contact, bullet, t2, other, t1, iter, toiOther, t3, found, count, ce, t4, toiContact, toi, t7, t6, t5);
      if (t1 > 10)
        continue;
      ...
      t1 = t2.state;
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(7, t8, body, contact, t1, bullet, t2, other, iter, t3, toiOther, found, count, t4, ce, t5, toiContact, toi, t7, t6);
      if (t1 === 3) {
        t1 = t2.t;
        if (typeof t1 !== 'number')
          return this.solveTimeOfImpactGivenBody$1$bailout(8, t8, body, contact, t3, bullet, t1, t2, other, iter, toiOther, found, count, t4, ce, t5, toiContact, toi, t7, t6);
        t1 = t1 < toi;
      } else
        t1 = false;
      if (t1) {
        toi = t2.t;
        if (toi !== (toi | 0))
          return this.solveTimeOfImpactGivenBody$1$bailout(9, t8, body, contact, bullet, t2, toi, other, iter, t3, count, t4, ce, t5, t6, t7);
        toiOther = other;
        toiContact = contact;
        found = true;
      }
  ...
  while (true) {
    ...
    c$0: {
      ...
      if (typeof type !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(12, body, count, toiOther, ce, toiContact, type);
      if (type === 2)
        break c$0;
      contact = ce.get$contact();
      t1 = contact.get$enabled();
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(13, body, count, contact, t1, ce, toiOther, toiContact);
      if (!t1)
        break c$0;
      fixtureA = contact.get$fixtureA();
      fixtureB = contact.get$fixtureB();
 ...
 solveTimeOfImpactGivenBody$1$bailout: function(state0, env0, env1, env2, env3, env4, env5, env6, env7, env8, env9, env10, env11, env12, env13, env14, env15, env16, env17, env18) {
  ...
  switch (state0) {
    ...
    case 16:
      state0 = 0;
    case 17:
      var bullet, body, t2, t3, t4, t5, t6, t7, t8, toiOther, iter, toiContact, toi, ce, found, count, other, type, t1, t10, contact, fixtureA, fixtureB, bodyA, bodyB, i;
 ...
 update$1: function(listener) {
  ...
  if (sensor) {
    ...
    while (true) {
      ...
      if (typeof t5 !== 'number')
        return this.update$1$bailout(5, listener, bodyA, wasTouching, bodyB, t1, t5, touching, t2, i, t3, sensor);
      if (!(i < t5))
        break;
      t4 = t4.get$points();
      if (typeof t4 !== 'string' && (typeof t4 !== 'object' || t4 === null || t4.constructor !== Array && !t4.is$JavaScriptIndexingBehavior))
        return this.update$1$bailout(6, listener, bodyA, wasTouching, bodyB, sensor, t1, touching, i, t3, t4, t2);
      if (i >= t4.length)
        throw $.ioore(i);
      mp2 = t4[i];
      ...
      while (true) {
        t4 = t1.pointCount;
        if (typeof t4 !== 'number')
          return this.update$1$bailout(7, listener, bodyA, bodyB, t4, t2, mp2, wasTouching, id2, t1, j, touching, i, t3, sensor);
        if (!(j < t4))
          break;
        if (j >= t3)
          throw $.ioore(j);
...
$$.ContactSolver = {"":"Object;constraints>,constraintCount,worldManifold,tangent,temp1,temp2,P,dv,dv1,dv2,x>,d,P1,P2,psolver,rA>,rB>",
 init$3: function(contacts, contactCount, impulseRatio) {
  ...
  for (t1 = this.worldManifold, t2 = t1.points, t3 = t2.length, t4 = this.tangent, t5 = this.temp2, t6 = this.temp1, t7 = $.getInterceptor$JSStringJSArray(contacts), t8 = t1.normal, i = 0; $.ltB(i, this.constraintCount); ++i) {
    ...
    if (typeof wA !== 'number')
      return this.init$3$bailout(3, restitution, vA, vB, impulseRatio, wA, i, t1, t2, contacts, t7, t4, radiusA, radiusB, bodyA, bodyB, t3, manifold, t5, t8, friction, t6);
    wB = bodyB.get$angularVelocity();
    if (typeof wB !== 'number')
      return this.init$3$bailout(4, restitution, vA, vB, impulseRatio, wB, i, wA, t2, t1, t7, t4, contacts, radiusA, radiusB, bodyA, bodyB, t3, manifold, t5, t8, friction, t6);
 ...
 solvePositionConstraints$1: function(baumgarte) {
  ...
  while (true) {
    ...
    if (typeof t5 !== 'number')
      return this.solvePositionConstraints$1$bailout(1, baumgarte, t5, minSeparation, i, psm, t1, t2, point, t4, t3, normal);
    if (!(i < t5))
      break;
    t5 = this.constraints;
    if (i >= t5.length)
    ...
    t5 = bodyA.get$mass();
    if (typeof t5 !== 'number')
      return this.solvePositionConstraints$1$bailout(2, baumgarte, minSeparation, i, t1, t2, t3, bodyA, bodyB, t5, c, t4, psm, normal, point);
    t7 = bodyA.get$invMass();
    if (typeof t7 !== 'number')
      return this.solvePositionConstraints$1$bailout(3, baumgarte, minSeparation, i, t1, t2, t3, bodyA, bodyB, t5, t7, t4, c, psm, normal, point);
    invMassA = t5 * t7;
    t7 = bodyA.get$invInertia();
    if (typeof t7 !== 'number')
      return this.solvePositionConstraints$1$bailout(5, baumgarte, minSeparation, i, t1, t2, t3, bodyA, bodyB, t4, invMassA, psm, normal, t5, point, c, t7);
    invIA = t5 * t7;
    t7 = bodyB.get$mass();
    if (typeof t7 !== 'number')
      return this.solvePositionConstraints$1$bailout(6, baumgarte, minSeparation, i, t1, t2, t3, bodyA, bodyB, t4, invMassA, psm, normal, invIA, point, c, t7);
    t10 = bodyB.get$invMass();
    if (typeof t10 !== 'number')
      return this.solvePositionConstraints$1$bailout(7, baumgarte, minSeparation, i, t1, t2, t3, bodyA, bodyB, t4, invMassA, psm, normal, invIA, point, c, t10, t7);
    invMassB = t7 * t10;
    t10 = bodyB.get$invInertia();
    if (typeof t10 !== 'number')
      return this.solvePositionConstraints$1$bailout(9, baumgarte, t10, minSeparation, i, t1, t2, t3, bodyA, bodyB, t4, invMassA, psm, normal, invIA, point, c, invMassB, t7);
    invIB = t7 * t10;
    ...
    while (true) {
      t6 = c.get$pointCount();
      if (typeof t6 !== 'number')
        return this.solvePositionConstraints$1$bailout(10, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, t6, bodyA, bodyB, t4, invMassA, psm, normal, invIA, point, c, invMassB);
      if (!(j < t6))
        break;
      psm.initialize$2(c, j);
      separation = psm.separation;
      if (typeof separation !== 'number')
        return this.solvePositionConstraints$1$bailout(11, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, bodyA, bodyB, t4, invMassA, psm, normal, invIA, separation, c, point, invMassB);
      ...
      if (minSeparation !== (minSeparation | 0))
        return this.solvePositionConstraints$1$bailout(12, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, bodyA, bodyB, t4, invMassA, psm, normal, invIA, separation, c, point, invMassB);
      C = $.max(-0.2, $.min(baumgarte * (separation + 0.005), 0));
      t8 = t3.x;
      if (typeof t8 !== 'number')
        return this.solvePositionConstraints$1$bailout(13, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, bodyA, bodyB, C, t4, invMassA, psm, normal, invIA, point, c, invMassB, t8);
      t10 = normal.y;
      if (typeof t10 !== 'number')
        return this.solvePositionConstraints$1$bailout(14, t10, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, bodyA, bodyB, C, t4, invMassA, psm, normal, invIA, point, c, invMassB, t8);
      t8 *= t10;
      t12 = t3.y;
      if (typeof t12 !== 'number')
        return this.solvePositionConstraints$1$bailout(15, baumgarte, t12, invIB, minSeparation, i, t1, t2, t3, j, bodyA, bodyB, C, t4, invMassA, t8, normal, invIA, psm, c, point, invMassB);
      t14 = normal.x;
      if (typeof t14 !== 'number')
        return this.solvePositionConstraints$1$bailout(16, baumgarte, t12, invIB, t14, minSeparation, i, t1, t2, t3, j, bodyA, bodyB, C, t4, invMassA, t8, normal, invIA, psm, c, point, invMassB);
      rnA = t8 - t12 * t14;
      t8 = t4.x;
      if (typeof t8 !== 'number')
        return this.solvePositionConstraints$1$bailout(17, baumgarte, invIB, t8, minSeparation, i, t1, t2, t3, j, bodyA, bodyB, C, t4, invMassA, psm, normal, invIA, point, c, invMassB, rnA);
      t10 = t8 * t10;
      t8 = t4.y;
      if (typeof t8 !== 'number')
        return this.solvePositionConstraints$1$bailout(19, baumgarte, invIB, t10, minSeparation, t8, i, t1, t2, t3, j, bodyA, bodyB, C, t4, invMassA, psm, normal, invIA, point, c, invMassB, rnA);
      rnB = t10 - t8 * t14;
      ...
      t7 = t6.get$angle();
      if (typeof t7 !== 'number')
        return this.solvePositionConstraints$1$bailout(21, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, t6, t7, bodyA, bodyB, t4, invMassA, psm, normal, invIA, point, c, invMassB);
      t9 = t3.x;
      if (typeof t9 !== 'number')
        return this.solvePositionConstraints$1$bailout(22, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, t9, t7, bodyA, bodyB, t6, t4, invMassA, psm, normal, invIA, point, c, invMassB);
      t11 = t1.y;
      if (typeof t11 !== 'number')
        return this.solvePositionConstraints$1$bailout(23, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, t6, t7, bodyA, bodyB, t11, t9, t4, invMassA, psm, normal, invIA, point, c, invMassB);
      t11 = t9 * t11;
      t9 = t3.y;
      if (typeof t9 !== 'number')
        return this.solvePositionConstraints$1$bailout(24, baumgarte, invIB, minSeparation, i, t1, t2, c, t3, j, t6, t7, bodyA, bodyB, t9, t4, t11, psm, normal, invIA, point, invMassA, invMassB);
      t14 = t1.x;
      if (typeof t14 !== 'number')
        return this.solvePositionConstraints$1$bailout(25, baumgarte, minSeparation, i, t6, t7, bodyA, bodyB, c, t11, psm, normal, invIA, point, invMassA, invMassB, invIB, t1, t2, t3, j, t9, t14, t4);
      ...
      t16 = t6.get$angle();
      if (typeof t16 !== 'number')
        return this.solvePositionConstraints$1$bailout(26, baumgarte, invIB, minSeparation, i, t1, t2, t6, t16, t3, j, bodyA, bodyB, t4, invMassA, psm, normal, point, invIA, c, invMassB);
      t18 = t4.x;
      if (typeof t18 !== 'number')
        return this.solvePositionConstraints$1$bailout(27, baumgarte, invIB, minSeparation, i, t1, t2, t6, t16, t3, j, bodyA, bodyB, t4, invMassA, t18, psm, normal, point, c, invIA, invMassB);
      t20 = t1.y;
      if (typeof t20 !== 'number')
        return this.solvePositionConstraints$1$bailout(28, baumgarte, invIB, invIA, minSeparation, i, t1, t2, t6, t16, t3, j, bodyA, bodyB, t4, invMassA, t18, t20, normal, psm, c, point, invMassB);
      t20 = t18 * t20;
      t18 = t4.y;
      if (typeof t18 !== 'number')
        return this.solvePositionConstraints$1$bailout(29, baumgarte, invIB, minSeparation, i, t1, t2, t6, t16, t3, j, bodyA, t20, bodyB, t4, invMassA, psm, normal, t18, point, c, invIA, invMassB);
      t23 = t1.x;
      if (typeof t23 !== 'number')
        return this.solvePositionConstraints$1$bailout(30, baumgarte, invIB, invIA, minSeparation, i, t1, t2, t6, t16, t3, j, bodyA, t20, bodyB, t4, invMassA, psm, normal, t18, t23, c, point, invMassB);
...
$$.TimeOfImpactSolver = {"":"Object;constraints>,count=,toiBody,psm,rA>,rB>,P,temp",
 ...
 solve$1: function(baumgarte) {
  ...
  while (true) {
    t6 = this.count;
    if (typeof t6 !== 'number')
      return this.solve$1$bailout0(1, baumgarte, t6, minSeparation, t5, t4, normal, point, t1, t2, i, t3);
    if (!(i < t6))
      break;
    t6 = this.constraints;
    if (i >= t6.length)
    ...
    if (typeof massA !== 'number')
      return this.solve$1$bailout0(2, baumgarte, c, minSeparation, t5, t4, normal, point, i, bodyA, bodyB, massA, t1, t2, t3);
    massB = bodyB.get$mass();
    if (typeof massB !== 'number')
      return this.solve$1$bailout0(3, baumgarte, c, minSeparation, t5, t4, normal, point, i, bodyA, bodyB, massA, massB, t1, t2, t3);
    ...
    if (typeof t6 !== 'number')
      return this.solve$1$bailout0(4, baumgarte, t3, c, minSeparation, t5, t4, normal, point, i, bodyA, bodyB, t1, t2, massA, massB, t6);
    invMassA = massA * t6;
    t6 = bodyA.get$invInertia();
    if (typeof t6 !== 'number')
      return this.solve$1$bailout0(5, baumgarte, invMassA, t6, c, minSeparation, t5, t4, normal, point, i, bodyA, bodyB, t1, t2, massA, massB, t3);
    invIA = massA * t6;
    t6 = bodyB.get$invMass();
    if (typeof t6 !== 'number')
      return this.solve$1$bailout0(6, baumgarte, invMassA, c, invIA, t6, minSeparation, t5, t4, normal, point, i, bodyA, bodyB, t1, t2, massB, t3);
    invMassB = massB * t6;
    t6 = bodyB.get$invInertia();
    if (typeof t6 !== 'number')
      return this.solve$1$bailout0(7, baumgarte, invMassA, c, invIA, minSeparation, invMassB, t4, normal, t5, point, i, bodyA, bodyB, t6, t1, t2, massB, t3);
    invIB = massB * t6;
    ...
    while (true) {
      t7 = c.get$pointCount();
      if (typeof t7 !== 'number')
        return this.solve$1$bailout0(8, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, point, t5, i, bodyA, bodyB, j, minSeparation, t7, t1, t2, t3);
      if (!(j < t7))
        break;
      t5.initialize$2(c, j);
      separation = t5.separation;
      if (typeof separation !== 'number')
        return this.solve$1$bailout0(9, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, point, separation, i, bodyA, bodyB, t5, j, minSeparation, t1, t2, t3);
      t3.setFrom$1(point).subLocal$1(bodyA.get$sweep().get$center());
      t4.setFrom$1(point).subLocal$1(bodyB.get$sweep().get$center());
      minSeparation = $.min(minSeparation, separation);
      if (minSeparation !== (minSeparation | 0))
        return this.solve$1$bailout0(10, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, point, separation, i, bodyA, minSeparation, bodyB, t5, j, t1, t2, t3);
      C = $.max(-0.2, $.min(baumgarte * (separation + 0.005), 0));
      t9 = t3.x;
      if (typeof t9 !== 'number')
        return this.solve$1$bailout0(11, C, invMassA, baumgarte, invIA, c, invMassB, t4, normal, invIB, point, t5, i, bodyA, minSeparation, bodyB, t9, j, t1, t2, t3);
      t11 = normal.y;
      if (typeof t11 !== 'number')
        return this.solve$1$bailout0(12, C, invMassA, baumgarte, invIA, c, invMassB, t4, normal, invIB, point, t5, i, bodyA, minSeparation, bodyB, t9, t11, j, t1, t2, t3);
      t9 *= t11;
      t13 = t3.y;
      if (typeof t13 !== 'number')
        return this.solve$1$bailout0(13, C, invMassA, baumgarte, invIA, t9, c, invMassB, t4, normal, invIB, point, t5, i, bodyA, minSeparation, bodyB, t13, j, t1, t2, t3);
      t15 = normal.x;
      if (typeof t15 !== 'number')
        return this.solve$1$bailout0(14, C, invMassA, baumgarte, invIA, t9, c, invMassB, t4, normal, invIB, point, t5, i, bodyA, minSeparation, bodyB, t13, t15, j, t1, t2, t3);
      rnA = t9 - t13 * t15;
      t9 = t4.x;
      if (typeof t9 !== 'number')
        return this.solve$1$bailout0(15, C, invMassA, baumgarte, invIA, c, invMassB, t4, normal, invIB, rnA, point, t5, i, bodyA, minSeparation, bodyB, j, t9, t1, t2, t3);
      t11 = t9 * t11;
      t9 = t4.y;
      if (typeof t9 !== 'number')
        return this.solve$1$bailout0(17, C, invMassA, baumgarte, invIA, c, invMassB, t4, normal, invIB, rnA, point, t5, i, t11, bodyA, minSeparation, bodyB, j, t9, t1, t2, t3);
      rnB = t11 - t9 * t15;
      ...
      t8 = t7.get$angle();
      if (typeof t8 !== 'number')
        return this.solve$1$bailout0(19, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, point, t5, i, bodyA, minSeparation, bodyB, j, t1, t2, t7, t8, t3);
      t10 = t3.x;
      if (typeof t10 !== 'number')
        return this.solve$1$bailout0(20, baumgarte, t10, invMassA, c, invIA, invMassB, t4, normal, invIB, point, t5, i, bodyA, minSeparation, bodyB, j, t1, t2, t7, t8, t3);
      t12 = t1.y;
      if (typeof t12 !== 'number')
        return this.solve$1$bailout0(21, baumgarte, t10, t12, c, invIA, invMassB, t4, normal, invIB, invMassA, point, t5, i, bodyA, minSeparation, bodyB, j, t1, t2, t7, t8, t3);
      t12 = t10 * t12;
      t10 = t3.y;
      if (typeof t10 !== 'number')
        return this.solve$1$bailout0(22, baumgarte, invMassA, t12, invIA, t10, invMassB, t4, c, invIB, point, normal, t5, i, bodyA, minSeparation, bodyB, j, t1, t2, t7, t8, t3);
      t15 = t1.x;
      if (typeof t15 !== 'number')
        return this.solve$1$bailout0(23, baumgarte, t10, t15, t4, i, bodyA, minSeparation, bodyB, t7, t8, invMassA, t12, invIA, c, invMassB, t5, normal, invIB, point, j, t1, t2, t3);
      ...
      t17 = t7.get$angle();
      if (typeof t17 !== 'number')
        return this.solve$1$bailout0(24, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, point, t5, i, bodyA, minSeparation, bodyB, j, t7, t17, t1, t2, t3);
      t19 = t4.x;
      if (typeof t19 !== 'number')
        return this.solve$1$bailout0(25, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, t19, point, t5, i, bodyA, minSeparation, bodyB, j, t7, t17, t1, t2, t3);
      t21 = t1.y;
      if (typeof t21 !== 'number')
        return this.solve$1$bailout0(26, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, t21, point, t19, i, t5, minSeparation, bodyB, bodyA, j, t7, t17, t1, t2, t3);
      t21 = t19 * t21;
      t19 = t4.y;
      if (typeof t19 !== 'number')
        return this.solve$1$bailout0(27, baumgarte, invMassA, t3, c, invIA, invMassB, t4, normal, invIB, point, t19, t5, i, bodyA, minSeparation, bodyB, j, t7, t17, t1, t2, t21);
      t24 = t1.x;
      if (typeof t24 !== 'number')
        return this.solve$1$bailout0(28, baumgarte, t21, t4, i, t19, t24, bodyA, minSeparation, bodyB, invMassA, c, invIA, invMassB, t5, normal, invIB, point, j, t7, t17, t1, t2, t3);
...
$.Collections_filter = function(source, destination, f) {
  var t1, t2;
  for (t1 = $.CONSTANT2.iterator$0(source); t1.get$hasNext() === true;) {
    t2 = t1.next$0();
    if (f.call$1(t2) === true)
      destination.push(t2);
  }
