...
$$.Collision = {"":"Object;_pool,cache,input,output,results1,results2,incidentEdge>,localTangent,localNormal>,planePoint,tangent,normal>,normal1,v11,v12,clipPoints1,clipPoints2",
 ...
 edgeSeparation$5: function(poly1, xf1, edge1, poly2, xf2) {
  ...
  if (typeof t1 !== 'number')
    return this.edgeSeparation$5$bailout(24, index, v1y, v3, xf2, t1, normal1Worldx, R1, vertices2, normal1Worldy, R);
  t12 = R.get$col1().get$x();
  if (typeof t12 !== 'number')
    return this.edgeSeparation$5$bailout(25, index, v1y, v3, xf2, t1, t12, normal1Worldx, R1, vertices2, normal1Worldy, R);
  t14 = v3.get$x();
  ...
  if (typeof t16 !== 'number')
    return this.edgeSeparation$5$bailout(27, index, v1y, v3, xf2, normal1Worldx, R1, normal1Worldy, vertices2, t16, t1);
  t18 = v3.get$y();
  if (typeof t18 !== 'number')
    return this.edgeSeparation$5$bailout(28, index, v1y, xf2, normal1Worldx, R1, normal1Worldy, vertices2, t16, t1, t18);
  v1x = t1 + t16 * t18;
 ...
 findIncidentEdge$6: function(c, poly1, xf1, edge1, poly2, xf2) {
  var normals1, count2, vertices2, normals2, t3, t4, t5, i, index, minDot, t1, dot, i2;
  poly1.get$vertexCount();
  normals1 = poly1.get$normals();
  count2 = poly2.get$vertexCount();
  if (typeof count2 !== 'number')
 ...
 findIncidentEdge$6$bailout: function(state0, env0, env1, env2, env3, env4, env5, env6, env7) {
  ...
  switch (state0) {
    ...
    case 1:
      ...
      normals2 = poly2.get$normals();
    case 2:
      var normals1, count2, xf2, poly2, edge1, xf1, c, vertices2, normals2, t3, t4, t5, i, index, minDot, t1, dot, i2;
      state0 = 0;
      t3 = xf1.get$rotation();
      t4 = $.index(normals1, edge1);
      t5 = this.normal1;
      $.Matrix22_mulMatrixAndVectorToOut(t3, t4, t5);
      $.Matrix22_mulTransMatrixAndVectorToOut(xf2.get$rotation(), t5, t5);
      for (i = 0, index = 0, minDot = 99999999999999; $.ltB(i, count2); ++i) {
        t1 = $.index(normals2, i);
        dot = $.add($.mul(t5.x, t1.get$x()), $.mul(t5.y, t1.get$y()));
        if ($.ltB(dot, minDot)) {
          minDot = dot;
 ...
 collidePolygons$5: function(manifold, polyA, xfA, polyB, xfB) {
  ...
  if (typeof frontOffset !== 'number')
    return this.collidePolygons$5$bailout(2, manifold, t8, xf2, t4, frontOffset, totalRadius, t1, t2, t3, t5, t6, flip);
...
$$.TimeOfImpact = {"":"Object;cache,distanceInput,xfA,xfB,distanceOutput,fcn,indexes,sweepA>,sweepB>,pool",
 timeOfImpact$2: function(output, input) {
  ...
  for (t1 = this.fcn, t2 = this.indexes, t5 = t2.length, t6 = target + 0.00125, t7 = target - 0.00125, t8 = this.distanceOutput, t9 = this.xfA, t11 = this.xfB, t13 = this.pool, t14 = 0, iter = 0; true;) {
    ...
    t15 = t8.distance;
    if (typeof t15 !== 'number')
      return this.timeOfImpact$2$bailout(5, output, t1, t2, t11, target, t7, t13, proxyA, proxyB, t15, t3, t4, t6, t8, t10, t12, tMax, t5, t14, iter, t9);
    if (t15 <= 0) {
      output.set$state(2);
      output.set$t(0);
      break;
    ...
    for (t20 = tMax, pushBackIter = 0; done = false, true;) {
      ...
      if (typeof s2 !== 'number')
        return this.timeOfImpact$2$bailout(7, output, t20, pushBackIter, t11, s2, t13, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t3, t4, t6, t10, t12, t5, t14, iter, t9);
      if (s2 > t6) {
        output.set$state(4);
        output.set$t(tMax);
        done = true;
      ...
      if (typeof s1 !== 'number')
        return this.timeOfImpact$2$bailout(8, output, pushBackIter, t11, t20, s2, t13, proxyA, proxyB, t8, tMax, t1, t2, s1, target, t7, t3, t4, t6, t10, t12, t5, t14, iter, t9);
      if (s1 < t7) {
        output.set$state(1);
        output.set$t(t14);
        done = true;
      ...
      for (a2 = t20, a1 = t14, rootIterCount = 0; true;) {
        ...
        if (typeof s !== 'number')
          return this.timeOfImpact$2$bailout(9, output, pushBackIter, t11, t20, t13, s2, s1, rootIterCount, a1, a2, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t, t3, t4, t6, s, t10, t12, t5, t14, iter, t9);
        t15 = $.CONSTANT0.abs$0(s - target);
        if (typeof t15 !== 'number')
          return this.timeOfImpact$2$bailout(10, output, pushBackIter, t11, t20, t13, s2, s1, rootIterCount, a1, a2, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t, t3, t4, t6, s, t10, t15, t12, t5, t14, iter, t9);
        if (t15 < 0.00125) {
          t20 = t;
          break;
        }
        ...
        if (a1 !== (a1 | 0))
          return this.timeOfImpact$2$bailout(11, output, pushBackIter, t11, t20, s2, s1, a1, a2, rootIterCount, proxyA, t13, proxyB, t8, tMax, t1, t2, target, t7, t3, t4, t6, t10, t12, t5, t14, iter, t9);
        ++rootIterCount;
        t16 = $.TimeOfImpact_toiRootIters;
        if (typeof t16 !== 'number')
          return this.timeOfImpact$2$bailout(12, output, pushBackIter, t11, t20, s2, s1, a1, a2, rootIterCount, t16, proxyA, t13, proxyB, t8, tMax, t1, t2, target, t7, t3, t4, t6, t10, t12, t5, t14, iter, t9);
        $.TimeOfImpact_toiRootIters = t16 + 1;
        if (rootIterCount === 50)
          break;
      }
      if (t20 !== (t20 | 0))
        return this.timeOfImpact$2$bailout(13, output, pushBackIter, t11, t13, proxyA, proxyB, t8, tMax, t1, t2, t20, target, t7, rootIterCount, t3, t4, t6, t10, t12, t5, t14, iter, t9);
    ...
    if (typeof t15 !== 'number')
      return this.timeOfImpact$2$bailout(14, output, t14, t1, t2, t11, done, target, t7, t13, iter, t15, proxyA, proxyB, t3, t4, t6, t8, t10, t12, tMax, t5, t9);
...
$$.PolygonShape = {"":"Shape;centroid>,vertices>,normals>,vertexCount>,type,radius",
 getSupport$1: function(d) {
  ...
  while (true) {
    ...
    t2 = t2.get$y();
    if (typeof t2 !== 'number')
      return this.getSupport$1$bailout0(9, d, t4, t2, bestValue, bestIndex, i, t1);
    value = t4 + t2 * t10;
    if (value > bestValue) {
      bestValue = value;
      bestIndex = i;
 ...
 solveTimeOfImpactGivenBody$1: function(body) {
  ...
  do {
    for (ce = body.get$contactList(), count = 0, found = false; !(ce == null); ce = ce.get$next()) {
      ...
      if (typeof type !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(2, t8, body, bullet, iter, t2, other, type, count, t3, toiContact, toi, toiOther, t4, found, ce, t7, t6, t5);
      if (bullet) {
        t1 = other.get$flags();
        if (t1 !== (t1 | 0))
          return this.solveTimeOfImpactGivenBody$1$bailout(3, t8, body, bullet, iter, t2, other, type, count, t1, t3, toiContact, toi, toiOther, t4, found, ce, t7, t6, t5);
        if ((t1 & 64) === 0)
          continue;
        if (!(type === 0)) {
          t1 = ce.get$contact().get$flags();
          if (t1 !== (t1 | 0))
            return this.solveTimeOfImpactGivenBody$1$bailout(4, t8, body, bullet, t1, iter, t2, other, count, t3, toiContact, toi, toiOther, t4, found, ce, t7, t6, t5);
          t10 = (t1 & 16) !== 0;
          t1 = t10;
        } else
          t1 = false;
      ...
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(5, t8, body, contact, t1, bullet, iter, t2, other, count, t3, toiContact, toi, toiOther, t4, found, ce, t7, t6, t5);
      if (!t1)
        continue;
      t1 = contact.get$toiCount();
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(6, t8, body, contact, bullet, iter, t2, other, t1, count, t3, toiContact, toi, toiOther, t4, found, ce, t7, t6, t5);
      if (t1 > 10)
        continue;
      ...
      t1 = t2.state;
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(7, t8, body, contact, t1, bullet, iter, t2, other, count, t3, toiContact, toi, toiOther, t4, found, ce, t7, t6, t5);
      if (t1 === 3) {
        t1 = t2.t;
        if (typeof t1 !== 'number')
          return this.solveTimeOfImpactGivenBody$1$bailout(8, t8, body, contact, bullet, t1, iter, t2, other, count, t3, toiContact, toi, toiOther, t4, found, ce, t7, t6, t5);
        t1 = t1 < toi;
      } else
        t1 = false;
      if (t1) {
  ...
  while (true) {
    ...
    c$0: {
      ...
      if (typeof type !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(12, ce, body, count, toiContact, toiOther, type);
      if (type === 2)
        break c$0;
      contact = ce.get$contact();
      t1 = contact.get$enabled();
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(13, ce, body, count, contact, t1, toiContact, toiOther);
      if (!t1)
        break c$0;
      fixtureA = contact.get$fixtureA();
      fixtureB = contact.get$fixtureB();
      ...
      t1 = contact.get$enabled();
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(14, ce, body, count, contact, toiContact, toiOther, t1);
      if (!t1)
        break c$0;
      t1 = contact.get$touching();
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(15, ce, body, count, contact, t1, toiContact, toiOther);
      if (!t1)
        break c$0;
      t1 = this.contacts;
      if (count >= t1.length)
