...
FrictionJointTest: {"": "Demo;_ground,_boxFixture,bodies,canvas,ctx,viewport,debugDraw,world,frameCount,fpsCounter,elapsedUs,worldStepTime,viewportScale,_stopwatch",
  _createGround$0: function() {
    ...
    shape.setAsBoxWithCenterAndAngle$4(0.4, 50, new $.Vector(-20, 0), 0);
    t2 = this._ground;
    t2.createFixtureFromShape$2;
    t1 = t2._fixDef;
    t1.shape = shape;
    t1.density = 0;
    t2.createFixture$1(t1);
    shape.setAsBoxWithCenterAndAngle$4(0.4, 50, new $.Vector(20, 0), 0);
    t1 = this._ground;
    t1.createFixtureFromShape$2;
    t2 = t1._fixDef;
  ...
  _createBoxShapeAndFixture$0: function() {
    ...
    boxShape.setAsBoxWithCenterAndAngle$4(3, 1.5, new $.Vector(0, 0), 1.5707963267948966);
  ...
  _createBox$0: function() {
    ...
    bodyDef = $.BodyDef$();
    bodyDef.type = 2;
    bodyDef.position = new $.Vector(-10, 30);
  ...
  _createFrictionBox$0: function() {
    ...
    fallingBox = this.world.createBody$1(bodyDef);
    fallingBox.createFixture$1(this._boxFixture);
    frictionJointDef = new $.FrictionJointDef(new $.Vector(0, 0), new $.Vector(0, 0), 0, 0, 0, null, null, null, false);
    frictionJointDef.type = 9;
...
main: function() {
  var test, t1;
  test = new $.FrictionJointTest(null, null, $.List_List($), null, null, null, null, null, null, null, null, null, 10, null);
  test.Demo$3("FrictionJoint test", null, 10);
  test._createGround$0();
  test._createBoxShapeAndFixture$0();
  test._createBox$0();
  test._createFrictionBox$0();
...
FrictionJoint: {"": "Joint;_localAnchorA,_localAnchorB,_linearImpulse,_angularImpulse,_maxForce,_maxTorque,type,_prev,_liblib1$_next,edgeA,edgeB,bodyA,bodyB,islandFlag,collideConnected,userData,localCenterA,localCenterB,invMassA,invIA,invMassB,invIB",
  ...
  solveVelocityConstraints$1: function(step) {
    var Cdot, angularMass, oldImpulse, maxImpulse, impulse, t1, r1, r2, t2, temp, tempY, K, t3, t4, t5, t6, t7, linearMass;
    ...
    maxImpulse = step.dt * this._maxTorque;
    this._angularImpulse = $.max(-maxImpulse, $.min(oldImpulse + -angularMass * Cdot, maxImpulse));
    impulse = this._angularImpulse - oldImpulse;
    t1 = this.bodyA;
    t1.set$angularVelocity($.$sub$n(t1.get$angularVelocity(), this.bodyA.get$invInertia() * impulse));
    t1 = this.bodyB;
    t1.set$angularVelocity($.$add$ns(t1.get$angularVelocity(), this.bodyB.get$invInertia() * impulse));
    r1 = new $.Vector(0, 0);
    r2 = new $.Vector(0, 0);
    t1 = this._localAnchorA;
    t2 = t1.x;
    ...
    temp = new $.Vector(0, 0);
    Cdot = new $.Vector(0, 0);
    t1 = this.bodyA.get$angularVelocity();
    t2 = $.getInterceptor$n(t1);
    tempY = t2.$mul(t1, r1.x);
    t1 = t2.$negate(t1);
    t2 = r1.y;
    ...
    temp.x = t1 * t2;
    temp.y = tempY;
    t2 = this.bodyB.get$angularVelocity();
    t1 = $.getInterceptor$n(t2);
    tempY = t1.$mul(t2, r2.x);
    t2 = t1.$negate(t2);
    t1 = r2.y;
    ...
    Cdot.y = tempY;
    t1 = this.bodyB.get$linearVelocity();
    Cdot.x = $.$add$ns(Cdot.x, t1.x);
    Cdot.y = $.$add$ns(Cdot.y, t1.y);
    t1 = this.bodyA.get$linearVelocity();
    Cdot.x = $.$sub$n(Cdot.x, t1.x);
    Cdot.y = $.$sub$n(Cdot.y, t1.y);
    ...
    maxImpulse = step.dt * this._maxForce;
    t1 = t7.x;
    t1 = $.$mul$n(t1, t1);
    t2 = t7.y;
