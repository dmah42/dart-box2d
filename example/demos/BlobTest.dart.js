...
$$.BlobTest = {"":"Demo;bodies,canvas,ctx,viewport,debugDraw,world,frameCount,fpsCounter,elapsedUs,worldStepTime,viewportScale,_stopwatch",
 initialize$0: function() {
  var sd, bd, ground, cvjd, i, angle, x, y, body, fd, cd, bd2, psd, fallingBox;
  sd = $.PolygonShape$();
  sd.setAsBox$2(50, 0.4);
  bd = $.BodyDef$();
  bd.position.setCoords$2(0, 0);
  ground = this.world.createBody$1(bd);
  this.bodies.push(ground);
  ground.createFixtureFromShape$1(sd);
  sd.setAsBoxWithCenterAndAngle$4(0.4, 50, $.Vector$(-10, 0), 0);
  ground.createFixtureFromShape$1(sd);
  sd.setAsBoxWithCenterAndAngle$4(0.4, 50, $.Vector$(10, 0), 0);
  ground.createFixtureFromShape$1(sd);
  ...
  for (i = 0; i < 20; ++i) {
    ...
    fd.shape = cd;
    fd.density = 1;
    $.getInterceptor$JSArray(fd).get$filter(fd).set$groupIndex(-2);
  ...
  bd2.type = 2;
  psd = $.PolygonShape$();
  psd.setAsBoxWithCenterAndAngle$4(3, 1.5, $.Vector$(0, 25), 0);
  bd2.position = $.Vector$(0, 25);
  fallingBox = this.world.createBody$1(bd2);
  this.bodies.push(fallingBox);
  fallingBox.createFixtureFromShape$2(psd, 1);
}
};
...
$$.Collision = {"":"Object;_pool,cache,input,output,results1,results2,incidentEdge>,localTangent,localNormal>,planePoint,tangent,normal>,normal1,v11,v12,clipPoints1,clipPoints2",
 ...
 collidePolygonAndCircle$5$bailout: function(state0, env0, env1, env2, env3, env4, env5, env6, env7) {
  ...
  switch (state0) {
    ...
    case 5:
      ...
      normals = polygon.get$normals();
    case 6:
      var v, cy, v1x, v1y, t1, b, b1, cLocaly, circle, polygon, manifold, cLocalx, radius, vertexCount, vertices, normals, t2, i, normalIndex, separation, vertex, tempx, tempy, norm, s, vertIndex2, v1, v2, mpoint, tempX, tempY, temp2X, temp2Y, u1, temp3X, temp3Y, temp4X, temp4Y, u2, dx, dy, t3, fcx, fcy, tx, ty;
      state0 = 0;
      for (t1 = $.getInterceptor$JSStringJSArray(vertices), t2 = $.getInterceptor$JSStringJSArray(normals), i = 0, normalIndex = 0, separation = 1e-12; $.ltB(i, vertexCount); ++i) {
 ...
 edgeSeparation$5: function(poly1, xf1, edge1, poly2, xf2) {
  ...
  for (t1 = $.getInterceptor$JSStringJSArray(vertices2), t2 = vertices2.length, index = 0, minDot = 99999999999999, i = 0; i < count2; ++i) {
    ...
    t3 = a.get$x();
    if (t3 !== (t3 | 0))
      return this.edgeSeparation$5$bailout(17, xf1, edge1, xf2, normal1Worldx, R1, vertices1, index, vertices2, minDot, i, R, count2, normal1x, t1, a, t3, normal1y, normal1Worldy);
    t3 *= normal1x;
    t5 = a.get$y();
    if (t5 !== (t5 | 0))
      return this.edgeSeparation$5$bailout(18, xf1, edge1, xf2, normal1Worldx, R1, vertices1, index, vertices2, minDot, i, R, count2, normal1x, t1, normal1Worldy, normal1y, t3, t5);
    dot = t3 + t5 * normal1y;
    if (dot < minDot) {
      minDot = dot;
      index = i;
  ...
  if (typeof t2 !== 'number')
    return this.edgeSeparation$5$bailout(19, xf1, v3, xf2, t2, normal1Worldx, R1, t1, index, vertices2, normal1Worldy, R);
  t4 = R.get$col1().get$y();
  if (typeof t4 !== 'number')
    return this.edgeSeparation$5$bailout(20, xf1, xf2, normal1Worldx, R1, index, vertices2, R, v3, t2, t4, t1, normal1Worldy);
  t6 = v3.get$x();
  if (typeof t6 !== 'number')
    return this.edgeSeparation$5$bailout(21, xf1, xf2, normal1Worldx, R1, index, vertices2, R, v3, t2, t4, t6, t1, normal1Worldy);
  t2 += t4 * t6;
  t8 = R.get$col2().get$y();
  if (typeof t8 !== 'number')
    return this.edgeSeparation$5$bailout(22, xf1, xf2, normal1Worldx, R1, index, vertices2, R, v3, t1, normal1Worldy, t2, t8);
  t10 = v3.get$y();
  if (typeof t10 !== 'number')
    return this.edgeSeparation$5$bailout(23, xf1, xf2, normal1Worldx, R1, index, vertices2, R, v3, t1, normal1Worldy, t2, t8, t10);
  v1y = t2 + t8 * t10;
  t2 = xf1.get$position().get$x();
  if (typeof t2 !== 'number')
    return this.edgeSeparation$5$bailout(24, v1y, v3, xf2, t2, normal1Worldx, R1, t1, index, vertices2, normal1Worldy, R);
  t13 = R.get$col1().get$x();
  if (typeof t13 !== 'number')
    return this.edgeSeparation$5$bailout(25, v1y, xf2, t2, t13, normal1Worldx, R1, index, vertices2, R, v3, t1, normal1Worldy);
  t15 = v3.get$x();
  if (typeof t15 !== 'number')
    return this.edgeSeparation$5$bailout(26, v1y, xf2, t2, t13, t15, normal1Worldx, R1, index, vertices2, R, v3, t1, normal1Worldy);
  t2 += t13 * t15;
  t17 = R.get$col2().get$x();
  if (typeof t17 !== 'number')
    return this.edgeSeparation$5$bailout(27, v1y, v3, xf2, normal1Worldx, R1, t1, index, vertices2, t2, t17, normal1Worldy);
  t19 = v3.get$y();
  if (typeof t19 !== 'number')
    return this.edgeSeparation$5$bailout(28, normal1Worldy, v1y, xf2, normal1Worldx, R1, t1, index, vertices2, t2, t17, t19);
  v1x = t2 + t17 * t19;
 ...
 collidePolygons$5: function(manifold, polyA, xfA, polyB, xfB) {
  ...
  if (typeof frontOffset !== 'number')
    return this.collidePolygons$5$bailout(2, manifold, xf2, t8, t3, frontOffset, totalRadius, t1, t2, t4, t5, t6, flip);
...
$$.DistanceProxy = {"":"Object;vertices>,count=,radius=",
 ...
 getSupport$1: function(direction) {
  ...
  while (true) {
    ...
    t3 = t3.get$y();
    if (typeof t3 !== 'number')
      return this.getSupport$1$bailout0(8, direction, t2, bestIndex, t3, bestValue, i, t4, t1);
    value = t4 + t3 * t9;
    if (value > bestValue) {
      bestIndex = i;
      bestValue = value;
 ...
 timeOfImpact$2: function(output, input) {
  ...
  for (t1 = this.fcn, t2 = this.indexes, t5 = t2.length, t6 = target + 0.00125, t7 = target - 0.00125, t8 = this.distanceOutput, t9 = this.xfA, t11 = this.xfB, t13 = this.pool, t14 = 0, iter = 0; true;) {
    ...
    for (t20 = tMax, pushBackIter = 0; done = false, true;) {
      ...
      if (typeof s2 !== 'number')
        return this.timeOfImpact$2$bailout(7, output, t11, t9, t20, s2, t13, proxyA, proxyB, t8, tMax, t1, target, t2, t7, t3, t4, t6, t10, t12, t14, iter, t5, pushBackIter);
      if (s2 > t6) {
        output.set$state(4);
        output.set$t(tMax);
        done = true;
      ...
      if (typeof s1 !== 'number')
        return this.timeOfImpact$2$bailout(8, output, t11, pushBackIter, t9, s2, t13, proxyA, proxyB, t8, tMax, s1, t2, target, t1, t7, t3, t4, t6, t10, t12, t14, iter, t5, t20);
      if (s1 < t7) {
        output.set$state(1);
        output.set$t(t14);
        done = true;
      ...
      for (a2 = t20, a1 = t14, rootIterCount = 0; true;) {
        ...
        if (typeof s !== 'number')
          return this.timeOfImpact$2$bailout(9, output, t11, t9, t5, s2, s1, rootIterCount, a1, a2, proxyA, t13, proxyB, t8, tMax, t1, target, t2, t7, t, t3, t4, t6, s, t10, t12, t14, iter, t20, pushBackIter);
        t15 = $.CONSTANT4.abs$0(s - target);
        if (typeof t15 !== 'number')
          return this.timeOfImpact$2$bailout(10, output, t11, t9, t5, s2, s1, rootIterCount, a1, a2, proxyA, t13, proxyB, t8, tMax, t1, target, t2, t7, t, t3, t4, t6, s, t10, t15, t12, t14, iter, t20, pushBackIter);
        if (t15 < 0.00125) {
          t20 = t;
          break;
        }
        ...
        if (a1 !== (a1 | 0))
          return this.timeOfImpact$2$bailout(11, output, t11, t9, t5, s2, s1, a1, a2, rootIterCount, t13, proxyA, proxyB, t8, tMax, t1, target, t2, t7, t3, t4, t6, t10, t12, t14, iter, t20, pushBackIter);
        ++rootIterCount;
        t16 = $.TimeOfImpact_toiRootIters;
        if (typeof t16 !== 'number')
          return this.timeOfImpact$2$bailout(12, output, t11, t9, t5, s2, s1, a1, a2, rootIterCount, t16, proxyA, t13, proxyB, t8, tMax, t1, target, t2, t7, t3, t4, t6, t10, t12, t14, iter, t20, pushBackIter);
        $.TimeOfImpact_toiRootIters = t16 + 1;
        if (rootIterCount === 50)
          break;
      }
      if (t20 !== (t20 | 0))
        return this.timeOfImpact$2$bailout(13, output, t11, pushBackIter, t13, proxyA, proxyB, t8, tMax, t20, t1, t2, rootIterCount, t7, target, t3, t4, t6, t10, t12, t14, iter, t5, t9);
    ...
    if (typeof t15 !== 'number')
      return this.timeOfImpact$2$bailout(14, output, t11, t9, done, t1, t2, target, t7, t13, iter, t15, proxyA, proxyB, t3, t4, t6, t8, t10, t12, tMax, t5, t14);
...
$$.PolygonShape = {"":"Shape;centroid>,vertices>,normals>,vertexCount>,type,radius",
 getSupport$1: function(d) {
  ...
  while (true) {
    ...
    t2 = t2.get$y();
    if (typeof t2 !== 'number')
      return this.getSupport$1$bailout(9, d, t3, bestIndex, bestValue, t2, i, t5, t1);
    value = t5 + t2 * t11;
    if (value > bestValue) {
      bestValue = value;
      bestIndex = i;
...
$$.Vector3 = {"":"Object;x=,y=,z>",
 ...
 add$1: function(argVec) {
  ...
  t6 = argVec.get$y();
  if (typeof t6 !== 'number')
    return this.add$1$bailout(4, argVec, t6, t1, t3);
  t6 = t1 + t6;
  t1 = this.z;
  if (typeof t1 !== 'number')
    return this.add$1$bailout(5, argVec, t6, t1, t3);
  t9 = argVec.get$z();
  if (typeof t9 !== 'number')
    return this.add$1$bailout(6, t6, t1, t9, t3);
  return $.Vector3$(t3, t6, t1 + t9);
},
 add$1$bailout: function(state0, env0, env1, env2, env3) {
  switch (state0) {
    case 1:
      t1 = env1;
      argVec = env0;
...
$$.Island = {"":"Object;listener,bodies>,contacts,joints>,positions,velocities,bodyCount>,jointCount,contactCount>,bodyCapacity,contactCapacity,jointCapacity,positionIterationCount,_contactSolver,_translation,impulse",
  ...
  if (allowSleep === true) {
    ...
    while (true) {
      ...
      c$0: {
        ...
        t1 = b.get$flags();
        if (t1 !== (t1 | 0))
          return this.solve$3$bailout(51, step, minSleepTime, i, b, t1);
        if ((t1 & 4) === 0) {
          b.set$sleepTime(0);
          minSleepTime = 0;
        }
        ...
        if ((t1 & 4) !== 0) {
          ...
          if (!(t1 * t3 > 0.0012184696791468343)) {
            ...
            t3 = t1.get$x();
            if (typeof t3 !== 'number')
              return this.solve$3$bailout(55, step, t2, t3, i, b, t1, minSleepTime);
            t5 = t2.get$x();
            if (typeof t5 !== 'number')
              return this.solve$3$bailout(56, step, t2, t3, i, t5, b, t1, minSleepTime);
            t5 = t3 * t5;
            t1 = t1.get$y();
            if (typeof t1 !== 'number')
              return this.solve$3$bailout(57, step, t2, i, b, t5, t1, minSleepTime);
            t2 = t2.get$y();
            if (typeof t2 !== 'number')
 ...
 addBody$1: function(body) {
  ...
  t1 = this.bodies;
  if (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array || !!t1.immutable$list) && !t1.is$JavaScriptIndexingBehavior())
    return this.addBody$1$bailout0(1, body, t1);
  t3 = this.bodyCount;
  if (typeof t3 !== 'number')
    return this.addBody$1$bailout0(2, body, t1, t3);
  this.bodyCount = t3 + 1;
  if (t3 !== (t3 | 0))
    throw $.iae(t3);
 ...
 addBody$1$bailout0: function(state0, env0, env1, env2) {
  switch (state0) {
    case 1:
      t1 = env1;
      body = env0;
...
$$.World = {"":"Object;_flags,_contactManager,_bodyList,_jointList,_bodyCount,_jointCount,_gravity,_allowSleep,_debugDraw,_fixtureDestructionListener,_jointDestructionListener,_pool,_inverseTimestep,_warmStarting,_continuousPhysics,_contactStacks,center>,axis,timestep,cA,cB,wqwrapper,toiInput,toiOutput,backup,toiSolver,contacts,island,stack",
 ...
 createBody$1$bailout: function(state0, b, t1) {
 ...
 solveTimeOfImpactGivenBody$1: function(body) {
  ...
  do {
    for (ce = body.get$contactList(), found = false, count = 0; !(ce == null); ce = ce.get$next()) {
      ...
      if (typeof type !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(2, t8, body, bullet, t2, other, type, iter, toiContact, t3, toiOther, found, toi, count, ce, t6, t4, t7, t5);
      if (bullet) {
        t1 = other.get$flags();
        if (t1 !== (t1 | 0))
          return this.solveTimeOfImpactGivenBody$1$bailout(3, t8, body, bullet, t2, other, type, iter, t1, toiContact, toi, toiOther, found, t3, count, ce, t6, t4, t7, t5);
        if ((t1 & 64) === 0)
          continue;
        if (!(type === 0)) {
          t1 = ce.get$contact().get$flags();
          if (t1 !== (t1 | 0))
            return this.solveTimeOfImpactGivenBody$1$bailout(4, t8, body, bullet, t1, t2, other, iter, toiContact, toi, toiOther, found, t3, count, ce, t6, t4, t7, t5);
          t10 = (t1 & 16) !== 0;
          t1 = t10;
        } else
          t1 = false;
      ...
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(5, t8, body, contact, t1, bullet, t2, other, iter, toiContact, toi, toiOther, found, t3, count, ce, t6, t4, t7, t5);
      if (!t1)
        continue;
      t1 = contact.get$toiCount();
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(6, t8, body, contact, bullet, t2, other, t1, iter, toiContact, toi, toiOther, found, t3, count, ce, t6, t4, t7, t5);
      if (t1 > 10)
        continue;
      ...
      t1 = t2.state;
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(7, t8, body, contact, t7, t1, bullet, t2, other, iter, toiContact, toi, toiOther, found, t3, count, ce, t5, t4, t6);
      if (t1 === 3) {
        t1 = t2.t;
        if (typeof t1 !== 'number')
          return this.solveTimeOfImpactGivenBody$1$bailout(8, t8, body, contact, t7, bullet, t1, t2, other, iter, toiContact, toi, toiOther, found, t3, count, ce, t5, t4, t6);
        t1 = t1 < toi;
      } else
        t1 = false;
      if (t1) {
        toi = t2.t;
        if (toi !== (toi | 0))
          return this.solveTimeOfImpactGivenBody$1$bailout(9, t8, body, contact, bullet, t2, other, toi, iter, t3, t4, t5, count, ce, t6, t7);
        toiOther = other;
        toiContact = contact;
        found = true;
      }
  ...
  while (true) {
    ...
    c$0: {
      ...
      if (typeof type !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(12, body, ce, toiContact, toiOther, count, type);
      if (type === 2)
        break c$0;
      contact = ce.get$contact();
      t1 = contact.get$enabled();
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(13, body, contact, ce, toiContact, t1, toiOther, count);
      if (!t1)
        break c$0;
      fixtureA = contact.get$fixtureA();
      fixtureB = contact.get$fixtureB();
      ...
      t1 = contact.get$enabled();
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(14, body, contact, ce, toiContact, toiOther, count, t1);
      if (!t1)
        break c$0;
      t1 = contact.get$touching();
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(15, body, contact, ce, toiContact, t1, toiOther, count);
      if (!t1)
        break c$0;
      t1 = this.contacts;
      if (count >= t1.length)
 ...
 update$1: function(listener) {
  ...
  if (sensor) {
    ...
    while (true) {
      ...
      if (typeof t5 !== 'number')
        return this.update$1$bailout(5, listener, bodyA, wasTouching, bodyB, t1, i, t5, touching, t2, t3, sensor);
      if (!(i < t5))
        break;
      t4 = t4.get$points();
      if (typeof t4 !== 'string' && (typeof t4 !== 'object' || t4 === null || t4.constructor !== Array && !t4.is$JavaScriptIndexingBehavior()))
        return this.update$1$bailout(6, listener, bodyA, wasTouching, bodyB, t1, i, touching, t2, t3, t4, sensor);
      if (i >= t4.length)
        throw $.ioore(i);
      mp2 = t4[i];
      ...
      while (true) {
        t4 = t1.pointCount;
        if (typeof t4 !== 'number')
          return this.update$1$bailout(7, listener, bodyA, bodyB, i, t4, t2, mp2, wasTouching, id2, t1, j, touching, t3, sensor);
        if (!(j < t4))
          break;
        if (j >= t3)
          throw $.ioore(j);
 ...
 solveVelocityConstraints$0: function() {
  ...
  while (true) {
    ...
    while (true) {
      ...
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(9, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t6, t2, j, t7, t8, wA, wB, t1, t11);
      if (!(j < t11))
        break;
      t11 = c.get$points();
      if (typeof t11 !== 'string' && (typeof t11 !== 'object' || t11 === null || t11.constructor !== Array && !t11.is$JavaScriptIndexingBehavior()))
        return this.solveVelocityConstraints$0$bailout(10, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t6, t2, j, t7, t8, wA, wB, t1, t11);
      if (j >= t11.length)
        throw $.ioore(j);
      ccp = t11[j];
      a = ccp.get$rA();
      ...
      if (typeof t13 !== 'number')
        return this.solveVelocityConstraints$0$bailout(11, ccp, a, t9, t11, i, t13, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t6, t2, j, t7, t8, wA, wB, t1);
      t13 = t11 * t13;
      t11 = vB.get$x();
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(12, ccp, a, t9, i, t10, t13, t11, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t6, t2, j, t7, t8, wA, wB, t1);
      t11 = t13 + t11;
      t13 = vA.get$x();
      if (typeof t13 !== 'number')
        return this.solveVelocityConstraints$0$bailout(13, ccp, a, t9, i, t10, t11, t13, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t6, t2, j, t7, t8, wA, wB, t1);
      t13 = t11 - t13;
      t11 = a.get$y();
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(14, ccp, a, t9, i, t10, t13, t11, bodyB, bodyA, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t6, t2, j, t7, t8, wA, wB, t1);
      t1.x = t13 + wA * t11;
      t18 = ccp.get$rB().get$x();
      if (typeof t18 !== 'number')
        return this.solveVelocityConstraints$0$bailout(15, ccp, a, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t18, c, friction, t3, t4, t5, t6, t2, j, t7, t8, wA, wB, t1);
      t18 = wB * t18;
      t20 = vB.get$y();
      if (typeof t20 !== 'number')
        return this.solveVelocityConstraints$0$bailout(16, ccp, a, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t18, t20, c, friction, t3, t4, t5, t6, t2, j, t7, t8, wA, wB, t1);
      t20 = t18 + t20;
      t18 = vA.get$y();
      if (typeof t18 !== 'number')
        return this.solveVelocityConstraints$0$bailout(17, ccp, a, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t20, t18, c, friction, t3, t4, t5, t6, t2, j, t7, t8, wA, wB, t1);
      t18 = t20 - t18;
      t20 = a.get$x();
      if (typeof t20 !== 'number')
        return this.solveVelocityConstraints$0$bailout(18, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t18, t20, c, friction, t3, t4, t5, t6, t2, j, t7, t8, wA, wB, t1);
      t1.y = t18 - wA * t20;
      t24 = t1.x;
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(19, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t24, t2, j, t7, t6, t8, wA, wB, t1);
      t26 = t2.x;
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(20, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t24, t2, t26, j, t7, t6, t8, wA, wB, t1);
      t26 = t24 * t26;
      t24 = t1.y;
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(21, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t26, t6, t2, j, t24, t7, t8, wA, wB, t1);
      t29 = t2.y;
      if (typeof t29 !== 'number')
        return this.solveVelocityConstraints$0$bailout(22, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t26, t6, t2, j, t24, t8, t29, wA, wB, t1, t7);
      vt = t26 + t24 * t29;
      t26 = ccp.get$tangentMass();
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(23, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t6, t2, j, t7, t8, vt, wA, wB, t26, t1);
      lambda = t26 * -vt;
      t26 = ccp.get$normalImpulse();
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(24, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, friction, t3, t4, t5, t6, t2, j, t7, t8, wA, wB, lambda, t26, t1);
      maxFriction = friction * t26;
      t26 = ccp.get$tangentImpulse();
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(25, ccp, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, t5, friction, t6, t2, j, t7, t8, wA, wB, lambda, t1, maxFriction, t26);
      t26 += lambda;
      ...
      t34 = t2.x;
      if (typeof t34 !== 'number')
        return this.solveVelocityConstraints$0$bailout(26, ccp, t9, newImpulse, t10, lambda, i, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, t5, friction, t6, t2, j, t7, t8, wA, wB, t34, t1);
      Px = t34 * lambda;
      t34 = t2.y;
      if (typeof t34 !== 'number')
        return this.solveVelocityConstraints$0$bailout(27, ccp, t9, newImpulse, t10, lambda, i, Px, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, t5, friction, t6, t2, j, t7, t8, wA, wB, t34, t1);
      Py = t34 * lambda;
      t34 = vA.get$x();
      if (typeof t34 !== 'number')
        return this.solveVelocityConstraints$0$bailout(28, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, Py, t34, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, t5, friction, t6, t2, j, t7, t8, wA, wB, t1);
      vA.set$x(t34 - Px * invMassA);
      t38 = vA.get$y();
      if (typeof t38 !== 'number')
        return this.solveVelocityConstraints$0$bailout(29, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, t38, c, t3, t4, t5, friction, t6, t2, j, t7, t8, wA, wB, t1);
      vA.set$y(t38 - Py * invMassA);
      t40 = ccp.get$rA();
      t41 = t40.get$x();
      if (typeof t41 !== 'number')
        return this.solveVelocityConstraints$0$bailout(30, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, t41, c, t3, t4, t5, friction, t6, t2, j, t7, t8, wA, wB, t1);
      t41 *= Py;
      t40 = t40.get$y();
      if (typeof t40 !== 'number')
        return this.solveVelocityConstraints$0$bailout(31, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, t41, t40, c, t3, t4, t5, friction, t6, t2, j, t7, t8, wA, wB, t1);
      wA -= invIA * (t41 - t40 * Px);
      t44 = vB.get$x();
      if (typeof t44 !== 'number')
        return this.solveVelocityConstraints$0$bailout(32, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, wA, t44, t5, t6, t2, j, t7, friction, t8, wB, t1);
      vB.set$x(t44 + Px * invMassB);
      t46 = vB.get$y();
      if (typeof t46 !== 'number')
        return this.solveVelocityConstraints$0$bailout(33, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, wA, t5, t6, t2, j, t46, friction, t7, t8, wB, t1);
      vB.set$y(t46 + Py * invMassB);
      t48 = ccp.get$rB();
      t49 = t48.get$x();
      if (typeof t49 !== 'number')
        return this.solveVelocityConstraints$0$bailout(34, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, wA, t5, t6, t2, j, t7, friction, t8, wB, t49, t1);
      t49 *= Py;
      t48 = t48.get$y();
      if (typeof t48 !== 'number')
        return this.solveVelocityConstraints$0$bailout(35, ccp, t9, newImpulse, t10, i, Px, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, c, t3, t4, wA, t5, t6, t2, j, t7, friction, t8, wB, t1, t49, t48);
      wB += invIB * (t49 - t48 * Px);
    ...
    if (t11) {
      ...
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(38, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, t15, invMassB, invIB, ccp, a1, t11, invIA, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t11 = t15 * t11;
      t15 = vB.get$x();
      if (typeof t15 !== 'number')
        return this.solveVelocityConstraints$0$bailout(39, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, t11, t15, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t15 = t11 + t15;
      t11 = vA.get$x();
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(40, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, a1, t15, t11, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t11 = t15 - t11;
      t15 = a1.get$y();
      if (typeof t15 !== 'number')
        return this.solveVelocityConstraints$0$bailout(41, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, ccp, a1, t11, t15, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t1.x = t11 + wA * t15;
      t18 = ccp.get$rB().get$x();
      if (typeof t18 !== 'number')
      ...
      t24 = t1.x;
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(46, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, b, t1, t24);
      t26 = b.get$x();
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(47, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, b, t1, t26, t24);
      t24 *= t26;
      t28 = t1.y;
      if (typeof t28 !== 'number')
        return this.solveVelocityConstraints$0$bailout(48, t28, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, ccp, invMassB, invIB, invIA, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, b, t1, t24);
      t30 = b.get$y();
      if (typeof t30 !== 'number')
      ...
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(50, t9, vn, i, t24, t10, bodyA, bodyB, vA, ccp, invMassA, invIA, vB, invIB, invMassB, c, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t24 = -t24;
      ...
      t24 = t23.get$x();
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(62, Py, t9, i, t10, t3, t4, t24, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, ccp, wB, newImpulse, invIB, t1, wA, Px);
      t24 *= Py;
      t23 = t23.get$y();
      if (typeof t23 !== 'number')
        return this.solveVelocityConstraints$0$bailout(63, t9, i, t10, t3, t4, t5, t24, t6, t23, bodyB, t7, bodyA, vA, vB, t2, ccp, wB, newImpulse, invIB, t8, t1, wA, Px);
      wB += invIB * (t24 - t23 * Px);
      ...
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(65, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t15, t11, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t11 = t15 * t11;
      t13 = vB.get$x();
      if (typeof t13 !== 'number')
      ...
      if (typeof t19 !== 'number')
        return this.solveVelocityConstraints$0$bailout(69, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t19, t1);
      t19 = wB * t19;
      t21 = vB.get$y();
      if (typeof t21 !== 'number')
        return this.solveVelocityConstraints$0$bailout(70, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1, t19, t21);
      t21 = t19 + t21;
      t19 = vA.get$y();
      if (typeof t19 !== 'number')
      ...
      if (typeof t25 !== 'number')
        return this.solveVelocityConstraints$0$bailout(73, t9, i, t10, t15, t25, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t25 = t15 * t25;
      t15 = vB.get$x();
      if (typeof t15 !== 'number')
        return this.solveVelocityConstraints$0$bailout(74, t9, i, t10, t25, t15, bodyB, bodyA, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t15 = t25 + t15;
      t25 = vA.get$x();
      if (typeof t25 !== 'number')
        return this.solveVelocityConstraints$0$bailout(75, t9, i, t10, bodyA, bodyB, t15, vA, vB, invMassA, invIA, invMassB, invIB, t25, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t25 = t15 - t25;
      t15 = cp2.get$rA().get$y();
      if (typeof t15 !== 'number')
        return this.solveVelocityConstraints$0$bailout(76, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t15, t25, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t10.x = t25 + wA * t15;
      ...
      t38 = t38.get$y();
      if (typeof t38 !== 'number')
        return this.solveVelocityConstraints$0$bailout(84, t9, i, t10, t41, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, t36, wA, wB, t38, t1);
      vn1 = t36 + t41 * t38;
      t36 = t10.x;
      if (typeof t36 !== 'number')
      ...
      if (typeof t68 !== 'number')
        return this.solveVelocityConstraints$0$bailout(101, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, t68, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t70 = t8.y;
      if (typeof t70 !== 'number')
        return this.solveVelocityConstraints$0$bailout(102, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, t68, cp2, t70, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      b.y = t68 - t70;
      $loop$1: {
        ...
        if (t11) {
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(105, t9, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, wA, wB, invIB, invIA, t1, t12, cp1, cp2, t11);
          t14 = t5.y;
          if (typeof t14 !== 'number')
            return this.solveVelocityConstraints$0$bailout(106, t9, i, t10, bodyA, bodyB, vA, vB, invIA, t11, invIB, t12, cp1, cp2, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1, t14);
          t12 *= t14;
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(107, t9, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, wA, wB, invIB, invIA, t1, t12, cp1, t11, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
          ...
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(113, t9, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t27, wA, wB, invIB, t28, t8, t1, cp1, cp2);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
            return this.solveVelocityConstraints$0$bailout(115, t9, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, wA, wB, invIB, t14, t27, t1, cp1, cp2);
          t14 -= t27 * t17;
          t30 = cp2.get$rB();
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(117, t30, t31, t9, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, wA, wB, invIB, t1, cp1, t14, cp2);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(119, t9, t22, i, t30, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, wA, wB, invIB, t1, cp1, cp2, t14);
        ...
        t13 = b.x;
        if (typeof t13 !== 'number')
          return this.solveVelocityConstraints$0$bailout(122, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, t11, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t13, t1);
        t4.set$x(t11 * t13);
        t4.set$y(0);
        ...
        t19 = b.y;
        if (typeof t19 !== 'number')
          return this.solveVelocityConstraints$0$bailout(125, t9, i, t10, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, c, a, t3, t4, t5, t15, t6, t2, t7, t8, wA, wB, t19, t1);
        vn2 = t15 + t19;
        if (t17 >= 0 && vn2 >= 0) {
          t3.setFrom$1(t4).subLocal$1(a);
          t5.setFrom$1(c.get$normal()).mulLocal$1(t3.x);
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(127, t12, t9, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, wA, wB, invIB, invIA, t1, cp1, cp2, t11);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(129, t9, t12, i, t11, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, wA, wB, invIB, invIA, t1, cp1, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
          ...
          t19 = t19.get$y();
          if (typeof t19 !== 'number')
            return this.solveVelocityConstraints$0$bailout(133, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t12, t6, t2, t20, t19, t8, wA, wB, t1, t7);
          t25 = t6.x;
          if (typeof t25 !== 'number')
          ...
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(135, t9, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, wB, invIB, t1, cp1, wA, t27, cp2, t28);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
            return this.solveVelocityConstraints$0$bailout(137, t14, t27, i, t10, t9, t4, t5, t3, t6, bodyA, bodyB, t7, t2, vA, vB, t8, wB, invIB, t1, cp1, wA, cp2);
          t14 -= t27 * t17;
          t30 = cp2.get$rB();
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(139, t9, i, t10, t14, t4, t30, t31, t6, bodyA, bodyB, t5, t2, vA, vB, t8, wB, invIB, t1, t7, cp1, wA, t3, cp2);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(141, t9, i, t10, t14, t4, t5, t3, t6, t22, t30, bodyB, bodyA, vA, vB, t2, wB, invIB, t8, t7, cp1, wA, cp2, t1);
          wB += invIB * (t14 + (t22 - t30 * t25));
          cp1.set$normalImpulse(t4.get$x());
          cp2.set$normalImpulse(t4.get$y());
          break $loop$1;
        ...
        if (typeof t11 !== 'number')
          return this.solveVelocityConstraints$0$bailout(143, t9, i, t10, bodyA, bodyB, b, vA, vB, invMassA, invMassB, invIB, invIA, cp1, cp2, c, a, t11, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
        t11 = -t11;
        t13 = b.y;
        if (typeof t13 !== 'number')
          return this.solveVelocityConstraints$0$bailout(144, t9, i, t10, bodyA, bodyB, b, vA, vB, invMassA, invMassB, invIB, invIA, cp1, cp2, c, a, t11, t3, t4, t5, t6, t2, t7, t8, wA, wB, t13, t1);
        t4.set$y(t11 * t13);
        t15 = c.get$K().get$col2().get$x();
        if (typeof t15 !== 'number')
          return this.solveVelocityConstraints$0$bailout(145, t9, i, t10, bodyA, bodyB, b, vA, vB, invMassA, invMassB, invIB, invIA, cp1, cp2, c, a, t3, t4, t5, t6, t2, t15, t7, t8, wA, wB, t1);
        t17 = t4.get$y();
        if (typeof t17 !== 'number')
          return this.solveVelocityConstraints$0$bailout(146, t9, i, t10, bodyA, bodyB, b, vA, vB, invMassA, invMassB, invIB, invIA, cp1, cp2, c, a, t3, t4, t5, t6, t2, t15, t7, t17, t8, wA, wB, t1);
        t15 *= t17;
        t19 = b.x;
        if (typeof t19 !== 'number')
          return this.solveVelocityConstraints$0$bailout(147, t9, i, t10, bodyA, bodyB, b, vA, vB, invMassA, invMassB, invIB, invIA, cp1, cp2, c, a, t3, t4, t5, t6, t2, t7, t8, t15, wA, wB, t1, t19);
        vn1 = t15 + t19;
        if (t17 >= 0 && vn1 >= 0) {
          t3.setFrom$1(t4).subLocal$1(a);
          t5.setFrom$1(c.get$normal()).mulLocal$1(t3.x);
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(149, t9, i, t10, t3, t4, t5, t12, t11, t6, bodyA, bodyB, t7, t2, vA, vB, t8, wA, wB, invIB, invIA, t1, cp1, cp2);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(151, t9, i, t10, t3, t4, t5, t6, t12, t11, bodyB, bodyA, vA, vB, t2, wA, wB, invIB, invIA, t8, t7, cp1, t1, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
          ...
          t20 = t19.get$x();
          if (typeof t20 !== 'number')
            return this.solveVelocityConstraints$0$bailout(153, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, t2, t7, t8, t12, wA, wB, t20, t19, t1);
          t22 = t6.y;
          if (typeof t22 !== 'number')
            return this.solveVelocityConstraints$0$bailout(154, t9, i, t10, t22, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, t2, t7, t8, t12, wA, wB, t20, t19, t1);
          t20 *= t22;
          t19 = t19.get$y();
          if (typeof t19 !== 'number')
            return this.solveVelocityConstraints$0$bailout(155, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, t2, t7, t8, t12, wA, wB, t1, t20, t19);
          t25 = t6.x;
          if (typeof t25 !== 'number')
            return this.solveVelocityConstraints$0$bailout(156, t9, i, t10, t25, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, t2, t7, t8, t12, wA, wB, t1, t20, t19);
          wA -= invIA * (t12 + (t20 - t19 * t25));
          t27 = cp1.get$rB();
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(157, t9, i, wA, t27, t3, t4, t5, t28, t6, bodyA, bodyB, t10, t2, vA, vB, t8, wB, invIB, t1, t7, cp1, cp2);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
            return this.solveVelocityConstraints$0$bailout(159, t9, i, wA, t10, t3, t4, t5, t14, t27, t6, bodyA, bodyB, t2, vA, vB, t8, wB, invIB, t1, t7, cp1, cp2);
          t14 -= t27 * t17;
          t30 = cp2.get$rB();
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(161, t9, i, wA, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t30, t14, wB, invIB, t31, t8, t1, cp1, cp2);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(163, t9, i, wA, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, t14, wB, invIB, t22, t30, t1, cp1, cp2);
          wB += invIB * (t14 + (t22 - t30 * t25));
          cp1.set$normalImpulse(t4.get$x());
          cp2.set$normalImpulse(t4.get$y());
          break $loop$1;
        ...
        if (vn1 >= 0 && vn2 >= 0) {
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(167, t9, t11, i, t12, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, wA, wB, invIB, invIA, t1, cp1, cp2);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(169, t9, i, t10, t12, t4, t5, t3, t11, t6, bodyA, bodyB, t7, t2, vA, vB, t8, wA, wB, invIB, invIA, t1, cp1, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
          ...
          t19 = t19.get$y();
          if (typeof t19 !== 'number')
            return this.solveVelocityConstraints$0$bailout(173, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, t12, t2, t7, t8, t20, wA, wB, t19, t1);
          t25 = t6.x;
          if (typeof t25 !== 'number')
            return this.solveVelocityConstraints$0$bailout(174, t9, i, t10, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t25, t6, t12, t2, t7, t8, t20, wA, wB, t19, t1);
          wA -= invIA * (t12 + (t20 - t19 * t25));
          t27 = cp1.get$rB();
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(175, wA, t27, t9, t28, i, t10, t3, t4, t5, t6, bodyA, bodyB, t7, t2, vA, vB, t8, wB, invIB, t1, cp1, cp2);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
            return this.solveVelocityConstraints$0$bailout(177, wA, t9, i, t14, t27, t3, t4, t5, t10, t6, bodyA, bodyB, t7, t2, vA, vB, t8, wB, invIB, t1, cp1, cp2);
          t14 -= t27 * t17;
          t30 = cp2.get$rB();
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(179, wA, t9, i, t10, t3, t4, t5, t14, t30, t6, t31, bodyB, bodyA, vA, vB, t2, wB, invIB, t8, t7, cp1, t1, cp2);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(181, wA, t9, i, t10, t3, t4, t5, t14, t6, bodyA, bodyB, t7, t2, vA, vB, t30, t22, wB, invIB, t8, t1, cp1, cp2);
          wB += invIB * (t14 + (t22 - t30 * t25));
          cp1.set$normalImpulse(t4.get$x());
          cp2.set$normalImpulse(t4.get$y());
          break $loop$1;
 ...
 solvePositionConstraints$1: function(baumgarte) {
  ...
  while (true) {
    ...
    while (true) {
      t6 = c.get$pointCount();
      if (typeof t6 !== 'number')
        return this.solvePositionConstraints$1$bailout1(10, baumgarte, invIB, i, t1, t2, j, minSeparation, t3, t6, bodyA, bodyB, t4, invMassA, psm, normal, invIA, point, c, invMassB);
      if (!(j < t6))
        break;
      psm.initialize$2(c, j);
      separation = psm.separation;
      if (typeof separation !== 'number')
        return this.solvePositionConstraints$1$bailout1(11, baumgarte, invIB, i, t1, t2, j, minSeparation, t3, bodyA, bodyB, t4, invMassA, psm, normal, invIA, separation, c, point, invMassB);
      ...
      if (minSeparation !== (minSeparation | 0))
        return this.solvePositionConstraints$1$bailout1(12, baumgarte, invIB, minSeparation, i, t1, t2, j, t3, bodyA, bodyB, t4, invMassA, psm, normal, invIA, separation, c, point, invMassB);
      C = $.max(-0.2, $.min(baumgarte * (separation + 0.005), 0));
      t8 = t3.x;
      if (typeof t8 !== 'number')
        return this.solvePositionConstraints$1$bailout1(13, baumgarte, invIB, minSeparation, i, t1, j, t2, t3, bodyA, bodyB, C, t4, invMassA, psm, normal, invIA, point, c, invMassB, t8);
      t10 = normal.y;
      if (typeof t10 !== 'number')
        return this.solvePositionConstraints$1$bailout1(14, t10, baumgarte, invIB, minSeparation, i, t1, t2, j, t3, bodyA, bodyB, C, t4, invMassA, psm, normal, invIA, point, c, invMassB, t8);
      t8 *= t10;
      t12 = t3.y;
      if (typeof t12 !== 'number')
        return this.solvePositionConstraints$1$bailout1(15, baumgarte, t12, invIB, minSeparation, i, t1, t2, j, t3, bodyA, bodyB, C, t4, invMassA, t8, normal, invIA, psm, c, point, invMassB);
      t14 = normal.x;
      if (typeof t14 !== 'number')
        return this.solvePositionConstraints$1$bailout1(16, baumgarte, t12, invIB, t14, minSeparation, i, t1, t2, j, t3, bodyA, bodyB, C, t4, invMassA, t8, normal, invIA, psm, c, point, invMassB);
      rnA = t8 - t12 * t14;
      t8 = t4.x;
      if (typeof t8 !== 'number')
        return this.solvePositionConstraints$1$bailout1(17, baumgarte, invIB, t8, minSeparation, i, t1, t2, j, t3, bodyA, bodyB, C, t4, invMassA, psm, normal, invIA, point, c, invMassB, rnA);
      t10 = t8 * t10;
      t8 = t4.y;
      if (typeof t8 !== 'number')
        return this.solvePositionConstraints$1$bailout1(19, baumgarte, invIB, t10, minSeparation, t8, i, t1, t2, j, t3, bodyA, bodyB, C, t4, invMassA, psm, normal, invIA, point, c, invMassB, rnA);
      rnB = t10 - t8 * t14;
      ...
      t7 = t6.get$angle();
      if (typeof t7 !== 'number')
        return this.solvePositionConstraints$1$bailout1(21, baumgarte, invIB, minSeparation, i, t1, t2, j, t3, t6, t7, bodyA, bodyB, t4, invMassA, psm, normal, invIA, point, c, invMassB);
      t9 = t3.x;
      if (typeof t9 !== 'number')
        return this.solvePositionConstraints$1$bailout1(22, baumgarte, invIB, minSeparation, i, t1, t2, j, t3, t9, t7, bodyA, bodyB, t6, t4, invMassA, psm, normal, invIA, point, c, invMassB);
      t11 = t1.y;
      if (typeof t11 !== 'number')
        return this.solvePositionConstraints$1$bailout1(23, baumgarte, invIB, minSeparation, i, t1, t2, j, t3, t6, t7, bodyA, bodyB, t11, t9, t4, invMassA, psm, normal, invIA, point, c, invMassB);
      t11 = t9 * t11;
      t9 = t3.y;
      if (typeof t9 !== 'number')
        return this.solvePositionConstraints$1$bailout1(24, baumgarte, invIB, c, minSeparation, i, t1, t2, j, t3, t6, t7, bodyA, bodyB, t9, t4, t11, psm, normal, invIA, point, invMassA, invMassB);
      t14 = t1.x;
      if (typeof t14 !== 'number')
        return this.solvePositionConstraints$1$bailout1(25, baumgarte, minSeparation, i, t6, t7, bodyA, bodyB, c, t11, psm, normal, invIA, point, invMassA, invMassB, invIB, t1, t2, j, t3, t9, t14, t4);
      ...
      t16 = t6.get$angle();
      if (typeof t16 !== 'number')
        return this.solvePositionConstraints$1$bailout1(26, baumgarte, invIB, minSeparation, i, t1, j, t6, t16, t2, t3, bodyA, bodyB, t4, invMassA, psm, normal, point, invIA, c, invMassB);
      t18 = t4.x;
      if (typeof t18 !== 'number')
        return this.solvePositionConstraints$1$bailout1(27, baumgarte, invIB, minSeparation, i, t1, j, t6, t16, t2, t3, bodyA, bodyB, t4, invMassA, t18, psm, normal, point, c, invIA, invMassB);
      t20 = t1.y;
      if (typeof t20 !== 'number')
        return this.solvePositionConstraints$1$bailout1(28, baumgarte, invIB, invIA, minSeparation, i, t1, j, t6, t16, t2, t3, bodyA, bodyB, t4, invMassA, t18, t20, normal, psm, c, point, invMassB);
      t20 = t18 * t20;
      t18 = t4.y;
      if (typeof t18 !== 'number')
        return this.solvePositionConstraints$1$bailout1(29, baumgarte, invIB, minSeparation, i, t1, t2, j, t6, t16, t3, bodyA, t20, bodyB, t4, invMassA, psm, normal, t18, point, c, invIA, invMassB);
      t23 = t1.x;
      if (typeof t23 !== 'number')
        return this.solvePositionConstraints$1$bailout1(30, baumgarte, invIB, invIA, minSeparation, i, t1, j, t6, t16, t2, t3, bodyA, t20, bodyB, t4, invMassA, psm, normal, t18, t23, c, point, invMassB);
 ...
 solve$1: function(baumgarte) {
  ...
  while (true) {
    ...
    while (true) {
      t7 = c.get$pointCount();
      if (typeof t7 !== 'number')
        return this.solve$1$bailout0(8, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, point, t5, j, bodyA, bodyB, minSeparation, i, t7, t1, t2, t3);
      if (!(j < t7))
        break;
      t5.initialize$2(c, j);
      separation = t5.separation;
      if (typeof separation !== 'number')
        return this.solve$1$bailout0(9, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, point, separation, j, bodyA, bodyB, minSeparation, i, t5, t1, t2, t3);
      t3.setFrom$1(point).subLocal$1(bodyA.get$sweep().get$center());
      t4.setFrom$1(point).subLocal$1(bodyB.get$sweep().get$center());
      minSeparation = $.min(minSeparation, separation);
      if (minSeparation !== (minSeparation | 0))
        return this.solve$1$bailout0(10, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, point, separation, j, bodyA, minSeparation, bodyB, i, t5, t1, t2, t3);
      C = $.max(-0.2, $.min(baumgarte * (separation + 0.005), 0));
      t9 = t3.x;
      if (typeof t9 !== 'number')
        return this.solve$1$bailout0(11, C, invMassA, baumgarte, invIA, c, invMassB, t4, normal, invIB, point, t5, j, bodyA, minSeparation, bodyB, t9, i, t1, t2, t3);
      t11 = normal.y;
      if (typeof t11 !== 'number')
        return this.solve$1$bailout0(12, C, invMassA, baumgarte, invIA, c, invMassB, t4, normal, invIB, point, t5, j, bodyA, minSeparation, bodyB, t9, t11, i, t1, t2, t3);
      t9 *= t11;
      t13 = t3.y;
      if (typeof t13 !== 'number')
        return this.solve$1$bailout0(13, C, invMassA, baumgarte, invIA, t9, c, invMassB, t4, normal, invIB, point, t5, j, bodyA, minSeparation, bodyB, t13, i, t1, t2, t3);
      t15 = normal.x;
      if (typeof t15 !== 'number')
        return this.solve$1$bailout0(14, C, invMassA, baumgarte, invIA, t9, c, invMassB, t4, normal, invIB, point, t5, j, bodyA, minSeparation, bodyB, t13, t15, i, t1, t2, t3);
      rnA = t9 - t13 * t15;
      t9 = t4.x;
      if (typeof t9 !== 'number')
        return this.solve$1$bailout0(15, C, invMassA, baumgarte, invIA, c, invMassB, t4, normal, invIB, rnA, point, t5, j, bodyA, minSeparation, bodyB, i, t9, t1, t2, t3);
      t11 = t9 * t11;
      t9 = t4.y;
      if (typeof t9 !== 'number')
        return this.solve$1$bailout0(17, C, invMassA, baumgarte, invIA, c, invMassB, t4, normal, invIB, rnA, point, t5, j, bodyA, minSeparation, bodyB, i, t11, t9, t1, t2, t3);
      rnB = t11 - t9 * t15;
      ...
      t8 = t7.get$angle();
      if (typeof t8 !== 'number')
        return this.solve$1$bailout0(19, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, point, t5, j, bodyA, minSeparation, bodyB, i, t1, t2, t7, t8, t3);
      t10 = t3.x;
      if (typeof t10 !== 'number')
        return this.solve$1$bailout0(20, baumgarte, t10, invMassA, c, invIA, invMassB, t4, normal, invIB, point, t5, j, bodyA, minSeparation, bodyB, i, t1, t2, t7, t8, t3);
      t12 = t1.y;
      if (typeof t12 !== 'number')
        return this.solve$1$bailout0(21, baumgarte, t10, t12, c, invIA, invMassB, t4, normal, invIB, invMassA, point, t5, j, bodyA, minSeparation, bodyB, i, t1, t2, t7, t8, t3);
      t12 = t10 * t12;
      t10 = t3.y;
      if (typeof t10 !== 'number')
        return this.solve$1$bailout0(22, baumgarte, invMassA, t12, invIA, t10, invMassB, t4, c, invIB, point, normal, t5, j, bodyA, minSeparation, bodyB, i, t1, t2, t7, t8, t3);
      t15 = t1.x;
      if (typeof t15 !== 'number')
      ...
      t17 = t7.get$angle();
      if (typeof t17 !== 'number')
        return this.solve$1$bailout0(24, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, point, t5, j, bodyA, minSeparation, bodyB, i, t7, t17, t1, t2, t3);
      t19 = t4.x;
      if (typeof t19 !== 'number')
        return this.solve$1$bailout0(25, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, t19, point, t5, j, bodyA, minSeparation, bodyB, i, t7, t17, t1, t2, t3);
      t21 = t1.y;
      if (typeof t21 !== 'number')
        return this.solve$1$bailout0(26, baumgarte, invMassA, c, invIA, invMassB, t4, normal, invIB, t21, point, t19, j, t5, minSeparation, bodyB, bodyA, i, t7, t17, t1, t2, t3);
      t21 = t19 * t21;
      t19 = t4.y;
      if (typeof t19 !== 'number')
        return this.solve$1$bailout0(27, baumgarte, invMassA, t3, c, invIA, invMassB, t4, normal, invIB, point, t19, t5, j, bodyA, minSeparation, bodyB, i, t7, t17, t1, t2, t21);
      t24 = t1.x;
      if (typeof t24 !== 'number')
...
$$.ConstantVolumeJoint = {"":"Joint;bodies>,targetLengths,targetVolume,normals>,step,_impulse,_world,distanceJoints,frequencyHz>,dampingRatio>,type,_prev,_liblib1$_next,edgeA,edgeB,bodyA,bodyB,islandFlag,collideConnected,userData,localCenterA,localCenterB,invMassA,invIA,invMassB,invIB",
 ...
 constrainEdges$1: function(argStep) {
  var i, perimeter, t1, next, t2, t3, dx, t4, t5, dy, dist, delta, deltaArea, toExtrude, done, t6, t7, norm;
  for (i = 0, perimeter = 0; t1 = this.bodies, $.ltB(i, $.getInterceptor$JSStringJSArray(t1).get$length(t1)); ++i) {
    t1 = this.bodies;
 ...
 initVelocityConstraints$1: function(argStep) {
  ...
  while (true) {
    ...
    t4 = this.bodies;
    if (typeof t4 !== 'string' && (typeof t4 !== 'object' || t4 === null || t4.constructor !== Array && !t4.is$JavaScriptIndexingBehavior()))
      return this.initVelocityConstraints$1$bailout2(6, d, t1, i, prev, t4);
    if (prev !== (prev | 0))
      throw $.iae(prev);
 ...
 solveVelocityConstraints$1: function(argStep) {
  var t1, d, i, dotMassSum, crossMassSum, prev, next, t2, t3, t4, t5, t6, t7, lambda, t8, t9;
  t1 = this.bodies;
  d = $.List_List($.getInterceptor$JSStringJSArray(t1).get$length(t1));
  ...
  for (dotMassSum = 0, i = 0, crossMassSum = 0; t1 = this.bodies, $.ltB(i, $.getInterceptor$JSStringJSArray(t1).get$length(t1)); ++i) {
    if (i === 0) {
      t1 = this.bodies;
...
$.BlobTest$ = function() {
  var t1 = new $.BlobTest($.List_List(null), null, null, null, null, null, null, null, null, null, 10, null);
...
$.ConstantVolumeJointDef$ = function() {
  var t1 = new $.ConstantVolumeJointDef(0, 0, $.List_List(null), null, 0, null, null, null, false);
