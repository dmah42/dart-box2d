...
$$.Collision = {"":"Object;_pool,cache,input,output,results1,results2,incidentEdge>,localTangent,localNormal>,planePoint,tangent,normal>,normal1,v11,v12,clipPoints1,clipPoints2",
 ...
 edgeSeparation$5: function(poly1, xf1, edge1, poly2, xf2) {
  ...
  for (t1 = vertices2.length, index = 0, minDot = 99999999999999, i = 0; i < count2; ++i) {
    ...
    t2 = a.get$x();
    if (t2 !== (t2 | 0))
      return this.edgeSeparation$5$bailout(17, xf1, edge1, xf2, index, normal1Worldx, minDot, R1, i, vertices2, R, vertices1, count2, normal1x, a, t2, normal1y, normal1Worldy);
    t2 *= normal1x;
    t4 = a.get$y();
    if (t4 !== (t4 | 0))
      return this.edgeSeparation$5$bailout(18, xf1, edge1, xf2, index, normal1Worldx, minDot, R1, i, vertices2, R, vertices1, count2, normal1x, normal1Worldy, normal1y, t2, t4);
    dot = t2 + t4 * normal1y;
    if (dot < minDot) {
      minDot = dot;
      index = i;
...
$$.DistanceProxy = {"":"Object;vertices>,count=,radius=",
 ...
 getSupport$1: function(direction) {
  ...
  while (true) {
    ...
    t3 = t3.get$y();
    if (typeof t3 !== 'number')
      return this.getSupport$1$bailout0(8, direction, t2, bestIndex, t4, bestValue, i, t3, t1);
    value = t4 + t3 * t9;
    if (value > bestValue) {
      bestValue = value;
      bestIndex = i;
 ...
 timeOfImpact$2: function(output, input) {
  ...
  for (t1 = this.fcn, t2 = this.indexes, t5 = t2.length, t6 = target + 0.00125, t7 = target - 0.00125, t8 = this.distanceOutput, t9 = this.xfA, t11 = this.xfB, t13 = this.pool, t14 = 0, iter = 0; true;) {
    ...
    for (t20 = tMax, pushBackIter = 0; done = false, true;) {
      ...
      if (typeof s2 !== 'number')
        return this.timeOfImpact$2$bailout(7, output, t11, s2, t13, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t3, t4, t6, t10, t14, t12, iter, t5, t20, pushBackIter, t9);
      if (s2 > t6) {
        output.set$state(4);
        output.set$t(tMax);
        done = true;
      ...
      if (typeof s1 !== 'number')
        return this.timeOfImpact$2$bailout(8, output, t11, s2, t13, proxyA, proxyB, t8, tMax, t1, t2, s1, target, t7, t3, t4, t6, t10, t14, t12, iter, t5, t20, pushBackIter, t9);
      if (s1 < t7) {
        output.set$state(1);
        output.set$t(t14);
        done = true;
      ...
      for (a2 = t20, a1 = t14, rootIterCount = 0; true;) {
        ...
        if (typeof s !== 'number')
          return this.timeOfImpact$2$bailout(9, output, t11, s2, s1, rootIterCount, a1, a2, t13, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t, t3, t4, t6, s, t10, t14, t12, iter, t5, t20, pushBackIter, t9);
        t15 = $.CONSTANT2.abs$0(s - target);
        if (typeof t15 !== 'number')
          return this.timeOfImpact$2$bailout(10, output, t11, s2, s1, rootIterCount, a1, a2, t13, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t, t3, t4, t6, s, t10, t14, t15, iter, t5, t20, pushBackIter, t12, t9);
        if (t15 < 0.00125) {
          t20 = t;
          break;
        }
        ...
        if (a1 !== (a1 | 0))
          return this.timeOfImpact$2$bailout(11, output, t11, s2, s1, a1, a2, t13, rootIterCount, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t3, t4, t6, t10, t14, t12, iter, t5, t20, pushBackIter, t9);
        ++rootIterCount;
        t16 = $.TimeOfImpact_toiRootIters;
        if (typeof t16 !== 'number')
          return this.timeOfImpact$2$bailout(12, output, t11, s2, s1, a1, a2, rootIterCount, t16, proxyA, t13, proxyB, t8, tMax, t1, t2, target, t7, t3, t4, t6, t10, t14, t12, iter, t5, t20, pushBackIter, t9);
        $.TimeOfImpact_toiRootIters = t16 + 1;
        if (rootIterCount === 50)
          break;
      }
      if (t20 !== (t20 | 0))
        return this.timeOfImpact$2$bailout(13, output, t11, t13, proxyA, proxyB, t8, tMax, t20, t1, t2, rootIterCount, target, t7, t3, t4, t6, t10, t14, t12, t5, iter, pushBackIter, t9);
...
$$.PolygonShape = {"":"Shape;centroid>,vertices>,normals>,vertexCount>,type,radius",
 getSupport$1: function(d) {
  ...
  while (true) {
    ...
    t2 = t2.get$y();
    if (typeof t2 !== 'number')
      return this.getSupport$1$bailout(9, d, t4, bestIndex, bestValue, i, t1, t2);
    value = t4 + t2 * t10;
    if (value > bestValue) {
      bestValue = value;
      bestIndex = i;
...
$$.Island = {"":"Object;listener,bodies>,contacts,joints>,positions,velocities,bodyCount>,jointCount,contactCount>,bodyCapacity,contactCapacity,jointCapacity,positionIterationCount,_contactSolver,_translation,impulse",
 ...
 solve$3: function(step, gravity, allowSleep) {
  ...
  while (true) {
    ...
    t1 = bodyA.get$type();
    if (typeof t1 !== 'number')
      return this.solve$3$bailout(24, step, i2, bodyB, t1, allowSleep, i1);
    if (!(t1 === 0)) {
      t1 = bodyB.get$type();
      if (typeof t1 !== 'number')
        return this.solve$3$bailout(25, step, i2, allowSleep, t1, i1);
      nonStatic = !(t1 === 0);
    } else
      nonStatic = false;
    if (nonStatic) {
  ...
  while (true) {
    ...
    while (true) {
      t1 = this.jointCount;
      if (typeof t1 !== 'number')
        return this.solve$3$bailout(32, step, t2, i, j, allowSleep, t1);
      if (!(j < t1))
        break;
      t1 = this.joints;
      if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))
        return this.solve$3$bailout(33, step, t2, allowSleep, j, i, t1);
      if (j >= t1.length)
        throw $.ioore(j);
 ...
 update$1: function(listener) {
  ...
  if (sensor) {
    ...
    while (true) {
      ...
      if (typeof t5 !== 'number')
        return this.update$1$bailout(5, listener, bodyA, wasTouching, i, bodyB, t1, t5, touching, t3, t2, sensor);
      if (!(i < t5))
        break;
      t4 = t4.get$points();
      if (typeof t4 !== 'string' && (typeof t4 !== 'object' || t4 === null || t4.constructor !== Array && !t4.is$JavaScriptIndexingBehavior()))
...
$$.ContactSolver = {"":"Object;constraints>,constraintCount,worldManifold,tangent,temp1,temp2,P,dv,dv1,dv2,x>,d,P1,P2,psolver,rA>,rB>",
 ...
 solveVelocityConstraints$0: function() {
  ...
  while (true) {
    ...
    while (true) {
      ...
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(9, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, t2, j, t7, t8, wA, wB, t1, t11);
      if (!(j < t11))
        break;
      t11 = c.get$points();
      if (typeof t11 !== 'string' && (typeof t11 !== 'object' || t11 === null || t11.constructor !== Array && !t11.is$JavaScriptIndexingBehavior()))
        return this.solveVelocityConstraints$0$bailout(10, t11, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, t2, j, t7, t8, wA, wB, t1);
      if (j >= t11.length)
        throw $.ioore(j);
      ccp = t11[j];
      a = ccp.get$rA();
      ...
      if (typeof t13 !== 'number')
        return this.solveVelocityConstraints$0$bailout(11, t9, ccp, a, t11, t10, t13, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, t2, j, t7, t8, wA, wB, t1);
      t13 = t11 * t13;
      t11 = vB.get$x();
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(12, t9, ccp, a, t10, i, t13, t11, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, t2, j, t7, t8, wA, wB, t1);
      t11 = t13 + t11;
      t13 = vA.get$x();
      if (typeof t13 !== 'number')
        return this.solveVelocityConstraints$0$bailout(13, t9, ccp, a, t10, i, t11, t13, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, t2, j, t7, t8, wA, wB, t1);
      t13 = t11 - t13;
      t11 = a.get$y();
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(14, t9, ccp, a, t10, i, c, t13, t11, bodyB, bodyA, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, t2, j, t7, t8, wA, wB, t1);
      t1.x = t13 + wA * t11;
      t18 = ccp.get$rB().get$x();
      if (typeof t18 !== 'number')
        return this.solveVelocityConstraints$0$bailout(15, t9, ccp, a, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, t18, invIB, t3, t4, friction, t5, t6, t2, j, t7, t8, wA, wB, t1);
      t18 = wB * t18;
      t20 = vB.get$y();
      if (typeof t20 !== 'number')
        return this.solveVelocityConstraints$0$bailout(16, t9, ccp, a, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t18, t20, t3, t4, friction, t5, t6, t2, j, t7, t8, wA, wB, t1);
      t20 = t18 + t20;
      t18 = vA.get$y();
      if (typeof t18 !== 'number')
        return this.solveVelocityConstraints$0$bailout(17, t9, ccp, a, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t20, t18, t3, t4, friction, t5, t6, t2, j, t7, t8, wA, wB, t1);
      t18 = t20 - t18;
      t20 = a.get$x();
      if (typeof t20 !== 'number')
        return this.solveVelocityConstraints$0$bailout(18, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t18, t20, t3, t4, friction, t5, t6, t2, j, t7, t8, wA, wB, t1);
      t1.y = t18 - wA * t20;
      t24 = t1.x;
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(19, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t24, t2, j, t6, t7, t8, wA, wB, t1);
      t26 = t2.x;
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(20, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t24, t2, j, t26, t7, t6, wA, wB, t8, t1);
      t26 = t24 * t26;
      t24 = t1.y;
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(21, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, t2, j, t7, t24, t8, wA, wB, t26, t1);
      t29 = t2.y;
      if (typeof t29 !== 'number')
        return this.solveVelocityConstraints$0$bailout(22, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, t2, j, t7, t24, t29, wA, wB, t8, t26, t1);
      vt = t26 + t24 * t29;
      t26 = ccp.get$tangentMass();
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(23, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, t2, j, t7, t8, wA, wB, vt, t26, t1);
      lambda = t26 * -vt;
      t26 = ccp.get$normalImpulse();
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(24, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, friction, t5, t6, t2, j, t7, t8, wA, wB, t1, lambda, t26);
      maxFriction = friction * t26;
      t26 = ccp.get$tangentImpulse();
      if (typeof t26 !== 'number')
        return this.solveVelocityConstraints$0$bailout(25, t9, ccp, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, t5, friction, t6, t2, j, t7, t8, wA, wB, t1, lambda, maxFriction, t26);
      t26 += lambda;
      ...
      t34 = t2.x;
      if (typeof t34 !== 'number')
        return this.solveVelocityConstraints$0$bailout(26, t9, ccp, t10, newImpulse, i, lambda, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, t5, friction, t6, t2, j, t7, t8, wA, wB, t34, t1);
      Px = t34 * lambda;
      t34 = t2.y;
      if (typeof t34 !== 'number')
        return this.solveVelocityConstraints$0$bailout(27, t9, ccp, t10, newImpulse, i, lambda, Px, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, t5, friction, t6, t2, j, t7, t8, wA, wB, t34, t1);
      Py = t34 * lambda;
      t34 = vA.get$x();
      if (typeof t34 !== 'number')
        return this.solveVelocityConstraints$0$bailout(28, t9, ccp, t10, newImpulse, i, Px, c, bodyA, bodyB, Py, t34, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, t5, friction, t6, t2, j, t7, t8, wA, wB, t1);
      vA.set$x(t34 - Px * invMassA);
      t38 = vA.get$y();
      if (typeof t38 !== 'number')
        return this.solveVelocityConstraints$0$bailout(29, t9, ccp, t10, newImpulse, i, Px, c, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, t38, t3, t4, t5, friction, t6, t2, j, t7, t8, wA, wB, t1);
      vA.set$y(t38 - Py * invMassA);
      t40 = ccp.get$rA();
      t41 = t40.get$x();
      if (typeof t41 !== 'number')
        return this.solveVelocityConstraints$0$bailout(30, t9, ccp, t10, newImpulse, i, Px, c, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, t41, t3, t4, t5, friction, t6, t2, j, t7, t8, wA, wB, t1);
      t41 *= Py;
      t40 = t40.get$y();
      if (typeof t40 !== 'number')
        return this.solveVelocityConstraints$0$bailout(31, t9, ccp, t10, newImpulse, i, Px, c, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, t41, t40, t3, t4, t5, friction, t6, t2, j, t7, t8, wA, wB, t1);
      wA -= invIA * (t41 - t40 * Px);
      t44 = vB.get$x();
      if (typeof t44 !== 'number')
        return this.solveVelocityConstraints$0$bailout(32, t9, ccp, t10, newImpulse, i, Px, c, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, t5, friction, wA, t44, t6, j, t7, t2, t8, wB, t1);
      vB.set$x(t44 + Px * invMassB);
      t46 = vB.get$y();
      if (typeof t46 !== 'number')
        return this.solveVelocityConstraints$0$bailout(33, t9, ccp, t10, newImpulse, i, Px, c, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, t5, friction, wA, t6, t2, j, t7, t46, t8, wB, t1);
      vB.set$y(t46 + Py * invMassB);
      t48 = ccp.get$rB();
      t49 = t48.get$x();
      if (typeof t49 !== 'number')
        return this.solveVelocityConstraints$0$bailout(34, t9, ccp, t10, newImpulse, i, Px, c, bodyA, bodyB, Py, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, t5, friction, wA, t6, t2, j, t7, t8, wB, t1, t49);
      t49 *= Py;
      t48 = t48.get$y();
      if (typeof t48 !== 'number')
        return this.solveVelocityConstraints$0$bailout(35, t9, ccp, t10, newImpulse, i, Px, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, t3, t4, t5, friction, wA, t6, t2, j, t7, t8, wB, t1, t49, t48);
      wB += invIB * (t49 - t48 * Px);
    ...
    if (t11) {
      ...
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(38, t9, t10, i, c, bodyA, bodyB, vA, vB, a1, ccp, invMassB, invIB, invIA, invMassA, t15, t11, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t11 = t15 * t11;
      t15 = vB.get$x();
      if (typeof t15 !== 'number')
        return this.solveVelocityConstraints$0$bailout(39, t9, t10, i, c, bodyA, bodyB, vA, vB, a1, ccp, invMassB, invIB, invIA, t11, invMassA, t15, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t15 = t11 + t15;
      t11 = vA.get$x();
      if (typeof t11 !== 'number')
        return this.solveVelocityConstraints$0$bailout(40, t9, t10, i, c, bodyA, bodyB, vA, vB, a1, ccp, invMassB, invIB, invIA, invMassA, t15, t11, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t11 = t15 - t11;
      t15 = a1.get$y();
      if (typeof t15 !== 'number')
        return this.solveVelocityConstraints$0$bailout(41, t9, t10, i, c, bodyA, bodyB, vA, vB, a1, ccp, invMassB, invIB, invIA, invMassA, t11, t15, t3, t4, t5, t6, t2, t7, t8, wA, wB, t1);
      t1.x = t11 + wA * t15;
      t18 = ccp.get$rB().get$x();
      if (typeof t18 !== 'number')
        return this.solveVelocityConstraints$0$bailout(42, t9, t10, i, c, bodyA, bodyB, vA, vB, a1, ccp, invMassB, invIB, invIA, invMassA, t3, t4, t18, t5, t6, t2, t7, t8, wA, wB, t1);
      t18 = wB * t18;
      t20 = vB.get$y();
      if (typeof t20 !== 'number')
        return this.solveVelocityConstraints$0$bailout(43, t9, t10, i, c, bodyA, bodyB, vA, vB, a1, ccp, invMassB, invIB, invIA, invMassA, t3, t4, t5, t18, t20, t6, t2, t7, t8, wA, wB, t1);
      t20 = t18 + t20;
      t18 = vA.get$y();
      if (typeof t18 !== 'number')
      ...
      t15 = t15.get$y();
      if (typeof t15 !== 'number')
        return this.solveVelocityConstraints$0$bailout(59, t9, t10, i, bodyA, bodyB, vA, vB, ccp, invMassB, newImpulse, invIB, invIA, Px, Py, t3, t4, t5, t6, t2, t7, t8, t16, wB, t15, wA, t1);
      wA -= invIA * (t16 - t15 * Px);
      t19 = vB.get$x();
      if (typeof t19 !== 'number')
      ...
      t24 = t23.get$x();
      if (typeof t24 !== 'number')
        return this.solveVelocityConstraints$0$bailout(62, t9, Py, t10, i, t3, t4, t5, t24, t6, t2, bodyA, bodyB, t7, vA, vB, wB, ccp, newImpulse, invIB, t1, t8, wA, Px);
      t24 *= Py;
      t23 = t23.get$y();
      if (typeof t23 !== 'number')
      ...
      if (typeof t32 !== 'number')
        return this.solveVelocityConstraints$0$bailout(80, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t30, t6, t2, t7, t8, wA, wB, t32, t1);
      t10.y = t30 - wA * t32;
      t36 = t9.x;
      ...
      if (typeof t39 !== 'number')
        return this.solveVelocityConstraints$0$bailout(82, t9, t10, i, t36, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t39, t1);
      t36 *= t39;
      t41 = t9.y;
      if (typeof t41 !== 'number')
      ...
      t38 = t38.get$y();
      if (typeof t38 !== 'number')
        return this.solveVelocityConstraints$0$bailout(84, t9, t10, i, t41, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, cp1, cp2, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t36, t1, t38);
      vn1 = t36 + t41 * t38;
      t36 = t10.x;
      if (typeof t36 !== 'number')
      ...
      $loop$1: {
        ...
        if (t11) {
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(105, t9, t10, i, t3, t4, t5, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, invIA, t11, invIB, wA, t12, cp1, t1, cp2);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(107, t9, t10, i, t3, t4, t5, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, invIA, invIB, wA, t12, cp1, t11, t1, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
          ...
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(113, t9, t10, i, t3, t4, t5, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, wA, t27, invIB, t28, t1, cp1, cp2);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
            return this.solveVelocityConstraints$0$bailout(115, t9, t10, i, t3, t4, t5, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, wA, invIB, t14, t27, t1, cp1, cp2);
          t14 -= t27 * t17;
          t30 = cp2.get$rB();
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(117, t30, t31, t9, t10, i, t3, t4, t5, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, wA, invIB, t1, cp1, t14, cp2);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(119, t9, t22, i, t30, t4, t5, t3, t10, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, wA, invIB, t1, cp1, cp2, t14);
        ...
        if (t17 >= 0 && vn2 >= 0) {
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(127, t9, t12, t10, i, t3, t4, t5, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, wA, invIA, invIB, t1, cp1, cp2, t11);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(129, t9, t12, i, t11, t4, t5, t3, t10, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, wA, invIA, invIB, t1, cp1, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
          ...
          t19 = t19.get$y();
          if (typeof t19 !== 'number')
            return this.solveVelocityConstraints$0$bailout(133, t9, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t12, t6, t2, t7, t20, t8, t19, wB, wA, t1);
          t25 = t6.x;
          if (typeof t25 !== 'number')
            return this.solveVelocityConstraints$0$bailout(134, t9, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t25, t3, t4, t5, t12, t6, t2, t7, t20, t19, wA, wB, t8, t1);
          wA -= invIA * (t12 + (t20 - t19 * t25));
          t27 = cp1.get$rB();
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(135, t9, t10, i, t3, t4, t5, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, invIB, t1, cp1, wA, t27, cp2, t28);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
            return this.solveVelocityConstraints$0$bailout(137, t9, t14, t27, t10, i, t3, t4, t5, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, invIB, t1, cp1, wA, cp2);
          t14 -= t27 * t17;
          t30 = cp2.get$rB();
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(139, t9, t10, i, t3, t4, t14, t30, t6, t31, t2, bodyA, bodyB, t7, vA, vB, wB, t8, invIB, t1, cp1, wA, t5, cp2);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(141, t9, t10, i, t3, t4, t14, t5, t6, t2, t8, t22, t30, bodyB, bodyA, vA, vB, wB, invIB, t7, t1, cp1, wA, cp2);
          wB += invIB * (t14 + (t22 - t30 * t25));
          cp1.set$normalImpulse(t4.get$x());
          cp2.set$normalImpulse(t4.get$y());
          break $loop$1;
        ...
        t13 = b.y;
        if (typeof t13 !== 'number')
          return this.solveVelocityConstraints$0$bailout(144, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, a, t3, t4, t5, t11, t6, t2, t7, t8, wA, wB, t13, t1);
        t4.set$y(t11 * t13);
        ...
        t17 = t4.get$y();
        if (typeof t17 !== 'number')
          return this.solveVelocityConstraints$0$bailout(146, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, a, t3, t4, t5, t6, t2, t7, t15, t8, wA, wB, t17, t1);
        t15 *= t17;
        t19 = b.x;
        if (typeof t19 !== 'number')
          return this.solveVelocityConstraints$0$bailout(147, t9, t10, i, c, bodyA, bodyB, vA, vB, invMassA, invIA, invMassB, invIB, b, cp1, cp2, a, t3, t4, t5, t6, t2, t7, t8, wA, wB, t15, t1, t19);
        vn1 = t15 + t19;
        if (t17 >= 0 && vn1 >= 0) {
          t3.setFrom$1(t4).subLocal$1(a);
          t5.setFrom$1(c.get$normal()).mulLocal$1(t3.x);
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(149, t9, t10, i, t3, t4, t5, t11, t6, t12, t2, bodyA, bodyB, t7, vA, vB, wB, wA, invIA, invIB, t1, cp1, cp2, t8);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(151, t9, t10, i, t3, t4, t5, t6, t2, t8, t12, t11, bodyB, bodyA, vA, vB, wB, wA, invIA, invIB, t7, t1, cp1, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
          ...
          t22 = t6.y;
          if (typeof t22 !== 'number')
            return this.solveVelocityConstraints$0$bailout(154, t9, t10, i, t22, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t6, t2, t7, t8, wA, wB, t12, t19, t20, t1);
          t20 *= t22;
          t19 = t19.get$y();
          if (typeof t19 !== 'number')
          ...
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(157, t9, t10, i, wA, t4, t5, t28, t27, t6, t3, t2, bodyA, bodyB, t7, vA, vB, wB, t8, invIB, t1, cp1, cp2);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
            return this.solveVelocityConstraints$0$bailout(159, t9, t10, i, wA, t4, t5, t3, t6, t14, t27, bodyA, bodyB, t7, vA, vB, wB, t8, t2, invIB, t1, cp1, cp2);
          t14 -= t27 * t17;
          t30 = cp2.get$rB();
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(161, t9, t10, i, wA, t4, t5, t3, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, t14, t30, invIB, t31, t1, cp1, cp2);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(163, t9, t10, i, wA, t4, t5, t3, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, t14, invIB, t22, t30, t1, cp1, cp2);
          wB += invIB * (t14 + (t22 - t30 * t25));
          cp1.set$normalImpulse(t4.get$x());
          cp2.set$normalImpulse(t4.get$y());
          break $loop$1;
        ...
        if (vn1 >= 0 && vn2 >= 0) {
          ...
          t12 = t11.get$x();
          if (typeof t12 !== 'number')
            return this.solveVelocityConstraints$0$bailout(167, t9, t11, t10, i, t12, t4, t5, t3, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, wA, invIA, invIB, t1, cp1, cp2);
          t14 = t5.y;
          if (typeof t14 !== 'number')
          ...
          t11 = t11.get$y();
          if (typeof t11 !== 'number')
            return this.solveVelocityConstraints$0$bailout(169, t9, t10, i, t3, t4, t5, t12, t11, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, wA, invIA, invIB, t1, cp1, cp2);
          t17 = t5.x;
          if (typeof t17 !== 'number')
          ...
          t25 = t6.x;
          if (typeof t25 !== 'number')
            return this.solveVelocityConstraints$0$bailout(174, t9, t10, i, bodyA, bodyB, vA, vB, invIA, invIB, cp1, cp2, t3, t4, t5, t25, t6, t2, t12, t7, t8, wA, wB, t20, t19, t1);
          wA -= invIA * (t12 + (t20 - t19 * t25));
          t27 = cp1.get$rB();
          t28 = t27.get$x();
          if (typeof t28 !== 'number')
            return this.solveVelocityConstraints$0$bailout(175, wA, t27, t28, t10, i, t9, t4, t5, t3, t6, t2, t8, bodyA, bodyB, t7, vA, vB, wB, invIB, t1, cp1, cp2);
          t14 = t28 * t14;
          t27 = t27.get$y();
          if (typeof t27 !== 'number')
            return this.solveVelocityConstraints$0$bailout(177, wA, t9, t10, i, t14, t27, t4, t5, t6, t3, t2, bodyA, bodyB, t7, vA, vB, wB, t8, invIB, t1, cp1, cp2);
          t14 -= t27 * t17;
          t30 = cp2.get$rB();
          t31 = t30.get$x();
          if (typeof t31 !== 'number')
            return this.solveVelocityConstraints$0$bailout(179, wA, t9, t10, i, t3, t4, t5, t6, t14, t30, bodyA, t31, bodyB, t7, vA, vB, wB, t8, t2, invIB, t1, cp1, cp2);
          t22 = t31 * t22;
          t30 = t30.get$y();
          if (typeof t30 !== 'number')
            return this.solveVelocityConstraints$0$bailout(181, wA, t9, t10, i, t3, t4, t5, t6, t14, t2, bodyA, bodyB, t7, vA, vB, wB, t22, t30, invIB, t1, cp1, cp2, t8);
          wB += invIB * (t14 + (t22 - t30 * t25));
          cp1.set$normalImpulse(t4.get$x());
          cp2.set$normalImpulse(t4.get$y());
          break $loop$1;
 ...
 solvePositionConstraints$1: function(baumgarte) {
  ...
  while (true) {
    ...
    if (typeof t5 !== 'number')
      return this.solvePositionConstraints$1$bailout1(1, baumgarte, t5, t4, minSeparation, t1, t2, psm, i, t3, normal, point);
    if (!(i < t5))
      break;
    t5 = this.constraints;
    if (i >= t5.length)
    ...
    t5 = bodyA.get$mass();
    if (typeof t5 !== 'number')
      return this.solvePositionConstraints$1$bailout1(2, baumgarte, minSeparation, i, t2, t1, t3, c, bodyA, bodyB, t5, t4, psm, normal, point);
    t7 = bodyA.get$invMass();
    if (typeof t7 !== 'number')
      return this.solvePositionConstraints$1$bailout1(3, baumgarte, minSeparation, i, t2, t1, t3, c, bodyA, bodyB, t5, t4, t7, psm, normal, point);
    invMassA = t5 * t7;
    t7 = bodyA.get$invInertia();
    if (typeof t7 !== 'number')
      return this.solvePositionConstraints$1$bailout1(5, baumgarte, minSeparation, i, t2, t1, t3, c, bodyA, bodyB, t4, invMassA, normal, point, psm, t5, t7);
    invIA = t5 * t7;
    t7 = bodyB.get$mass();
    if (typeof t7 !== 'number')
      return this.solvePositionConstraints$1$bailout1(6, baumgarte, minSeparation, i, t2, t1, t3, c, bodyA, bodyB, t4, invMassA, normal, point, psm, invIA, t7);
    t10 = bodyB.get$invMass();
    if (typeof t10 !== 'number')
      return this.solvePositionConstraints$1$bailout1(7, baumgarte, minSeparation, i, t2, t1, t3, c, bodyA, bodyB, t4, invMassA, normal, point, psm, invIA, t7, t10);
    invMassB = t7 * t10;
    t10 = bodyB.get$invInertia();
    if (typeof t10 !== 'number')
      return this.solvePositionConstraints$1$bailout1(9, baumgarte, t10, minSeparation, t1, t2, i, t3, c, bodyA, bodyB, t4, invMassA, normal, point, psm, invIA, invMassB, t7);
    invIB = t7 * t10;
    ...
    while (true) {
      t6 = c.get$pointCount();
      if (typeof t6 !== 'number')
        return this.solvePositionConstraints$1$bailout1(10, baumgarte, invIB, t1, t2, minSeparation, j, t3, i, c, bodyA, bodyB, t6, t4, invMassA, normal, point, psm, invIA, invMassB);
      if (!(j < t6))
        break;
      psm.initialize$2(c, j);
      separation = psm.separation;
      if (typeof separation !== 'number')
        return this.solvePositionConstraints$1$bailout1(11, baumgarte, invIB, t1, t2, minSeparation, j, t3, i, c, bodyA, bodyB, t4, invMassA, normal, point, separation, invIA, psm, invMassB);
      ...
      if (minSeparation !== (minSeparation | 0))
        return this.solvePositionConstraints$1$bailout1(12, baumgarte, invIB, minSeparation, t1, t2, j, t3, i, c, bodyA, bodyB, t4, invMassA, normal, point, separation, invIA, psm, invMassB);
      C = $.max(-0.2, $.min(baumgarte * (separation + 0.005), 0));
      t8 = t3.x;
      if (typeof t8 !== 'number')
        return this.solvePositionConstraints$1$bailout1(13, baumgarte, invIB, minSeparation, j, t2, t1, t3, i, c, bodyA, bodyB, C, t4, invMassA, normal, point, psm, invIA, t8, invMassB);
      t10 = normal.y;
      if (typeof t10 !== 'number')
        return this.solvePositionConstraints$1$bailout1(14, baumgarte, invIB, minSeparation, j, t2, t1, t3, i, c, bodyA, bodyB, C, t4, invMassA, normal, point, psm, invIA, t8, invMassB, t10);
      t8 *= t10;
      t12 = t3.y;
      if (typeof t12 !== 'number')
        return this.solvePositionConstraints$1$bailout1(15, baumgarte, invIB, minSeparation, j, t2, t1, t3, i, c, bodyA, bodyB, C, t4, invMassA, normal, t8, psm, invIA, point, invMassB, t12);
      t14 = normal.x;
      if (typeof t14 !== 'number')
        return this.solvePositionConstraints$1$bailout1(16, t14, baumgarte, invIB, minSeparation, t1, t2, j, t3, i, c, bodyA, bodyB, C, t4, invMassA, normal, t8, psm, invIA, point, invMassB, t12);
      rnA = t8 - t12 * t14;
      t8 = t4.x;
      if (typeof t8 !== 'number')
        return this.solvePositionConstraints$1$bailout1(17, baumgarte, invIB, t8, minSeparation, t1, t2, j, t3, i, c, bodyA, bodyB, C, t4, invMassA, normal, point, psm, invIA, invMassB, rnA);
      t10 = t8 * t10;
      t8 = t4.y;
      if (typeof t8 !== 'number')
        return this.solvePositionConstraints$1$bailout1(19, baumgarte, invIB, t10, t8, minSeparation, t1, t2, j, t3, i, c, bodyA, bodyB, C, t4, invMassA, normal, point, psm, invIA, invMassB, rnA);
      rnB = t10 - t8 * t14;
      ...
      t7 = t6.get$angle();
      if (typeof t7 !== 'number')
        return this.solvePositionConstraints$1$bailout1(21, baumgarte, invIB, minSeparation, t1, t2, j, t3, i, t6, t7, bodyA, bodyB, c, t4, psm, normal, point, invMassA, invIA, invMassB);
      t9 = t3.x;
      if (typeof t9 !== 'number')
        return this.solvePositionConstraints$1$bailout1(22, baumgarte, invIB, minSeparation, t1, t2, j, t3, t9, t6, t7, bodyA, bodyB, c, t4, psm, normal, point, invMassA, invIA, i, invMassB);
      t11 = t1.y;
      if (typeof t11 !== 'number')
        return this.solvePositionConstraints$1$bailout1(23, baumgarte, invIB, minSeparation, t1, t2, j, t3, t9, t11, t6, t7, bodyA, bodyB, c, t4, psm, normal, point, invMassA, invIA, i, invMassB);
      t11 = t9 * t11;
      t9 = t3.y;
      if (typeof t9 !== 'number')
        return this.solvePositionConstraints$1$bailout1(24, baumgarte, invIB, minSeparation, t1, t2, j, t3, i, t9, t7, bodyA, bodyB, c, t4, t6, t11, psm, normal, point, invIA, invMassA, invMassB);
      t14 = t1.x;
      if (typeof t14 !== 'number')
        return this.solvePositionConstraints$1$bailout1(25, baumgarte, minSeparation, i, t6, t7, bodyA, bodyB, c, t11, psm, normal, point, invIA, invMassA, invMassB, invIB, t1, t2, j, t3, t9, t14, t4);
      ...
      t16 = t6.get$angle();
      if (typeof t16 !== 'number')
        return this.solvePositionConstraints$1$bailout1(26, baumgarte, invIB, minSeparation, j, t1, t2, i, t6, t16, t3, c, bodyA, bodyB, t4, psm, normal, point, invMassA, invIA, invMassB);
      t18 = t4.x;
      if (typeof t18 !== 'number')
        return this.solvePositionConstraints$1$bailout1(27, baumgarte, invIB, minSeparation, j, t1, t2, i, t6, t16, t3, c, bodyA, bodyB, t4, t18, psm, normal, point, invIA, invMassA, invMassB);
      t20 = t1.y;
      if (typeof t20 !== 'number')
        return this.solvePositionConstraints$1$bailout1(28, baumgarte, invIB, minSeparation, j, t1, t2, i, t6, t16, t3, c, bodyA, bodyB, t4, t18, t20, normal, psm, invIA, point, invMassA, invMassB);
      t20 = t18 * t20;
      t18 = t4.y;
      if (typeof t18 !== 'number')
        return this.solvePositionConstraints$1$bailout1(29, baumgarte, invIB, minSeparation, j, t2, t1, t6, t16, i, t3, c, bodyA, t20, bodyB, t4, psm, normal, t18, point, invIA, invMassA, invMassB);
      t23 = t1.x;
      if (typeof t23 !== 'number')
        return this.solvePositionConstraints$1$bailout1(30, baumgarte, invIB, minSeparation, j, t2, t1, t6, t16, i, t3, c, bodyA, t20, bodyB, t4, psm, normal, t18, t23, invIA, point, invMassA, invMassB);
 ...
 solve$1: function(baumgarte) {
  ...
  while (true) {
    ...
    while (true) {
      t7 = c.get$pointCount();
      if (typeof t7 !== 'number')
        return this.solve$1$bailout0(8, baumgarte, invMassA, invIA, t5, t4, normal, invMassB, point, invIB, i, j, minSeparation, c, bodyA, bodyB, t1, t2, t7, t3);
      if (!(j < t7))
        break;
      t5.initialize$2(c, j);
      separation = t5.separation;
      if (typeof separation !== 'number')
        return this.solve$1$bailout0(9, baumgarte, invMassA, invIA, t5, t4, normal, invMassB, point, invIB, separation, j, i, minSeparation, c, bodyA, bodyB, t1, t2, t3);
      t3.setFrom$1(point).subLocal$1(bodyA.get$sweep().get$center());
      t4.setFrom$1(point).subLocal$1(bodyB.get$sweep().get$center());
      minSeparation = $.min(minSeparation, separation);
      if (minSeparation !== (minSeparation | 0))
        return this.solve$1$bailout0(10, baumgarte, invMassA, invIA, t5, t4, normal, invMassB, point, invIB, separation, j, i, c, bodyA, minSeparation, bodyB, t1, t2, t3);
      C = $.max(-0.2, $.min(baumgarte * (separation + 0.005), 0));
      t9 = t3.x;
      if (typeof t9 !== 'number')
      ...
      t13 = t3.y;
      if (typeof t13 !== 'number')
        return this.solve$1$bailout0(13, C, invMassA, baumgarte, invIA, t9, t4, normal, invMassB, point, invIB, t5, j, i, c, bodyA, minSeparation, bodyB, t13, t1, t2, t3);
      t15 = normal.x;
      if (typeof t15 !== 'number')
        return this.solve$1$bailout0(14, C, invMassA, baumgarte, invIA, t9, t4, normal, invMassB, point, invIB, t5, j, i, c, bodyA, minSeparation, bodyB, t13, t15, t1, t2, t3);
      rnA = t9 - t13 * t15;
      t9 = t4.x;
      if (typeof t9 !== 'number')
        return this.solve$1$bailout0(15, C, invMassA, baumgarte, invIA, t5, t4, normal, invMassB, point, invIB, rnA, j, i, c, bodyA, minSeparation, bodyB, t9, t1, t2, t3);
      t11 = t9 * t11;
      t9 = t4.y;
      if (typeof t9 !== 'number')
        return this.solve$1$bailout0(17, C, invMassA, baumgarte, invIA, t5, t4, normal, invMassB, point, invIB, rnA, j, i, t11, bodyA, minSeparation, bodyB, t9, t1, t2, t3, c);
      rnB = t11 - t9 * t15;
      ...
      t19 = t4.x;
      if (typeof t19 !== 'number')
        return this.solve$1$bailout0(25, baumgarte, invMassA, invIA, t5, t4, normal, t19, point, invIB, i, j, c, invMassB, minSeparation, bodyB, bodyA, t7, t17, t1, t2, t3);
      t21 = t1.y;
      if (typeof t21 !== 'number')
        return this.solve$1$bailout0(26, baumgarte, invMassA, invIA, t5, t4, normal, t19, t21, invIB, i, point, j, c, invMassB, minSeparation, bodyB, bodyA, t7, t17, t1, t2, t3);
      t21 = t19 * t21;
      t19 = t4.y;
      if (typeof t19 !== 'number')
        return this.solve$1$bailout0(27, baumgarte, invMassA, invIA, t5, t4, normal, invMassB, point, invIB, t19, j, i, c, bodyA, minSeparation, bodyB, t7, t17, t1, t2, t3, t21);
      t24 = t1.x;
      if (typeof t24 !== 'number')
...
$$.ConstantVolumeJoint = {"":"Joint;bodies>,targetLengths,targetVolume,normals>,step,_impulse,_world,distanceJoints,frequencyHz>,dampingRatio>,type,_prev,_liblib1$_next,edgeA,edgeB,bodyA,bodyB,islandFlag,collideConnected,userData,localCenterA,localCenterB,invMassA,invIA,invMassB,invIB",
 ...
 initVelocityConstraints$1: function(argStep) {
  ...
  while (true) {
    ...
    t4 = this.bodies;
    if (typeof t4 !== 'string' && (typeof t4 !== 'object' || t4 === null || t4.constructor !== Array && !t4.is$JavaScriptIndexingBehavior()))
      return this.initVelocityConstraints$1$bailout2(6, d, i, t1, t4, prev);
    if (prev !== (prev | 0))
      throw $.iae(prev);
