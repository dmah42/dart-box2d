...
TimeOfImpact: {"": "Object;cache,distanceInput,xfA,xfB,distanceOutput,fcn,indexes,sweepA<,sweepB<,pool",
  timeOfImpact$2: function(output, input) {
    ...
    t4 = t2.angleZero;
    if (typeof t4 !== "number")
      return this.timeOfImpact$2$bailout(2, output, input, t1, d, t4, t2, t3, proxyA, proxyB);
    t2.angleZero = t4 - d;
    t4 = t2.angle;
    if (typeof t4 !== "number")
      return this.timeOfImpact$2$bailout(3, output, input, t1, d, t4, t2, t3, proxyA, proxyB);
    t2.angle = t4 - d;
    t4 = t3.angleZero;
    if (typeof t4 !== "number")
      throw t4.$div();
    ...
    t4 = t3.angleZero;
    if (typeof t4 !== "number")
      return this.timeOfImpact$2$bailout(4, output, input, t1, d, t4, t2, t3, proxyA, proxyB);
    t3.angleZero = t4 - d;
    t4 = t3.angle;
    if (typeof t4 !== "number")
      return this.timeOfImpact$2$bailout(5, output, input, t1, d, t4, t2, t3, proxyA, proxyB);
    t3.angle = t4 - d;
    tMax = input.get$tMax();
    ...
    if (typeof t4 !== "number")
      return this.timeOfImpact$2$bailout(7, output, input, t1, 0, t4, t2, t3, proxyA, proxyB, tMax);
    t5 = proxyB.get$radius();
    if (typeof t5 !== "number")
      return this.timeOfImpact$2$bailout(8, output, input, t1, 0, t4, t2, t3, proxyA, proxyB, tMax, t5);
    ...
    for (t6 = this.fcn, t7 = this.indexes, t8 = t7.length, t9 = target + 0.00125, t10 = target - 0.00125, t11 = this.distanceOutput, t12 = this.xfA, t13 = this.xfB, t14 = this.pool, t15 = 0, iter = 0; true;) {
      ...
      for (t20 = tMax, pushBackIter = 0; done = false, true;) {
        ...
        if (typeof s2 !== "number")
          return this.timeOfImpact$2$bailout(9, output, 0, t1, 0, t4, t2, t3, proxyA, proxyB, tMax, t5, s2, t6, t7, t8, t13, t12, t14, t10, t15, t9, iter, t11, t20, pushBackIter, target);
        if (s2 > t9) {
        ...
        if (typeof s1 !== "number")
          return this.timeOfImpact$2$bailout(10, output, 0, t1, 0, t4, t2, t3, proxyA, proxyB, tMax, t5, s2, t6, t7, t8, t13, t12, t14, t10, t15, t9, iter, t11, t20, pushBackIter, target, s1);
        if (s1 < t10) {
        ...
        for (a2 = t20, a1 = t15, rootIterCount = 0; true;) {
          ...
          if (typeof s !== "number")
            return this.timeOfImpact$2$bailout(11, output, 0, t1, 0, t4, t2, t3, proxyA, proxyB, tMax, t5, s2, t6, t7, t8, t13, t12, t14, t10, t15, t9, iter, t11, t20, pushBackIter, target, s1, rootIterCount, a1, a2, t, s);
          ...
          if (typeof t16 !== "number")
            return this.timeOfImpact$2$bailout(12, output, 0, t1, 0, t4, t2, t3, proxyA, proxyB, tMax, t5, s2, t6, t7, t8, t13, t12, t14, t10, t15, t9, iter, t11, t20, pushBackIter, target, s1, rootIterCount, a1, a2, 0, 0, t16);
      ...
      if (typeof t16 !== "number")
        return this.timeOfImpact$2$bailout(13, output, 0, t1, 0, t4, t2, t3, proxyA, proxyB, tMax, t5, 0, t6, t7, t8, t13, t12, t14, t10, t15, t9, iter, t11, 0, 0, target, 0, 0, 0, 0, 0, 0, t16, done);
  ...
  timeOfImpact$2$bailout: function(state0, output, input, t1, d, t4, t2, t3, proxyA, proxyB, tMax, t5, s2, t6, t7, t8, t13, t12, t14, t10, t15, t9, iter, t11, t20, pushBackIter, target, s1, rootIterCount, a1, a2, t, s, t16, done) {
    switch (state0) {
      case 0:
        t1 = $.TimeOfImpact_toiCalls;
      case 1:
        ...
        if (typeof t4 !== "number")
          throw t4.$div();
        t4 = Math.floor($.$div$n(t4, 6.283185307179586));
        if (isNaN(t4))
          $.throwExpression(new $.UnsupportedError("NaN"));
        if (t4 == Infinity || t4 == -Infinity)
          $.throwExpression(new $.UnsupportedError("Infinity"));
...
BroadPhase: {"": "Object;_tree,proxyCount,moveBuffer,_pairBuffer,_pairCapacity,_pairCount,queryProxy",
  ...
  treeCallback$1: function(proxy) {
    var t1, t2, t3, oldBuffer, i, i0, t4;
    ...
    if (t2 === t3) {
      ...
      for (t2 = this._pairBuffer, i = oldBuffer.length, t3 = t2.length, i0 = 0; i0 < i; ++i0) {
        t4 = oldBuffer[i0];
        if (i0 >= t3)
          throw $.ioore(i0);
        t2[i0] = t4;
...
PolygonShape: {"": "Shape;centroid,vertices<,normals,vertexCount<,type,radius",
  ...
  setFrom$2: function(otherVertices, count) {
    var t1, t2, t3, i, t4, edge, t5, i2, i20, t6, t7, t8;
    this.vertexCount = count;
    for (t1 = this.vertices, t2 = t1.length, t3 = otherVertices.length, i = 0; i < this.vertexCount; ++i) {
      if (i >= t2)
        throw $.ioore(i);
      t4 = t1[i];
      if (i >= t3)
        throw $.ioore(i);
      t4.setFrom$1(otherVertices[i]);
    }
    edge = new $.Vector(0, 0);
    for (t3 = this.normals, t4 = t3.length, i = 0; t5 = this.vertexCount, i < t5; i = i2) {
      i2 = i + 1;
      i20 = i2 < t5 ? i2 : 0;
      if (i20 >= t2)
        throw $.ioore(i20);
      ...
      edge.x = $.$sub$n(edge.x, t7.get$x(t5));
      edge.y = $.$sub$n(edge.y, t7.get$y(t5));
      if (i >= t4)
        throw $.ioore(i);
      t5 = t3[i];
      t7 = edge.x;
      ...
      if (typeof t6 !== "number")
        throw $.iae(t6);
      t8 = $.getInterceptor$x(t5);
      t8.set$x(t5, 1 * t6);
      t8.set$y(t5, -1 * t7);
      t3[i].normalize$0();
    }
    this.computeCentroidToOut$3(t1, t5, this.centroid);
  },
  ...
  computeCentroidToOut$3: function(vs, count, out) {
    var t1, t2, t3, t4, pRef, e1, e2, p3, area, i, p2, p30, t5, D, triangleArea;
    out.x = 0;
    out.y = 0;
    if (count === 2) {
      t1 = vs.length;
      ...
      out.x = $.$add$ns(out.x, t2.get$x(t1));
      out.y = $.$add$ns(out.y, t2.get$y(t1));
      out.x = $.$mul$n(out.x, 0.5);
      out.y = $.$mul$n(out.y, 0.5);
      return;
    }
    pRef = new $.Vector(0, 0);
    pRef.x = 0;
    ...
    e1 = new $.Vector(0, 0);
    e2 = new $.Vector(0, 0);
    for (t1 = vs.length, p3 = vs[0], area = 0, i = 0; i < count;) {
      if (i >= t1)
        throw $.ioore(i);
      p2 = vs[i];
      ++i;
      ...
      triangleArea = 0.5 * D;
      area += triangleArea;
      out.x = $.$add$ns(out.x, pRef.x);
      out.y = $.$add$ns(out.y, pRef.y);
      out.x = $.$add$ns(out.x, t2.get$x(p2));
      out.y = $.$add$ns(out.y, t2.get$y(p2));
      out.x = $.$add$ns(out.x, t4.get$x(p30));
      out.y = $.$add$ns(out.y, t4.get$y(p30));
      t4 = triangleArea * 0.3333333333333333;
      out.x = $.$mul$n(out.x, t4);
      out.y = $.$mul$n(out.y, t4);
    }
    t1 = 1 / area;
    out.x = $.$mul$n(out.x, t1);
    out.y = $.$mul$n(out.y, t1);
  },
...
Matrix22: {"": "Object;col1<,col2<",
  ...
  addLocal$1: function(other) {
    ...
    t3 = other.col1.x;
    if (typeof t3 !== "number")
      return this.addLocal$1$bailout(2, other, t1, t2, t3);
    t1.x = t2 + t3;
    t3 = this.col1;
    t2 = t3.y;
    if (typeof t2 !== "number")
      return this.addLocal$1$bailout(3, other, 0, t2, t3);
    t1 = other.col1.y;
    if (typeof t1 !== "number")
      return this.addLocal$1$bailout(4, other, t1, t2, t3);
    t3.y = t2 + t1;
    t1 = this.col2;
    t2 = t1.x;
    if (typeof t2 !== "number")
      return this.addLocal$1$bailout(5, other, t1, t2);
    t3 = other.col2.x;
    if (typeof t3 !== "number")
      return this.addLocal$1$bailout(6, other, t1, t2, t3);
    t1.x = t2 + t3;
    t3 = this.col2;
    t2 = t3.y;
    if (typeof t2 !== "number")
      return this.addLocal$1$bailout(7, other, 0, t2, t3);
    t1 = other.col2.y;
    if (typeof t1 !== "number")
      return this.addLocal$1$bailout(8, 0, t1, t2, t3);
    t3.y = t2 + t1;
    return this;
  },
  addLocal$1$bailout: function(state0, other, t1, t2, t3) {
    switch (state0) {
      case 0:
        t1 = this.col1;
        t2 = t1.x;
...
Body: {"": "Object;world,flags@,contactList<,sleepTime@,userData@,_linearVelocity,_angularVelocity,mass<,invMass<,next@,prev@,fixtureList<,fixtureCount,jointList@,_force<,_torque@,_inertia,invInertia<,linearDamping<,angularDamping<,_type,islandIndex?,originTransform<,sweep<,_fixDef,_pmd,_pxf,oldCenter,tempCenter",
  ...
  applyForce$2: function(force, point) {
    ...
    this.set$awake(true);
    t1 = this._force;
    t1.x = $.$add$ns(t1.x, force.x);
    t1.y = $.$add$ns(t1.y, force.y);
    t1 = this._torque;
    t2 = this.sweep.center;
    t2 = $.$sub$n($.$mul$n($.$sub$n(point.x, t2.x), force.y), $.$mul$n($.$sub$n(point.y, t2.y), force.x));
    if (typeof t2 !== "number")
      throw $.iae(t2);
    this._torque = t1 + t2;
  },
  applyLinearImpulse$2: function(impulse, point) {
    ...
    t1.x = $.$add$ns(t1.x, $.$mul$n(impulse.x, this.invMass));
    t1.y = $.$add$ns(t1.y, $.$mul$n(impulse.y, this.invMass));
    t1 = this._angularVelocity;
    t2 = this.invInertia;
    t3 = this.sweep.center;
    t3 = $.$sub$n($.$mul$n($.$sub$n(point.x, t3.x), impulse.y), $.$mul$n($.$sub$n(point.y, t3.y), impulse.x));
    if (typeof t3 !== "number")
      throw $.iae(t3);
    this._angularVelocity = $.$add$ns(t1, t2 * t3);
  },
  applyAngularImpulse$1: function(impulse) {
    if (!$.$eq(this._type, 2))
      return;
    this.set$awake(true);
    this._angularVelocity = $.$add$ns(this._angularVelocity, this.invInertia * impulse);
  },
...
Island: {"": "Object;listener,bodies,contacts,joints,positions,velocities,bodyCount,jointCount,contactCount,bodyCapacity,contactCapacity,jointCapacity,positionIterationCount,_contactSolver,_translation,impulse",
  ...
  solve$3: function(step, gravity, allowSleep) {
    ...
    while (true) {
      ...
      t1 = bodyA._type;
      if (typeof t1 !== "number")
        return this.solve$3$bailout(14, step, 0, 0, 0, allowSleep, t1, 0, 0, 0, 0, 0, 0, bodyB, i1, i2);
      if (t1 !== 0) {
        bodyB.get$type;
        t1 = bodyB._type;
        if (typeof t1 !== "number")
          return this.solve$3$bailout(15, step, 0, 0, 0, allowSleep, t1, 0, 0, 0, 0, 0, 0, 0, i1, i2);
        nonStatic = t1 !== 0;
      } else
        nonStatic = false;
      if (nonStatic) {
  ...
  solve$3$bailout: function(state0, step, b, gravity, i, allowSleep, t1, t2, t3, t4, velocityDelta, a1, b1, bodyB, i1, i2, temp, t5, t6, ratio, minSleepTime) {
    switch (state0) {
      case 0:
        i = 0;
      default:
  ...
  report$1: function(constraints) {
    var t1, t2, t3, t4, t5, t6, t7, i, cc, t8, j, t9;
    t1 = this.listener;
    if (t1 == null)
      return;
    for (t2 = this.impulse, t3 = t2.normalImpulses, t4 = t3.length, t2 = t2.tangentImpulses, t5 = t2.length, t6 = this.contacts, t7 = constraints.length, i = 0; $.JSNumber_methods.$lt(i, this.contactCount); ++i) {
      if (i >= t6.length)
        throw $.ioore(i);
      if (i >= t7)
        throw $.ioore(i);
      cc = constraints[i];
      for (t8 = $.getInterceptor$x(cc), j = 0; $.JSNumber_methods.$lt(j, cc.get$pointCount()); ++j) {
        t9 = $.$index$asx(t8.get$points(cc), j).get$normalImpulse();
        if (j >= t4)
          throw $.ioore(j);
        t3[j] = t9;
        t9 = $.$index$asx(t8.get$points(cc), j).get$tangentImpulse();
        if (j >= t5)
          throw $.ioore(j);
        t2[j] = t9;
      }
...
World: {"": "Object;_flags,_contactManager,_bodyList,_jointList,_bodyCount,_jointCount,_gravity,_allowSleep,_debugDraw,_fixtureDestructionListener,_jointDestructionListener,_pool,_inverseTimestep,_warmStarting,_continuousPhysics,_contactStacks,center<,axis,timestep,cA,cB,wqwrapper,toiInput,toiOutput,backup,toiSolver,contacts,island,stack",
  ...
  solveTimeOfImpactGivenBody$1: function(body) {
    ...
    do {
      for (ce = body.get$contactList(), found = false, count = 0; ce != null; ce = ce.get$next()) {
        ...
        if (typeof type !== "number")
          return this.solveTimeOfImpactGivenBody$1$bailout(1, type, body, ce, bullet, t1, other, iter, t2, toi, t3, toiContact, count, t5, found, t6, toiOther, t4, t7);
        if (bullet) {
          t8 = other.get$flags();
          if (typeof t8 !== "number")
            throw t8.$and();
          ...
          if (type !== 0) {
            ...
            if (t8 !== (t8 | 0))
              return this.solveTimeOfImpactGivenBody$1$bailout(2, 0, body, ce, bullet, t1, other, iter, t2, toi, t3, toiContact, count, t5, found, t6, toiOther, t4, t7, t8);
            t8 = (t8 & 16) !== 0;
          } else
            t8 = false;
          if (t8)
        ...
        if (t1.state === 3) {
          t8 = t1.t;
          if (typeof t8 !== "number")
            return this.solveTimeOfImpactGivenBody$1$bailout(3, 0, body, ce, bullet, t1, other, iter, t2, toi, t3, toiContact, count, t5, found, t6, toiOther, t4, t7, t8, contact);
          t8 = t8 < toi;
        } else
          t8 = false;
        if (t8) {
          ...
          if (typeof toi !== "number")
            return this.solveTimeOfImpactGivenBody$1$bailout(4, 0, body, ce, bullet, t1, other, iter, t2, toi, t3, 0, count, t5, 0, t6, 0, t4, t7, 0, contact);
          toiOther = other;
          toiContact = contact;
          found = true;
        }
    ...
    while (true) {
      ...
      c$0: {
        ...
        if (typeof type !== "number")
          return this.solveTimeOfImpactGivenBody$1$bailout(6, type, body, ce, 0, 0, 0, 0, 0, 0, 0, toiContact, count, 0, 0, 0, toiOther);
        if (type === 2)
          break c$0;
        contact = ce.get$contact();
        if (!contact.get$enabled())
    ...
    if (typeof t1 !== "number")
      return this.solveTimeOfImpactGivenBody$1$bailout(7, 0, 0, 0, 0, t1, 0, 0, 0, 0, 0, toiContact);
    if (t1 !== 0) {
  ...
  solveTimeOfImpactGivenBody$1$bailout: function(state0, type, body, ce, bullet, t1, other, iter, t2, toi, t3, toiContact, count, t5, found, t6, toiOther, t4, t7, t8, contact) {
    switch (state0) {
      case 0:
        bullet = body.get$bullet();
        t1 = this.toiOutput;
...
Contact: {"": "Object;flags@,prev@,next@,edge1<,edge2<,fixtureA<,fixtureB<,manifold@,toiCount@",
  ...
  update$1: function(listener) {
    ...
    if (!wasTouching && touching) {
      listener.beginContact$1;
      listener._handleContact$2(this, true);
    }
    if (wasTouching && !touching) {
      listener.endContact$1;
      listener._handleContact$2(this, false);
    }
    if (!sensor && touching)
      listener.preSolve$2;
  }
...
ContactSolver: {"": "Object;constraints,constraintCount,worldManifold,tangent,temp1,temp2,P,dv,dv1,dv2,x>,d,P1,P2,psolver,rA<,rB<",
  init$3: function(contacts, contactCount, impulseRatio) {
    var t1, i, t2, t3, t4, t5, t6, t7, contact, fixtureA, fixtureB, t8, shapeA, t9, shapeB, radiusA, radiusB, bodyA, bodyB, manifold, friction, restitution, restitution0, vA, vB, wA, wB, cc, t10, t11, t12, j, t13, cp, ccp, t14, t15, t16, rnA, rnB, rtA, rtB, a, vRel, ccp1, ccp2, invMassA, invIA, invMassB, invIB, rn1A, rn1B, rn2A, rn2B, k11, k22, k12;
    ...
    for (t1 = this.worldManifold, t2 = t1.points, t3 = t2.length, t4 = this.tangent, t5 = this.temp2, t6 = this.temp1, t7 = t1.normal, i = 0; $.JSNumber_methods.$lt(i, this.constraintCount); ++i) {
      ...
      if (typeof restitution !== "number")
        return this.init$3$bailout(1, contacts, t2, impulseRatio, radiusA, radiusB, t4, i, t3, friction, t5, restitution, t7, t6, bodyA, t1, bodyB, manifold);
      ...
      if (typeof wA !== "number")
        return this.init$3$bailout(2, contacts, t2, impulseRatio, radiusA, radiusB, t4, i, t3, friction, t5, restitution, t7, t6, bodyA, t1, bodyB, manifold, vA, vB, wA);
      bodyB.get$angularVelocity;
      wB = bodyB._angularVelocity;
      if (typeof wB !== "number")
        return this.init$3$bailout(3, contacts, t2, impulseRatio, radiusA, radiusB, t4, i, t3, friction, t5, restitution, t7, t6, bodyA, t1, bodyB, manifold, vA, vB, wA, wB);
  ...
  init$3$bailout: function(state0, contacts, t2, impulseRatio, radiusA, radiusB, t4, i, t3, friction, t5, restitution, t7, t6, bodyA, t1, bodyB, manifold, vA, vB, wA, wB) {
    switch (state0) {
      case 0:
        this.constraintCount = contactCount;
        t1 = this.constraints;
        ...
        i = 0;
      default:
        var contact, fixtureA, fixtureB, t8, shapeA, t9, shapeB, restitution0, cc, t10, t11, t12, j, t13, cp, ccp, t14, t15, t16, rnA, rnB, rtA, rtB, t17, a, vRel, ccp1, ccp2, invMassA, invIA, invMassB, invIB, rn1A, rn1B, rn2A, rn2B, k11, k22, k12;
        L0:
          while (true)
            switch (state0) {
              case 0:
...
TimeOfImpactSolver: {"": "Object;constraints,count@,toiBody,psm,rA<,rB<,P,temp",
  initialize$3: function(_, contacts, argCount, argToiBody) {
    var t1, t2, i, contact, fixtureA, fixtureB, shapeA, t3, shapeB, radiusA, radiusB, bodyA, bodyB, manifold, constraint, t4, j, cp;
    this.count = argCount;
...
RevoluteJoint: {"": "Joint;localAnchor1,localAnchor2,impulse,_motorImpulse,mass<,motorMass,_enableMotor,_maxMotorTorque,_motorSpeed,_enableLimit,referenceAngle,lowerAngle,upperAngle,limitState,type,_prev,_liblib1$_next,edgeA,edgeB,bodyA,bodyB,islandFlag,collideConnected,userData,localCenterA,localCenterB,invMassA,invIA,invMassB,invIB",
  ...
  get$jointAngle: function() {
    var b1 = this.bodyA;
    return $.$sub$n($.$sub$n(this.bodyB.get$sweep().angle, b1.get$sweep().angle), this.referenceAngle);
  },
...
Body$: function(bd, world) {
  ...
  t3 = t2.x;
  t2 = t2.y;
  t4 = bd.angularDamping;
  t5 = bd.userData;
  t6 = $.FixtureDef$();
  t7 = $.Matrix22$(null, null);
  t7 = new $.Body(world, 0, null, 0, t5, new $.Vector(t3, t2), 0, null, null, null, null, null, 0, null, new $.Vector(0, 0), 0, 0, 0, bd.linearDamping, t4, bd.type, null, new $.Transform(new $.Vector(0, 0), t1), new $.Sweep(new $.Vector(0, 0), new $.Vector(0, 0), new $.Vector(0, 0), 0, 0), t6, new $.MassData(0, new $.Vector(0, 0), 0), new $.Transform(new $.Vector(0, 0), t7), new $.Vector(0, 0), new $.Vector(0, 0));
  t7.Body$2(bd, world);
  return t7;
},
...
Stopwatch: {"": "Object;_liblib4$_start,_stop",
  start$0: function(_) {
    var t1 = this._liblib4$_start == null;
...
Car: {"": "Object;_maxForwardSpeed,_maxBackwardSpeed,_backTireMaxDriveForce,_frontTireMaxDriveForce,_backTireMaxLateralImpulse,_frontTireMaxLateralImpulse,_lockAngle,_turnSpeedPerSec,_body,_blTire,_brTire,_flTire,_frTire,_flJoint,_frJoint",
  update$2: function(time, controlState) {
    var desiredAngle, turnPerTimeStep, angleNow, angle;
    ...
    if (typeof time !== "number")
      throw $.iae(time);
    turnPerTimeStep = this._turnSpeedPerSec * 1000 / time;
  ...
  Car$1: function(world) {
    var def, vertices, shape, t1, t2, jointDef, t3, t4, t5;
    def = $.BodyDef$();
    def.type = 2;
    this._body = world.createBody$1(def);
    this._body.userData = "Car";
    this._body.angularDamping = 3;
    vertices = $.List_List(8);
    vertices[0] = new $.Vector(1.5, 0);
    vertices[1] = new $.Vector(3, 2.5);
    vertices[2] = new $.Vector(2.8, 5.5);
    vertices[3] = new $.Vector(1, 10);
    vertices[4] = new $.Vector(-1, 10);
    vertices[5] = new $.Vector(-2.8, 5.5);
    vertices[6] = new $.Vector(-3, 2.5);
    vertices[7] = new $.Vector(-1.5, 0);
    shape = $.PolygonShape$();
    shape.setFrom$2(vertices, 8);
    t1 = this._body;
    t1.createFixtureFromShape$2;
    t2 = t1._fixDef;
    t2.shape = shape;
    t2.density = 0.1;
    t1.createFixture$1(t2);
    jointDef = $.RevoluteJointDef$();
    jointDef.bodyA = this._body;
    jointDef.enableLimit = true;
    jointDef.lowerAngle = 0;
    jointDef.upperAngle = 0;
    t2 = jointDef.localAnchorB;
    t2.x = 0;
    t2.y = 0;
    t2 = this._maxForwardSpeed;
    t1 = this._maxBackwardSpeed;
    t3 = this._backTireMaxDriveForce;
    t4 = this._backTireMaxLateralImpulse;
    this._blTire = $.Tire$(world, t2, t1, t3, t4);
    jointDef.bodyB = this._blTire._body;
    t5 = jointDef.localAnchorA;
    t5.x = -3;
    t5.y = 0.75;
    world.createJoint$1(jointDef);
    this._brTire = $.Tire$(world, t2, t1, t3, t4);
    jointDef.bodyB = this._brTire._body;
    t5.x = 3;
    t5.y = 0.75;
    world.createJoint$1(jointDef);
    t4 = this._frontTireMaxDriveForce;
    t3 = this._frontTireMaxLateralImpulse;
    this._flTire = $.Tire$(world, t2, t1, t4, t3);
    jointDef.bodyB = this._flTire._body;
    t5.x = -3;
    t5.y = 8.5;
    this._flJoint = world.createJoint$1(jointDef);
    this._frTire = $.Tire$(world, t2, t1, t4, t3);
...
Racer: {"": "Demo;_controlState,_groundBody,_car,_lastTime,bodies,canvas,ctx,viewport,debugDraw,world,frameCount,fpsCounter,elapsedUs,worldStepTime,viewportScale,_stopwatch",
  initialize$0: function(_) {
    ...
    t1 = new $._EventStreamSubscription(0, t1._target, t1._eventType, this.get$_handleKeyDown(), t1._useCapture);
    t2 = t1._onData;
    if (t2 != null && !t1.get$isPaused())
      $.$$dom_addEventListener$3$x(t1._target, t1._eventType, t2, t1._useCapture);
    t1 = new $._EventStream(document, $.EventStreamProvider_keyup._eventType, false);
    t1 = new $._EventStreamSubscription(0, t1._target, t1._eventType, this.get$_handleKeyUp(), t1._useCapture);
    t2 = t1._onData;
    if (t2 != null && !t1.get$isPaused())
      $.$$dom_addEventListener$3$x(t1._target, t1._eventType, t2, t1._useCapture);
    this.world._contactManager.contactListener = this;
  },
  step$1: function(_, time) {
    this._car.update$2($.$sub$n(time, this._lastTime), this._controlState);
    this._lastTime = time;
    $.Demo.prototype.step$1.call(this, this, time);
  },
  _createGround$0: function() {
    var def, shape, fixtureDef, t1;
    def = $.BodyDef$();
    this._groundBody = this.world.createBody$1(def);
    this._groundBody.userData = "Ground";
    shape = $.PolygonShape$();
    fixtureDef = $.FixtureDef$();
    fixtureDef.shape = shape;
    fixtureDef.isSensor = true;
    t1 = $.GroundArea__lastHash;
    $.GroundArea__lastHash = $.$add$ns(t1, 1);
    fixtureDef.userData = new $.GroundArea(t1, 0.001, false);
    shape.setAsBoxWithCenterAndAngle$4(27, 21, new $.Vector(-30, 30), 0.3490658503988659);
    this._groundBody.createFixture$1(fixtureDef);
    t1 = $.GroundArea__lastHash;
    $.GroundArea__lastHash = $.$add$ns(t1, 1);
    fixtureDef.userData = new $.GroundArea(t1, 0.2, false);
    shape.setAsBoxWithCenterAndAngle$4(27, 15, new $.Vector(20, 40), -0.6981317007977318);
    this._groundBody.createFixture$1(fixtureDef);
  },
  _createBoundary$0: function() {
    ...
    fixtureDef = $.FixtureDef$();
    fixtureDef.shape = shape;
    shape.setAsEdge$2(new $.Vector(-150, -100), new $.Vector(150, -100));
  ...
  _handleKeyDown$1: function($event) {
    switch ($.get$keyCode$x($event)) {
      case 37:
        this._controlState = $.$or$n(this._controlState, 4);
        break;
      case 38:
        this._controlState = $.$or$n(this._controlState, 1);
        break;
      case 39:
        this._controlState = $.$or$n(this._controlState, 8);
        break;
      case 40:
        this._controlState = $.$or$n(this._controlState, 2);
        break;
    }
  },
  ...
  _handleKeyUp$1: function($event) {
    switch ($.get$keyCode$x($event)) {
      case 37:
        this._controlState = $.$and$n(this._controlState, 4294967291);
        break;
      case 38:
        this._controlState = $.$and$n(this._controlState, 4294967294);
        break;
      case 39:
        this._controlState = $.$and$n(this._controlState, 4294967287);
        break;
      case 40:
        this._controlState = $.$and$n(this._controlState, 4294967293);
        break;
    }
  },
  ...
  _handleContact$2: function(contact, began) {
    ...
    if (typeof fudA === "object" && fudA !== null && !!$.getInterceptor(fudA).$isTire && typeof fudB === "object" && fudB !== null && !!$.getInterceptor(fudB).$isGroundArea)
      if (began) {
        t1 = fudA.get$_groundAreas();
        t1.add$1(t1, fudB);
        fudA._updateTraction$0();
      } else {
        t1 = fudA.get$_groundAreas();
        if (t1.remove$1(t1, fudB))
          fudA._updateTraction$0();
      }
    else if (typeof fudA === "object" && fudA !== null && !!$.getInterceptor(fudA).$isGroundArea && typeof fudB === "object" && fudB !== null && !!$.getInterceptor(fudB).$isTire)
      if (began) {
        t1 = fudB.get$_groundAreas();
        t1.add$1(t1, fudA);
        fudB._updateTraction$0();
      } else {
        t1 = fudB.get$_groundAreas();
        if (t1.remove$1(t1, fudA))
          fudB._updateTraction$0();
      }
  }
},
...
Tire: {"": "Object;_body,_maxForwardSpeed,_maxBackwardSpeed,_maxDriveForce,_maxLateralImpulse,_currentTraction@,_groundAreas<,_worldLeft,_worldUp",
  updateFriction$0: function() {
    var t1, out, t2, t3, t4, t5, t6, currentForwardSpeed;
    t1 = this._body;
    t1.getWorldVector$1;
    out = new $.Vector(0, 0);
    $.Matrix22_mulMatrixAndVectorToOut(t1.originTransform.rotation, this._worldLeft, out);
    t1 = this._body;
    t1.get$linearVelocity;
    t1 = t1._linearVelocity;
    t2 = out.x;
    t3 = $.getInterceptor$n(t2);
    t1 = $.$add$ns(t3.$mul(t2, t1.x), $.$mul$n(out.y, t1.y));
    out.x = t3.$mul(t2, t1);
    out.y = $.$mul$n(out.y, t1);
    t1 = -this._body.mass;
    out.x = $.$mul$n(out.x, t1);
    ...
    out.x = $.$mul$n(out.x, t2);
    out.y = $.$mul$n(out.y, t2);
    t2 = this._body;
    t2.get$worldCenter;
    t1.applyLinearImpulse$2(out, t2.sweep.center);
    t2 = this._body;
    ...
    t3 = t2._inertia;
    t4 = t2.mass;
    t5 = t2.sweep.localCenter;
    t6 = t5.x;
    t6 = $.$mul$n(t6, t6);
    t5 = t5.y;
    t5 = $.$add$ns(t6, $.$mul$n(t5, t5));
    if (typeof t5 !== "number")
      throw $.iae(t5);
    t2.get$angularVelocity;
    t2.applyAngularImpulse$1(0.1 * t1 * (t3 + t4 * t5) * $.$negate$n(t2._angularVelocity));
    t2 = this._body;
    t2.getWorldVector$1;
    out = new $.Vector(0, 0);
    $.Matrix22_mulMatrixAndVectorToOut(t2.originTransform.rotation, this._worldUp, out);
    t2 = this._body;
    t2.get$linearVelocity;
    t2 = t2._linearVelocity;
    t5 = out.x;
    t4 = $.getInterceptor$n(t5);
    t2 = $.$add$ns(t4.$mul(t5, t2.x), $.$mul$n(out.y, t2.y));
    out.x = t4.$mul(t5, t2);
    out.y = $.$mul$n(out.y, t2);
    t2 = out.x;
    t2 = $.$mul$n(t2, t2);
    t5 = out.y;
    t5 = $.$add$ns(t2, $.$mul$n(t5, t5));
    if (typeof t5 !== "number")
      $.throwExpression(new $.ArgumentError(t5));
    currentForwardSpeed = Math.sqrt(t5);
    out.normalize$0();
    t1 = this._body;
    t2 = $.$mul$n(this._currentTraction, -2 * currentForwardSpeed);
    out.x = $.$mul$n(out.x, t2);
    out.y = $.$mul$n(out.y, t2);
    t2 = this._body;
    t2.get$worldCenter;
    t1.applyForce$2(out, t2.sweep.center);
  },
  updateDrive$1: function(controlState) {
    var desiredSpeed, t1, out, out0, t2, t3, currentSpeed, force;
    switch ($.$and$n(controlState, 3)) {
      case 1:
    ...
    t1.getWorldVector$1;
    out = new $.Vector(0, 0);
    $.Matrix22_mulMatrixAndVectorToOut(t1.originTransform.rotation, new $.Vector(0, 1), out);
    t1 = this._body;
    t1.getWorldVector$1;
    out0 = new $.Vector(0, 0);
    $.Matrix22_mulMatrixAndVectorToOut(t1.originTransform.rotation, this._worldUp, out0);
    t1 = this._body;
    t1.get$linearVelocity;
    t1 = t1._linearVelocity;
    t2 = out0.x;
    t3 = $.getInterceptor$n(t2);
    t1 = $.$add$ns(t3.$mul(t2, t1.x), $.$mul$n(out0.y, t1.y));
    out0.x = t3.$mul(t2, t1);
    out0.y = $.$mul$n(out0.y, t1);
    currentSpeed = $.$add$ns($.$mul$n(out0.x, out.x), $.$mul$n(out0.y, out.y));
    if ($.JSNumber_methods.$lt(desiredSpeed, currentSpeed))
      force = -this._maxDriveForce;
    else
      force = $.JSNumber_methods.$gt(desiredSpeed, currentSpeed) ? this._maxDriveForce : 0;
    if (Math.abs(force) > 0) {
      t1 = this._body;
      t2 = $.$mul$n(this._currentTraction, force);
      out.x = $.$mul$n(out.x, t2);
      out.y = $.$mul$n(out.y, t2);
      t2 = this._body;
      t2.get$worldCenter;
  ...
  _updateTraction$0: function() {
    ...
    if (t1._liblib0$_length === 0)
      ...
      t1.forEach$1(t1, new $.Tire__updateTraction_closure(this));
    }
  },
  Tire$5: function(world, _maxForwardSpeed, _maxBackwardSpeed, _maxDriveForce, _maxLateralImpulse) {
    var def, polygonShape, t1, t2;
    def = $.BodyDef$();
    def.type = 2;
    this._body = world.createBody$1(def);
    this._body.userData = "Tire";
    polygonShape = $.PolygonShape$();
    polygonShape.setAsBox$2(0.5, 1.25);
    t1 = this._body;
    t1.createFixtureFromShape$2;
    t2 = t1._fixDef;
    t2.shape = polygonShape;
    t2.density = 1;
    t1.createFixture$1(t2).userData = this;
    this._currentTraction = 1;
  },
  $isTire: true
},

Tire__updateTraction_closure: {"": "Closure;this_0",
  call$1: function(element) {
    var t1 = this.this_0;
...
main: function() {
  var racer, t1;
  racer = new $.Racer(null, null, null, 0, $.List_List($), null, null, null, null, null, null, null, null, null, 2.5, null);
  racer.Demo$3("Racer", new $.Vector(0, 0), 2.5);
  racer.initialize$0(racer);
  racer.initializeAnimation$0();
  t1 = document.body;
  t1.get$nodes;
  new $._ChildNodeListLazy(t1)._this.appendChild($._ElementFactoryProvider_createElement_html("<p>Use the arrow keys to drive the car.</p>"));
  racer.runAnimation$0();
},

Tire$: function(world, _maxForwardSpeed, _maxBackwardSpeed, _maxDriveForce, _maxLateralImpulse) {
  var t1 = new $.Tire(null, _maxForwardSpeed, _maxBackwardSpeed, _maxDriveForce, _maxLateralImpulse, null, new $.HashSet(0, null, null, null, null), new $.Vector(1, 0), new $.Vector(0, 1));
