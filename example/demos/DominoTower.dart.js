...
$$.World = {"": "Object;_flags,_contactManager,_bodyList,_jointList,_bodyCount,_jointCount,_gravity,_allowSleep,_debugDraw,_fixtureDestructionListener,_jointDestructionListener,_pool,_inverseTimestep,_warmStarting,_continuousPhysics,_contactStacks,center>,axis,timestep,cA,cB,wqwrapper,toiInput,toiOutput,backup,toiSolver,contacts,island,stack",
  ...
  drawDebugData$0: function() {
    ...
    if ((drawFlags & 2) === 2)
      for (j = this._jointList; j != null; j = j.get$_liblib0$_next())
        this.drawJoint$1(j);
    if ((drawFlags & 8) === 8) {
  ...
  solve$1: function(timeStep) {
    ...
    for (j = this.get$jointList(); j != null; j = j.get$_liblib0$_next())
      ...
      case 6:
        if (state0 === 6 || state0 === 5 || state0 === 4 || state0 === 3 || state0 === 0 && typeof other === "object" && other !== null && !!other.$isvec2)
          switch (state0) {
            ...
            case 6:
              state0 = 0;
              return $.vec2$raw(t3, $.$$div$n(t1, t6));
          }
    }
  },
...
$$.vec4 = {"": "Object;x=,y=,z=,w>",
  ...
  $div: function(_, other) {
    ...
    if (typeof other === "number") {
      ...
      t7 = this.w;
      if (typeof t7 !== "number")
        return this.$$div$bailout(4, t1, o, t3, t5, t7);
      return $.vec4$raw(t1, t3, t5, t7 * o);
    }
    if (typeof other === "object" && other !== null && !!other.$isvec4) {
      t1 = this.x;
      if (typeof t1 !== "number")
        return this.$$div$bailout(5, t1, 0, 0, 0, 0, other);
      t3 = other.x;
      if (typeof t3 !== "number")
        return this.$$div$bailout(6, t1, 0, t3, 0, 0, other);
      t3 = t1 / t3;
      t1 = this.y;
      if (typeof t1 !== "number")
        return this.$$div$bailout(7, t1, 0, t3, 0, 0, other);
      t6 = other.y;
      if (typeof t6 !== "number")
        return this.$$div$bailout(8, t1, 0, t3, 0, 0, other, t6);
      t6 = t1 / t6;
      t1 = this.z;
      if (typeof t1 !== "number")
        return this.$$div$bailout(9, t1, 0, t3, 0, 0, other, t6);
      t9 = other.z;
      if (typeof t9 !== "number")
        return this.$$div$bailout(10, t1, 0, t3, 0, 0, other, t6, t9);
      t9 = t1 / t9;
      t1 = this.w;
      if (typeof t1 !== "number")
        return this.$$div$bailout(11, t1, 0, t3, 0, 0, other, t6, t9);
      t12 = other.w;
      if (typeof t12 !== "number")
        return this.$$div$bailout(12, t1, 0, t3, 0, 0, 0, t6, t9, t12);
      return $.vec4$raw(t3, t6, t9, t1 / t12);
    }
  },
  $$div$bailout: function(state0, t1, o, t3, t5, t7, other, t6, t9, t12) {
    switch (state0) {
      case 0:
      default:
        if (state0 === 4 || state0 === 3 || state0 === 2 || state0 === 1 || state0 === 0 && typeof other === "number")
      ...
      case 12:
        if (state0 === 12 || state0 === 11 || state0 === 10 || state0 === 9 || state0 === 8 || state0 === 7 || state0 === 6 || state0 === 5 || state0 === 0 && typeof other === "object" && other !== null && !!other.$isvec4)
          switch (state0) {
            ...
            case 12:
              state0 = 0;
              return $.vec4$raw(t3, t6, t9, $.$$div$n(t1, t12));
          }
    }
  },
  $mul: function(_, other) {
