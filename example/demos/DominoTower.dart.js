...
$$.Collision = {"": ["_pool", "cache", "input", "output", "results1", "results2", "incidentEdge?", "localTangent", "localNormal?", "planePoint", "tangent", "normal?", "normal1", "v11", "v12", "clipPoints1", "clipPoints2"],
 ...
 findMaxSeparation$5: function(results, poly1, xf1, poly2, xf2) {
  ...
  if (typeof dLocal1x !== 'number')
    return this.findMaxSeparation$5$bailout(3, results, dLocal1x, poly1, xf1, xf2, dx, poly2, count1, normals1, dy, R);
  dLocal1y = $.add($.mul(dx, R.get$col2().get$x()), $.mul(dy, R.get$col2().get$y()));
  if (typeof dLocal1y !== 'number')
    return this.findMaxSeparation$5$bailout(4, results, dLocal1x, poly1, xf1, xf2, poly2, count1, normals1, dLocal1y);
 ...
 findIncidentEdge$6: function(c, poly1, xf1, edge1, poly2, xf2) {
  var normals1, count2, vertices2, normals2, t3, t4, t5, minDot, i, index, t1, dot, i2;
  poly1.get$vertexCount();
  normals1 = poly1.get$normals();
  count2 = poly2.get$vertexCount();
  if (typeof count2 !== 'number')
 ...
 findIncidentEdge$6$bailout: function(state0, env0, env1, env2, env3, env4, env5, env6, env7) {
  ...
  switch (state0) {
    ...
    case 1:
      ...
      normals2 = poly2.get$normals();
    case 2:
      var normals1, count2, xf2, poly2, edge1, xf1, c, vertices2, normals2, t3, t4, t5, minDot, i, index, t1, dot, i2;
      state0 = 0;
      t3 = xf1.get$rotation();
      t4 = $.index(normals1, edge1);
      t5 = this.normal1;
      $.Matrix22_mulMatrixAndVectorToOut(t3, t4, t5);
      $.Matrix22_mulTransMatrixAndVectorToOut(xf2.get$rotation(), t5, t5);
      for (minDot = 99999999999999, i = 0, index = 0; $.ltB(i, count2); ++i) {
        t1 = $.index(normals2, i);
        dot = $.add($.mul(t5.x, t1.get$x()), $.mul(t5.y, t1.get$y()));
        if ($.ltB(dot, minDot)) {
          index = i;
 ...
 collidePolygons$5: function(manifold, polyA, xfA, polyB, xfB) {
  var totalRadius, t2, t1, t3, t4, edge1, poly2, poly1, xf2, xf1, flip, count1, vertices1, t5, t6, t7, t8, frontOffset, sideOffset1, sideOffset2, t9, np, pointCount, i, cp;
  manifold.set$pointCount(0);
  ...
  if (typeof frontOffset !== 'number')
    return this.collidePolygons$5$bailout(2, flip, t8, manifold, t4, frontOffset, totalRadius, t1, t2, t3, t5, t6, xf2);
 ...
 collidePolygons$5$bailout: function(state0, env0, env1, env2, env3, env4, env5, env6, env7, env8, env9, env10, env11) {
  ...
  switch (state0) {
    ...
    case 1:
      ...
      frontOffset = $.add($.mul(t4.x, t2.x), $.mul(t4.y, t2.y));
    case 2:
      var totalRadius, xfB, polyB, xfA, polyA, manifold, t2, t1, t3, t4, edge1, poly2, poly1, xf2, xf1, flip, count1, vertices1, t5, t6, t7, t8, frontOffset, sideOffset1, sideOffset2, t9, np, pointCount, i, cp;
      state0 = 0;
      sideOffset1 = $.add($.neg($.add($.mul(t8.x, t2.x), $.mul(t8.y, t2.y))), totalRadius);
      sideOffset2 = $.add($.add($.mul(t8.x, t3.x), $.mul(t8.y, t3.y)), totalRadius);
      t8.negateLocal$0();
...
$$.DistanceProxy = {"": ["vertices?", "count=", "radius="],
 ...
 getSupport$1: function(direction) {
  ...
  while (true) {
    ...
    t3 = t3.get$y();
    if (typeof t3 !== 'number')
      return this.getSupport$1$bailout(8, direction, t2, bestIndex, bestValue, t4, i, t3, t1);
    value = t4 + t3 * t9;
    if (value > bestValue) {
      bestValue = value;
      bestIndex = i;
...
$$.TimeOfImpact = {"": ["cache", "distanceInput", "xfA", "xfB", "distanceOutput", "fcn", "indexes", "sweepA?", "sweepB?", "pool"],
 ...
 timeOfImpact$2: function(output, input) {
  ...
  for (t1 = this.fcn, t2 = this.indexes, t5 = t2.length, t6 = target + 0.00125, t7 = target - 0.00125, t8 = this.distanceOutput, t9 = this.xfA, t11 = this.xfB, t13 = this.pool, t14 = 0, iter = 0; true;) {
    ...
    t15 = t8.distance;
    if (typeof t15 !== 'number')
      return this.timeOfImpact$2$bailout(5, iter, output, t1, t2, t11, target, t7, t13, proxyA, proxyB, t15, t3, t4, t6, t8, t5, t10, t12, tMax, t14, t9);
    if (t15 <= 0) {
      output.set$state(2);
      output.set$t(0);
      break;
    ...
    for (t20 = tMax, pushBackIter = 0; done = false, true;) {
      ...
      if (typeof s2 !== 'number')
        return this.timeOfImpact$2$bailout(7, output, iter, t20, pushBackIter, t11, s2, t13, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t3, t4, t6, t5, t10, t12, t14, t9);
      if (s2 > t6) {
        output.set$state(4);
        output.set$t(tMax);
        done = true;
      ...
      if (typeof s1 !== 'number')
        return this.timeOfImpact$2$bailout(8, output, iter, pushBackIter, t20, s2, t13, t11, proxyA, proxyB, t8, tMax, t1, t2, s1, target, t7, t3, t4, t6, t5, t10, t12, t14, t9);
      if (s1 < t7) {
        output.set$state(1);
        output.set$t(t14);
        done = true;
      ...
      for (a2 = t20, a1 = t14, rootIterCount = 0; true;) {
        ...
        if (typeof s !== 'number')
          return this.timeOfImpact$2$bailout(9, output, iter, pushBackIter, t20, t11, t13, s2, s1, rootIterCount, a1, a2, proxyB, proxyA, t8, tMax, t1, t2, target, t7, t, t3, t4, t6, s, t5, t10, t12, t14, t9);
        t15 = $.abs(s - target);
        if (typeof t15 !== 'number')
          return this.timeOfImpact$2$bailout(10, output, iter, pushBackIter, t20, t11, t13, s2, s1, rootIterCount, a1, a2, proxyB, proxyA, t8, tMax, t1, t2, target, t7, t, t3, t4, t6, s, t5, t10, t15, t12, t14, t9);
        if (t15 < 0.00125) {
          t20 = t;
          break;
        }
        ...
        if (a1 !== (a1 | 0))
          return this.timeOfImpact$2$bailout(11, output, iter, pushBackIter, t20, s2, s1, a1, a2, t13, rootIterCount, proxyA, proxyB, t11, t8, tMax, t1, t2, target, t7, t3, t4, t6, t5, t10, t12, t14, t9);
        ++rootIterCount;
        t16 = $.TimeOfImpact_toiRootIters;
        if (typeof t16 !== 'number')
          return this.timeOfImpact$2$bailout(12, output, iter, pushBackIter, t20, s2, s1, a1, a2, rootIterCount, t16, proxyA, t13, proxyB, t11, t8, tMax, t1, t2, target, t7, t3, t4, t6, t5, t10, t12, t14, t9);
        $.TimeOfImpact_toiRootIters = t16 + 1;
        if (rootIterCount === 50)
          break;
      }
      if (t20 !== (t20 | 0))
        return this.timeOfImpact$2$bailout(13, output, iter, pushBackIter, t11, t13, proxyA, proxyB, t8, tMax, t1, t2, t20, target, t7, rootIterCount, t3, t4, t6, t5, t10, t12, t14, t9);
 ...
 initialize$6: function(cache, argProxyA, argSweepA, argProxyB, argSweepB, t1) {
  ...
  if (count === 1) {
    ...
    if (t6) {
      ...
      if (typeof t3 !== 'string' && (typeof t3 !== 'object' || t3 === null || t3.constructor !== Array && !t3.is$JavaScriptIndexingBehavior()))
        return this.initialize$6$bailout(8, t13, t1, t9, t2, t7, t11, t4, t5, t10, t3, t12, t14);
      if (0 >= t7.length)
        throw $.ioore(0);
      t8 = t7[0];
      if (t8 !== (t8 | 0))
      ...
      if (typeof t16 !== 'string' && (typeof t16 !== 'object' || t16 === null || t16.constructor !== Array && !t16.is$JavaScriptIndexingBehavior()))
        return this.initialize$6$bailout(9, t13, t1, t9, t2, t7, t15, t11, t4, t5, t10, t12, t14, t16);
      if (1 >= t7.length)
        throw $.ioore(1);
      t7 = t7[1];
      if (t7 !== (t7 | 0))
      ...
      if (typeof t5 !== 'string' && (typeof t5 !== 'object' || t5 === null || t5.constructor !== Array && !t5.is$JavaScriptIndexingBehavior()))
        return this.initialize$6$bailout(10, t11, t13, t4, t14, t10, t1, t9, t12, t5);
      if (0 >= t1.length)
        throw $.ioore(0);
      t1 = t1[0];
      if (t1 !== (t1 | 0))
      ...
      if (t1 < 0 || t1 >= t5.length)
        throw $.ioore(t1);
      t14.setFrom$1(t5[t1]);
      $.Transform_mulToOut(t4, t14, t9);
      t11.setFrom$1(t9);
      t11.subLocal$1(t13);
      t13 = t11.x;
      if (typeof t13 !== 'number')
        return this.initialize$6$bailout(11, t11, t12, t10, t13);
      t14 = t12.x;
      if (typeof t14 !== 'number')
        return this.initialize$6$bailout(12, t11, t12, t10, t13, t14);
      t14 = t13 * t14;
      t11 = t11.y;
      if (typeof t11 !== 'number')
        return this.initialize$6$bailout(13, t11, t12, t10, t14);
      t12 = t12.y;
      if (typeof t12 !== 'number')
        return this.initialize$6$bailout(14, t11, t12, t10, t14);
      s = t14 + t11 * t12;
      if (s < 0) {
        t10.negateLocal$0();
        s = -s;
      ...
      if (typeof t3 !== 'string' && (typeof t3 !== 'object' || t3 === null || t3.constructor !== Array && !t3.is$JavaScriptIndexingBehavior()))
        return this.initialize$6$bailout(15, t13, t1, t9, t7, t3, t11, t4, t5, t10, t2, t12, t14);
      if (0 >= t1.length)
        throw $.ioore(0);
      t8 = t1[0];
      if (t8 !== (t8 | 0))
      ...
      if (typeof t16 !== 'string' && (typeof t16 !== 'object' || t16 === null || t16.constructor !== Array && !t16.is$JavaScriptIndexingBehavior()))
        return this.initialize$6$bailout(16, t13, t1, t9, t7, t11, t4, t5, t10, t2, t15, t12, t14, t16);
      if (1 >= t1.length)
        throw $.ioore(1);
      t1 = t1[1];
      if (t1 !== (t1 | 0))
      ...
      if (typeof t4 !== 'string' && (typeof t4 !== 'object' || t4 === null || t4.constructor !== Array && !t4.is$JavaScriptIndexingBehavior()))
        return this.initialize$6$bailout(17, t11, t13, t5, t10, t4, t9, t12, t7, t14);
      if (0 >= t7.length)
        throw $.ioore(0);
      t7 = t7[0];
      if (t7 !== (t7 | 0))
      ...
      t14 = t12.x;
      if (typeof t14 !== 'number')
        return this.initialize$6$bailout(19, t11, t12, t9, t14, t10);
      t14 = t9 * t14;
      t11 = t11.y;
      if (typeof t11 !== 'number')
        return this.initialize$6$bailout(20, t12, t11, t10, t14);
      t12 = t12.y;
      if (typeof t12 !== 'number')
        return this.initialize$6$bailout(21, t11, t12, t14, t10);
      s = t14 + t11 * t12;
      if (s < 0) {
        t10.negateLocal$0();
        s = -s;
          ...
          default:
            if (state0 === 14 || state0 === 13 || state0 === 12 || state0 === 11 || state0 === 10 || state0 === 9 || state0 === 8 || state0 === 0 && t3)
              switch (state0) {
                ...
                case 10:
                  state0 = 0;
                  t13.setFrom$1($.index(t5, $.index(t1, 0)));
                  $.Transform_mulToOut(t4, t13, t8);
                  t10.setFrom$1(t8);
                  t10.subLocal$1(t12);
                  t12 = t10.x;
                case 11:
              ...
              switch (state0) {
                ...
                case 17:
                  state0 = 0;
                  t13.setFrom$1($.index(t4, $.index(t6, 0)));
                  $.Transform_mulToOut(t5, t13, t12);
                  t10.setFrom$1(t12);
                  t10.subLocal$1(t8);
                  t8 = t10.x;
...
$$.PolygonShape = {"": ["centroid?", "vertices?", "normals?", "vertexCount?", "type", "radius"],
 ...
 getSupport$1: function(d) {
  ...
  while (true) {
    ...
    t2 = t2.get$y();
    if (typeof t2 !== 'number')
      return this.getSupport$1$bailout(9, d, t4, t2, bestValue, bestIndex, i, t1);
    value = t4 + t2 * t10;
    if (value > bestValue) {
      bestValue = value;
      bestIndex = i;
...
$$.Island = {"": ["listener", "bodies?", "contacts", "joints", "positions", "velocities", "bodyCount?", "jointCount", "contactCount?", "bodyCapacity", "contactCapacity", "jointCapacity", "positionIterationCount", "_contactSolver", "_translation", "impulse"],
 ...
 solve$3: function(step, gravity, allowSleep) {
  ...
  while (true) {
    ...
    t1 = bodyA.get$type();
    if (typeof t1 !== 'number')
      return this.solve$3$bailout(24, i2, bodyB, allowSleep, step, t1, i1);
    if (!(t1 === 0)) {
      t1 = bodyB.get$type();
      if (typeof t1 !== 'number')
  ...
  while (true) {
    ...
    while (true) {
      t1 = this.jointCount;
      if (typeof t1 !== 'number')
        return this.solve$3$bailout(46, step, t2, allowSleep, t1, i, contactsOkay, jointsOkay, j);
      if (!(j < t1))
        break;
      t1 = this.joints;
      if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))
        return this.solve$3$bailout(47, t1, step, allowSleep, t2, i, contactsOkay, jointsOkay, j);
      if (j >= t1.length)
        throw $.ioore(j);
 ...
 solve$1: function(baumgarte) {
  ...
  while (true) {
    ...
    while (true) {
      t7 = c.get$pointCount();
      if (typeof t7 !== 'number')
        return this.solve$1$bailout(8, baumgarte, invMassA, invIA, t5, t4, normal, invMassB, point, invIB, i, c, bodyA, j, bodyB, minSeparation, t1, t2, t7, t3);
      if (!(j < t7))
        break;
      t5.initialize$2(c, j);
      separation = t5.separation;
      if (typeof separation !== 'number')
        return this.solve$1$bailout(9, baumgarte, invMassA, invIA, t5, t4, normal, invMassB, point, invIB, separation, i, c, bodyA, j, bodyB, minSeparation, t1, t2, t3);
      t3.setFrom$1(point).subLocal$1(bodyA.get$sweep().get$center());
      t4.setFrom$1(point).subLocal$1(bodyB.get$sweep().get$center());
      minSeparation = $.min(minSeparation, separation);
      C = $.max(-0.2, $.min(baumgarte * (separation + 0.005), 0));
      t8 = t3.x;
      if (typeof t8 !== 'number')
        return this.solve$1$bailout(10, C, invMassA, baumgarte, invIA, t5, t4, normal, invMassB, point, invIB, i, t8, c, bodyA, minSeparation, j, bodyB, t1, t2, t3);
      t10 = normal.y;
      if (typeof t10 !== 'number')
        return this.solve$1$bailout(11, C, invMassA, baumgarte, invIA, t5, t4, normal, invMassB, point, invIB, i, t8, t10, bodyA, minSeparation, j, bodyB, c, t1, t2, t3);
      t8 *= t10;
      t12 = t3.y;
      if (typeof t12 !== 'number')
        return this.solve$1$bailout(12, C, invMassA, baumgarte, invIA, t8, t4, normal, invMassB, point, invIB, t5, i, c, bodyA, minSeparation, j, t12, bodyB, t1, t2, t3);
      t14 = normal.x;
      if (typeof t14 !== 'number')
        return this.solve$1$bailout(13, C, invMassA, baumgarte, invIA, t8, t4, normal, invMassB, point, invIB, t5, i, c, bodyA, minSeparation, j, t12, bodyB, t14, t1, t2, t3);
      rnA = t8 - t12 * t14;
      t8 = t4.x;
      if (typeof t8 !== 'number')
        return this.solve$1$bailout(14, C, invMassA, baumgarte, invIA, t5, t4, normal, invMassB, point, invIB, rnA, i, c, bodyA, minSeparation, j, t8, bodyB, t1, t2, t3);
      t10 = t8 * t10;
      t8 = t4.y;
      if (typeof t8 !== 'number')
        return this.solve$1$bailout(16, C, invMassA, baumgarte, invIA, t5, t4, normal, invMassB, point, invIB, rnA, i, t10, bodyA, minSeparation, j, bodyB, t8, t1, t2, t3, c);
      rnB = t10 - t8 * t14;
      ...
      t10 = t3.y;
      if (typeof t10 !== 'number')
        return this.solve$1$bailout(21, baumgarte, t10, invMassA, t12, invIA, t5, t4, invMassB, normal, point, invIB, i, c, bodyA, minSeparation, j, bodyB, t1, t2, t7, t8, t3);
      t15 = t1.x;
      if (typeof t15 !== 'number')
...
$.DominoTower$ = function() {
  var t1 = new $.DominoTower(null, $._ListImpl_List(null), null, null, null, null, null, null, null, null, null, 10, null);
