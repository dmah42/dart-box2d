...
CircleStress: {"": "Demo;_joint,bodies,canvas,ctx,viewport,debugDraw,world,frameCount,fpsCounter,elapsedUs,worldStepTime,viewportScale,_stopwatch",
  initialize$0: function(_) {
    var bd, ground, shape, t1, sd, b, fd, wallDef, rightWall, leftWall, cornerDef, myBod, topDef, topBody, body, i, cd, t2, t3, bodyDef, groundBody, rjd, j, yPos, circ, bod, fd2, myBody;
    bd = $.BodyDef$();
    ...
    rightWall.createFixtureFromShape$2;
    t1 = rightWall._fixDef;
    t1.shape = sd;
    t1.density = 0;
    rightWall.createFixture$1(t1);
    wallDef.position = new $.Vector(-45, 25);
    leftWall = this.world.createBody$1(wallDef);
    this.bodies.push(leftWall);
    leftWall.createFixtureFromShape$2;
    t1 = leftWall._fixDef;
    t1.shape = sd;
    t1.density = 0;
    leftWall.createFixture$1(t1);
    cornerDef = $.BodyDef$();
    sd.setAsBox$2(20, 3);
    ...
    myBod.createFixtureFromShape$2;
    t1 = myBod._fixDef;
    t1.shape = sd;
    t1.density = 0;
    myBod.createFixture$1(t1);
    cornerDef.angle = 0.7853981633974483;
    cornerDef.position = new $.Vector(35, 8);
    myBod = this.world.createBody$1(cornerDef);
    this.bodies.push(myBod);
    ...
    body.set$bullet;
    t1 = body.flags;
    body.flags = (t1 & 4294967287) >>> 0;
    bodyDef = $.BodyDef$();
    groundBody = this.world.createBody$1(bodyDef);
    rjd = $.RevoluteJointDef$();
    body.get$position;
    rjd.initialize$3(rjd, body, groundBody, body.originTransform.position);
    ...
    for (j = 0; j < 8; ++j)
      for (yPos = 50 + j, i = 0; i < 20; ++i) {
        circ = new $.CircleShape(new $.Vector(0, 0), 0, 0);
        bod = $.BodyDef$();
        bod.type = 2;
        ...
        fd2.friction = 0.5;
        fd2.restitution = 0.7;
        bod.position = new $.Vector(-39 + 2 * i, yPos);
...
main: function() {
  var stress = new $.CircleStress(null, $.List_List($), null, null, null, null, null, null, null, null, null, 10, null);
  stress.Demo$3("Circle stress", null, 10);
...
CircleShape: {"": "Shape;position>,type,radius",
  ...
  computeMass$2: function(massData, density) {
    ...
    t2 = this.radius;
    massData.mass = $.$mul$n($.$mul$n(t1, t2), t2);
    t2 = massData.center;
    t1 = this.position;
    t3 = t1.x;
    t4 = t1.y;
...
PolygonShape: {"": "Shape;centroid<,vertices<,normals<,vertexCount<,type,radius",
  ...
  setAsEdge$2: function(v1, v2) {
    ...
    if (0 >= t3)
      throw $.ioore(0);
    t1[0].setFrom$1(v2).subLocal$1(v1);
    t2 = t1[0];
    ...
    if (1 >= t3)
      throw $.ioore(1);
    t1[1].setFrom$1(t1[0]).negateLocal$0();
  },
...
ContactSolver: {"": "Object;constraints,constraintCount,worldManifold,tangent,temp1,temp2,P,dv,dv1,dv2,x>,d,P1,P2,psolver,rA<,rB<",
  ...
  solvePositionConstraints$1: function(baumgarte) {
    ...
    while (true) {
      ...
      t5 = bodyA.get$mass();
      if (typeof t5 !== "number")
        return this.solvePositionConstraints$1$bailout(1, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, t5, t3, c);
      invMassA = t5 * bodyA.get$invMass();
      invIA = t5 * bodyA.get$invInertia();
      t5 = bodyB.get$mass();
      if (typeof t5 !== "number")
        return this.solvePositionConstraints$1$bailout(2, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, t5, t3, c, invMassA, invIA);
      ...
      while (true) {
        ...
        if (typeof separation !== "number")
          return this.solvePositionConstraints$1$bailout(3, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, separation, j, $.JSNumber_methods, invMassB);
        t6 = point.x;
        t7 = point.y;
        t3.x = t6;
        t3.y = t7;
        ...
        t6 = t3.x;
        if (typeof t6 !== "number")
          return this.solvePositionConstraints$1$bailout(4, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, separation, j, $.JSNumber_methods, invMassB, t6, t7);
        t8 = t7.x;
        if (typeof t8 !== "number")
          return this.solvePositionConstraints$1$bailout(5, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, separation, j, $.JSNumber_methods, invMassB, t6, t7, t8);
        t3.x = t6 - t8;
        t8 = t3.y;
        if (typeof t8 !== "number")
          return this.solvePositionConstraints$1$bailout(6, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, separation, j, $.JSNumber_methods, invMassB, 0, t7, t8);
        t7 = t7.y;
        if (typeof t7 !== "number")
          return this.solvePositionConstraints$1$bailout(7, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, separation, j, $.JSNumber_methods, invMassB, 0, t7, t8);
        t3.y = t8 - t7;
        t7 = point.x;
        t8 = point.y;
        t4.x = t7;
        ...
        t7 = t4.x;
        if (typeof t7 !== "number")
          return this.solvePositionConstraints$1$bailout(8, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, separation, j, $.JSNumber_methods, invMassB, 0, t7, t8);
        t6 = t8.x;
        if (typeof t6 !== "number")
          return this.solvePositionConstraints$1$bailout(9, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, separation, j, $.JSNumber_methods, invMassB, t6, t7, t8);
        t4.x = t7 - t6;
        t6 = t4.y;
        if (typeof t6 !== "number")
          return this.solvePositionConstraints$1$bailout(10, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, separation, j, $.JSNumber_methods, invMassB, t6, 0, t8);
        t8 = t8.y;
        if (typeof t8 !== "number")
          return this.solvePositionConstraints$1$bailout(11, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, separation, j, $.JSNumber_methods, invMassB, t6, 0, t8);
        t4.y = t6 - t8;
        minSeparation = $.min(minSeparation, separation);
        C = $.max(-0.2, $.min(baumgarte * (separation + 0.005), 0));
        t8 = t3.x;
        if (typeof t8 !== "number")
          return this.solvePositionConstraints$1$bailout(12, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, 0, 0, t8, C);
        t6 = normal.y;
        if (typeof t6 !== "number")
          return this.solvePositionConstraints$1$bailout(13, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, t6, 0, t8, C);
        t8 *= t6;
        t7 = t3.y;
        if (typeof t7 !== "number")
          return this.solvePositionConstraints$1$bailout(14, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, t6, t7, t8, C);
        t9 = normal.x;
        if (typeof t9 !== "number")
          return this.solvePositionConstraints$1$bailout(15, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, t6, t7, t8, C, t9);
        rnA = t8 - t7 * t9;
        t7 = t4.x;
        if (typeof t7 !== "number")
          return this.solvePositionConstraints$1$bailout(16, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, t6, t7, 0, C, t9, rnA);
        t7 *= t6;
        t8 = t4.y;
        if (typeof t8 !== "number")
          return this.solvePositionConstraints$1$bailout(17, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, t6, t7, t8, C, t9, rnA);
        rnB = t7 - t8 * t9;
        ...
        t6 = t1.x;
        if (typeof t6 !== "number")
          return this.solvePositionConstraints$1$bailout(18, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, t6, 0, 0, 0, 0, 0, impulse);
        t1.x = t6 * impulse;
        t6 = t1.y;
        if (typeof t6 !== "number")
          return this.solvePositionConstraints$1$bailout(19, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, t6, 0, 0, 0, 0, 0, impulse);
        t1.y = t6 * impulse;
        t6 = t1.x;
        t7 = t1.y;
        t2.x = t6;
        ...
        t7 = t2.x;
        if (typeof t7 !== "number")
          return this.solvePositionConstraints$1$bailout(20, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, 0, t7);
        t2.x = t7 * invMassA;
        t7 = t2.y;
        if (typeof t7 !== "number")
          return this.solvePositionConstraints$1$bailout(21, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, 0, t7);
        t2.y = t7 * invMassA;
        t7 = bodyA.get$sweep().center;
        t6 = t7.x;
        if (typeof t6 !== "number")
          return this.solvePositionConstraints$1$bailout(22, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, t6, t7);
        t8 = t2.x;
        if (typeof t8 !== "number")
          return this.solvePositionConstraints$1$bailout(23, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, t6, t7, t8);
        t7.x = t6 - t8;
        t8 = t7.y;
        if (typeof t8 !== "number")
          return this.solvePositionConstraints$1$bailout(24, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, 0, t7, t8);
        t6 = t2.y;
        if (typeof t6 !== "number")
          return this.solvePositionConstraints$1$bailout(25, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, t6, t7, t8);
        t7.y = t8 - t6;
        t6 = bodyA.get$sweep();
        t8 = t6.angle;
        if (typeof t8 !== "number")
          return this.solvePositionConstraints$1$bailout(26, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, t6, 0, t8);
        t7 = t3.x;
        if (typeof t7 !== "number")
          return this.solvePositionConstraints$1$bailout(27, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, t6, t7, t8);
        t9 = t1.y;
        if (typeof t9 !== "number")
          return this.solvePositionConstraints$1$bailout(28, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, t6, t7, t8, 0, t9);
        t9 = t7 * t9;
        t7 = t3.y;
        if (typeof t7 !== "number")
          return this.solvePositionConstraints$1$bailout(29, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, t6, t7, t8, 0, t9);
        t10 = t1.x;
        if (typeof t10 !== "number")
          return this.solvePositionConstraints$1$bailout(30, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, t6, t7, t8, 0, t9, 0, 0, t10);
        ...
        t7 = t2.x;
        if (typeof t7 !== "number")
          return this.solvePositionConstraints$1$bailout(31, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, 0, t7);
        t2.x = t7 * invMassB;
        t7 = t2.y;
        if (typeof t7 !== "number")
          return this.solvePositionConstraints$1$bailout(32, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, 0, t7);
        t2.y = t7 * invMassB;
        t7 = bodyB.get$sweep().center;
        t10 = t7.x;
        if (typeof t10 !== "number")
          return this.solvePositionConstraints$1$bailout(33, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, 0, t7, 0, 0, 0, 0, 0, t10);
        t9 = t2.x;
        if (typeof t9 !== "number")
          return this.solvePositionConstraints$1$bailout(34, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, 0, t7, 0, 0, t9, 0, 0, t10);
        t7.x = t10 + t9;
        t9 = t7.y;
        if (typeof t9 !== "number")
          return this.solvePositionConstraints$1$bailout(35, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, 0, t7, 0, 0, t9);
        t10 = t2.y;
        if (typeof t10 !== "number")
          return this.solvePositionConstraints$1$bailout(36, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, 0, t7, 0, 0, t9, 0, 0, t10);
        t7.y = t9 + t10;
        t10 = bodyB.get$sweep();
        t9 = t10.angle;
        if (typeof t9 !== "number")
          return this.solvePositionConstraints$1$bailout(37, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, 0, 0, 0, 0, t9, 0, 0, t10);
        t7 = t4.x;
        if (typeof t7 !== "number")
          return this.solvePositionConstraints$1$bailout(38, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, 0, t7, 0, 0, t9, 0, 0, t10);
        t8 = t1.y;
        if (typeof t8 !== "number")
          return this.solvePositionConstraints$1$bailout(39, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, 0, t7, t8, 0, t9, 0, 0, t10);
        t8 = t7 * t8;
        t7 = t4.y;
        if (typeof t7 !== "number")
          return this.solvePositionConstraints$1$bailout(40, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, 0, t7, t8, 0, t9, 0, 0, t10);
        t6 = t1.x;
        if (typeof t6 !== "number")
          return this.solvePositionConstraints$1$bailout(41, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, $.JSNumber_methods, t3, c, invMassA, invIA, invIB, $.JSNumber_methods, 0, j, $.JSNumber_methods, invMassB, t6, t7, t8, 0, t9, 0, 0, t10);
  ...
  solvePositionConstraints$1$bailout: function(state0, baumgarte, psm, t1, point, normal, minSeparation, i, t2, t4, bodyA, bodyB, t5, t3, c, invMassA, invIA, invIB, t6, separation, j, t7, invMassB, t8, t9, t10, C, t11, rnA, impulse, t12) {
    switch (state0) {
      case 0:
        t1 = this.P;
        t2 = this.temp1;
          ...
          while (true)
            switch (state0) {
              ...
              case 1:
                ...
                invMassA = t6.$mul(t5, bodyA.get$invMass());
                invIA = t6.$mul(t5, bodyA.get$invInertia());
                t5 = bodyB.get$mass();
              case 2:
                state0 = 0;
                t6 = $.getInterceptor$n(t5);
                invMassB = t6.$mul(t5, bodyB.get$invMass());
                ...
                L1:
                  while (true)
                    switch (state0) {
                      ...
                      case 17:
                        state0 = 0;
                        rnB = $.$sub$n(t9, $.$mul$n(t10, t11));
                        K = $.$add$ns($.$add$ns(t7.$add(invMassA, invMassB), $.$mul$n(t5.$mul(invIA, rnA), rnA)), $.$mul$n(t6.$mul(invIB, rnB), rnB));
                        if ($.$gt$n(K, 0)) {
                          if (typeof K !== "number")
                            throw $.iae(K);
                          impulse = -C / K;
                      ...
                      case 18:
                        state0 = 0;
                        t1.x = $.$mul$n(t8, impulse);
                        t8 = t1.y;
                      case 19:
                        state0 = 0;
                        t1.y = $.$mul$n(t8, impulse);
                        t8 = t1.x;
                        t9 = t1.y;
                        t2.x = t8;
                        t2.y = t9;
                      ...
                      case 20:
                        state0 = 0;
                        t2.x = $.$mul$n(t9, invMassA);
                        t9 = t2.y;
                      case 21:
                        state0 = 0;
                        t2.y = $.$mul$n(t9, invMassA);
                        t9 = bodyA.get$sweep().center;
                        t8 = t9.x;
                      case 22:
                        state0 = 0;
                      ...
                      case 30:
                        state0 = 0;
                        t8.angle = $.$sub$n(t10, t5.$mul(invIA, $.$sub$n(t11, $.$mul$n(t9, t12))));
                        bodyA.synchronizeTransform$0();
                        t12 = t1.x;
                        t9 = t1.y;
                        t2.x = t12;
                      ...
                      case 41:
                        state0 = 0;
                        t12.angle = $.$add$ns(t11, t6.$mul(invIB, $.$sub$n(t10, $.$mul$n(t9, t8))));
                        bodyB.synchronizeTransform$0();
                        ++j;
                    }
                ++i;
...
TimeOfImpactSolver: {"": "Object;constraints,count@,toiBody,psm,rA<,rB<,P,temp",
  ...
  solve$1: function(baumgarte) {
    ...
    while (true) {
      ...
      while (true) {
        ...
        if (typeof separation !== "number")
          return this.solve$1$bailout(3, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, separation, j);
        t7 = point.x;
        t8 = point.y;
        t3.x = t7;
        t3.y = t8;
        ...
        t7 = t3.x;
        if (typeof t7 !== "number")
          return this.solve$1$bailout(4, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, separation, j, t8, t7);
        t9 = t8.x;
        if (typeof t9 !== "number")
          return this.solve$1$bailout(5, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, separation, j, t8, t7, t9);
        t3.x = t7 - t9;
        t9 = t3.y;
        if (typeof t9 !== "number")
          return this.solve$1$bailout(6, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, separation, j, t8, 0, t9);
        t8 = t8.y;
        if (typeof t8 !== "number")
          return this.solve$1$bailout(7, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, separation, j, t8, 0, t9);
        t3.y = t9 - t8;
        t8 = point.x;
        t9 = point.y;
        t4.x = t8;
        ...
        t8 = t4.x;
        if (typeof t8 !== "number")
          return this.solve$1$bailout(8, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, separation, j, t8, 0, t9);
        t7 = t9.x;
        if (typeof t7 !== "number")
          return this.solve$1$bailout(9, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, separation, j, t8, t7, t9);
        t4.x = t8 - t7;
        t7 = t4.y;
        if (typeof t7 !== "number")
          return this.solve$1$bailout(10, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, separation, j, 0, t7, t9);
        t9 = t9.y;
        if (typeof t9 !== "number")
          return this.solve$1$bailout(11, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, separation, j, 0, t7, t9);
        t4.y = t7 - t9;
        minSeparation = $.min(minSeparation, separation);
        C = $.max(-0.2, $.min(baumgarte * (separation + 0.005), 0));
        t9 = t3.x;
        if (typeof t9 !== "number")
          return this.solve$1$bailout(12, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, 0, 0, t9, C);
        t7 = normal.y;
        if (typeof t7 !== "number")
          return this.solve$1$bailout(13, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, 0, t7, t9, C);
        t9 *= t7;
        t8 = t3.y;
        if (typeof t8 !== "number")
          return this.solve$1$bailout(14, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, t7, t9, C);
        t10 = normal.x;
        if (typeof t10 !== "number")
          return this.solve$1$bailout(15, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, t7, t9, C, t10);
        rnA = t9 - t8 * t10;
        t8 = t4.x;
        if (typeof t8 !== "number")
          return this.solve$1$bailout(16, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, t7, 0, C, t10, rnA);
        t8 *= t7;
        t9 = t4.y;
        if (typeof t9 !== "number")
          return this.solve$1$bailout(17, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, t7, t9, C, t10, rnA);
        rnB = t8 - t9 * t10;
        ...
        t7 = t1.x;
        if (typeof t7 !== "number")
          return this.solve$1$bailout(18, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, 0, t7, 0, 0, 0, 0, impulse);
        t1.x = t7 * impulse;
        t7 = t1.y;
        if (typeof t7 !== "number")
          return this.solve$1$bailout(19, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, 0, t7, 0, 0, 0, 0, impulse);
        t1.y = t7 * impulse;
        t7 = t1.x;
        t8 = t1.y;
        t2.x = t7;
        ...
        t8 = t2.x;
        if (typeof t8 !== "number")
          return this.solve$1$bailout(20, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8);
        t2.x = t8 * invMassA;
        t8 = t2.y;
        if (typeof t8 !== "number")
          return this.solve$1$bailout(21, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8);
        t2.y = t8 * invMassA;
        t8 = bodyA.get$sweep().center;
        t7 = t8.x;
        if (typeof t7 !== "number")
          return this.solve$1$bailout(22, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, t7);
        t9 = t2.x;
        if (typeof t9 !== "number")
          return this.solve$1$bailout(23, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, t7, t9);
        t8.x = t7 - t9;
        t9 = t8.y;
        if (typeof t9 !== "number")
          return this.solve$1$bailout(24, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, 0, t9);
        t7 = t2.y;
        if (typeof t7 !== "number")
          return this.solve$1$bailout(25, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, t7, t9);
        t8.y = t9 - t7;
        t7 = bodyA.get$sweep();
        t9 = t7.angle;
        if (typeof t9 !== "number")
          return this.solve$1$bailout(26, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, 0, t7, t9);
        t8 = t3.x;
        if (typeof t8 !== "number")
          return this.solve$1$bailout(27, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, t7, t9);
        t10 = t1.y;
        if (typeof t10 !== "number")
          return this.solve$1$bailout(28, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, t7, t9, 0, t10);
        t10 = t8 * t10;
        t8 = t3.y;
        if (typeof t8 !== "number")
          return this.solve$1$bailout(29, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, t7, t9, 0, t10);
        t11 = t1.x;
        if (typeof t11 !== "number")
          return this.solve$1$bailout(30, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, t7, t9, 0, t10, 0, 0, t11);
        ...
        t8 = t2.x;
        if (typeof t8 !== "number")
          return this.solve$1$bailout(31, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8);
        t2.x = t8 * invMassB;
        t8 = t2.y;
        if (typeof t8 !== "number")
          return this.solve$1$bailout(32, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8);
        t2.y = t8 * invMassB;
        t8 = bodyB.get$sweep().center;
        t11 = t8.x;
        if (typeof t11 !== "number")
          return this.solve$1$bailout(33, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, 0, 0, 0, 0, 0, 0, t11);
        t10 = t2.x;
        if (typeof t10 !== "number")
          return this.solve$1$bailout(34, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, 0, 0, 0, t10, 0, 0, t11);
        t8.x = t11 + t10;
        t10 = t8.y;
        if (typeof t10 !== "number")
          return this.solve$1$bailout(35, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, 0, 0, 0, t10);
        t11 = t2.y;
        if (typeof t11 !== "number")
          return this.solve$1$bailout(36, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, 0, 0, 0, t10, 0, 0, t11);
        t8.y = t10 + t11;
        t11 = bodyB.get$sweep();
        t10 = t11.angle;
        if (typeof t10 !== "number")
          return this.solve$1$bailout(37, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, 0, 0, 0, 0, t10, 0, 0, t11);
        t8 = t4.x;
        if (typeof t8 !== "number")
          return this.solve$1$bailout(38, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, 0, 0, 0, t10, 0, 0, t11);
        t9 = t1.y;
        if (typeof t9 !== "number")
          return this.solve$1$bailout(39, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, 0, t9, 0, t10, 0, 0, t11);
        t9 = t8 * t9;
        t8 = t4.y;
        if (typeof t8 !== "number")
          return this.solve$1$bailout(40, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, 0, t9, 0, t10, 0, 0, t11);
        t7 = t1.x;
        if (typeof t7 !== "number")
          return this.solve$1$bailout(41, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, 0, point, t2, t4, 0, invMassA, invIA, invMassB, $.JSNumber_methods, invIB, $.JSNumber_methods, $.JSNumber_methods, 0, j, t8, t7, t9, 0, t10, 0, 0, t11);
  ...
  solve$1$bailout: function(state0, baumgarte, minSeparation, i, t3, c, t5, normal, bodyA, bodyB, t1, massA, point, t2, t4, massB, invMassA, invIA, invMassB, t8, invIB, t7, t6, separation, j, t10, t9, t11, C, t12, rnA, impulse, t13) {
    switch (state0) {
      case 0:
        t1 = this.P;
        t2 = this.temp;
                ...
                L1:
                  while (true)
                    switch (state0) {
                      ...
                      case 17:
                        state0 = 0;
                        rnB = $.$sub$n(t10, $.$mul$n(t11, t12));
                        K = $.$add$ns($.$add$ns(t8.$add(invMassA, invMassB), $.$mul$n(t6.$mul(invIA, rnA), rnA)), $.$mul$n(t7.$mul(invIB, rnB), rnB));
                        if ($.$gt$n(K, 0)) {
                          if (typeof K !== "number")
                            throw $.iae(K);
                          impulse = -C / K;
                      ...
                      case 18:
                        state0 = 0;
                        t1.x = $.$mul$n(t9, impulse);
                        t9 = t1.y;
                      case 19:
                        state0 = 0;
                        t1.y = $.$mul$n(t9, impulse);
                        t9 = t1.x;
                        t10 = t1.y;
                        t2.x = t9;
                        t2.y = t10;
                      ...
                      case 20:
                        state0 = 0;
                        t2.x = $.$mul$n(t10, invMassA);
                        t10 = t2.y;
                      case 21:
                        state0 = 0;
                        t2.y = $.$mul$n(t10, invMassA);
                        t10 = bodyA.get$sweep().center;
                        t9 = t10.x;
                      case 22:
                        state0 = 0;
                      ...
                      case 30:
                        state0 = 0;
                        t9.angle = $.$sub$n(t11, t6.$mul(invIA, $.$sub$n(t12, $.$mul$n(t10, t13))));
                        bodyA.synchronizeTransform$0();
                        t13 = t1.x;
                        t10 = t1.y;
                        t2.x = t13;
                      ...
                      case 41:
                        state0 = 0;
                        t13.angle = $.$add$ns(t12, t7.$mul(invIB, $.$sub$n(t11, $.$mul$n(t10, t9))));
                        bodyB.synchronizeTransform$0();
                        ++j;
                    }
                ++i;
...
ConstantVolumeJoint: {"": "Joint;bodies,targetLengths,targetVolume,normals,step,_impulse,_world,distanceJoints,frequencyHz,dampingRatio,type,_prev,_liblib1$_next,edgeA,edgeB,bodyA,bodyB,islandFlag,collideConnected,userData,localCenterA,localCenterB,invMassA,invIA,invMassB,invIB",
  ...
  ConstantVolumeJoint$2: function(_world, def) {
    var i, t1, next, t2, t3, temp, dist, djd, t4;
    if ($.$le$n($.get$length$asx(def.get$bodies()), 2))
      throw $.wrapException(new $.ArgumentError("You cannot create a constant volume joint with less than three bodies."));
    this.bodies = $.List_List$from(def.get$bodies(), true);
    ...
    t1 = def.get$joints();
    if (t1 != null && !$.$eq($.get$length$asx(t1), $.get$length$asx(def.get$bodies())))
    ...
    if (t1 == null) {
      ...
      t2 = $.get$length$asx(def.get$joints());
      t3 = def.get$joints();
      t1.setRange$4;
      if (!!t1.immutable$list)
        $.throwExpression(new $.UnsupportedError("set range"));
...
RevoluteJoint: {"": "Joint;localAnchor1,localAnchor2,impulse,_motorImpulse,mass<,motorMass,_enableMotor,_maxMotorTorque,_motorSpeed,_enableLimit,referenceAngle,lowerAngle,upperAngle,limitState,type,_prev,_liblib1$_next,edgeA,edgeB,bodyA,bodyB,islandFlag,collideConnected,userData,localCenterA,localCenterB,invMassA,invIA,invMassB,invIB",
  ...
  solveVelocityConstraints$1: function(step) {
    var b1, b2, v1, w1, v2, w2, m1, m2, i1, i2, t1, Cdot, imp, oldImpulse, maxImpulse, temp, r1, r2, t2, t3, t4, t5, t6, Cdot1, tempY, Cdot2, P;
    b1 = this.bodyA;
    b2 = this.bodyB;
...
RevoluteJointDef$: function() {
  var t1 = new $.RevoluteJointDef(new $.Vector(0, 0), new $.Vector(0, 0), 0, false, 0, 0, false, 0, 0, 0, null, null, null, false);
