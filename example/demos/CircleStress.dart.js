 ...
 initVelocityConstraints$1: function(argStep) {
  ...
  while (true) {
    ...
    if (i === 0) {
      ...
      t1 = $.getInterceptor$JSStringJSArray(t1).get$length(t1);
      if (typeof t1 !== 'number')
        return this.initVelocityConstraints$1$bailout2(3, d, t1, i);
      prev = t1 - 1;
    } else
      prev = i - 1;
    t1 = this.bodies;
    t1 = $.getInterceptor$JSStringJSArray(t1).get$length(t1);
    if (typeof t1 !== 'number')
      return this.initVelocityConstraints$1$bailout2(4, d, prev, i, t1);
    next = i === t1 - 1 ? 0 : i + 1;
    if (i >= d.length)
      throw $.ioore(i);
    t1 = d[i];
    ...
    t4 = this.bodies;
    if (typeof t4 !== 'string' && (typeof t4 !== 'object' || t4 === null || t4.constructor !== Array && !t4.is$JavaScriptIndexingBehavior()))
      return this.initVelocityConstraints$1$bailout2(6, d, t1, prev, i, t4);
    if (prev !== (prev | 0))
      throw $.iae(prev);
