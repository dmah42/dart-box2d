...
$$.BoxTest = {"": ["bodies", "canvas", "ctx", "viewport", "debugDraw", "world", "frameCount", "fpsCounter", "elapsedUs", "worldStepTime", "viewportScale", "_stopwatch"],
 "super": "Demo",
...
$$.Collision = {"": ["_pool", "cache", "input", "output", "results1", "results2", "incidentEdge?", "localTangent", "localNormal?", "planePoint", "tangent", "normal?", "normal1", "v11", "v12", "clipPoints1", "clipPoints2"],
 ...
 findIncidentEdge$6: function(c, poly1, xf1, edge1, poly2, xf2) {
  var normals1, count2, vertices2, normals2, t3, t4, t5, index, i, minDot, t1, dot, i2;
  poly1.get$vertexCount();
  normals1 = poly1.get$normals();
  count2 = poly2.get$vertexCount();
  if (typeof count2 !== 'number')
  ...
  for (index = 0, i = 0, minDot = 99999999999999; i < count2; ++i) {
 ...
 findIncidentEdge$6$bailout: function(state0, env0, env1, env2, env3, env4, env5, env6, env7) {
  ...
  switch (state0) {
    ...
    case 1:
      ...
      normals2 = poly2.get$normals();
    case 2:
      var normals1, count2, xf2, poly2, edge1, xf1, c, vertices2, normals2, t3, t4, t5, index, i, minDot, t1, dot, i2;
      state0 = 0;
      t3 = xf1.get$rotation();
      t4 = $.index(normals1, edge1);
      t5 = this.normal1;
      $.Matrix22_mulMatrixAndVectorToOut(t3, t4, t5);
      $.Matrix22_mulTransMatrixAndVectorToOut(xf2.get$rotation(), t5, t5);
      for (index = 0, i = 0, minDot = 99999999999999; $.ltB(i, count2); ++i) {
        t1 = $.index(normals2, i);
        dot = $.add($.mul(t5.x, t1.get$x()), $.mul(t5.y, t1.get$y()));
        if ($.ltB(dot, minDot)) {
          minDot = dot;
 ...
 collidePolygons$5: function(manifold, polyA, xfA, polyB, xfB) {
  var totalRadius, t2, t1, t3, t4, edge1, poly1, xf2, xf1, poly2, flip, count1, vertices1, t5, t6, t7, t8, frontOffset, sideOffset1, sideOffset2, t9, np, pointCount, i, cp;
  manifold.set$pointCount(0);
  ...
  if (typeof frontOffset !== 'number')
    return this.collidePolygons$5$bailout(2, manifold, flip, t8, t4, frontOffset, totalRadius, t1, t2, t3, t5, t6, xf2);
 ...
 collidePolygons$5$bailout: function(state0, env0, env1, env2, env3, env4, env5, env6, env7, env8, env9, env10, env11) {
  ...
  switch (state0) {
    ...
    case 1:
      ...
      frontOffset = $.add($.mul(t4.x, t2.x), $.mul(t4.y, t2.y));
    case 2:
      var totalRadius, xfB, polyB, xfA, polyA, manifold, t2, t1, t3, t4, edge1, poly1, xf2, xf1, poly2, flip, count1, vertices1, t5, t6, t7, t8, frontOffset, sideOffset1, sideOffset2, t9, np, pointCount, i, cp;
      state0 = 0;
      sideOffset1 = $.add($.neg($.add($.mul(t8.x, t2.x), $.mul(t8.y, t2.y))), totalRadius);
      sideOffset2 = $.add($.add($.mul(t8.x, t3.x), $.mul(t8.y, t3.y)), totalRadius);
      t8.negateLocal$0();
...
$$.DistanceProxy = {"": ["vertices?", "count=", "radius="],
 ...
 getSupport$1: function(direction) {
  ...
  while (true) {
    ...
    t4 = t3.get$x();
    if (typeof t4 !== 'number')
      return this.getSupport$1$bailout(6, direction, t3, t4, bestIndex, bestValue, i, t2, t1);
    t4 *= t6;
    t3 = t3.get$y();
    if (typeof t3 !== 'number')
...
$$.TimeOfImpact = {"": ["cache", "distanceInput", "xfA", "xfB", "distanceOutput", "fcn", "indexes", "sweepA?", "sweepB?", "pool"],
 ...
 timeOfImpact$2: function(output, input) {
  var t1, proxyA, proxyB, t3, t4, tMax, t6, t8, target, t10, t11, t12, t2, t5, t7, t9, t13, t14, iter, t15, t20, pushBackIter, done, s2, s1, a1, a2, rootIterCount, t, s, t16;
  ...
  for (t1 = this.fcn, t2 = this.indexes, t5 = t2.length, t6 = target + 0.00125, t7 = target - 0.00125, t8 = this.distanceOutput, t9 = this.xfA, t11 = this.xfB, t13 = this.pool, t14 = 0, iter = 0; true;) {
    ...
    t15 = t8.distance;
    if (typeof t15 !== 'number')
      return this.timeOfImpact$2$bailout(5, iter, output, t1, t2, t11, target, t7, t13, t9, proxyA, proxyB, t15, t3, t4, t6, t8, t5, t10, t12, tMax, t14);
    if (t15 <= 0) {
      output.set$state(2);
      output.set$t(0);
      break;
    ...
    for (t20 = tMax, pushBackIter = 0; done = false, true;) {
      ...
      if (typeof s2 !== 'number')
        return this.timeOfImpact$2$bailout(7, output, iter, t20, pushBackIter, t11, t14, s2, t13, proxyA, proxyB, t8, tMax, t1, t2, target, t7, t3, t4, t6, t5, t10, t12, t9);
      if (s2 > t6) {
        output.set$state(4);
        output.set$t(tMax);
        done = true;
      ...
      if (typeof s1 !== 'number')
        return this.timeOfImpact$2$bailout(8, output, iter, pushBackIter, t20, t9, s2, t13, t11, proxyA, proxyB, t8, tMax, t1, t2, s1, target, t7, t3, t4, t6, t5, t10, t12, t14);
      if (s1 < t7) {
        output.set$state(1);
        output.set$t(t14);
        done = true;
      ...
      for (a1 = t14, a2 = t20, rootIterCount = 0; true;) {
        t = (rootIterCount & 1) === 1 ? a1 + (target - s1) * (a2 - a1) / (s2 - s1) : 0.5 * (a1 + a2);
        s = t1.evaluate$3(t2[0], t2[1], t);
        if (typeof s !== 'number')
          return this.timeOfImpact$2$bailout(9, output, iter, pushBackIter, t20, t9, t11, t13, s2, s1, rootIterCount, a1, proxyB, proxyA, t8, tMax, t1, t2, target, t7, t, t3, t4, t6, s, t5, t10, t12, a2, t14);
        t15 = $.abs(s - target);
        if (typeof t15 !== 'number')
          return this.timeOfImpact$2$bailout(10, output, iter, pushBackIter, t20, t9, t11, t13, s2, s1, rootIterCount, a1, proxyB, proxyA, t8, tMax, t1, t2, target, t7, t, t3, t4, t6, s, t5, t10, t15, t12, a2, t14);
        if (t15 < 0.00125) {
          t20 = t;
          break;
        }
        ...
        if (a1 !== (a1 | 0))
          return this.timeOfImpact$2$bailout(11, output, iter, pushBackIter, t20, t9, a2, s2, s1, a1, t13, rootIterCount, proxyB, t11, t8, proxyA, tMax, t1, t2, target, t7, t3, t4, t6, t5, t10, t12, t14);
        ++rootIterCount;
        t16 = $.TimeOfImpact_toiRootIters;
        if (typeof t16 !== 'number')
          return this.timeOfImpact$2$bailout(12, output, iter, pushBackIter, t20, t9, a2, s2, s1, a1, rootIterCount, t16, proxyA, t13, proxyB, t11, t8, tMax, t1, t2, target, t7, t3, t4, t6, t5, t10, t12, t14);
        $.TimeOfImpact_toiRootIters = t16 + 1;
        if (rootIterCount === 50)
          break;
      }
      if (t20 !== (t20 | 0))
        return this.timeOfImpact$2$bailout(13, output, iter, pushBackIter, t11, t14, t13, proxyA, proxyB, t8, tMax, t1, t2, target, t20, t7, rootIterCount, t3, t4, t6, t5, t10, t12, t9);
    ...
    if (typeof t15 !== 'number')
      return this.timeOfImpact$2$bailout(14, output, t1, t14, t2, t11, target, done, t7, t13, iter, t15, proxyA, proxyB, t3, t4, t6, t8, t5, t10, t12, tMax, t9);
 ...
 timeOfImpact$2$bailout: function(state0, env0, env1, env2, env3, env4, env5, env6, env7, env8, env9, env10, env11, env12, env13, env14, env15, env16, env17, env18, env19, env20, env21, env22, env23, env24, env25, env26, env27, env28, env29) {
  ...
  switch (state0) {
    ...
    case 4:
      ...
      iter = 0;
    default:
      var t1, input, output, proxyA, proxyB, t3, t4, tMax, t6, t8, target, t10, t11, t12, t2, t5, t7, t9, t13, t14, iter, t15, t20, pushBackIter, done, s2, s1, a1, a2, rootIterCount, t16, t, s;
      L0:
        while (true)
          switch (state0) {
            case 0:
...
$$.PolygonShape = {"": ["centroid?", "vertices?", "normals?", "vertexCount?", "type", "radius"],
 ...
 getSupport$1: function(d) {
  ...
  while (true) {
    ...
    t2 = t2.get$y();
    if (typeof t2 !== 'number')
      return this.getSupport$1$bailout(9, d, bestIndex, t4, t2, bestValue, i, t1);
    value = t4 + t2 * t10;
    if (value > bestValue) {
      bestValue = value;
      bestIndex = i;
 ...
 solve$3: function(step, gravity, allowSleep) {
  ...
  while (true) {
    ...
    while (true) {
      t1 = this.jointCount;
      if (typeof t1 !== 'number')
        return this.solve$3$bailout(46, step, j, allowSleep, t2, i, contactsOkay, jointsOkay, t1);
      if (!(j < t1))
        break;
      t1 = this.joints;
      if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))
        return this.solve$3$bailout(47, t1, j, allowSleep, step, i, t2, contactsOkay, jointsOkay);
      if (j >= t1.length)
        throw $.ioore(j);
...
$$.World = {"": ["_flags", "_contactManager", "_bodyList", "_jointList", "_bodyCount", "_jointCount", "_gravity", "_allowSleep", "_debugDraw", "_fixtureDestructionListener", "_jointDestructionListener", "_pool", "_inverseTimestep", "_warmStarting", "_continuousPhysics", "_contactStacks", "center?", "axis", "timestep", "cA", "cB", "wqwrapper", "toiInput", "toiOutput", "backup", "toiSolver", "contacts", "island", "stack"],
 ...
 solveTimeOfImpactGivenBody$1: function(body) {
  ...
  while (true) {
    for (ce = body.get$contactList(), found = false, count = 0; !(ce == null); ce = ce.get$next()) {
      ...
      if (typeof type !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(2, body, count, bullet, iter, t2, other, type, t3, t4, toiContact, toi, toiOther, t6, found, ce, t7, t5, t8);
      if (bullet) {
        t1 = other.get$flags();
        if (t1 !== (t1 | 0))
          return this.solveTimeOfImpactGivenBody$1$bailout(3, body, t7, bullet, iter, t2, other, type, t1, t3, t4, toiContact, toi, toiOther, found, ce, count, t6, t5, t8);
        if ((t1 & 64) === 0)
          continue;
        if (!(type === 0)) {
          t1 = ce.get$contact().get$flags();
          if (t1 !== (t1 | 0))
            return this.solveTimeOfImpactGivenBody$1$bailout(4, t6, body, bullet, t1, t2, other, iter, t3, t4, toiContact, toi, toiOther, found, ce, t7, count, t5, t8);
          t10 = (t1 & 16) !== 0;
          t1 = t10;
        } else
          t1 = false;
      ...
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(5, t8, body, contact, t1, bullet, iter, t2, other, t3, t4, toiContact, toi, toiOther, t6, found, ce, count, t5, t7);
      if (!t1)
        continue;
      t1 = contact.get$toiCount();
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(6, t8, body, contact, bullet, iter, t2, other, t1, t3, t4, toiContact, toi, toiOther, t6, found, ce, count, t5, t7);
      if (t1 > 10)
        continue;
      ...
      t1 = t2.state;
      if (typeof t1 !== 'number')
        return this.solveTimeOfImpactGivenBody$1$bailout(7, body, contact, t1, bullet, iter, t2, other, t6, t3, t4, toiContact, toi, toiOther, found, ce, count, t7, t5, t8);
      if (t1 === 3) {
        t1 = t2.t;
        if (typeof t1 !== 'number')
          return this.solveTimeOfImpactGivenBody$1$bailout(8, body, contact, t6, bullet, t1, iter, t2, other, t3, t4, toiContact, toi, toiOther, found, ce, count, t7, t5, t8);
        t1 = t1 < toi;
      } else
        t1 = false;
      if (t1) {
        toi = t2.t;
        if (toi !== (toi | 0))
          return this.solveTimeOfImpactGivenBody$1$bailout(9, body, contact, bullet, iter, t2, toi, other, t3, t4, t5, t6, ce, count, t7, t8);
        toiOther = other;
        toiContact = contact;
        found = true;
      }
  ...
  if (typeof t2 !== 'boolean')
    return this.solveTimeOfImpactGivenBody$1$bailout(10, body, toiOther, t1, t2, toiContact);
  if (!t2) {
  ...
  if (typeof t1 !== 'number')
    return this.solveTimeOfImpactGivenBody$1$bailout(11, body, toiOther, t1, toiContact);
  ...
  while (true) {
    ...
    c$0: {
      ...
      t1 = contact.get$enabled();
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(13, body, contact, t1, ce, count, toiContact, toiOther);
      if (!t1)
        break c$0;
      fixtureA = contact.get$fixtureA();
      fixtureB = contact.get$fixtureB();
      ...
      t1 = contact.get$enabled();
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(14, body, contact, ce, count, toiContact, toiOther, t1);
      if (!t1)
        break c$0;
      t1 = contact.get$touching();
      if (typeof t1 !== 'boolean')
        return this.solveTimeOfImpactGivenBody$1$bailout(15, body, contact, t1, ce, count, toiContact, toiOther);
      if (!t1)
        break c$0;
      t1 = this.contacts;
      if (count >= t1.length)
...
$$.ContactSolver = {"": ["constraints?", "constraintCount", "worldManifold", "tangent", "temp1", "temp2", "P", "dv", "dv1", "dv2", "x?", "d", "P1", "P2", "psolver", "rA?", "rB?"],
 ...
 init$3: function(contacts, contactCount, impulseRatio) {
  ...
  for (t1 = this.worldManifold, t2 = t1.points, t3 = t2.length, t4 = this.tangent, t5 = this.temp2, t6 = this.temp1, t7 = t1.normal, i = 0; $.ltB(i, this.constraintCount); ++i) {
    ...
    if (typeof wA !== 'number')
      return this.init$3$bailout(3, restitution, vA, vB, wA, i, impulseRatio, contacts, t4, t3, t5, radiusA, radiusB, t6, bodyB, manifold, bodyA, t7, t2, friction, t1);
 ...
 solvePositionConstraints$1: function(baumgarte) {
  var t1, t2, t3, t4, psm, normal, point, i, minSeparation, t5, c, bodyA, bodyB, t7, invMassA, invIA, t10, invMassB, invIB, j, t6, separation, C, t9, t11, t13, rnA, rnB, K, impulse, t14, t16, t18, t20, t23;
  t1 = this.P;
  t2 = this.temp1;
  t3 = this.rA;
  t4 = this.rB;
  ...
  while (true) {
    ...
    if (typeof t5 !== 'number')
      return this.solvePositionConstraints$1$bailout(1, baumgarte, i, t1, t2, minSeparation, t3, t5, t4, psm, normal, point);
    if (!(i < t5))
      break;
    t5 = this.constraints;
    if (i >= t5.length)
    ...
    while (true) {
      t6 = c.get$pointCount();
      if (typeof t6 !== 'number')
        return this.solvePositionConstraints$1$bailout(10, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, c, bodyA, bodyB, t6, t4, invMassA, normal, point, psm, invIA, invMassB);
      if (!(j < t6))
        break;
      psm.initialize$2(c, j);
      separation = psm.separation;
      if (typeof separation !== 'number')
        return this.solvePositionConstraints$1$bailout(11, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, c, bodyA, bodyB, t4, invMassA, normal, point, separation, invIA, psm, invMassB);
      ...
      t7 = t3.x;
      if (typeof t7 !== 'number')
        return this.solvePositionConstraints$1$bailout(12, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, c, bodyA, bodyB, C, t4, invMassA, normal, point, psm, invIA, t7, invMassB);
      t9 = normal.y;
      if (typeof t9 !== 'number')
        return this.solvePositionConstraints$1$bailout(13, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, c, bodyA, bodyB, C, t4, invMassA, normal, point, psm, invIA, t7, invMassB, t9);
      t7 *= t9;
      t11 = t3.y;
      if (typeof t11 !== 'number')
        return this.solvePositionConstraints$1$bailout(14, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, c, bodyA, bodyB, C, t4, invMassA, normal, t7, point, invIA, psm, invMassB, t11);
      t13 = normal.x;
      if (typeof t13 !== 'number')
        return this.solvePositionConstraints$1$bailout(15, t13, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, c, bodyA, bodyB, C, t4, invMassA, normal, t7, point, invIA, psm, invMassB, t11);
      rnA = t7 - t11 * t13;
      t7 = t4.x;
      if (typeof t7 !== 'number')
        return this.solvePositionConstraints$1$bailout(16, baumgarte, invIB, t7, minSeparation, i, t1, t2, t3, j, c, bodyA, bodyB, C, t4, invMassA, normal, point, psm, invIA, invMassB, rnA);
      t9 = t7 * t9;
      t7 = t4.y;
      if (typeof t7 !== 'number')
        return this.solvePositionConstraints$1$bailout(18, baumgarte, invIB, t9, t7, minSeparation, i, t1, t2, t3, j, c, bodyA, bodyB, C, t4, invMassA, normal, point, psm, invIA, invMassB, rnA);
      rnB = t9 - t7 * t13;
      ...
      t7 = t6.get$angle();
      if (typeof t7 !== 'number')
        return this.solvePositionConstraints$1$bailout(20, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, t6, t7, bodyA, bodyB, c, t4, invMassA, normal, point, psm, invIA, invMassB);
      t9 = t3.x;
      if (typeof t9 !== 'number')
        return this.solvePositionConstraints$1$bailout(21, baumgarte, invIB, minSeparation, i, t1, t2, t3, t9, j, t6, t7, bodyA, bodyB, c, t4, invMassA, normal, point, psm, invIA, invMassB);
      t11 = t1.y;
      if (typeof t11 !== 'number')
        return this.solvePositionConstraints$1$bailout(22, baumgarte, invIB, minSeparation, i, t1, t2, t3, t9, j, t6, t7, bodyA, bodyB, c, t4, invMassA, normal, t11, point, invIA, psm, invMassB);
      t11 = t9 * t11;
      t9 = t3.y;
      if (typeof t9 !== 'number')
        return this.solvePositionConstraints$1$bailout(23, baumgarte, invIB, minSeparation, i, t1, t2, t3, j, t9, t7, bodyA, bodyB, c, t4, t6, t11, invMassA, normal, point, invIA, psm, invMassB);
      t14 = t1.x;
      if (typeof t14 !== 'number')
      ...
      t16 = t6.get$angle();
      if (typeof t16 !== 'number')
        return this.solvePositionConstraints$1$bailout(25, baumgarte, invIB, minSeparation, i, t1, t2, t6, t16, j, c, t3, bodyB, t4, invMassA, bodyA, normal, point, invIA, psm, invMassB);
      t18 = t4.x;
      if (typeof t18 !== 'number')
        return this.solvePositionConstraints$1$bailout(26, baumgarte, invIB, minSeparation, i, t1, t2, t6, t16, j, c, t3, bodyB, t4, t18, bodyA, normal, invMassA, invIA, point, psm, invMassB);
      t20 = t1.y;
      if (typeof t20 !== 'number')
        return this.solvePositionConstraints$1$bailout(27, baumgarte, invIB, minSeparation, i, t1, t2, t6, t16, j, c, t3, bodyB, t4, t18, t20, normal, invMassA, invIA, bodyA, psm, point, invMassB);
      t20 = t18 * t20;
      t18 = t4.y;
      if (typeof t18 !== 'number')
        return this.solvePositionConstraints$1$bailout(28, baumgarte, invIB, minSeparation, i, t1, t2, t6, t16, j, c, t3, t20, bodyB, bodyA, t4, invMassA, normal, t18, point, invIA, psm, invMassB);
      t23 = t1.x;
      if (typeof t23 !== 'number')
        return this.solvePositionConstraints$1$bailout(29, baumgarte, invIB, minSeparation, i, t1, t2, t6, t16, j, c, t3, t20, bodyB, bodyA, t4, invMassA, normal, t18, t23, invIA, point, psm, invMassB);
 ...
 solvePositionConstraints$1$bailout: function(state0, env0, env1, env2, env3, env4, env5, env6, env7, env8, env9, env10, env11, env12, env13, env14, env15, env16, env17, env18, env19, env20, env21, env22) {
  ...
  switch (state0) {
    case 0:
      ...
      minSeparation = 0;
    default:
      var t1, t2, t3, t4, psm, normal, point, i, minSeparation, t5, baumgarte, c, bodyA, bodyB, t7, invMassA, t9, invIA, t11, invMassB, t13, invIB, j, separation, t6, C, t12, rnA, t15, t18, rnB, K, impulse, t8, t10, t17, t19, t22;
      L0:
        while (true)
          switch (state0) {
            case 0:
...
$$.TimeOfImpactSolver = {"": ["constraints?", "count=", "toiBody", "psm", "rA?", "rB?", "P", "temp"],
 ...
 solve$1: function(baumgarte) {
  ...
  while (true) {
    t6 = this.count;
    if (typeof t6 !== 'number')
      return this.solve$1$bailout(1, baumgarte, t5, t4, normal, i, point, minSeparation, t1, t2, t3, t6);
    if (!(i < t6))
      break;
    t6 = this.constraints;
    if (i >= t6.length)
    ...
    while (true) {
      t7 = c.get$pointCount();
      if (typeof t7 !== 'number')
        return this.solve$1$bailout(8, baumgarte, invMassA, invIA, t5, t4, normal, invMassB, point, invIB, i, c, j, bodyB, minSeparation, bodyA, t1, t2, t7, t3);
      if (!(j < t7))
        break;
      t5.initialize$2(c, j);
      separation = t5.separation;
      if (typeof separation !== 'number')
        return this.solve$1$bailout(9, baumgarte, invMassA, invIA, t5, t4, normal, invMassB, point, invIB, separation, i, c, j, bodyB, minSeparation, bodyA, t1, t2, t3);
      t3.setFrom$1(point).subLocal$1(bodyA.get$sweep().get$center());
      t4.setFrom$1(point).subLocal$1(bodyB.get$sweep().get$center());
      minSeparation = $.min(minSeparation, separation);
      C = $.max(-0.2, $.min(baumgarte * (separation + 0.005), 0));
      t8 = t3.x;
      if (typeof t8 !== 'number')
        return this.solve$1$bailout(10, C, invMassA, baumgarte, invIA, t5, t4, normal, invMassB, point, invIB, i, t8, c, j, minSeparation, bodyB, bodyA, t1, t2, t3);
      t10 = normal.y;
      if (typeof t10 !== 'number')
        return this.solve$1$bailout(11, C, invMassA, baumgarte, invIA, t5, t4, normal, invMassB, point, invIB, i, t8, t10, j, minSeparation, bodyB, bodyA, c, t1, t2, t3);
      t8 *= t10;
      t12 = t3.y;
      if (typeof t12 !== 'number')
        return this.solve$1$bailout(12, C, invMassA, baumgarte, invIA, t8, t4, normal, invMassB, point, invIB, t5, i, c, j, minSeparation, bodyB, bodyA, t12, t1, t2, t3);
      t14 = normal.x;
      if (typeof t14 !== 'number')
        return this.solve$1$bailout(13, C, invMassA, baumgarte, invIA, t8, t4, normal, invMassB, point, invIB, t5, i, c, j, minSeparation, bodyB, bodyA, t14, t12, t1, t2, t3);
      rnA = t8 - t12 * t14;
      t8 = t4.x;
      if (typeof t8 !== 'number')
        return this.solve$1$bailout(14, C, invMassA, baumgarte, invIA, t5, t4, normal, invMassB, point, invIB, rnA, i, c, j, minSeparation, bodyB, bodyA, t8, t1, t2, t3);
      t10 = t8 * t10;
      t8 = t4.y;
      if (typeof t8 !== 'number')
        return this.solve$1$bailout(16, C, invMassA, baumgarte, invIA, t5, t4, normal, invMassB, point, invIB, rnA, i, t10, j, minSeparation, bodyB, bodyA, t8, t1, t2, t3, c);
      rnB = t10 - t8 * t14;
      ...
      t8 = t7.get$angle();
      if (typeof t8 !== 'number')
        return this.solve$1$bailout(18, baumgarte, invMassA, invIA, t5, t4, invMassB, normal, point, invIB, i, c, j, minSeparation, bodyB, bodyA, t1, t2, t7, t8, t3);
      t10 = t3.x;
      if (typeof t10 !== 'number')
        return this.solve$1$bailout(19, baumgarte, invMassA, invIA, t5, t4, invMassB, normal, point, invIB, i, c, j, minSeparation, bodyB, bodyA, t1, t2, t7, t8, t3, t10);
      t12 = t1.y;
      if (typeof t12 !== 'number')
        return this.solve$1$bailout(20, t12, baumgarte, invMassA, invIA, t5, t4, invMassB, normal, point, invIB, i, c, j, minSeparation, bodyB, bodyA, t1, t2, t7, t8, t3, t10);
      t12 = t10 * t12;
      t10 = t3.y;
      if (typeof t10 !== 'number')
        return this.solve$1$bailout(21, baumgarte, t10, invMassA, t12, invIA, t5, t4, invMassB, normal, point, invIB, i, c, j, minSeparation, bodyB, bodyA, t1, t2, t7, t8, t3);
      t15 = t1.x;
      if (typeof t15 !== 'number')
      ...
      t17 = t7.get$angle();
      if (typeof t17 !== 'number')
        return this.solve$1$bailout(23, baumgarte, invMassA, invIA, t5, t4, normal, invMassB, point, invIB, i, c, j, minSeparation, bodyB, bodyA, t7, t17, t1, t2, t3);
      t19 = t4.x;
      if (typeof t19 !== 'number')
        return this.solve$1$bailout(24, baumgarte, invMassA, invIA, t5, t4, normal, t19, point, invIB, i, invMassB, c, j, minSeparation, bodyB, bodyA, t7, t17, t1, t2, t3);
      t21 = t1.y;
      if (typeof t21 !== 'number')
        return this.solve$1$bailout(25, baumgarte, invMassA, invIA, t5, t4, normal, t19, t21, invIB, i, point, invMassB, c, j, minSeparation, bodyB, bodyA, t7, t17, t1, t2, t3);
      t21 = t19 * t21;
      t19 = t4.y;
      if (typeof t19 !== 'number')
        return this.solve$1$bailout(26, baumgarte, invMassA, invIA, t5, t4, normal, invMassB, point, invIB, t19, i, c, j, minSeparation, bodyB, bodyA, t7, t17, t1, t2, t3, t21);
      t24 = t1.x;
      if (typeof t24 !== 'number')
...
$.BoxTest$ = function() {
  var t1 = new $.BoxTest($._ListImpl_List(null), null, null, null, null, null, null, null, null, null, 10, null);
