...
BoxTest: {"": "Demo;bodies,canvas,ctx,viewport,debugDraw,world,frameCount,fpsCounter,elapsedUs,worldStepTime,viewportScale,_stopwatch",
  _createGround$0: function() {
    ...
    shape.setAsBoxWithCenterAndAngle$4(0.4, 50, new $.Vector(-10, 0), 0);
    t1.shape = shape;
    t1.density = 0;
    ground.createFixture$1(t1);
    shape.setAsBoxWithCenterAndAngle$4(0.4, 50, new $.Vector(10, 0), 0);
  ...
  _createBox$0: function() {
    ...
    shape = $.PolygonShape$();
    shape.setAsBoxWithCenterAndAngle$4(3, 1.5, new $.Vector(0, 0), 1.5707963267948966);
    ...
    bodyDef = $.BodyDef$();
    bodyDef.type = 2;
    bodyDef.position = new $.Vector(0, 30);
...
main: function() {
  var boxTest = new $.BoxTest($.List_List($), null, null, null, null, null, null, null, null, null, 10, null);
  boxTest.Demo$3("Box test", null, 10);
  boxTest._createGround$0();
  boxTest._createBox$0();
