...
DominoTower: {"": "Demo;dominoDensity,bodies,canvas,ctx,viewport,debugDraw,world,frameCount,fpsCounter,elapsedUs,worldStepTime,viewportScale,_stopwatch",
  ...
  initialize$0: function(_) {
    var sd, bd, t1, t2, t3, body, fd, b, i, currX, j, currY, t4, t5, t6, t7;
    sd = $.PolygonShape$();
    sd.setAsBox$2(50, 10);
    bd = $.BodyDef$();
    t1 = new $.Vector2(new Float64Array(2));
    ...
    for (currX = 18.75, j = 1; j < 25; ++j) {
      ...
      currY = 0.5 + 1.386 * j;
      for (t1 = 25 - j, t2 = currY + 0.6, t3 = currY - 0.6, t4 = currY - 0.2, t5 = t1 - 1, t6 = 1.5 * t1 / 2, i = 0; i < t1; ++i) {
        currX = i * 1.5 * 1 - t6;
        ...
        if (i === 0)
          this.makeDomino$3(currX - 1.25 + 0.1, t4, false);
        if (i === t5)
          this.makeDomino$3(currX + 1.25 - 0.1, t4, false);
        t7 = this.dominoDensity;
        if (t7 == null)
        ...
        this.makeDomino$3(currX, t3, true);
      }
    }
  }
},
...
Collision: {"": "Object;_pool,cache,input,output,results1,results2,incidentEdge<,localTangent,localNormal<,planePoint,tangent,normal<,normal1,v11,v12,clipPoints1,clipPoints2",
  ...
  collideCircles$5: function(manifold, circle1, xfA, circle2, xfB) {
    var t1, v, t2, t3, t4, t5, t6, t7, t8, t9, v1, t10, t11, t12, t13, t14, t15, t16, dx, dy, radius;
    ...
    t10 = t5[1];
    t11 = xfB.rotation;
    t12 = t11.col1._liblib3$_f;
    if (1 >= t12.length)
      throw $.ioore(1);
    t13 = t12[1];
    t14 = $.getInterceptor$x(v1);
    t15 = t14.get$x(v1);
    if (typeof t15 !== "number")
      throw $.iae(t15);
    t15 = $.JSNumber_methods.$mul(t13, t15);
    ...
    if (typeof t16 !== "number")
      throw $.iae(t16);
    t16 = $.JSNumber_methods.$mul(t13, t16);
    if (0 >= t5.length)
      throw $.ioore(0);
    t5 = t5[0];
    if (0 >= t12.length)
    ...
    if (typeof t13 !== "number")
      throw $.iae(t13);
    t13 = $.JSNumber_methods.$mul(t12, t13);
    if (0 >= t11.length)
      throw $.ioore(0);
    t11 = t11[0];
    t14 = t14.get$y(v1);
    if (typeof t14 !== "number")
      throw $.iae(t14);
    dx = t5 + t13 + $.JSNumber_methods.$mul(t11, t14) - (t2 + t6 + t7);
    dy = t10 + t15 + t16 - (t3 + t8 + t9);
    ...
    t4 = t4.get$position(circle2);
    t1 = t1._liblib3$_f;
    t3 = t4.get$_liblib3$_f();
    if (0 >= t3.length)
      throw $.ioore(0);
    t3 = t3[0];
    t6 = t1.length;
  ...
  collidePolygonAndCircle$5: function(manifold, polygon, xfA, circle, xfB) {
    var t1, v, t2, t3, t4, t5, t6, t7, t8, t9, v1x, v1y, cLocaly, cLocalx, radius, vertexCount, vertices, normals, normalIndex, separation, i, vertex, norm, s, vertIndex2, v1, v2, mpoint, temp2X, t10, temp4X, t11, t12, dx, dy, fcx, fcy;
    manifold.set$pointCount(0);
    ...
    t7 = $.JSNumber_methods.$mul(t5[1], t6.get$x(v));
    t4 = t4.col2._liblib3$_f;
    if (1 >= t4.length)
      throw $.ioore(1);
    t8 = $.JSNumber_methods.$mul(t4[1], t6.get$y(v));
    if (0 >= t2.length)
      throw $.ioore(0);
    t2 = t2[0];
    if (0 >= t5.length)
      throw $.ioore(0);
    t5 = $.JSNumber_methods.$mul(t5[0], t6.get$x(v));
    if (0 >= t4.length)
      throw $.ioore(0);
    t6 = $.JSNumber_methods.$mul(t4[0], t6.get$y(v));
    ...
    if (1 >= t8)
      throw $.ioore(1);
    cLocalx = v1x * t3 + v1y * t4[1];
    radius = $.$add$ns(polygon.get$radius(), circle.get$radius());
    if (typeof radius !== "number")
      return this.collidePolygonAndCircle$5$bailout(1, manifold, cLocalx, polygon, circle, radius, t1, cLocaly);
  ...
  collidePolygonAndCircle$5$bailout: function(state0, manifold, cLocalx, polygon, circle, radius, t1, cLocaly) {
  ...
  computeMass$2: function(massData, density) {
    ...
    if (this.vertexCount === 2) {
      ...
      if (0 >= t2)
        throw $.ioore(0);
      t3 = t1[0];
      t4 = massData.center._liblib3$_f;
      t5 = t3.get$_liblib3$_f();
      if (0 >= t5.length)
        throw $.ioore(0);
      t5 = t5[0];
      t6 = t4.length;
    ...
    t1[1] = 0;
    t1[0] = 0;
    t2 = new $.Vector2(new Float64Array(2))._liblib3$_f;
    t3 = t2.length;
    if (0 >= t3)
      throw $.ioore(0);
    t2[0] = 0;
    ...
    t2[1] = 0;
    t2[0] = 0;
    t3 = new $.Vector2(new Float64Array(2))._liblib3$_f;
    t4 = t3.length;
    if (0 >= t4)
      throw $.ioore(0);
    t3[0] = 0;
    if (1 >= t4)
      throw $.ioore(1);
    t3[1] = 0;
    t4 = new $.Vector2(new Float64Array(2))._liblib3$_f;
    t5 = t4.length;
    if (0 >= t5)
      throw $.ioore(0);
    t4[0] = 0;
...
Body: {"": "Object;world,flags@,contactList@,sleepTime@,userData@,_linearVelocity,_angularVelocity,mass<,invMass<,next@,prev@,fixtureList<,fixtureCount,jointList<,_force<,_torque@,_inertia,invInertia<,linearDamping<,angularDamping<,_type<,islandIndex?,originTransform<,sweep<,_fixDef,_pmd,_pxf,oldCenter,tempCenter",
  ...
  set$linearVelocity: function(v) {
    ...
    if ($.$eq(this._type, 0))
      return;
    if (v.get$x(v) * v.get$x(v) + v.get$y(v) * v.get$y(v) > 0)
      this.set$awake(true);
