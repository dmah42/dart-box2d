...
Isolate.$defineClass("HashSetImplementation", "Object", ["_backingMap?"], {
 ...
 get$filter: function() { return new $.Closure6(this); },
 forEach$1: function(f) {
  var t0 = ({});
  t0.f_1 = f;
  $.forEach(this._backingMap, new $.Closure4(t0));
 },
...
Isolate.$defineClass("HashSetIterator", "Object", ["_nextValidIndex", "_entries"], {
 ...
 get$next: function() { return new $.Closure8(this); },
 hasNext$0: function() {
...
Isolate.$defineClass("DoubleLinkedQueue", "Object", ["_sentinel"], {
 ...
 get$filter: function() { return new $.Closure9(this); },
 forEach$1: function(f) {
  for (var entry = this._sentinel.get$_next(); !(entry === this._sentinel); entry = entry0) {
    var entry0 = entry;
    var nextEntry = entry.get$_next();
 ...
 get$length: function() {
  var t0 = ({});
  t0.counter_1 = 0;
  this.forEach$1(new $.Closure2(t0));
  return t0.counter_1;
 },
...
Isolate.$defineClass("_DoubleLinkedQueueIterator", "Object", ["_currentEntry", "_sentinel"], {
 ...
 get$next: function() { return new $.Closure10(this); },
 hasNext$0: function() {
...
Isolate.$defineClass("StopwatchImplementation", "Object", ["_stop", "_start"], {
 ...
 stop$0: function() {
  if (this._start === (void 0) || !(this._stop === (void 0))) {
    return;
  }
  this._stop = $.now();
 },
...
Isolate.$defineClass("_AllMatchesIterator", "Object", ["_done", "_next=", "_str", "_re"], {
 ...
 get$next: function() { return new $.Closure11(this); }
});
...
Isolate.$defineClass("ListIterator", "Object", ["list", "i"], {
 ...
 get$next: function() { return new $.Closure12(this); },
 hasNext$0: function() {
...
Isolate.$defineClass("BenchmarkRunner", "Object", ["resultsWriter", "benchmarks", "steps", "solveLoops"], {
 addBenchmark$1: function(benchmark) {
  $.add$1(this.benchmarks, benchmark);
 },
 runBenchmarks$0: function() {
  for (var t0 = $.iterator(this.benchmarks); t0.hasNext$0() === true; ) {
    var t1 = t0.next$0();
    $.print('Running ' + $.stringToString(t1.get$name()));
    $.clear(this.resultsWriter);
    t1.runBenchmark$1(this.resultsWriter);
    $.print(this.resultsWriter);
    $.print('');
    $.print('------------------------------------------------');
  }
 },
 setupBenchmarks$0: function() {
  this.addBenchmark$1($.BallDropBench$2(this.solveLoops, this.steps));
  this.addBenchmark$1($.BallCageBench$2(this.solveLoops, this.steps));
  this.addBenchmark$1($.CircleStressBench$2(this.solveLoops, this.steps));
  this.addBenchmark$1($.DominoPlatformBench$2(this.solveLoops, this.steps));
  this.addBenchmark$1($.DominoTowerBench$2(this.solveLoops, this.steps));
 }
});

Isolate.$defineClass("Benchmark", "Object", ["bodies?"], {
 get$bodyCount: function() {
  return $.get$length(this.bodies);
 },
 get$checksum: function() {
  var positionSum = $.Vector$2(0, 0);
  var velocitySum = $.Vector$2(0, 0);
  for (var t0 = $.iterator(this.bodies); t0.hasNext$0() === true; ) {
    var t1 = t0.next$0();
    positionSum.addLocal$1(t1.get$position());
    velocitySum.addLocal$1(t1.get$linearVelocity());
  }
  return $.add($.add($.add(positionSum.x, positionSum.y), velocitySum.x), velocitySum.y);
 },
 runBenchmark$1: function(resultsWriter) {
  for (var t0 = $.iterator(this._steps); t0.hasNext$0() === true; ) {
    var t1 = t0.next$0();
    if (typeof t1 !== 'number') return this.runBenchmark$1$bailout(resultsWriter, 1, t0, t1);
    for (var t2 = $.iterator(this.solveLoops); t2.hasNext$0() === true; ) {
      var t3 = t2.next$0();
      this.initialize$0();
      var watch = $.StopwatchImplementation$0();
      watch.start$0();
      for (var i = 0; i < t1; i = i + 1) {
        this.world.step$3(0.016666666666666666, t3, t3);
      }
      watch.stop$0();
      this._recordResults$4(watch.elapsedInMs$0(), resultsWriter, t3, t1);
    }
  }
 },
 runBenchmark$1$bailout: function(resultsWriter, state, env0, env1) {
  switch (state) {
    case 1:
      t0 = env0;
      t1 = env1;
    ...
    case 1:
      L0: while (true) {
        switch (state) {
          ...
          case 1:
            state = 0;
            var t2 = $.iterator(this.solveLoops);
            L1: while (true) {
 ...
 _recordResults$4: function(time, resultsWriter, benchmarkIterations, steps) {
  ...
  $.add$1(resultsWriter, $.add($.add(' (', steps) + ' steps, ', benchmarkIterations) + ' solve loops)');
  $.add$1(resultsWriter, ' : ');
  $.add$1(resultsWriter, time);
  $.add$1(resultsWriter, 'ms');
  $.add$1(resultsWriter, $.add('  (', $.div(steps, $.div(time, 1000))) + ' steps/second)');
  $.add$1(resultsWriter, '\n');
...
Isolate.$defineClass("BallCageBench", "Benchmark", ["_steps", "solveLoops", "world", "bodies"], {
 initialize$0: function() {
  this.resetWorld$0();
  var circleShape = $.CircleShape$0();
  circleShape.radius = 2;
  var circleFixtureDef = $.FixtureDef$0();
  circleFixtureDef.shape = circleShape;
  circleFixtureDef.friction = 0.9;
  circleFixtureDef.restitution = 1;
  var circleBodyDef = $.BodyDef$0();
  var borderLimitX = -20 + $.mul(20, circleShape.radius);
  var borderLimitY = -20 + $.mul(20, circleShape.radius);
  for (var i = 0; i < 10; i = i + 1) {
    var shiftX = $.add(-20, $.mul($.mul(circleShape.radius, 2), i));
    var shiftY = $.add(-20, $.mul($.mul(circleShape.radius, 2), i));
    circleBodyDef.position = $.Vector$2(shiftX, -20);
    ...
    circleBodyDef.position = $.Vector$2(shiftX, borderLimitY);
    var circleBody0 = this.world.createBody$1(circleBodyDef);
    $.add$1(this.bodies, circleBody0);
    circleBody0.createFixture$1(circleFixtureDef);
    circleBodyDef.position = $.Vector$2(-20, shiftY);
    var circleBody1 = this.world.createBody$1(circleBodyDef);
    $.add$1(this.bodies, circleBody1);
    circleBody1.createFixture$1(circleFixtureDef);
    circleBodyDef.position = $.Vector$2(borderLimitX, shiftY);
    var circleBody2 = this.world.createBody$1(circleBodyDef);
    $.add$1(this.bodies, circleBody2);
    circleBody2.createFixture$1(circleFixtureDef);
  }
  var bouncingCircle = $.CircleShape$0();
  bouncingCircle.radius = 1;
  var activeFixtureDef = $.FixtureDef$0();
  activeFixtureDef.restitution = 1;
  activeFixtureDef.density = 0.05;
  activeFixtureDef.shape = bouncingCircle;
  var activeBodyDef = $.BodyDef$0();
  activeBodyDef.linearVelocity = $.Vector$2(0, -20);
  activeBodyDef.position = $.Vector$2(15, 15);
...
Isolate.$defineClass("BallDropBench", "Benchmark", ["_steps", "solveLoops", "world", "bodies"], {
 get$name: function() {
  return 'Ball Drop';
 },
 initialize$0: function() {
  this.resetWorld$0();
  var fd = $.FixtureDef$0();
  var cd = $.CircleShape$0();
  cd.radius = 1;
  fd.shape = cd;
  var bodyDef = $.BodyDef$0();
  bodyDef.type = 2;
  bodyDef.position = $.Vector$2(0, 0);
...
Isolate.$defineClass("CircleStressBench", "Benchmark", ["_joint", "_steps", "solveLoops", "world", "bodies"], {
 initialize$0: function() {
  this.resetWorld$0();
  var bd = $.BodyDef$0();
  var ground = this.world.createBody$1(bd);
  $.add$1(this.bodies, ground);
  var shape = $.PolygonShape$0();
  shape.setAsEdge$2($.Vector$2(-40.0, 0.0), $.Vector$2(40.0, 0.0));
  ground.createFixtureFromShape$1(shape);
  var sd = $.PolygonShape$0();
  sd.setAsBox$2(50.0, 10.0);
  var bd0 = $.BodyDef$0();
  bd0.type = 0;
  bd0.position = $.Vector$2(0.0, -10.0);
  var b = this.world.createBody$1(bd0);
  $.add$1(this.bodies, b);
  var fd = $.FixtureDef$0();
  fd.shape = sd;
  fd.friction = 1.0;
  ...
  var wallDef = $.BodyDef$0();
  wallDef.position = $.Vector$2(45.0, 25.0);
  ...
  var cornerDef = $.BodyDef$0();
  sd.setAsBox$2(20.0, 3.0);
  cornerDef.angle = -0.7853981633974483;
  cornerDef.position = $.Vector$2(-35, 8.0);
  var myBod = this.world.createBody$1(cornerDef);
  $.add$1(this.bodies, myBod);
  myBod.createFixtureFromShape$1(sd);
  cornerDef.angle = 0.7853981633974483;
  cornerDef.position = $.Vector$2(35, 8.0);
  var myBod0 = this.world.createBody$1(cornerDef);
  $.add$1(this.bodies, myBod0);
  myBod0.createFixtureFromShape$1(sd);
  sd.setAsBox$2(50.0, 10.0);
  var topDef = $.BodyDef$0();
  topDef.type = 0;
  topDef.angle = 0;
  topDef.position = $.Vector$2(0.0, 75.0);
  ...
  var bd1 = $.BodyDef$0();
  bd1.type = 2;
  bd1.position = $.Vector$2(0.0, 10.0);
  var body = this.world.createBody$1(bd1);
  ...
  for (var i = 0; i < 5; i = i + 1) {
    ...
    fd0.friction = 0.1;
    fd0.restitution = 0.9;
    var xPos = $.mul(6, $.cos(6.283185307179586 * $.div(i, $.toDouble(5))));
    var yPos = $.mul(6, $.sin(6.283185307179586 * $.div(i, $.toDouble(5))));
    cd.position.setCoords$2(xPos, yPos);
    body.createFixture$1(fd0);
  }
  body.set$bullet(false);
  var bodyDef = $.BodyDef$0();
  var groundBody = this.world.createBody$1(bodyDef);
  var rjd = $.RevoluteJointDef$0();
  ...
  for (var j = 0; j < 8; j = j + 1) {
    var yPos0 = 50 + j;
    for (var i0 = 0; i0 < 20; i0 = i0 + 1) {
      var circ = $.CircleShape$0();
      var bod = $.BodyDef$0();
      bod.type = 2;
      if ($.mod(i0, 2) === 0) {
        var t0 = 1.0;
      ...
      circ.radius = 1.0 + t0 * 0.5 * 0.75;
      var fd2 = $.FixtureDef$0();
      fd2.shape = circ;
      fd2.density = $.mul(circ.radius, 1.5);
      fd2.friction = 0.5;
      fd2.restitution = 0.7;
      bod.position = $.Vector$2(-39 + 2 * i0, yPos0);
...
Isolate.$defineClass("DominoPlatformBench", "Benchmark", ["_steps", "solveLoops", "world", "bodies"], {
 initialize$0: function() {
  this.resetWorld$0();
  var fd = $.FixtureDef$0();
  var sd = $.PolygonShape$0();
  ...
  for (var t0 = 25 - 1, t1 = 29.5 / t0, i0 = 0; i0 < 4; i0 = i0 + 1) {
    var t2 = 5 * i0;
    for (var t3 = 7.3 + t2, j = 0; j < 25; j = j + 1) {
      fd1.friction = 0.5;
      bd1.position = $.Vector$2(-14.75 + j * t1, t3);
      if (i0 === 2 && j === 0) {
        bd1.angle = -0.1;
        var t4 = bd1.position;
...
Isolate.$defineClass("DominoTowerBench", "Benchmark", ["dominoDensity", "_steps", "solveLoops", "world", "bodies"], {
 initialize$0: function() {
  this.resetWorld$0();
  var sd = $.PolygonShape$0();
  sd.setAsBox$2(50.0, 10.0);
  ...
  fd.restitution = 0.85;
  bd0.bullet = true;
  bd0.position = $.Vector$2(30, 50);
  var b = this.world.createBody$1(bd0);
  $.add$1(this.bodies, b);
  b.createFixture$1(fd);
  b.set$linearVelocity($.Vector$2(-25, -25));
  b.set$angularVelocity(6.7);
  fd.density = 25;
  bd0.position = $.Vector$2(-30, 25);
  var b0 = this.world.createBody$1(bd0);
  $.add$1(this.bodies, b0);
  b0.createFixture$1(fd);
  b0.set$linearVelocity($.Vector$2(35, -10));
  b0.set$angularVelocity(-8.3);
  for (var currX = (void 0), i = 0; i < 25; i = i0) {
    var currX0 = i * 1.5 * 1 - 18.75;
    this.makeDomino$4(currX0, 0.5, false, this.world);
    this.makeDomino$4(currX0, 1.1, true, this.world);
    currX = currX0;
    var i0 = i + 1;
  }
  for (var j = 1, currX1 = 18.75; j < 25; j = j + 1, currX1 = currX2) {
    var currX2 = currX1;
    if (j > 3) {
    ...
    var t2 = 25 - j;
    var t3 = currY - 0.6;
    for (var t4 = 1.5 * t2 / 2, t5 = t2 - 1, currX3 = currX1, i1 = 0; i1 < t2; currX3 = currX4, i1 = i2) {
      var currX4 = currX3;
      var currX5 = i1 * 1.5 * 1 - t4;
      this.dominoDensity = $.mul(this.dominoDensity, 2.5);
      if (i1 === 0) {
        this.makeDomino$4(currX5 - 1.25 + 0.1, t1, false, this.world);
      }
      if (i1 === t5) {
        this.makeDomino$4(currX5 + 1.25 - 0.1, t1, false, this.world);
      }
      this.dominoDensity = $.div(this.dominoDensity, 2.5);
      this.makeDomino$4(currX5, currY, false, this.world);
      this.makeDomino$4(currX5, t0, true, this.world);
      this.makeDomino$4(currX5, t3, true, this.world);
      currX4 = currX5;
      var i2 = i1 + 1;
    }
    currX2 = currX3;
 ...
 makeDomino$4: function(x, y, horizontal, world_) {
  ...
  fd.friction = 0.1;
  fd.restitution = 0.65;
  bd.position = $.Vector$2(x, y);
  if (t0) {
    var t1 = 1.5707963267948966;
  } else {
    t1 = 0;
  }
  bd.angle = t1;
...
Isolate.$defineClass("Distance", "Object", ["normal?", "temp", "searchDirection", "closestPoint", "saveB", "saveA", "simplex", "maxIters", "iters", "calls"], {
 ...
 get$distance: function() { return new $.Closure13(this); }
});
...
Isolate.$defineClass("TimeOfImpact", "Object", ["pool", "sweepB?", "sweepA?", "indexes", "fcn", "distanceOutput", "xfB", "xfA", "distanceInput", "cache"], {
 ...
 get$timeOfImpact: function() { return new $.Closure14(this); },
...
Isolate.$defineClass("CircleShape", "Shape", ["position?", "radius", "type"], {
 computeMass$2: function(massData, density) {
  ...
  massData.set$inertia($.mul(massData.get$mass(), $.add($.mul($.mul(0.5, this.radius), this.radius), $.dot(this.position, this.position))));
 },
 clone$0: function() {
  return $.CircleShape$copy$1(this);
 },
 computeAxisAlignedBox$2: function(argBox, argTransform) {
  var p = $.Vector$2(0, 0);
  $.mulMatrixAndVectorToOut(argTransform.get$rotation(), this.position, p);
...
Isolate.$defineClass("PolygonShape", "Shape", ["vertexCount?", "normals?", "vertices?", "centroid?", "radius", "type"], {
 ...
 setAsEdge$2: function(v1, v2) {
  this.vertexCount = 2;
  $.index(this.vertices, 0).setFrom$1(v1);
  $.index(this.vertices, 1).setFrom$1(v2);
  this.centroid.setFrom$1(v1).addLocal$1(v2).mulLocal$1(0.5);
  $.index(this.normals, 0).setFrom$1(v2).subLocal$1(v1);
  $.crossVectorAndNumToOut($.index(this.normals, 0), 1, $.index(this.normals, 0));
  $.index(this.normals, 0).normalize$0();
  $.index(this.normals, 1).setFrom$1($.index(this.normals, 0)).negateLocal$0();
 },
...
Isolate.$defineClass("Body", "Object", ["tempCenter", "oldCenter", "_pxf", "_pmd", "_fixDef", "sweep?", "originTransform?", "islandIndex!", "_type?", "angularDamping?", "linearDamping?", "invInertia?", "_inertia", "_torque=", "_force?", "jointList=", "fixtureCount", "fixtureList", "prev=", "next=", "invMass?", "mass=", "_angularVelocity", "_linearVelocity", "userData=", "sleepTime=", "contactList=", "flags=", "world"], {
 ...
 getLocalPointToOut$2: function(worldPoint, out) {
  $.mulTransToOut(this.originTransform, worldPoint, out);
 },
...
Isolate.$defineClass("World", "Object", ["stack", "island", "contacts", "toiSolver", "backup", "toiOutput", "toiInput", "wqwrapper", "cB", "cA", "timestep", "axis", "center?", "_contactStacks", "_continuousPhysics", "_warmStarting", "_inverseTimestep", "_pool", "_jointDestructionListener", "_fixtureDestructionListener", "_debugDraw", "_allowSleep", "_gravity", "_jointCount", "_bodyCount", "_jointList", "_bodyList", "_contactManager?", "_flags="], {
 ...
 createJoint$1: function(def) {
  ...
  if (!$.eqNullB(this._jointList)) {
    this._jointList.set$_prev(j);
  }
  this._jointList = j;
  this._jointCount = $.add(this._jointCount, 1);
  j.get$edgeA().set$joint(j);
  var t0 = j.get$bodyB();
  j.get$edgeA().set$other(t0);
  j.get$edgeA().set$prev((void 0));
  var t1 = j.get$bodyA().get$jointList();
  j.get$edgeA().set$next(t1);
  if (!$.eqNullB(j.get$bodyA().get$jointList())) {
    var t2 = j.get$edgeA();
    j.get$bodyA().get$jointList().set$prev(t2);
  }
  var t3 = j.get$edgeA();
  j.get$bodyA().set$jointList(t3);
  j.get$edgeB().set$joint(j);
  var t4 = j.get$bodyA();
  j.get$edgeB().set$other(t4);
  j.get$edgeB().set$prev((void 0));
  var t5 = j.get$bodyB().get$jointList();
  j.get$edgeB().set$next(t5);
  if (!$.eqNullB(j.get$bodyB().get$jointList())) {
    var t6 = j.get$edgeB();
    j.get$bodyB().get$jointList().set$prev(t6);
  }
  var t7 = j.get$edgeB();
  j.get$bodyB().set$jointList(t7);
  var bodyA = def.get$bodyA();
  var bodyB = def.get$bodyB();
  if ($.eqB(def.get$collideConnected(), false)) {
    for (var edge = bodyB.get$contactList(); !$.eqNullB(edge); edge = edge0) {
      var edge0 = edge;
      if ($.eqB(edge.get$other(), bodyA)) {
...
Isolate.$defineClass("Joint", "Object", ["userData=", "collideConnected?", "islandFlag=", "bodyB=", "bodyA=", "edgeB?", "edgeA?", "_lib2_next=", "_prev!", "type="], {
 solvePositionConstraints$1: function(baumgarte) {
 },
...
Isolate.$defineClass("JointEdge", "Object", ["next=", "prev=", "joint=", "other="], {
 next$0: function() { return this.next.$call$0(); }
});

Isolate.$defineClass("JointDef", "Object", ["collideConnected?", "bodyB=", "bodyA=", "userData=", "type="], {
});

Isolate.$defineClass("ConstantVolumeJoint", "Joint", ["dampingRatio?", "frequencyHz?", "distanceJoints", "_world", "_impulse", "step", "normals?", "targetVolume", "targetLengths", "bodies?", "invIB", "invMassB", "invIA", "invMassA", "localCenterB", "localCenterA", "userData", "collideConnected", "islandFlag", "bodyB", "bodyA", "edgeB", "edgeA", "_lib2_next", "_prev", "type"], {
 solveVelocityConstraints$1: function(argStep) {
  var d = $.List($.get$length(this.bodies));
  $.setRuntimeTypeInfo(d, ({E: 'Vector'}));
  for (var i = 0; $.ltB(i, $.get$length(this.bodies)); i = i + 1) {
    var t0 = $.Vector$2(0, 0);
    var t1 = d.length;
    if (i < 0 || i >= t1) throw $.ioore(i);
    d[i] = t0;
  }
  for (var i0 = 0, crossMassSum = 0.0, dotMassSum = 0.0; $.ltB(i0, $.get$length(this.bodies)); i0 = i1, crossMassSum = crossMassSum0, dotMassSum = dotMassSum0) {
    var crossMassSum0 = crossMassSum;
    var dotMassSum0 = dotMassSum;
    if (i0 === 0) {
      var prev = $.sub($.get$length(this.bodies), 1);
    } else {
      prev = i0 - 1;
    }
    if (i0 === $.sub($.get$length(this.bodies), 1)) {
      var next = 0;
    } else {
      next = i0 + 1;
    }
    var t2 = d.length;
    if (i0 < 0 || i0 >= t2) throw $.ioore(i0);
    d[i0].setFrom$1($.index(this.bodies, next).get$worldCenter());
    var t3 = d.length;
    if (i0 < 0 || i0 >= t3) throw $.ioore(i0);
    d[i0].subLocal$1($.index(this.bodies, prev).get$worldCenter());
    var t4 = d.length;
    if (i0 < 0 || i0 >= t4) throw $.ioore(i0);
    var dotMassSum1 = $.add(dotMassSum, $.div(d[i0].get$lengthSquared(), $.index(this.bodies, i0).get$mass()));
    var t5 = $.index(this.bodies, i0).get$linearVelocity();
    var t6 = d.length;
    if (i0 < 0 || i0 >= t6) throw $.ioore(i0);
    crossMassSum0 = $.add(crossMassSum, $.crossVectors(t5, d[i0]));
    dotMassSum0 = dotMassSum1;
    var i1 = i0 + 1;
  }
  var lambda = -2.0 * crossMassSum / dotMassSum;
  this._impulse = $.add(this._impulse, lambda);
  for (var i2 = 0; $.ltB(i2, $.get$length(this.bodies)); i2 = i2 + 1) {
    var t7 = $.index(this.bodies, i2).get$linearVelocity();
    var t8 = t7.get$x();
    var t9 = $.index(this.bodies, i2).get$invMass();
    var t10 = d.length;
    if (i2 < 0 || i2 >= t10) throw $.ioore(i2);
    t7.set$x($.add(t8, $.mul($.mul($.mul(t9, d[i2].get$y()), 0.5), lambda)));
    var t11 = $.index(this.bodies, i2).get$linearVelocity();
    var t12 = t11.get$y();
    var t13 = $.index(this.bodies, i2).get$invMass();
    var t14 = d.length;
    if (i2 < 0 || i2 >= t14) throw $.ioore(i2);
    t11.set$y($.add(t12, $.mul($.mul($.mul(t13, $.neg(d[i2].get$x())), 0.5), lambda)));
  }
 },
 solvePositionConstraints$1: function(baumgarte) {
 ...
 initVelocityConstraints$1: function(argStep) {
  ...
  for (var i0 = 0; $.ltB(i0, $.get$length(this.bodies)); i0 = i0 + 1) {
    if (i0 === 0) {
      var prev = $.sub($.get$length(this.bodies), 1);
    } else {
      prev = i0 - 1;
  ...
  if (this.step.get$warmStarting() === true) {
    this._impulse = $.mul(this._impulse, this.step.get$dtRatio());
    for (var i1 = 0; $.ltB(i1, $.get$length(this.bodies)); i1 = i1 + 1) {
      var t4 = $.index(this.bodies, i1).get$linearVelocity();
      var t5 = t4.get$x();
      var t6 = $.index(this.bodies, i1).get$invMass();
      var t7 = d.length;
      if (i1 < 0 || i1 >= t7) throw $.ioore(i1);
      t4.set$x($.add(t5, $.mul($.mul($.mul(t6, d[i1].get$y()), 0.5), this._impulse)));
      var t8 = $.index(this.bodies, i1).get$linearVelocity();
      var t9 = t8.get$y();
      var t10 = $.index(this.bodies, i1).get$invMass();
      var t11 = d.length;
      if (i1 < 0 || i1 >= t11) throw $.ioore(i1);
      t8.set$y($.add(t9, $.mul($.mul($.mul(t10, $.neg(d[i1].get$x())), 0.5), this._impulse)));
    }
  } else {
    this._impulse = 0.0;
  }
 ...
 constrainEdges$1: function(argStep) {
  for (var perimeter = 0.0, i = 0; $.ltB(i, $.get$length(this.bodies)); perimeter = perimeter0, i = i0) {
    var perimeter0 = perimeter;
    if (i === $.sub($.get$length(this.bodies), 1)) {
      var next = 0;
    } else {
      next = i + 1;
    }
    ...
    var dist0 = dist;
    if ($.ltB(dist, 1.192e-7)) {
      dist0 = 1.0;
    }
    var t0 = $.div(dy, dist0);
    $.index(this.normals, i).set$x(t0);
    var t1 = $.div($.neg(dx), dist0);
    $.index(this.normals, i).set$y(t1);
    perimeter0 = $.add(perimeter, dist0);
    var i0 = i + 1;
  }
  var delta = $.Vector$2(0, 0);
  var toExtrude = $.mul(0.5, $.sub(this.targetVolume, this.get$area())) / perimeter;
  for (var i1 = 0, done = true; $.ltB(i1, $.get$length(this.bodies)); i1 = i2, done = done0) {
    var done0 = done;
    if (i1 === $.sub($.get$length(this.bodies), 1)) {
      var next0 = 0;
    } else {
      next0 = i1 + 1;
    }
    delta.setCoords$2($.mul(toExtrude, $.add($.index(this.normals, i1).get$x(), $.index(this.normals, next0).get$x())), $.mul(toExtrude, $.add($.index(this.normals, i1).get$y(), $.index(this.normals, next0).get$y())));
    var norm = $.get$length(delta);
    if ($.gtB(norm, 0.2)) {
      delta.mulLocal$1($.div(0.2, norm));
    }
    done0 = done;
    if ($.gtB(norm, 0.005)) {
      done0 = false;
    }
    var t2 = $.index(this.bodies, next0).get$sweep().get$center();
    t2.set$x($.add(t2.get$x(), delta.x));
    var t3 = $.index(this.bodies, next0).get$sweep().get$center();
    t3.set$y($.add(t3.get$y(), delta.y));
    $.index(this.bodies, next0).synchronizeTransform$0();
    var i2 = i1 + 1;
  }
  return done;
 },
 get$area: function() {
  var result = $.add(0.0, $.sub($.mul($.index(this.bodies, $.sub($.get$length(this.bodies), 1)).get$worldCenter().get$x(), $.index(this.bodies, 0).get$worldCenter().get$y()), $.mul($.index(this.bodies, 0).get$worldCenter().get$x(), $.index(this.bodies, $.sub($.get$length(this.bodies), 1)).get$worldCenter().get$y())));
  for (var i = 0, result0 = result; $.ltB(i, $.sub($.get$length(this.bodies), 1)); i = i + 1, result0 = result1) {
    var result1 = result0;
    var t0 = $.index(this.bodies, i).get$worldCenter().get$x();
    var t1 = this.bodies;
    var t2 = i + 1;
    result1 = $.add(result0, $.sub($.mul(t0, $.index(t1, t2).get$worldCenter().get$y()), $.mul($.index(this.bodies, t2).get$worldCenter().get$x(), $.index(this.bodies, i).get$worldCenter().get$y())));
  }
  return result0 * 0.5;
 },
 ...
 ConstantVolumeJoint$2: function(_world, def) {
  if ($.leB($.get$length(def.get$bodies()), 2)) {
    throw $.captureStackTrace($.IllegalArgumentException$1('You cannot create a constant volume joint with less than three bodies.'));
  }
  this.bodies = $.List$from(def.get$bodies());
  var t0 = $.List($.get$length(this.bodies));
  $.setRuntimeTypeInfo(t0, ({E: 'num'}));
  this.targetLengths = t0;
  for (var i = 0; $.ltB(i, $.get$length(this.targetLengths)); i = i + 1) {
    if (i === $.sub($.get$length(this.targetLengths), 1)) {
      var next = 0;
    } else {
      next = i + 1;
    }
    var temp = $.Vector$copy$1($.index(this.bodies, i).get$worldCenter());
  ...
  if (!$.eqNullB(def.get$joints()) && !$.eqB($.get$length(def.get$joints()), $.get$length(def.get$bodies()))) {
    throw $.captureStackTrace($.IllegalArgumentException$1('Incorrect joint definition.  Joints have to correspond to the bodies'));
  }
  if ($.eqNullB(def.get$joints())) {
    var djd = $.DistanceJointDef$0();
    var t1 = $.List($.get$length(this.bodies));
    $.setRuntimeTypeInfo(t1, ({E: 'DistanceJoint'}));
    this.distanceJoints = t1;
    for (var i0 = 0; $.ltB(i0, $.get$length(this.targetLengths)); i0 = i0 + 1) {
      if (i0 === $.sub($.get$length(this.targetLengths), 1)) {
        var next0 = 0;
      } else {
        next0 = i0 + 1;
      }
      ...
      djd.initialize$4($.index(this.bodies, i0), $.index(this.bodies, next0), $.index(this.bodies, i0).get$worldCenter(), $.index(this.bodies, next0).get$worldCenter());
      $.indexSet(this.distanceJoints, i0, this._world.createJoint$1(djd));
    }
  } else {
    var t2 = $.List($.get$length(def.get$joints()));
  ...
  var t3 = $.List($.get$length(this.bodies));
  $.setRuntimeTypeInfo(t3, ({E: 'Vector'}));
  this.normals = t3;
  for (var i1 = 0; $.ltB(i1, $.get$length(this.normals)); i1 = i1 + 1) {
    $.indexSet(this.normals, i1, $.Vector$2(0, 0));
  }
...
Isolate.$defineClass("DistanceJoint", "Joint", ["bias", "gamma", "dampingRatio?", "frequencyHz?", "length=", "mass=", "impulse", "u", "localAnchor2", "localAnchor1", "invIB", "invMassB", "invIA", "invMassA", "localCenterB", "localCenterA", "userData", "collideConnected", "islandFlag", "bodyB", "bodyA", "edgeB", "edgeA", "_lib2_next", "_prev", "type"], {
 solvePositionConstraints$1: function(baumgarte) {
  if ($.gtB(this.frequencyHz, 0.0)) {
    return true;
  }
  var b1 = this.bodyA;
  var b2 = this.bodyB;
  ...
  $.mulMatrixAndVectorToOut(b1.get$originTransform().get$rotation(), r1, r1);
  $.mulMatrixAndVectorToOut(b2.get$originTransform().get$rotation(), r2, r2);
  d.x = $.sub($.sub($.add(b2.get$sweep().get$center().get$x(), r2.x), b1.get$sweep().get$center().get$x()), r1.x);
  d.y = $.sub($.sub($.add(b2.get$sweep().get$center().get$y(), r2.y), b1.get$sweep().get$center().get$y()), r1.y);
  var C = $.clamp($.sub(d.normalize$0(), $.get$length(this)), -0.2, 0.2);
  var imp = $.mul($.neg(this.mass), C);
  this.u.setFrom$1(d);
  var Px = $.mul(imp, this.u.get$x());
  var Py = $.mul(imp, this.u.get$y());
  var t0 = b1.get$sweep().get$center();
  t0.set$x($.sub(t0.get$x(), $.mul(b1.get$invMass(), Px)));
  var t1 = b1.get$sweep().get$center();
  t1.set$y($.sub(t1.get$y(), $.mul(b1.get$invMass(), Py)));
  var t2 = b1.get$sweep();
  t2.set$angle($.sub(t2.get$angle(), $.mul(b1.get$invInertia(), $.sub($.mul(r1.x, Py), $.mul(r1.y, Px)))));
  var t3 = b2.get$sweep().get$center();
  t3.set$x($.add(t3.get$x(), $.mul(b2.get$invMass(), Px)));
  var t4 = b2.get$sweep().get$center();
  t4.set$y($.add(t4.get$y(), $.mul(b2.get$invMass(), Py)));
  var t5 = b2.get$sweep();
  t5.set$angle($.add(t5.get$angle(), $.mul(b2.get$invInertia(), $.sub($.mul(r2.x, Py), $.mul(r2.y, Px)))));
  b1.synchronizeTransform$0();
  b2.synchronizeTransform$0();
  return $.lt($.abs(C), 0.005);
 },
 solveVelocityConstraints$1: function(step) {
  var b1 = this.bodyA;
  var b2 = this.bodyB;
  ...
  var t2 = b2.get$linearVelocity();
  t2.set$x($.add(t2.get$x(), $.mul(b2.get$invMass(), Px)));
  var t3 = b2.get$linearVelocity();
 ...
 initVelocityConstraints$1: function(step) {
  ...
  $.mulMatrixAndVectorToOut(b1.get$originTransform().get$rotation(), r1, r1);
  $.mulMatrixAndVectorToOut(b2.get$originTransform().get$rotation(), r2, r2);
  var t0 = $.sub($.sub($.add(b2.get$sweep().get$center().get$x(), r2.x), b1.get$sweep().get$center().get$x()), r1.x);
  this.u.set$x(t0);
  var t1 = $.sub($.sub($.add(b2.get$sweep().get$center().get$y(), r2.y), b1.get$sweep().get$center().get$y()), r1.y);
  this.u.set$y(t1);
  var len = $.get$length(this.u);
  if ($.gtB(len, 0.005)) {
    var t2 = this.u;
    t2.set$x($.mul(t2.get$x(), $.div(1.0, len)));
    var t3 = this.u;
    t3.set$y($.mul(t3.get$y(), $.div(1.0, len)));
  } else {
    this.u.setCoords$2(0.0, 0.0);
  }
  var cr1u = $.crossVectors(r1, this.u);
  var cr2u = $.crossVectors(r2, this.u);
  var invMass = $.add($.add($.add(b1.get$invMass(), $.mul($.mul(b1.get$invInertia(), cr1u), cr1u)), b2.get$invMass()), $.mul($.mul(b2.get$invInertia(), cr2u), cr2u));
  $.assert($.gt(invMass, 1.192e-7));
  this.mass = $.div(1.0, invMass);
  if ($.gtB(this.frequencyHz, 0.0)) {
    var C = $.sub(len, $.get$length(this));
    var omega = $.mul(6.283185307179586, this.frequencyHz);
    var d = $.mul($.mul(2.0, this.mass), this.dampingRatio) * omega;
    var k = $.mul($.mul(this.mass, omega), omega);
    this.gamma = $.mul(step.get$dt(), $.add(d, $.mul(step.get$dt(), k)));
    if (!$.eqB(this.gamma, 0.0)) {
      var t4 = $.div(1.0, this.gamma);
    } else {
      t4 = 0.0;
    }
    this.gamma = t4;
    this.bias = $.mul($.mul($.mul(C, step.get$dt()), k), this.gamma);
    this.mass = $.add(invMass, this.gamma);
    if (!$.eqB(this.mass, 0.0)) {
      var t5 = $.div(1.0, this.mass);
    } else {
      t5 = 0.0;
    }
    this.mass = t5;
  ...
  if (step.get$warmStarting() === true) {
    this.impulse = $.mul(this.impulse, step.get$dtRatio());
    var P = $.Vector$2(0, 0);
    P.setFrom$1(this.u).mulLocal$1(this.impulse);
    var t6 = b1.get$linearVelocity();
    t6.set$x($.sub(t6.get$x(), $.mul(b1.get$invMass(), P.x)));
    var t7 = b1.get$linearVelocity();
    t7.set$y($.sub(t7.get$y(), $.mul(b1.get$invMass(), P.y)));
    b1.set$angularVelocity($.sub(b1.get$angularVelocity(), $.mul(b1.get$invInertia(), $.crossVectors(r1, P))));
    var t8 = b2.get$linearVelocity();
    t8.set$x($.add(t8.get$x(), $.mul(b2.get$invMass(), P.x)));
    var t9 = b2.get$linearVelocity();
    t9.set$y($.add(t9.get$y(), $.mul(b2.get$invMass(), P.y)));
    b2.set$angularVelocity($.add(b2.get$angularVelocity(), $.mul(b2.get$invInertia(), $.crossVectors(r2, P))));
  } else {
    this.impulse = 0.0;
  }
 }
...
Isolate.$defineClass("DistanceJointDef", "JointDef", ["dampingRatio?", "frequencyHz?", "length=", "localAnchorB?", "localAnchorA?", "collideConnected", "bodyB", "bodyA", "userData", "type"], {
...
Isolate.$defineClass("RevoluteJoint", "Joint", ["limitState", "upperAngle?", "lowerAngle?", "referenceAngle?", "_enableLimit", "_motorSpeed", "_maxMotorTorque", "_enableMotor", "motorMass", "mass?", "_motorImpulse", "impulse", "localAnchor2", "localAnchor1", "invIB", "invMassB", "invIA", "invMassA", "localCenterB", "localCenterA", "userData", "collideConnected", "islandFlag", "bodyB", "bodyA", "edgeB", "edgeA", "_lib2_next", "_prev", "type"], {
 ...
 solvePositionConstraints$1: function(baumgarte) {
  ...
  if (this._enableLimit === true && !$.eqB(this.limitState, 0)) {
    var angle = $.sub($.sub(b2.get$sweep().get$angle(), b1.get$sweep().get$angle()), this.referenceAngle);
    if ($.eqB(this.limitState, 3)) {
      var C = $.clamp($.sub(angle, this.lowerAngle), -0.13962634015954636, 0.13962634015954636);
      var limitImpulse = $.mul($.neg(this.motorMass), C);
      var angularError0 = $.abs(C);
      var limitImpulse0 = limitImpulse;
      angularError = angularError0;
    } else {
      if ($.eqB(this.limitState, 1)) {
        var C0 = $.sub(angle, this.lowerAngle);
        var angularError1 = $.neg(C0);
        var C1 = $.clamp($.add(C0, 0.03490658503988659), -0.13962634015954636, 0.0);
        limitImpulse0 = $.mul($.neg(this.motorMass), C1);
        angularError = angularError1;
      } else {
        limitImpulse0 = 0.0;
        angularError = 0.0;
        if ($.eqB(this.limitState, 2)) {
          var C2 = $.sub(angle, this.upperAngle);
          var C3 = $.clamp($.sub(C2, 0.03490658503988659), 0.0, 0.13962634015954636);
          limitImpulse0 = $.mul($.neg(this.motorMass), C3);
          angularError = C2;
        }
      }
    }
    var t0 = b1.get$sweep();
    t0.set$angle($.sub(t0.get$angle(), $.mul(b1.get$invInertia(), limitImpulse0)));
    var t1 = b2.get$sweep();
    t1.set$angle($.add(t1.get$angle(), $.mul(b2.get$invInertia(), limitImpulse0)));
    b1.synchronizeTransform$0();
    b2.synchronizeTransform$0();
  }
  var imp = $.Vector$2(0, 0);
  var r1 = $.Vector$2(0, 0);
  var r2 = $.Vector$2(0, 0);
  var C4 = $.Vector$2(0, 0);
  r1.setFrom$1(this.localAnchor1).subLocal$1(b1.get$localCenter());
  ...
  $.mulMatrixAndVectorToOut(b1.get$originTransform().get$rotation(), r1, r1);
  $.mulMatrixAndVectorToOut(b2.get$originTransform().get$rotation(), r2, r2);
  C4.setFrom$1(b2.get$sweep().get$center()).addLocal$1(r2);
  C4.subLocal$1(b1.get$sweep().get$center()).subLocal$1(r1);
  var positionError = $.get$length(C4);
  var invMass1 = b1.get$invMass();
  var invMass2 = b2.get$invMass();
  var invI1 = b1.get$invInertia();
  var invI2 = b2.get$invInertia();
  if ($.gtB(C4.get$lengthSquared(), 0.0025000000000000005)) {
    var u = $.Vector$2(0, 0);
    ...
    imp.setFrom$1(C4).negateLocal$0().mulLocal$1(m0);
    u.setFrom$1(imp).mulLocal$1($.mul(0.5, invMass1));
    b1.get$sweep().get$center().subLocal$1(u);
    u.setFrom$1(imp).mulLocal$1($.mul(0.5, invMass2));
    b2.get$sweep().get$center().addLocal$1(u);
    C4.setFrom$1(b2.get$sweep().get$center()).addLocal$1(r2);
    C4.subLocal$1(b1.get$sweep().get$center()).subLocal$1(r1);
  }
  var K1 = $.Matrix22$2((void 0), (void 0));
  var t2 = $.add(invMass1, invMass2);
  K1.col1.set$x(t2);
  K1.col2.set$x(0.0);
  K1.col1.set$y(0.0);
  var t3 = $.add(invMass1, invMass2);
  K1.col2.set$y(t3);
  var K2 = $.Matrix22$2((void 0), (void 0));
  var t4 = $.mul($.mul(invI1, r1.y), r1.y);
  K2.col1.set$x(t4);
  var t5 = $.mul($.mul($.neg(invI1), r1.x), r1.y);
  K2.col2.set$x(t5);
  var t6 = $.mul($.mul($.neg(invI1), r1.x), r1.y);
  K2.col1.set$y(t6);
  var t7 = $.mul($.mul(invI1, r1.x), r1.x);
  K2.col2.set$y(t7);
  var K3 = $.Matrix22$2((void 0), (void 0));
  var t8 = $.mul($.mul(invI2, r2.y), r2.y);
  K3.col1.set$x(t8);
  var t9 = $.mul($.mul($.neg(invI2), r2.x), r2.y);
  K3.col2.set$x(t9);
  var t10 = $.mul($.mul($.neg(invI2), r2.x), r2.y);
  K3.col1.set$y(t10);
  var t11 = $.mul($.mul(invI2, r2.x), r2.x);
  K3.col2.set$y(t11);
  K1.addLocal$1(K2).addLocal$1(K3);
  K1.solveToOut$2(C4.negateLocal$0(), imp);
  C4.setFrom$1(imp).mulLocal$1(b1.get$invMass());
  b1.get$sweep().get$center().subLocal$1(C4);
  var t12 = b1.get$sweep();
  t12.set$angle($.sub(t12.get$angle(), $.mul(b1.get$invInertia(), $.crossVectors(r1, imp))));
  C4.setFrom$1(imp).mulLocal$1(b2.get$invMass());
  b2.get$sweep().get$center().addLocal$1(C4);
  var t13 = b2.get$sweep();
  t13.set$angle($.add(t13.get$angle(), $.mul(b2.get$invInertia(), $.crossVectors(r2, imp))));
  b1.synchronizeTransform$0();
  b2.synchronizeTransform$0();
 ...
 solveVelocityConstraints$1: function(step) {
  ...
  if (this._enableMotor === true && !$.eqB(this.limitState, 3)) {
    ...
    this._motorImpulse = $.clamp($.add(this._motorImpulse, imp), $.neg(maxImpulse), maxImpulse);
    var imp0 = $.sub(this._motorImpulse, oldImpulse);
    var w11 = $.sub(w1, $.mul(i1, imp0));
    var w21 = $.add(w2, $.mul(i2, imp0));
    w10 = w11;
    w20 = w21;
  }
  var temp = $.Vector$2(0, 0);
  var r1 = $.Vector$2(0, 0);
  var r2 = $.Vector$2(0, 0);
  if (this._enableLimit === true && !$.eqB(this.limitState, 0)) {
    r1.setFrom$1(this.localAnchor1).subLocal$1(b1.get$localCenter());
    ...
    $.mulMatrixAndVectorToOut(b1.get$originTransform().get$rotation(), r1, r1);
    $.mulMatrixAndVectorToOut(b2.get$originTransform().get$rotation(), r2, r2);
    var Cdot1 = $.Vector$2(0, 0);
    var Cdot0 = $.Vector3$3(0, 0, 0);
    $.crossNumAndVectorToOut(w10, r1, temp);
    $.crossNumAndVectorToOut(w20, r2, Cdot1);
    Cdot1.addLocal$1(v2).subLocal$1(v1).subLocal$1(temp);
    var Cdot2 = $.sub(w20, w10);
    Cdot0.setCoords$3(Cdot1.x, Cdot1.y, Cdot2);
    var imp1 = $.Vector3$3(0, 0, 0);
    this.mass.solve33ToOut$2(Cdot0.negateLocal$0(), imp1);
    if ($.eqB(this.limitState, 3)) {
      this.impulse.addLocal$1(imp1);
    } else {
      if ($.eqB(this.limitState, 1)) {
        if ($.ltB($.add(this.impulse.get$z(), imp1.z), 0.0)) {
          this.mass.solve22ToOut$2(Cdot1.negateLocal$0(), temp);
          imp1.x = temp.x;
          imp1.y = temp.y;
          imp1.z = $.neg(this.impulse.get$z());
          var t0 = this.impulse;
          t0.set$x($.add(t0.get$x(), temp.x));
          var t1 = this.impulse;
        ...
        if ($.eqB(this.limitState, 2)) {
          if ($.gtB($.add(this.impulse.get$z(), imp1.z), 0.0)) {
            this.mass.solve22ToOut$2(Cdot1.negateLocal$0(), temp);
            imp1.x = temp.x;
            imp1.y = temp.y;
            imp1.z = $.neg(this.impulse.get$z());
            var t2 = this.impulse;
            t2.set$x($.add(t2.get$x(), temp.x));
            var t3 = this.impulse;
            t3.set$y($.add(t3.get$y(), temp.y));
            this.impulse.set$z(0.0);
          }
        }
      }
    ...
    var P = $.Vector$2(0, 0);
    P.setCoords$2(imp1.x, imp1.y);
    temp.setFrom$1(P).mulLocal$1(m1);
    v1.subLocal$1(temp);
    var w12 = $.sub(w10, $.mul(i1, $.add($.crossVectors(r1, P), imp1.z)));
    temp.setFrom$1(P).mulLocal$1(m2);
    v2.addLocal$1(temp);
    var w22 = $.add(w20, $.mul(i2, $.add($.crossVectors(r2, P), imp1.z)));
    var w13 = w12;
    var w23 = w22;
  } else {
    r1.setFrom$1(this.localAnchor1).subLocal$1(b1.get$localCenter());
    ...
    $.mulMatrixAndVectorToOut(b1.get$originTransform().get$rotation(), r1, r1);
    $.mulMatrixAndVectorToOut(b2.get$originTransform().get$rotation(), r2, r2);
    var Cdot3 = $.Vector$2(0, 0);
    var imp2 = $.Vector$2(0, 0);
    $.crossNumAndVectorToOut(w10, r1, temp);
    $.crossNumAndVectorToOut(w20, r2, Cdot3);
    Cdot3.addLocal$1(v2).subLocal$1(v1).subLocal$1(temp);
    this.mass.solve22ToOut$2(Cdot3.negateLocal$0(), imp2);
    var t4 = this.impulse;
    t4.set$x($.add(t4.get$x(), imp2.x));
    var t5 = this.impulse;
    t5.set$y($.add(t5.get$y(), imp2.y));
    temp.setFrom$1(imp2).mulLocal$1(m1);
    v1.subLocal$1(temp);
    var w14 = $.sub(w10, $.mul(i1, $.crossVectors(r1, imp2)));
    temp.setFrom$1(imp2).mulLocal$1(m2);
    v2.addLocal$1(temp);
    var w24 = $.add(w20, $.mul(i2, $.crossVectors(r2, imp2)));
    w13 = w14;
    w23 = w24;
  }
  b1.set$angularVelocity(w13);
  b2.set$angularVelocity(w23);
 },
 initVelocityConstraints$1: function(step) {
  var b1 = this.bodyA;
  var b2 = this.bodyB;
  if (this._enableMotor === true || this._enableLimit === true) {
    $.assert($.gtB(b1.get$invInertia(), 0.0) || $.gtB(b2.get$invInertia(), 0.0));
  }
  var r1 = $.Vector$2(0, 0);
  var r2 = $.Vector$2(0, 0);
  r1.setFrom$1(this.localAnchor1).subLocal$1(b1.get$localCenter());
  ...
  var i1 = b1.get$invInertia();
  var i2 = b2.get$invInertia();
  var t0 = $.add($.add($.add(m1, m2), $.mul($.mul(r1.y, r1.y), i1)), $.mul($.mul(r2.y, r2.y), i2));
  this.mass.get$col1().set$x(t0);
  var t1 = $.sub($.mul($.mul($.neg(r1.y), r1.x), i1), $.mul($.mul(r2.y, r2.x), i2));
  this.mass.get$col2().set$x(t1);
  var t2 = $.sub($.mul($.neg(r1.y), i1), $.mul(r2.y, i2));
  this.mass.get$col3().set$x(t2);
  var t3 = this.mass.get$col2().get$x();
  this.mass.get$col1().set$y(t3);
  var t4 = $.add($.add($.add(m1, m2), $.mul($.mul(r1.x, r1.x), i1)), $.mul($.mul(r2.x, r2.x), i2));
  this.mass.get$col2().set$y(t4);
  var t5 = $.add($.mul(r1.x, i1), $.mul(r2.x, i2));
  this.mass.get$col3().set$y(t5);
  var t6 = this.mass.get$col3().get$x();
  this.mass.get$col1().set$z(t6);
  var t7 = this.mass.get$col3().get$y();
  this.mass.get$col2().set$z(t7);
  var t8 = $.add(i1, i2);
  this.mass.get$col3().set$z(t8);
  this.motorMass = $.add(i1, i2);
  if ($.gtB(this.motorMass, 0.0)) {
    this.motorMass = $.div(1.0, this.motorMass);
  }
  if ($.eqB(this._enableMotor, false)) {
    this._motorImpulse = 0.0;
  }
  if (this._enableLimit === true) {
    var jointAngle = $.sub($.sub(b2.get$sweep().get$angle(), b1.get$sweep().get$angle()), this.referenceAngle);
    if ($.ltB($.abs($.sub(this.upperAngle, this.lowerAngle)), 0.06981317007977318)) {
      this.limitState = 3;
    } else {
      if ($.leB(jointAngle, this.lowerAngle)) {
        if (!$.eqB(this.limitState, 1)) {
          this.impulse.set$z(0.0);
        }
        this.limitState = 1;
      } else {
        if ($.geB(jointAngle, this.upperAngle)) {
          if (!$.eqB(this.limitState, 2)) {
            this.impulse.set$z(0.0);
          }
          this.limitState = 2;
  ...
  if (step.get$warmStarting() === true) {
    ...
    this._motorImpulse = $.mul(this._motorImpulse, step.get$dtRatio());
    var temp = $.Vector$2(0, 0);
    var P = $.Vector$2(0, 0);
    P.setCoords$2(this.impulse.get$x(), this.impulse.get$y());
    temp.setFrom$1(P).mulLocal$1(m1);
    b1.get$linearVelocity().subLocal$1(temp);
    b1.set$angularVelocity($.sub(b1.get$angularVelocity(), $.mul(i1, $.add($.add($.crossVectors(r1, P), this._motorImpulse), this.impulse.get$z()))));
    temp.setFrom$1(P).mulLocal$1(m2);
    b2.get$linearVelocity().addLocal$1(temp);
    b2.set$angularVelocity($.add(b2.get$angularVelocity(), $.mul(i2, $.add($.add($.crossVectors(r2, P), this._motorImpulse), this.impulse.get$z()))));
  } else {
...
Isolate.$defineClass("RevoluteJointDef", "JointDef", ["maxMotorTorque?", "motorSpeed?", "enableMotor?", "upperAngle?", "lowerAngle?", "enableLimit?", "referenceAngle?", "localAnchorB?", "localAnchorA?", "collideConnected", "bodyB", "bodyA", "userData", "type"], {
...
Isolate.$defineClass("Matrix22", "Object", ["col2?", "col1?"], {
 ...
 solveToOut$2: function(b, out) {
  ...
  var tempy = $.mul(det0, $.sub($.mul(a11, b.get$y()), $.mul(a21, b.get$x())));
  out.set$x($.mul(det0, $.sub($.mul(a22, b.get$x()), $.mul(a12, b.get$y()))));
  out.set$y(tempy);
 },
...
Isolate.$defineClass("Matrix33", "Object", ["col3?", "col2?", "col1?"], {
 solve33ToOut$2: function(b, out) {
  $.crossToOut(this.col2, this.col3, out);
  var det = $.dot2(this.col1, out);
  var det0 = det;
  if (!$.eqB(det, 0.0)) {
    det0 = $.div(1.0, det);
  }
  $.crossToOut(this.col2, this.col3, out);
  var x = $.mul(det0, $.dot2(b, out));
  $.crossToOut(b, this.col3, out);
  var y = $.mul(det0, $.dot2(this.col1, out));
  $.crossToOut(this.col2, b, out);
  var z = $.mul(det0, $.dot2(this.col1, out));
  out.set$x(x);
  out.set$y(y);
  out.set$z(z);
 },
 solve22ToOut$2: function(b, out) {
  ...
  out.set$x($.mul(det0, $.sub($.mul(a22, b.get$x()), $.mul(a12, b.get$y()))));
  out.set$y($.mul(det0, $.sub($.mul(a11, b.get$y()), $.mul(a21, b.get$x()))));
 },
 setZero$0: function() {
  this.col1.setZero$0();
  this.col2.setZero$0();
...
Isolate.$defineClass("Vector3", "Object", ["z=", "y=", "x="], {
 ...
 subLocal$1: function(argVec) {
  this.x = $.sub(this.x, argVec.get$x());
  this.y = $.sub(this.y, argVec.get$y());
  this.z = $.sub(this.z, argVec.get$z());
  return this;
 },
 add$1: function(argVec) {
  return $.Vector3$3($.add(this.x, argVec.get$x()), $.add(this.y, argVec.get$y()), $.add(this.z, argVec.get$z()));
 },
 ...
 operator$eq$1: function(other) {
  if (!$.eqNullB(other) && (typeof other === 'object' && !!other.is$Vector3)) {
...
Isolate.$defineClass("_ListWrapper", "Object", [], {
 ...
 get$filter: function() { return new $.Closure28(this); },
 forEach$1: function(f) {
...
Isolate.$defineClass("_VariableSizeListIterator", "Object", [], {
 ...
 get$next: function() { return new $.Closure36(this); },
 hasNext$0: function() {
...
Isolate.$defineClass("Closure3", "Closure7", [], {
 $call$2: function(a, b) {
...
Isolate.$defineClass('Closure6', 'Closure7', function BoundClosure(self) { this.self = self; }, {
...
Isolate.$defineClass('Closure11', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$0: function() { return this.self.next$0(); }
});
Isolate.$defineClass('Closure12', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$0: function() { return this.self.next$0(); }
});
Isolate.$defineClass('Closure13', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$3: function(arg0, arg1, arg2) { return this.self.distance$3(arg0, arg1, arg2); }
});
Isolate.$defineClass('Closure14', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$2: function(arg0, arg1) { return this.self.timeOfImpact$2(arg0, arg1); }
});
Isolate.$defineClass('Closure15', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$0: function() { return this.self.count$0(); }
});
Isolate.$defineClass('Closure16', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.filter$1(arg0); }
});
Isolate.$defineClass('Closure17', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.filter$1(arg0); }
});
Isolate.$defineClass('Closure18', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.filter$1(arg0); }
});
Isolate.$defineClass('Closure19', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.filter$1(arg0); }
});
Isolate.$defineClass('Closure20', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.filter$1(arg0); }
});
Isolate.$defineClass('Closure21', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.count$1(arg0); },
 $call$0: function() {
  return this.$call$1((void 0))
}
});
Isolate.$defineClass('Closure22', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.count$1(arg0); },
 $call$0: function() {
  return this.$call$1((void 0))
}
});
Isolate.$defineClass('Closure23', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.filter$1(arg0); }
});
Isolate.$defineClass('Closure24', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.filter$1(arg0); }
});
Isolate.$defineClass('Closure25', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.filter$1(arg0); }
});
Isolate.$defineClass('Closure26', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.filter$1(arg0); }
});
Isolate.$defineClass('Closure27', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.filter$1(arg0); }
});
Isolate.$defineClass('Closure28', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.filter$1(arg0); }
});
Isolate.$defineClass('Closure29', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.filter$1(arg0); }
});
Isolate.$defineClass('Closure30', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.filter$1(arg0); }
});
Isolate.$defineClass('Closure31', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.filter$1(arg0); }
});
Isolate.$defineClass('Closure32', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.filter$1(arg0); }
});
Isolate.$defineClass('Closure33', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.filter$1(arg0); }
});
Isolate.$defineClass('Closure34', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.filter$1(arg0); }
});
Isolate.$defineClass('Closure35', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$1: function(arg0) { return this.self.filter$1(arg0); }
});
Isolate.$defineClass('Closure36', 'Closure7', function BoundClosure(self) { this.self = self; }, {
 $call$0: function() { return this.self.next$0(); }
});
...
$.RevoluteJointDef$0 = function() {
  var t0 = $.Vector$2(0.0, 0.0);
  var t1 = new $.RevoluteJointDef(0.0, 0.0, false, 0.0, 0.0, false, 0.0, $.Vector$2(0.0, 0.0), t0, false, (void 0), (void 0), (void 0), 0);
...
$.CircleShape$copy$1 = function(other) {
  var t0 = other.get$type();
  var t1 = other.get$radius();
  return new $.CircleShape($.Vector$copy$1(other.get$position()), t1, t0);
};
...
$.JointEdge$0 = function() {
  return new $.JointEdge((void 0), (void 0), (void 0), (void 0));
};
...
$.BallDropBench$2 = function(solveLoops, steps) {
  return new $.BallDropBench(steps, solveLoops, (void 0), (void 0));
};
...
$.DominoTowerBench$2 = function(solveLoops, steps) {
  return new $.DominoTowerBench((void 0), steps, solveLoops, (void 0), (void 0));
};
...
$.Matrix33$0 = function() {
  var t0 = $.Vector3$3(0, 0, 0);
  var t1 = $.Vector3$3(0, 0, 0);
  return new $.Matrix33($.Vector3$3(0, 0, 0), t1, t0);
};
...
$.DistanceJoint$1 = function(def) {
  var t0 = def.get$type();
  var t1 = def.get$bodyA();
  var t2 = def.get$bodyB();
  var t3 = def.get$collideConnected();
  var t4 = def.get$userData();
  var t5 = $.Vector$2(0, 0);
  var t6 = $.Vector$2(0, 0);
  var t7 = $.JointEdge$0();
  var t8 = $.JointEdge$0();
  var t9 = $.Vector$copy$1(def.get$localAnchorA());
  var t10 = $.Vector$copy$1(def.get$localAnchorB());
  var t11 = $.get$length(def);
  var t12 = $.Vector$2(0, 0);
  var t13 = def.get$frequencyHz();
  return new $.DistanceJoint(0.0, 0.0, def.get$dampingRatio(), t13, t11, (void 0), 0.0, t12, t10, t9, (void 0), (void 0), (void 0), (void 0), t6, t5, t4, t3, false, t2, t1, t8, t7, (void 0), (void 0), t0);
};
...
$.ConstantVolumeJoint$2 = function(_world, def) {
  ...
  var t6 = $.Vector$2(0, 0);
  var t7 = $.JointEdge$0();
  var t8 = new $.ConstantVolumeJoint((void 0), (void 0), (void 0), _world, 0, (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), t6, t5, t4, t3, false, t2, t1, $.JointEdge$0(), t7, (void 0), (void 0), t0);
  t8.ConstantVolumeJoint$2(_world, def);
  return t8;
};
...
$.Joint$create = function(argWorld, def) {
  $0:{
    var t0 = def.get$type();
    if (5 === t0) {
      ...
      if (3 === t0) {
        return $.DistanceJoint$1(def);
      } else {
        if (2 === t0) {
          throw $.captureStackTrace($.NotImplementedException$0());
        } else {
          if (1 === t0) {
            return $.RevoluteJoint$1(def);
          } else {
            if (8 === t0) {
              throw $.captureStackTrace($.NotImplementedException$0());
            } else {
                ...
                if (7 === t0) {
                  ...
                  if (6 === t0) {
                    ...
                    if (4 === t0) {
                      ...
                      if (10 === t0) {
                        return $.ConstantVolumeJoint$2(argWorld, def);
                      }
                    }
                  }
                }
...
$.BenchmarkRunner$0 = function() {
  var t0 = $.StringBufferImpl$1('');
  var t1 = $.List((void 0));
  $.setRuntimeTypeInfo(t1, ({E: 'Benchmark'}));
  return new $.BenchmarkRunner(t0, t1, $.CTC5, $.CTC4);
};
...
$.RevoluteJoint$1 = function(def) {
  ...
  var t9 = $.Vector$2(0, 0);
  var t10 = $.Vector$2(0, 0);
  var t11 = $.Vector3$3(0, 0, 0);
  var t12 = new $.RevoluteJoint((void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), $.Matrix33$0(), 0, t11, t10, t9, (void 0), (void 0), (void 0), (void 0), t6, t5, t4, t3, false, t2, t1, t8, t7, (void 0), (void 0), t0);
  t12.RevoluteJoint$1(def);
  return t12;
};
...
$.CircleShape$0 = function() {
  return new $.CircleShape($.Vector$2(0, 0), 0, 0);
};
...
$.CircleStressBench$2 = function(solveLoops, steps) {
  return new $.CircleStressBench((void 0), steps, solveLoops, (void 0), (void 0));
};
...
$.DistanceJointDef$0 = function() {
  var t0 = $.Vector$2(0.0, 0.0);
  var t1 = new $.DistanceJointDef(0.0, 0.0, 1.0, $.Vector$2(0.0, 0.0), t0, false, (void 0), (void 0), (void 0), 0);
  t1.DistanceJointDef$0();
  return t1;
};

$.DominoPlatformBench$2 = function(solveLoops, steps) {
  return new $.DominoPlatformBench(steps, solveLoops, (void 0), (void 0));
};
...
$.BallCageBench$2 = function(solveLoops, steps) {
  return new $.BallCageBench(steps, solveLoops, (void 0), (void 0));
};
...
$.CTC4 = Isolate.makeConstantList([10, 30]);
$.CTC7 = new Isolate.$isolateProperties._DeletedKeySentinel();
$.CTC5 = Isolate.makeConstantList([10, 100, 500, 2000]);
...
_ConsoleImpl.get$count = function() { return new $.Closure15(this); };
...
$.$defineNativeClass('DOMStringList', ["length?"], {
 ...
 get$filter: function() { return new $.Closure16(this); },
 forEach$1: function(f) {
...
$.$defineNativeClass('FileList', ["length?"], {
 ...
 get$filter: function() { return new $.Closure17(this); },
 forEach$1: function(f) {
  return $.forEach3(this, f);
 },
 add$1: function(value) {
...
$.$defineNativeClass('Float32Array', ["length?"], {
 ...
 get$filter: function() { return new $.Closure18(this); },
 forEach$1: function(f) {
  return $.forEach3(this, f);
 },
 add$1: function(value) {
...
$.$defineNativeClass('Float64Array', ["length?"], {
 ...
 get$filter: function() { return new $.Closure19(this); },
 forEach$1: function(f) {
  return $.forEach3(this, f);
 },
 add$1: function(value) {
...
$.$defineNativeClass('HTMLCollection', ["length?"], {
 ...
 get$filter: function() { return new $.Closure20(this); },
 forEach$1: function(f) {
  return $.forEach3(this, f);
 },
 add$1: function(value) {
...
$.$defineNativeClass('IDBIndex', ["name?"], {
 ...
 get$count: function() { return new $.Closure21(this); }
});
...
$.$defineNativeClass('IDBObjectStore', ["name?"], {
 ...
 get$count: function() { return new $.Closure22(this); },
 clear$0: function() {
  return this.clear();
 },
...
$.$defineNativeClass('HTMLInputElement', ["type=", "pattern?", "name?"], {
 step$3: function(arg0, arg1, arg2) { return this.step.$call$3(arg0, arg1, arg2); }
});
...
$.$defineNativeClass('NamedNodeMap', ["length?"], {
 ...
 get$filter: function() { return new $.Closure27(this); },
 forEach$1: function(f) {
  return $.forEach3(this, f);
 },
 add$1: function(value) {
