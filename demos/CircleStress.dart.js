...
$$.CircleStress = {"":
 ["_joint", "_stopwatch", "viewportScale", "worldStepTime", "elapsedUs", "fpsCounter", "frameCount", "world", "debugDraw", "viewport", "ctx", "canvas", "bodies"],
 super: "Demo",
...
$.CircleStress$ = function() {
  var t1 = $.ListFactory_List(null);
  $.setRuntimeTypeInfo(t1, ({E: 'Body'}));
  t1 = new $.CircleStress(null, $.StopwatchImplementation$start(), 10, null, null, null, null, null, null, null, null, null, t1);
