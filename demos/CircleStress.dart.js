...
$$.CircleStress = {"":
 ...
 initialize$0: function() {
  ...
  var rightWall = $.propertyTypeCheck(t1.createBody$1(wallDef), 'is$Body');
  t2.push(rightWall);
  rightWall.createFixtureFromShape$1(sd);
  wallDef.position = $.Vector$(-45.0, 25.0);
  var leftWall = $.propertyTypeCheck(t1.createBody$1(wallDef), 'is$Body');
  t2.push(leftWall);
  ...
  var myBod = $.propertyTypeCheck(t1.createBody$1(cornerDef), 'is$Body');
  t2.push(myBod);
  myBod.createFixtureFromShape$1(sd);
  cornerDef.angle = 0.7853981633974483;
  cornerDef.position = $.Vector$(35, 8.0);
  myBod = $.propertyTypeCheck(t1.createBody$1(cornerDef), 'is$Body');
  t2.push(myBod);
  myBod.createFixtureFromShape$1(sd);
  sd.setAsBox$2(50.0, 10.0);
  var topDef = $.BodyDef$();
  ...
  for (var i = 0; $.ltB(i, 5); i = $.intTypeCheck($.add(i, 1))) {
    ...
    fd.friction = 0.1;
    fd.restitution = 0.9;
    var t3 = $.div(i, $.toDouble(5));
    if (typeof t3 !== 'number') throw $.iae(t3);
    var t4 = $.Math_cos(6.283185307179586 * t3);
    if (typeof t4 !== 'number') throw $.iae(t4);
    var xPos = 6 * t4;
    t4 = $.div(i, $.toDouble(5));
    if (typeof t4 !== 'number') throw $.iae(t4);
    var t5 = $.Math_sin(6.283185307179586 * t4);
  ...
  for (var j = 0; $.ltB(j, 8); j = $.intTypeCheck($.add(j, 1))) {
    for (i = 0; $.ltB(i, 20); i = $.intTypeCheck($.add(i, 1))) {
      ...
      var myBody = $.propertyTypeCheck(t1.createBody$1(bod), 'is$Body');
      t2.push(myBody);
