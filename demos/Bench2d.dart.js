...
$$.StopwatchImplementation = {"":
 ...
 elapsed$0: function() {
  ...
  var t2 = this._stop;
  if (typeof t2 !== 'number') return this.elapsed$0$bailout(2, t1, t2);
  t1 = t2 - t1;
  return t1;
 },
 elapsed$0$bailout: function(state, env0, env1) {
  ...
  switch (state) {
    ...
    case 3:
    case 4:
      if (state == 3 || state == 4 || (state == 0 && t2 == null)) {
        switch (state) {
          case 0:
            t1 = $.Clock_now();
          case 3:
...
$$.Bench2d = {"":
 ...
 bench$0: function() {
  ...
  for (var i = 0; $.ltB(i, 256); i = $.intTypeCheck($.add(i, 1))) {
  ...
  for (var total = 0, i = 0; $.ltB(i, 256); i = $.intTypeCheck($.add(i, 1))) {
    if (i !== (i | 0)) throw $.iae(i);
    t1 = times.length;
    if (i < 0 || i >= t1) throw $.ioore(i);
    total = $.intTypeCheck($.add(total, times[i]));
  }
  $.print(total);
 },
 warmup$0: function() {
 ...
 initialize$0: function() {
  ...
  for (var i = 0; $.ltB(i, 20); i = $.intTypeCheck($.add(i, 1))) {
    y.setFrom$1(x);
    for (var j = i; $.ltB(j, 20); j = $.intTypeCheck($.add(j, 1))) {
      bd = $.BodyDef$();
      bd.type = 2;
      bd.position.setFrom$1(y);
      $.propertyTypeCheck(t1.createBody$1(bd), 'is$Body').createFixture$1(fixDef);
      y.addLocal$1(deltaY);
    }
    x.addLocal$1(deltaX);
  }
...
$$.Distance = {"":
 ...
 get$distance: function() { return new $.BoundClosure2(this, 'distance$3'); }
};
...
$.$defineNativeClass('HTMLInputElement', ["value=", "type?"], {
