...
$$.StopwatchImplementation = {"":
 ...
 elapsed$0: function() {
  ...
  if (this._stop == null) {
    var t1 = $.Clock_now();
    if (typeof t1 !== 'number') return this.elapsed$0$bailout(1, t1, 0);
    var t2 = this._start;
    if (typeof t2 !== 'number') return this.elapsed$0$bailout(2, t2, t1);
    t2 = t1 - t2;
    t1 = t2;
  } else {
    t1 = this._stop;
    if (typeof t1 !== 'number') return this.elapsed$0$bailout(3, t1, 0);
    t2 = this._start;
    if (typeof t2 !== 'number') return this.elapsed$0$bailout(4, t1, t2);
    t2 = t1 - t2;
    t1 = t2;
  }
  return t1;
 ...
 elapsed$0$bailout: function(state, env0, env1) {
  ...
  switch (state) {
    ...
    case 3:
    case 4:
      if (state == 1 || state == 2 || (state == 0 && this._stop == null)) {
        switch (state) {
          case 0:
            var t1 = $.Clock_now();
          case 1:
 ...
 start$0: function() {
  if (this._start == null) this._start = $.Clock_now();
    ...
    var t2 = this._stop;
    if (typeof t2 !== 'number') return this.start$0$bailout(2, t2, t1, 0);
    var t3 = this._start;
    if (typeof t3 !== 'number') return this.start$0$bailout(3, t2, t1, t3);
...
$$.Bench2d = {"":
 ["world", "debugDraw", "viewport", "ctx", "canvas"],
 super: "Object",
 bench$0: function() {
  var bench2d = $.Bench2d$();
  var times = $.ListFactory_List(256);
  $.setRuntimeTypeInfo(times, ({E: 'num'}));
  for (var i = 0; i < 256; ++i) {
...
$$.Manifold = {"":
 ...
 setFrom$1: function(other) {
  var i = 0;
  while (true) {
    var t1 = other.get$pointCount();
    if (typeof t1 !== 'number') return this.setFrom$1$bailout(1, other, t1, i, 0);
    if (!(i < t1)) break;
    t1 = this.points;
    var t2 = t1.length;
    if (i < 0 || i >= t2) throw $.ioore(i);
    ...
    if (typeof t3 !== 'string' && (typeof t3 !== 'object' || t3 === null || (t3.constructor !== Array && !t3.is$JavaScriptIndexingBehavior()))) return this.setFrom$1$bailout(2, other, t1, t3, i);
    var t4 = t3.length;
    if (i < 0 || i >= t4) throw $.ioore(i);
    t1.setFrom$1(t3[i]);
    ++i;
...
$$.PolygonShape = {"":
 ...
 setAsEdge$2: function(v1, v2) {
  ...
  t5[0].setFrom$1(v2).subLocal$1(v1);
  var t7 = this.normals;
  var t8 = t7.length;
  ...
  $.Vector_crossVectorAndNumToOut(t7, 1, t9[0]);
  t7 = this.normals;
  var t11 = t7.length;
  if (0 < 0 || 0 >= t11) throw $.ioore(0);
  t7[0].normalize$0();
  var t12 = this.normals;
  var t13 = t12.length;
  if (1 < 0 || 1 >= t13) throw $.ioore(1);
  t12 = t12[1];
  var t14 = this.normals;
  var t15 = t14.length;
  if (0 < 0 || 0 >= t15) throw $.ioore(0);
  t12.setFrom$1(t14[0]).negateLocal$0();
 },
