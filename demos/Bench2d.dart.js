...
Isolate.$defineClass("Bench2d", "Object", ["world", "debugDraw", "viewport", "ctx", "canvas"], {
 bench$0: function() {
  var bench2d = $.Bench2d$0();
  var times = $.List(256);
  $.setRuntimeTypeInfo(times, ({E: 'int'}));
  for (var i = 0; i < 256; i = i + 1) {
    var watch = $.StopwatchImplementation$0();
    watch.start$0();
    bench2d.step$0();
    watch.stop$0();
    var t0 = $.div(watch.elapsed$0(), watch.frequency$0());
    var t1 = times.length;
    if (i < 0 || i >= t1) throw $.ioore(i);
    times[i] = t0;
    var t2 = times.length;
  ...
  for (var total = 0, i0 = 0; i0 < 256; total = total0, i0 = i1) {
    var total0 = total;
    var t3 = times.length;
    if (i0 < 0 || i0 >= t3) throw $.ioore(i0);
    total0 = $.add(total, times[i0]);
    var i1 = i0 + 1;
  }
  $.print(total);
 },
 ...
 initialize$0: function() {
  ...
  shape.setAsEdge$2($.Vector$2(-40.0, 0), $.Vector$2(40.0, 0));
  var fixDef = $.FixtureDef$0();
  fixDef.shape = shape;
  fixDef.density = 0;
  ground.createFixture$1(fixDef);
  var shape0 = $.PolygonShape$0();
  shape0.setAsBox$2(0.5, 0.5);
  var fixDef0 = $.FixtureDef$0();
  fixDef0.shape = shape0;
  fixDef0.density = 5;
  var x = $.Vector$2(-7.0, 0.75);
  var y = $.Vector$2(0, 0);
  var deltaX = $.Vector$2(0.5625, 1);
  var deltaY = $.Vector$2(1.125, 0.0);
  for (var i = 0; i < 20; i = i + 1) {
    y.setFrom$1(x);
    for (var j = i; j < 20; j = j + 1) {
      var bd0 = $.BodyDef$0();
      bd0.type = 2;
      bd0.position.setFrom$1(y);
      this.world.createBody$1(bd0).createFixture$1(fixDef0);
      y.addLocal$1(deltaY);
    }
    x.addLocal$1(deltaX);
  }
...
Isolate.$defineClass("_VariableSizeListIterator", "Object", [], {
 ...
 get$next: function() { return new $.Closure34(this); },
 hasNext$0: function() {
...
Isolate.$defineClass("Distance", "Object", ["normal?", "temp", "searchDirection", "closestPoint", "saveB", "saveA", "simplex", "maxIters", "iters", "calls"], {
 ...
 get$distance: function() { return new $.Closure35(this); }
});
...
Isolate.$defineClass("TimeOfImpact", "Object", ["pool", "sweepB?", "sweepA?", "indexes", "fcn", "distanceOutput", "xfB", "xfA", "distanceInput", "cache"], {
 ...
 get$timeOfImpact: function() { return new $.Closure36(this); },
...
$.Bench2d$0 = function() {
  var t0 = new $.Bench2d((void 0), (void 0), (void 0), (void 0), (void 0));
  t0.Bench2d$0();
  return t0;
};
...
_ConsoleImpl.get$count = function() { return new $.Closure13(this); };
...
$.$defineNativeClass('DOMStringList', ["length?"], {
 ...
 get$filter: function() { return new $.Closure14(this); },
 forEach$1: function(f) {
...
$.$defineNativeClass('IDBIndex', [], {
 ...
 get$count: function() { return new $.Closure19(this); }
});
...
$.$defineNativeClass('IDBObjectStore', [], {
 ...
 get$count: function() { return new $.Closure20(this); },
 clear$0: function() {
  return this.clear();
 },
...
$.$defineNativeClass('HTMLInputElement', ["type=", "pattern?"], {
...
$.$defineNativeClass('Int16Array', ["length?"], {
 ...
 get$filter: function() { return new $.Closure21(this); },
 forEach$1: function(f) {
  return $.forEach3(this, f);
 },
 add$1: function(value) {
