...
$$._WorkerSendPort_send_anon = {"":
 ...
 call$0: function() {
  ...
  if ($._globalState0().get$isWorker() === true)
    ...
    $.index($._globalState0().get$managers(), t1.get$_workerId()).postMessage$1(workerMessage);
}
};
...
$$._NativeJsSendPort_send_anon = {"":
 ...
 call$0: function() {
  ...
  var isolate = $.index($._globalState0().get$isolates(), t2.get$_isolateId());
  if (isolate == null)
    return;
  if (t2.get$_receivePort().get$_callback() == null)
    return;
  var shouldSerialize = !($._globalState0().get$currentContext() == null) && !$.eqB($._globalState0().get$currentContext().get$id(), t2.get$_isolateId());
  ...
  $._globalState0().get$topEventLoop().enqueue$3(isolate, new $._NativeJsSendPort_send_anon0(t2, t1, shouldSerialize), 'receive ' + $.S(msg));
}
};
...
$.CTC20 = 'Incorrect number or type of arguments';
...
$.CTC21 = 'Cannot setRange on immutable List.';
$.CTC13 = new Isolate.$isolateProperties.UnsupportedOperationException('Cannot setRange on immutable List.');
...
$.CTC23 = 'Cannot sort immutable List.';
