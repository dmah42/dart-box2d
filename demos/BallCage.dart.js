...
$$.BallCage = {"":
 ...
 initialize$0: function() {
  ...
  for (var t1 = this.world, t2 = this.bodies, i = 0; i < 10; ++i) {
    var t3 = $.mul($.mul(circleShape.radius, 2), i);
    if (typeof t3 !== 'number')
      throw $.iae(t3);
    var shiftX = -20 + t3;
    t3 = $.mul($.mul(circleShape.radius, 2), i);
    if (typeof t3 !== 'number')
      throw $.iae(t3);
    var shiftY = -20 + t3;
...
$.BallCage_main = function() {
  var cage = $.BallCage$();
  cage.initialize$0();
  cage.initializeAnimation$0();
  cage.runAnimation$0();
};
...
$.BallCage$ = function() {
  var t1 = new $.BallCage($.ListImplementation_List(null, 'Body'), null, null, null, null, null, null, null, null, null, 10, $.throwNoSuchMethod('', 'constructorClosure: () => String from Function \'slowToString\':.', []));
  t1.Demo$3('Ball cage', null, 10);
  return t1;
};
...
//@ sourceMappingURL=BallCage.dart.js.map