...
$$.BallCage = {"":
 ...
 initialize$0: function() {
  ...
  for (t1 = this.world, t2 = this.bodies, i = 0; $.ltB(i, 10); i = $.intTypeCheck($.add(i, 1))) {
    var t3 = circleShape.radius * 2;
    if (typeof i !== 'number') throw $.iae(i);
    t3 *= i;
    if (typeof t3 !== 'number') throw $.iae(t3);
    var shiftX = -20 + t3;
    t3 = circleShape.radius * 2;
    if (typeof i !== 'number') throw $.iae(i);
    t3 *= i;
    if (typeof t3 !== 'number') throw $.iae(t3);
    var shiftY = -20 + t3;
    circleBodyDef.position = $.Vector$(shiftX, -20);
    var circleBody = $.propertyTypeCheck(t1.createBody$1(circleBodyDef), 'is$Body');
    t2.push(circleBody);
    circleBody.createFixture$1(circleFixtureDef);
    circleBodyDef.position = $.Vector$(shiftX, borderLimitX);
    circleBody = $.propertyTypeCheck(t1.createBody$1(circleBodyDef), 'is$Body');
    t2.push(circleBody);
    circleBody.createFixture$1(circleFixtureDef);
