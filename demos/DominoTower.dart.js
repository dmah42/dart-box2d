...
$$.DominoTower = {"":
 ["dominoDensity", "fps", "frameCount", "world", "debugDraw", "viewport", "ctx", "canvas", "bodies"],
 super: "Demo",
 initialize$0: function() {
  ...
  var b = $.propertyTypeCheck(t1.createBody$1(bd), 'is$Body');
  t2.push(b);
  ...
  b = $.propertyTypeCheck(t1.createBody$1(bd), 'is$Body');
  t2.push(b);
  b.createFixture$1(fd);
  ...
  for (var j = 1, currX = 18.75; $.ltB(j, 25); j = $.intTypeCheck($.add(j, 1))) {
    ...
    for (t1 = 25 - j, t2 = 1.5 * t1 / 2, t3 = currY - 0.2, t4 = t1 - 1, t5 = currY + 0.6, t6 = currY - 0.6, i = 0; $.ltB(i, t1); i = $.intTypeCheck($.add(i, 1))) {
      currX = $.numTypeCheck($.sub($.mul($.mul(i, 1.5), 1), t2));
      this.dominoDensity = $.mul(this.dominoDensity, 2.5);
      $.eqB(i, 0) && this.makeDomino$3($.add($.sub(currX, 1.25), 0.1), t3, false);
      $.eqB(i, t4) && this.makeDomino$3($.sub($.add(currX, 1.25), 0.1), t3, false);
...
$$.PolygonShape = {"":
 ...
 computeAxisAlignedBox$2: function(argAabb, argXf) {
  ...
  t2 = $.add(upper.y, t2);
  argAabb.get$upperBound().set$y(t2);
 },
...
$.DominoTower$ = function() {
  var t1 = $.ListFactory_List(null);
  $.setRuntimeTypeInfo(t1, ({E: 'Body'}));
  t1 = new $.DominoTower(null, null, null, null, null, null, null, null, t1);
  t1.Demo$0();
  return t1;
};
