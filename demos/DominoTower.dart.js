...
Isolate.$defineClass("DominoTower", "Demo", ["dominoDensity", "fps", "frameCount", "world", "debugDraw", "viewport", "ctx", "canvas", "bodies"], {
 initialize$0: function() {
  ...
  for (var i = 0, currX = (void 0); i < 25; i = i0) {
    var currX0 = i * 1.5 * 1 - 18.75;
    this.makeDomino$3(currX0, 0.5, false);
    this.makeDomino$3(currX0, 1.1, true);
    currX = currX0;
    var i0 = i + 1;
  }
  for (var j = 1, currX1 = 18.75; j < 25; j = j + 1, currX1 = currX2) {
    ...
    var t2 = currY - 0.2;
    var t3 = 25 - j;
    for (var t4 = 1.5 * t3 / 2, t5 = t3 - 1, currX3 = currX1, i1 = 0; i1 < t3; currX3 = currX4, i1 = i2) {
      var currX4 = currX3;
      var currX5 = i1 * 1.5 * 1 - t4;
      this.dominoDensity = $.mul(this.dominoDensity, 2.5);
      if (i1 === 0) {
        this.makeDomino$3(currX5 - 1.25 + 0.1, t2, false);
      }
      if (i1 === t5) {
        this.makeDomino$3(currX5 + 1.25 - 0.1, t2, false);
      }
      this.dominoDensity = $.div(this.dominoDensity, 2.5);
      this.makeDomino$3(currX5, currY, false);
      this.makeDomino$3(currX5, t1, true);
      this.makeDomino$3(currX5, t0, true);
      currX4 = currX5;
      var i2 = i1 + 1;
    }
    currX2 = currX3;
...
$.DominoTower$0 = function() {
  var t0 = $.List((void 0));
  $.setRuntimeTypeInfo(t0, ({E: 'Body'}));
  var t1 = new $.DominoTower((void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), t0);
  t1.Demo$0();
  return t1;
};
