...
$$.HashMapImplementation = {"":
 ...
 _probeForAdding$1: function(key) {
  ...
  for (var numberOfProbes = 1, insertionIndex = -1; true;) {
    ...
    if (existingKey == null) {
      ...
      return hash;
    else if (insertionIndex < 0 && $.CTC24 === existingKey)
      insertionIndex = hash;
          ...
          switch (state) {
            ...
            case 3:
              ...
              if (existingKey == null) {
                ...
                return hash;
              else if ($.ltB(insertionIndex, 0) && $.CTC24 === existingKey)
                insertionIndex = hash;
              var numberOfProbes0 = numberOfProbes + 1;
              hash = $.HashMapImplementation__nextProbe(hash, numberOfProbes, $.get$length(this._keys));
            case 4:
 ...
 remove$1: function(key) {
  ...
  if ($.geB(index, 0)) {
    ...
    $.indexSet(this._keys, index, $.CTC24);
...
$$.BoxTest = {"":
 ...
 _createGround$0: function() {
  ...
  shape.setAsBoxWithCenterAndAngle$4(0.4, 50.0, $.Vector$(-10.0, 0.0), 0.0);
  ground.createFixtureFromShape$1(shape);
  shape.setAsBoxWithCenterAndAngle$4(0.4, 50.0, $.Vector$(10.0, 0.0), 0.0);
  ground.createFixtureFromShape$1(shape);
 ...
 _createBox$0: function() {
  var shape = $.PolygonShape$();
  shape.setAsBoxWithCenterAndAngle$4(3.0, 1.5, $.Vector$(0, 0), 1.5707963267948966);
  ...
  var bodyDef = $.BodyDef$();
  bodyDef.type = 2;
  bodyDef.position = $.Vector$(0, 30.0);
...
$.BoxTest$ = function() {
  var t1 = new $.BoxTest($.ListImplementation_List(null, 'Body'), null, null, null, null, null, null, null, null, null, 10, $.StopwatchImplementation$start());
...
$.CTC24 = new Isolate.$isolateProperties._DeletedKeySentinel();
