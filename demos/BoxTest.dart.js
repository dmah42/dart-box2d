...
$$.BoxTest = {"":
 ["bodies", "canvas", "ctx", "viewport", "debugDraw", "world", "frameCount", "fpsCounter", "elapsedUs", "worldStepTime", "viewportScale", "_stopwatch"],
 "super": "Demo",
 ...
 _createGround$0: function() {
  ...
  var ground = this.world.createBody$1(bodyDef);
  shape.setAsBox$2(50, 0.4);
  ground.createFixtureFromShape$1(shape);
  shape.setAsBoxWithCenterAndAngle$4(0.4, 50, $.Vector$(-10, 0), 0);
  ground.createFixtureFromShape$1(shape);
  shape.setAsBoxWithCenterAndAngle$4(0.4, 50, $.Vector$(10, 0), 0);
  ground.createFixtureFromShape$1(shape);
 ...
 _createBox$0: function() {
  var shape = $.PolygonShape$();
  shape.setAsBoxWithCenterAndAngle$4(3, 1.5, $.Vector$(0, 0), 1.5707963267948966);
...
$$.Demo = {"":
 ["bodies?", "debugDraw!", "frameCount=", "fpsCounter?", "elapsedUs?", "worldStepTime?"],
 "super": "Object",
...
$$.PolygonShape = {"":
 ...
 setAsBoxWithCenterAndAngle$4: function(hx, hy, center, angle) {
  ...
  for (var i = 0; $.ltB(i, this.vertexCount); ++i) {
    ...
    if (i < 0 || i >= t1.length)
      throw $.ioore(i);
    $.Transform_mulToOut(xf, t2, t1[i]);
    if (i < 0 || i >= t3.length)
      throw $.ioore(i);
    t2 = t3[i];
    if (i < 0 || i >= t3.length)
      throw $.ioore(i);
    $.Matrix22_mulMatrixAndVectorToOut(t4, t2, t3[i]);
  }
},
...
$$.World = {"":
 ...
 step$3: function(dt, velocityIterations, positionIterations) {
  ...
  if ($.gtB(t1.get$dt(), 0))
    this.solve$1(t1);
  if (this._continuousPhysics === true && $.gtB(t1.get$dt(), 0))
  ...
  if ((drawFlags & 4) === 4) {
    ...
    for (b = this._bodyList, t1 = !(0 === (drawFlags & 64)); !(b == null); b = b.get$next()) {
      ...
      for (f = b.get$fixtureList(); !(f == null); f = f.get$next()) {
        ...
        var vs = $.ListImplementation_List(4, 'Vector');
 ...
 drawShape$3: function(fixture, xf, color) {
  switch (fixture.get$type()) {
    ...
    case 1:
      ...
      var vertices = $.ListImplementation_List(vertexCount, 'Vector');
      for (var i = 0; $.ltB(i, vertexCount); ++i) {
        t1 = $.Vector$(0, 0);
        if (i < 0 || i >= vertices.length)
          throw $.ioore(i);
...
$$.Demo_initializeAnimation_anon = {"":
 ...
 call$0: function() {
  var t1 = this.this_0;
  var t2 = $.toString(t1.get$frameCount());
...
$$.Demo_initializeAnimation_anon0 = {"":
 ...
 call$0: function() {
  var t1 = this.this_1;
  var t2 = $.S($.div(t1.get$elapsedUs(), 1000)) + ' ms';
...
$.BoxTest$ = function() {
  var t1 = new $.BoxTest($.ListImplementation_List(null, 'Body'), null, null, null, null, null, null, null, null, null, 10, $.throwNoSuchMethod('', 'constructorClosure: () => String from Function \'slowToString\':.', []));
...
$.CanvasViewportTransform$ = function(extents, center) {
  return new $.CanvasViewportTransform($.Vector$copy(extents), $.Vector$copy(center), 20);
};
...
$.Futures_wait = function(futures) {
  ...
  if ($.isEmpty(futures) === true)
    return $.FutureImpl_FutureImpl$immediate($.CTC0, 'List');
