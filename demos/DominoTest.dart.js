...
$$.DominoTest = {"":
 ...
 initialize$0: function() {
  ...
  bd = $.BodyDef$();
  bd.type = 2;
  for (var t3 = 25 - 1, t4 = 29.5 / t3, i = 0; $.ltB(i, 4); i = $.intTypeCheck($.add(i, 1))) {
    for (var j = 0; $.ltB(j, 25); j = $.intTypeCheck($.add(j, 1))) {
      ...
      t5 += -14.75;
      if (typeof i !== 'number') throw $.iae(i);
      bd.position = $.Vector$(t5, 7.3 + 5 * i);
      if (i === 2 && $.eqB(j, 0)) {
        bd.angle = -0.1;
        t5 = bd.position;
        t5.set$x($.add(t5.get$x(), 0.1));
      } else {
        if (i === 3 && $.eqB(j, t3)) {
          bd.angle = 0.1;
          t5 = bd.position;
      ...
      var myBody = $.propertyTypeCheck(t1.createBody$1(bd), 'is$Body');
...
$.DominoTest$ = function() {
  var t1 = $.ListFactory_List(null);
  $.setRuntimeTypeInfo(t1, ({E: 'Body'}));
  t1 = new $.DominoTest(null, null, null, null, null, null, null, t1);
  t1.Demo$0();
  return t1;
};
