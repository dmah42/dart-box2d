...
$$.PolygonShape = {"":
 ...
 setAsBox$2: function(hx, hy) {
  ...
  t4 = this.vertices;
  var t6 = t4.length;
  if (2 >= t6) throw $.ioore(2);
  t4[2].setCoords$2(hx, hy);
  var t7 = this.vertices;
  var t8 = t7.length;
  if (3 >= t8) throw $.ioore(3);
  t7[3].setCoords$2(t3, hy);
  t3 = this.normals;
  var t9 = t3.length;
  if (0 >= t9) throw $.ioore(0);
  t3[0].setCoords$2(0.0, -1.0);
  var t10 = this.normals;
  var t11 = t10.length;
  if (1 >= t11) throw $.ioore(1);
  t10[1].setCoords$2(1.0, 0.0);
  var t12 = this.normals;
  var t13 = t12.length;
  if (2 >= t13) throw $.ioore(2);
  t12[2].setCoords$2(0.0, 1.0);
  var t14 = this.normals;
  var t15 = t14.length;
  if (3 >= t15) throw $.ioore(3);
  t14[3].setCoords$2(-1.0, 0.0);
