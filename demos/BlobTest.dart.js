...
Isolate.$defineClass("BlobTest", "Demo", ["fps", "frameCount", "world", "debugDraw", "viewport", "ctx", "canvas", "bodies"], {
 initialize$0: function() {
  var sd = $.PolygonShape$0();
  sd.setAsBox$2(50.0, 0.4);
  var bd = $.BodyDef$0();
  bd.position.setCoords$2(0.0, 0.0);
  $.assert(!$.eqNullB(this.world));
  var ground = this.world.createBody$1(bd);
  $.add$1(this.bodies, ground);
  ground.createFixtureFromShape$1(sd);
  sd.setAsBoxWithCenterAndAngle$4(0.4, 50.0, $.Vector$2(-10.0, 0.0), 0.0);
  ground.createFixtureFromShape$1(sd);
  sd.setAsBoxWithCenterAndAngle$4(0.4, 50.0, $.Vector$2(10.0, 0.0), 0.0);
  ground.createFixtureFromShape$1(sd);
  var cvjd = $.ConstantVolumeJointDef$0();
  for (var i = 0; i < 20; i = i + 1) {
    var angle = $.translateAndScale(i, 0, 20, 0, 6.283185307179586);
    var bd0 = $.BodyDef$0();
    bd0.fixedRotation = true;
    var x = 0.0 + $.mul(5.0, $.sin(angle));
    var y = 10.0 + $.mul(5.0, $.cos(angle));
    bd0.position.setFrom$1($.Vector$2(x, y));
    bd0.type = 2;
    var body = this.world.createBody$1(bd0);
  ...
  var bd2 = $.BodyDef$0();
  bd2.type = 2;
  var psd = $.PolygonShape$0();
  var t0 = 10.0 + 15.0;
  psd.setAsBoxWithCenterAndAngle$4(3.0, 1.5, $.Vector$2(0.0, t0), 0.0);
  bd2.position = $.Vector$2(0.0, t0);
  var fallingBox = this.world.createBody$1(bd2);
  $.add$1(this.bodies, fallingBox);
...
Isolate.$defineClass("PolygonShape", "Shape", ["vertexCount?", "normals?", "vertices?", "centroid?", "radius", "type"], {
 ...
 setAsBoxWithCenterAndAngle$4: function(hx, hy, center, angle) {
  ...
  for (var i = 0; $.ltB(i, this.vertexCount); i = i + 1) {
    $.mulToOut(xf, $.index(this.vertices, i), $.index(this.vertices, i));
    $.mulMatrixAndVectorToOut(xf.rotation, $.index(this.normals, i), $.index(this.normals, i));
  }
 },
...
Isolate.$defineClass("ConstantVolumeJointDef", "JointDef", ["joints?", "bodies?", "dampingRatio?", "frequencyHz?", "collideConnected", "bodyB", "bodyA", "userData", "type"], {
 addBody$1: function(argBody) {
  $.add$1(this.bodies, argBody);
  if ($.eqB($.get$length(this.bodies), 1)) {
    this.bodyA = argBody;
  } else {
    if ($.eqB($.get$length(this.bodies), 2)) {
      this.bodyB = argBody;
    }
  }
 },
...
$.ConstantVolumeJointDef$0 = function() {
  var t0 = $.List((void 0));
  $.setRuntimeTypeInfo(t0, ({E: 'Body'}));
  var t1 = new $.ConstantVolumeJointDef((void 0), t0, 0.0, 0.0, false, (void 0), (void 0), (void 0), 0);
...
$.BlobTest$0 = function() {
  var t0 = $.List((void 0));
  $.setRuntimeTypeInfo(t0, ({E: 'Body'}));
  var t1 = new $.BlobTest((void 0), (void 0), (void 0), (void 0), (void 0), (void 0), (void 0), t0);
  t1.Demo$0();
  return t1;
};
...
$.translateAndScale = function(val, fromMin, fromMax, toMin, toMax) {
