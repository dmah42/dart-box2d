...
$$.BlobTest = {"":
 ...
 initialize$0: function() {
  ...
  for (var i = 0; i < 20; ++i) {
    ...
    var t3 = $.Math_sin(angle);
    if (typeof t3 !== 'number') throw $.iae(t3);
    var x = 0.0 + 5.0 * t3;
    var t4 = $.Math_cos(angle);
  ...
  t1.createJoint$1(cvjd);
  var bd2 = $.BodyDef$();
  bd2.type = 2;
  var psd = $.PolygonShape$();
  t3 = 10.0 + 15.0;
  psd.setAsBoxWithCenterAndAngle$4(3.0, 1.5, $.Vector$(0.0, t3), 0.0);
  bd2.position = $.Vector$(0.0, t3);
  var fallingBox = t1.createBody$1(bd2);
  t2.push(fallingBox);
...
$$.ConstantVolumeJointDef = {"":
 ...
 addBody$1: function(argBody) {
  ...
  t1.push(argBody);
  var t2 = t1.length;
  if (t2 === 1) this.bodyA = argBody;
  else {
    t1 = t1.length;
    if (t1 === 2) this.bodyB = argBody;
  }
 },
