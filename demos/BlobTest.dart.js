...
$$.HashMapImplementation = {"":
 ...
 operator$indexSet$2: function(key, value) {
  ...
  if ($.index(this._keys, index) == null || $.index(this._keys, index) === $.CTC9) this._numberOfEntries = $.add(this._numberOfEntries, 1);
...
$$.BlobTest = {"":
 ["_stopwatch", "viewportScale", "worldStepTime", "elapsedUs", "fpsCounter", "frameCount", "world", "debugDraw", "viewport", "ctx", "canvas", "bodies"],
 super: "Demo",
...
$$.ConstantVolumeJointDef = {"":
 ...
 addBody$1: function(argBody) {
  var t1 = this.bodies;
  t1.push(argBody);
  if (t1.length === 1) this.bodyA = argBody;
  else {
    if (t1.length === 2) this.bodyB = argBody;
  }
 },
...
$.BlobTest$ = function() {
  var t1 = $.ListFactory_List(null);
  $.setRuntimeTypeInfo(t1, ({E: 'Body'}));
  t1 = new $.BlobTest($.StopwatchImplementation$start(), 10, null, null, null, null, null, null, null, null, null, t1);
  t1.Demo$3('Blob test', null, 10);
  return t1;
};
