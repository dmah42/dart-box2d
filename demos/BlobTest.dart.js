...
$$.BlobTest = {"":
 ...
 initialize$0: function() {
  ...
  var t1 = this.world;
  $.assert(!(t1 === null));
  var ground = $.propertyTypeCheck(t1.createBody$1(bd), 'is$Body');
  var t2 = this.bodies;
  t2.push(ground);
  ...
  for (var i = 0; $.ltB(i, 20); i = $.intTypeCheck($.add(i, 1))) {
    var angle = $.numTypeCheck($.MathBox_translateAndScale(i, 0, 20, 0, 6.283185307179586));
    bd = $.BodyDef$();
    ...
    bd.type = 2;
    var body = $.propertyTypeCheck(t1.createBody$1(bd), 'is$Body');
    t2.push(body);
    var fd = $.FixtureDef$();
    var cd = $.CircleShape$();
    cd.radius = 0.5;
  ...
  var fallingBox = $.propertyTypeCheck(t1.createBody$1(bd2), 'is$Body');
  t2.push(fallingBox);
...
$$.PolygonShape = {"":
 ...
 setAsBoxWithCenterAndAngle$4: function(hx, hy, center, angle) {
  $.numTypeCheck(hx);
  $.numTypeCheck(hy);
  $.propertyTypeCheck(center, 'is$Vector');
  $.numTypeCheck(angle);
  this.vertexCount = 4;
  var t1 = this.vertices;
  var t2 = t1.length;
  ...
  for (var i = 0; $.ltB(i, this.vertexCount); i = $.intTypeCheck($.add(i, 1))) {
    if (i !== (i | 0)) throw $.iae(i);
    t2 = t1.length;
    if (i < 0 || i >= t2) throw $.ioore(i);
    t3 = t1[i];
...
$$.CanvasDraw = {"":
 ...
 set$_color: function(color) {
  $.propertyTypeCheck(color, 'is$Color3');
  var t1 = this.ctx;
 ...
 drawSegment$3: function(p1, p2, color) {
  $.propertyTypeCheck(p1, 'is$Vector');
  $.propertyTypeCheck(p2, 'is$Vector');
  this.set$_color($.propertyTypeCheck(color, 'is$Color3'));
 ...
 drawSolidCircle$4: function(center, radius, axis, color) {
  $.propertyTypeCheck(center, 'is$Vector');
  $.numTypeCheck(radius);
  $.propertyTypeCheck(axis, 'is$Vector');
  this.set$_color($.propertyTypeCheck(color, 'is$Color3'));
  this.getWorldToScreenToOut$2(center, center);
  radius = $.numTypeCheck($.mul(radius, this.viewportTransform.get$scale()));
  var t1 = this.ctx;
  t1.beginPath$0();
 ...
 drawSolidPolygon$3: function(vertices, vertexCount, color) {
  $.listTypeCheck(vertices);
  if (typeof vertices !== 'object' || vertices === null || (vertices.constructor !== Array && !vertices.is$JavaScriptIndexingBehavior())) return this.drawSolidPolygon$3$bailout(1, vertexCount, color, vertices);
  $.intTypeCheck(vertexCount);
  this.set$_color($.propertyTypeCheck(color, 'is$Color3'));
  for (var i = 0; $.ltB(i, vertexCount); i = $.intTypeCheck($.add(i, 1))) {
    if (i !== (i | 0)) throw $.iae(i);
  ...
  for (i = 1; $.ltB(i, vertexCount); i = $.intTypeCheck($.add(i, 1))) {
    if (i !== (i | 0)) throw $.iae(i);
    t2 = vertices.length;
    if (i < 0 || i >= t2) throw $.ioore(i);
    t3 = vertices[i].get$x();
 ...
 drawSolidPolygon$3$bailout: function(state, vertexCount, color, vertices) {
  $.intTypeCheck(vertexCount);
  this.set$_color($.propertyTypeCheck(color, 'is$Color3'));
  for (var i = 0; $.ltB(i, vertexCount); i = $.intTypeCheck($.add(i, 1))) {
 ...
 drawPolygon$3: function(vertices, vertexCount, color) {
  $.listTypeCheck(vertices);
  if (typeof vertices !== 'object' || vertices === null || (vertices.constructor !== Array && !vertices.is$JavaScriptIndexingBehavior())) return this.drawPolygon$3$bailout(1, vertexCount, color, vertices, 0);
  $.intTypeCheck(vertexCount);
  if (vertexCount !== (vertexCount | 0)) return this.drawPolygon$3$bailout(2, color, vertices, vertexCount, 0);
  $.propertyTypeCheck(color, 'is$Color3');
  if (vertexCount === 1) {
    var t1 = vertices.length;
 ...
 drawPolygon$3$bailout: function(state, env0, env1, env2, env3) {
  switch (state) {
    case 1:
      var vertexCount = env0;
      var color = env1;
      var vertices = env2;
      break;
    case 2:
      ...
      L0: while (true) {
        switch (state) {
          case 0:
            ...
            this.drawSegment$3($.index(vertices, i), $.index(vertices, $.add(i, 1)), color);
            i = $.intTypeCheck($.add(i, 1));
          case 3:
            state = 0;
        }
...
$$.DebugDraw = {"":
 ...
 getWorldToScreenToOut$2: function(argWorld, argScreen) {
  $.propertyTypeCheck(argWorld, 'is$Vector');
  $.propertyTypeCheck(argScreen, 'is$Vector');
...
$$.World = {"":
 ...
 drawJoint$1: function(joint) {
  $.propertyTypeCheck(joint, 'is$Joint');
  var bodyA = $.propertyTypeCheck(joint.get$bodyA(), 'is$Body');
  var bodyB = $.propertyTypeCheck(joint.get$bodyB(), 'is$Body');
  var xf1 = $.propertyTypeCheck(bodyA.get$originTransform(), 'is$Transform');
  var xf2 = $.propertyTypeCheck(bodyB.get$originTransform(), 'is$Transform');
  var x1 = $.propertyTypeCheck(xf1.get$position(), 'is$Vector');
  var x2 = $.propertyTypeCheck(xf2.get$position(), 'is$Vector');
  var p1 = $.Vector$(0, 0);
  var p2 = $.Vector$(0, 0);
 ...
 drawShape$3: function(fixture, xf, color) {
  $.propertyTypeCheck(fixture, 'is$Fixture');
  $.propertyTypeCheck(xf, 'is$Transform');
  $.propertyTypeCheck(color, 'is$Color3');
  switch (fixture.get$type()) {
    case 0:
      ...
      var radius = $.numTypeCheck(circle.get$radius());
      t1 = this.axis;
    ...
    case 1:
      ...
      var vertexCount = $.intTypeCheck(poly.get$vertexCount());
      $.assert($.le(vertexCount, 8));
      var vertices = $.ListFactory_List(vertexCount);
      $.setRuntimeTypeInfo(vertices, ({E: 'Vector'}));
      for (var i = 0; $.ltB(i, vertexCount); i = $.intTypeCheck($.add(i, 1))) {
        $.indexSet(vertices, i, $.Vector$(0, 0));
      }
      for (i = 0; $.ltB(i, vertexCount); i = $.intTypeCheck($.add(i, 1))) {
        t1 = $.index(poly.get$vertices(), i);
        $.assert(!(t1 == null));
        t2 = $.index(vertices, i);
        $.assert(!(t2 == null));
        $.Transform_mulToOut(xf, $.index(poly.get$vertices(), i), $.index(vertices, i));
      }
 ...
 drawDebugData$0: function() {
  ...
  if (t1 == null) return;
  var drawFlags = $.intTypeCheck(t1.get$drawFlags());
  if ($.eqB($.and(drawFlags, 1), 1)) {
    var xf = $.Transform$();
    var color = $.Color3$();
    for (var b = $.propertyTypeCheck(this._bodyList, 'is$Body'); !(b == null); b = $.propertyTypeCheck(b.get$next(), 'is$Body')) {
      xf.setFrom$1(b.get$originTransform());
      for (var f = $.propertyTypeCheck(b.get$fixtureList(), 'is$Fixture'); !(f == null); f = $.propertyTypeCheck(f.get$next(), 'is$Fixture')) {
  ...
  if ($.eqB($.and(drawFlags, 2), 2)) {
    for (var j = $.propertyTypeCheck(this._jointList, 'is$Joint'); !(j == null); j = $.propertyTypeCheck(j.get$_lib0_next(), 'is$Joint')) {
      this.drawJoint$1(j);
    }
  }
  if ($.eqB($.and(drawFlags, 8), 8)) {
    color = $.Color3$fromRGB(0.3, 0.9, 0.9);
    for (var c = $.propertyTypeCheck(this._contactManager.get$contactList(), 'is$Contact'), t1 = this.cA, t2 = this.cB; !(c == null); c = $.propertyTypeCheck(c.get$next(), 'is$Contact')) {
      var fixtureA = $.propertyTypeCheck(c.get$fixtureA(), 'is$Fixture');
      var fixtureB = $.propertyTypeCheck(c.get$fixtureB(), 'is$Fixture');
  ...
  if ($.eqB($.and(drawFlags, 4), 4)) {
    ...
    for (b = $.propertyTypeCheck(this._bodyList, 'is$Body'); !(b == null); b = $.propertyTypeCheck(b.get$next(), 'is$Body')) {
      ...
      for (f = $.propertyTypeCheck(b.get$fixtureList(), 'is$Fixture'); !(f == null); f = $.propertyTypeCheck(f.get$next(), 'is$Fixture')) {
        var aabb = $.propertyTypeCheck(f.get$proxy().get$box(), 'is$AxisAlignedBox');
        var vs = $.ListFactory_List(4);
        $.setRuntimeTypeInfo(vs, ({E: 'Vector'}));
        for (var i = 0; $.ltB(i, vs.length); i = $.intTypeCheck($.add(i, 1))) {
          t1 = $.Vector$(0, 0);
          if (i !== (i | 0)) throw $.iae(i);
          t2 = vs.length;
          if (i < 0 || i >= t2) throw $.ioore(i);
  ...
  if ($.eqB($.and(drawFlags, 16), 16)) {
    xf = $.Transform$();
    for (b = $.propertyTypeCheck(this._bodyList, 'is$Body'), t1 = xf.position; !(b == null); b = $.propertyTypeCheck(b.get$next(), 'is$Body')) {
      xf.setFrom$1(b.get$originTransform());
 ...
 set$debugDraw: function(debugDraw) {
  this._debugDraw = $.propertyTypeCheck(debugDraw, 'is$DebugDraw');
 },
...
$$.Joint = {"":
 ...
 getAnchorB$1: function(argOut) {
  $.propertyTypeCheck(argOut, 'is$Vector');
 },
...
$$.ConstantVolumeJointDef = {"":
 ...
 addBody$1: function(argBody) {
  $.propertyTypeCheck(argBody, 'is$Body');
  var t1 = this.bodies;
  t1.push(argBody);
  var t2 = t1.length;
 ...
 is$ConstantVolumeJointDef: true
};
...
$$.Color3 = {"":
 ...
 setFrom$1: function(argColor) {
  $.propertyTypeCheck(argColor, 'is$Color3');
...
$$.CanvasViewportTransform = {"":
 ...
 getWorldToScreen$2: function(argWorld, argScreen) {
  ...
  var t2 = this.extents;
  var gridCorrectedX = $.numTypeCheck($.add(t1, t2.get$x()));
  var gridCorrectedY = $.numTypeCheck($.sub(t2.get$y(), $.mul(argWorld.get$y(), this.scale)));
...
$.Color3$fromRGB = function(r, g, b) {
  $.numTypeCheck(r);
  $.numTypeCheck(g);
  return new $.Color3($.numTypeCheck(b), g, r);
};
...
$.CanvasViewportTransform$ = function(extents, center) {
  $.propertyTypeCheck(extents, 'is$Vector');
  $.propertyTypeCheck(center, 'is$Vector');
...
$.CanvasDraw$ = function(viewport, ctx) {
  return new $.CanvasDraw(ctx, $.propertyTypeCheck(viewport, 'is$IViewportTransform'), 1);
};
...
$.MathBox_translateAndScale = function(val, fromMin, fromMax, toMin, toMax) {
  $.numTypeCheck(val);
  $.numTypeCheck(fromMin);
  $.numTypeCheck(fromMax);
  $.numTypeCheck(toMin);
  $.numTypeCheck(toMax);
  return $.numTypeCheck($.add(toMin, $.mul($.numTypeCheck($.div($.sub(val, fromMin), $.sub(fromMax, fromMin))), $.sub(toMax, toMin))));
};
...
$.defineProperty(Object.prototype, 'is$_DirectoryEntryImpl', function() { return false; });
$.defineProperty(Object.prototype, 'is$_DirectoryEntrySyncImpl', function() { return false; });
...
$.$defineNativeClass('WebKitCSSMatrix', ["a="], {
 ...
 scale$3: function(scaleX, scaleY, scaleZ) {
  return this.scale($.numTypeCheck(scaleX),$.numTypeCheck(scaleY),$.numTypeCheck(scaleZ));
 },
...
$.$defineNativeClass('CSSStyleDeclaration', ["length?"], {
 ...
 setProperty$3: function(propertyName, value, priority) {
  return this.setProperty($.stringTypeCheck(propertyName),$.stringTypeCheck(value),$.stringTypeCheck(priority));
 },
...
$.$defineNativeClass('HTMLCanvasElement', ["width!", "height!"], {
 getContext$1: function(contextId) {
  return this.getContext($.stringTypeCheck(contextId));
 },
 is$Node: function() { return true; }
});
...
$.$defineNativeClass('CanvasRenderingContext2D', ["font!"], {
 ...
 setStrokeColor$5: function(c_OR_color_OR_grayLevel_OR_r, alpha_OR_g_OR_m, b_OR_y, a_OR_k, a) {
  return this.setStrokeColor(c_OR_color_OR_grayLevel_OR_r,$.numTypeCheck(alpha_OR_g_OR_m),$.numTypeCheck(b_OR_y),$.numTypeCheck(a_OR_k),$.numTypeCheck(a));
 },
 ...
 setFillColor$5: function(c_OR_color_OR_grayLevel_OR_r, alpha_OR_g_OR_m, b_OR_y, a_OR_k, a) {
  return this.setFillColor(c_OR_color_OR_grayLevel_OR_r,$.numTypeCheck(alpha_OR_g_OR_m),$.numTypeCheck(b_OR_y),$.numTypeCheck(a_OR_k),$.numTypeCheck(a));
 },
 ...
 scale$2: function(sx, sy) {
  return this.scale($.numTypeCheck(sx),$.numTypeCheck(sy));
 },
 get$scale: function() { return new $.BoundClosure1(this, 'scale$2'); },
 moveTo$2: function(x, y) {
  return this.moveTo($.numTypeCheck(x),$.numTypeCheck(y));
 },
 lineTo$2: function(x, y) {
  return this.lineTo($.numTypeCheck(x),$.numTypeCheck(y));
 },
 fillText$4: function(text, x, y, maxWidth) {
  return this.fillText($.stringTypeCheck(text),$.numTypeCheck(x),$.numTypeCheck(y),$.numTypeCheck(maxWidth));
 },
 ...
 clearRect$4: function(x, y, width, height) {
  return this.clearRect($.numTypeCheck(x),$.numTypeCheck(y),$.numTypeCheck(width),$.numTypeCheck(height));
 },
 beginPath$0: function() {
  return this.beginPath();
 },
 arc$6: function(x, y, radius, startAngle, endAngle, anticlockwise) {
  return this.arc($.numTypeCheck(x),$.numTypeCheck(y),$.numTypeCheck(radius),$.numTypeCheck(startAngle),$.numTypeCheck(endAngle),$.boolTypeCheck(anticlockwise));
 }
});
...
$.$defineNativeClass('Entry', [], {
 moveTo$4: function(parent, name, successCallback, errorCallback) {
  $.callTypeCheck(parent, 'is$_DirectoryEntryImpl');
  $.stringTypeCheck(name);
...
$.$defineNativeClass('EntrySync', [], {
 ...
 moveTo$2: function(parent, name) {
  return this.moveTo($.callTypeCheck(parent, 'is$_DirectoryEntrySyncImpl'),$.stringTypeCheck(name));
 }
});
...
$.$defineNativeClass('HTMLInputElement', ["width!", "value=", "type?", "height!"], {
 step$1: function(arg0) { return this.step.$call$1(arg0); },
 step$3: function(arg0, arg1, arg2) { return this.step.$call$3(arg0, arg1, arg2); },
 is$Node: function() { return true; }
});
...
$.$defineNativeClass('SVGMatrix', ["a="], {
 scale$1: function(scaleFactor) {
  return this.scale($.numTypeCheck(scaleFactor));
 },
 get$scale: function() { return new $.BoundClosure4(this, 'scale$1'); }
});
...
;
 ...
 _requestAnimationFrame$1: function(callback) {
  return this.requestAnimationFrame($.convertDartClosureToJS($.functionTypeCheck(callback), 1));
 },
...
(function(){
  ...
  var v11/*class(_CharacterDataImpl)*/ = [v1/*class(_TextImpl)*/,v1/*class(_TextImpl)*/,'CharacterData|Comment|Comment'].join('|');
  var table = [
