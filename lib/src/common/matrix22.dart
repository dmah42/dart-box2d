...
class Matrix22 {
   ...
   */
  Matrix22() : col1 = new Vector2.zero(), col2 = new Vector2.zero();

  /** Constructs a new Matrix22 representing an angle. */
  Matrix22.fromAngle(double angle)
      : col1 = new Vector2.zero(), col2 = new Vector2.zero() {
    setAngle(angle);
  }

  /** Create a new Matrix equal to the given Matrix. */
  Matrix22.copy(Matrix22 other)
      : col1 = new Vector2.copy(other.col1),
        col2 = new Vector2.copy(other.col2);
   ...
   */
  void setFromColumns(Vector2 v1, Vector2 v2) {
    col1.setFrom(v1);
    col2.setFrom(v2);
  }
   ...
   * parameter.
   */
  void multiplyVectorToOut(Vector2 v, Vector2 out) {
   ...
   */
  static void mulTransMatrixAndVectorToOut(Matrix22 matrix, Vector2 vector,
      Vector2 out) {
   ...
   * the result in the given parameter out.
   */
  static void mulMatrixAndVectorToOut(Matrix22 matrix, Vector2 vector,
      Vector2 out) {
  ...
  void solveToOut(Vector2 b, Vector2 out) {
